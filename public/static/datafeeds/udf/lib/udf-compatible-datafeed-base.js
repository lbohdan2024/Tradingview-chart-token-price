        ...
        .then((response) => {
          ...
          if (response.s !== undefined) {
            ...
            const result = {
              ...
              currency_code:
                (_c = response.currency_code) !== null && _c !== void 0
                  ? _c
                  : response["currency-code"],
              original_currency_code:
                (_d = response.original_currency_code) !== null && _d !== void 0
                  ? _d
                  : response["original-currency-code"],
              unit_id:
                (_e = response.unit_id) !== null && _e !== void 0
                  ? _e
                  : response["unit-id"],
              original_unit_id:
                (_f = response.original_unit_id) !== null && _f !== void 0
                  ? _f
                  : response["original-unit-id"],
              unit_conversion_types:
                (_g = response.unit_conversion_types) !== null && _g !== void 0
                  ? _g
                  : response["unit-conversion-types"],
              has_intraday:
                (_j =
                  (_h = response.has_intraday) !== null && _h !== void 0
                    ? _h
                    : response["has-intraday"]) !== null && _j !== void 0
                  ? _j
                  : false,
              visible_plots_set:
                (_k = response.visible_plots_set) !== null && _k !== void 0
                  ? _k
                  : response["visible-plots-set"],
              minmov:
                (_m =
                  (_l = response.minmovement) !== null && _l !== void 0
                    ? _l
                    : response.minmov) !== null && _m !== void 0
                  ? _m
                  : 0,
              minmove2:
                (_o = response.minmovement2) !== null && _o !== void 0
                  ? _o
                  : response.minmove2,
              session:
                (_p = response.session) !== null && _p !== void 0
                  ? _p
                  : response["session-regular"],
              session_holidays:
                (_q = response.session_holidays) !== null && _q !== void 0
                  ? _q
                  : response["session-holidays"],
              supported_resolutions:
                (_t =
                  (_s =
                    (_r = response.supported_resolutions) !== null &&
                    _r !== void 0
                      ? _r
              ...
              has_daily:
                (_v =
                  (_u = response.has_daily) !== null && _u !== void 0
                    ? _u
                    : response["has-daily"]) !== null && _v !== void 0
                  ? _v
                  : true,
              intraday_multipliers:
                (_x =
                  (_w = response.intraday_multipliers) !== null && _w !== void 0
                    ? _w
              ...
              has_weekly_and_monthly:
                (_y = response.has_weekly_and_monthly) !== null && _y !== void 0
                  ? _y
                  : response["has-weekly-and-monthly"],
              has_empty_bars:
                (_z = response.has_empty_bars) !== null && _z !== void 0
                  ? _z
                  : response["has-empty-bars"],
              volume_precision:
                (_0 = response.volume_precision) !== null && _0 !== void 0
                  ? _0
                  : response["volume-precision"],
              format:
                (_1 = response.format) !== null && _1 !== void 0 ? _1 : "price",
            };
