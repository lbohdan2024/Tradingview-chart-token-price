  ...
  [607],
  {
    42838: (e, t, i) => {
      ...
      const u = new o.TranslatedString(
        ...
        T = n.t(null, void 0, i(71776)),
        I = n.t(null, void 0, i(13350)),
        V = n.t(null, void 0, i(819));
      class C extends s.StudyLineDataSourceDefinitionsViewModel {
        ...
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs().styles.childs(),
            ...
            s = e.baseLine.childs(),
            C = (0, r.createLinePropertyDefinition)(
              {
    ...
    15306: (e, t, i) => {
      i.r(t), i.d(t, { StudyOverlayDefinitionsViewModel: () => U });
      var n = i(11542),
        o = i(45126),
        r = i(56570),
        s = i(50151),
      ...
      function f(e) {
        return n.t(e, { context: "input" }, i(32856));
      }
      var v,
        _ = i(68159),
        S = i(10074),
      ...
      const L = new o.TranslatedString(
        ...
        x = n.t(null, void 0, i(55761)),
        B = n.t(null, void 0, i(3554)),
        O = n.t(null, void 0, i(34456)),
        $ = n.t(null, void 0, i(99906)),
        R = n.t(null, void 0, i(59213)),
        E = n.t(null, void 0, i(98236)),
        F = n.t(null, void 0, i(9394)),
        G = n.t(null, void 0, i(69217)),
        j = n.t(null, void 0, i(92516)),
        H = n.t(null, void 0, i(72926)),
        z = n.t(null, void 0, i(64075)),
        J = [
          { title: A, value: 0 },
          { title: N, value: 1 },
          { title: W, value: 9 },
      ...
      r.enabled("chart_style_hilo") && J.push({ title: E, value: 12 });
            ...
            (function (e, t, r, a, u) {
              ...
              for (const v of t) {
                ...
                const t = h(v),
                  _ = `StudyInput${v.id}`,
                  S = f(t),
                  m = new o.TranslatedString(t, S);
                let P = null;
                if ("resolution" === v.type)
                  P = (0, l.createOptionsPropertyDefinition)(
                    {
                      option: (0, l.convertToDefinitionProperty)(
                        e,
                        r[v.id],
                        d.format({ inputName: m }),
                      ),
                    },
                    {
                      id: _,
                      title: S,
                      options: new p.WatchedValue(u.resolutionItems),
                    },
                  );
                else if ("source" === v.type) {
                  const t = (0, s.ensure)(u.sourcesItems);
                  P = (0, l.createOptionsPropertyDefinition)(
                    {
                      option: (0, l.convertToDefinitionProperty)(
                        e,
                    ...
                    { id: _, title: S, options: t },
                  );
                } else if ("options" in v && void 0 !== v.options) {
                  const t = [];
                  for (const e of v.options) {
                    const o = (v.optionsTitles && v.optionsTitles[e]) || e,
                      r = n.t(o, { context: "input" }, i(32856));
                  ...
                  P = (0, l.createOptionsPropertyDefinition)(
                    ...
                    { id: _, title: S, options: new p.WatchedValue(t) },
                  );
                } else if ("symbol" === v.type) {
                  const t = r[v.id],
                    i = (0, s.ensure)(u.getSymbolInfoBySymbol),
                    n = (0, s.ensure)(u.onSymbolsInfosChanged);
                  P = (0, l.createSymbolPropertyDefinition)(
                    {
                      symbol: (0, l.getSymbolDefinitionProperty)(
                        ...
                        n,
                        d.format({ inputName: m }),
                        u.customSymbolInputSetter,
                      ),
                    },
                    { id: _, title: S },
                  );
                } else if ("session" === v.type)
                  P = (0, l.createSessionPropertyDefinition)(
                    {
                  ...
                  P = (0, l.createCheckablePropertyDefinition)(
                    {
                  ...
                  const t = {
                    id: _,
                    title: S,
                    type: "float" === v.type || "price" === v.type ? 1 : 0,
                    defval: v.defval,
                  };
                  void 0 !== v.min && (t.min = new p.WatchedValue(v.min)),
                    void 0 !== v.max && (t.max = new p.WatchedValue(v.max)),
                    void 0 !== v.step &&
                      isFinite(v.step) &&
                      v.step > 0 &&
                      (t.step = new p.WatchedValue(v.step)),
                    (P = (0, l.createNumberPropertyDefinition)(
                      {
                  ...
                  P = (0, l.createTextPropertyDefinition)(
                    {
                    ...
                    { id: _, title: S, isEditable: !0, isMultiLine: !1 },
                  );
                c.push(P);
              }
        ...
        _stylePropertyDefinitions() {
          ...
          const e = this._source.properties().childs(),
            ...
            i = (0, l.createCheckablePropertyDefinition)(
              ...
              { id: "StudyOverlayPriceLine", title: H },
            ),
          ...
          return J.map((t) =>
            t.readonly
              ...
              : {
                  ...
                  title: t.title,
                  disabled:
                    (0, C.isCloseBasedSymbol)(e) &&
                    !(0, C.isSingleValueBasedStyle)(t.value),
                },
          );
        }
      }
