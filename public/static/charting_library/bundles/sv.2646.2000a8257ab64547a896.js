(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    4543: (t) => {
      t.exports = { en: ["Cancel"], sv: ["Avbryt"] };
    },
    47742: (t) => {
      t.exports = { en: ["Close menu"], sv: ["Stäng menyn"] };
    },
    69207: (t) => {
      t.exports = { en: ["Add to favorites"], sv: ["Lägg till som favorit"] };
    },
    30448: (t) => {
      t.exports = {
    ...
    79825: (t) => {
      t.exports = { en: ["Load layout"], sv: ["Ladda layout"] };
    },
    11478: (t) => {
      t.exports = { en: ["Layout name"], sv: ["Layoutnamn"] };
    },
    21329: (t) => {
      t.exports = {
