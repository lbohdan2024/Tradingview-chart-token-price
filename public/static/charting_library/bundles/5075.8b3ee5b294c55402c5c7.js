(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5075],
  {
    ...
    53885: (e, t, o) => {
      "use strict";
      o.d(t, { getStyleClasses: () => s, isCircleLogoWithUrlProps: () => a });
      var n = o(97754),
        r = o(3196),
        i = o.n(r);
      function s(e, t) {
        return n(i()["tv-circle-logo"], i()[`tv-circle-logo--${e}`], t);
      }
      function a(e) {
        return (
          "logoUrl" in e &&
      ...
      function s(e) {
        ...
        return (
          (0, r.useIsomorphicLayoutEffect)(() => {
            ...
            return (0, i.addOutsideEventListener)(u.current, n, l, document, e);
          }, [t, o, s, a, l]),
          c || d
        );
      }
    ...
    26996: (e, t, o) => {
      ...
      function l(e) {
        ...
        return r.createElement(
          "span",
          { className: i(a().loader, n && a().static, t) },
    ...
    67961: (e, t, o) => {
      "use strict";
      o.d(t, { OverlapManager: () => i, getRootOverlapManager: () => a });
      var n = o(50151);
      class r {
        constructor() {
          this._storage = [];
    ...
    50238: (e, t, o) => {
      "use strict";
      o.d(t, { useRovingTabindexElement: () => i });
      var n = o(50959),
        r = o(39416);
      function i(e, t = []) {
    ...
    59695: (e, t, o) => {
      ...
      var n = o(50959),
        r = o(53885),
        i = o(3196);
      const s = o.n(i)()["tv-circle-logo--visually-hidden"];
      function a(e) {
        var t, o;
          ...
          n.createElement(
            ...
            n.createElement(
              ...
              n.createElement(
                m,
                {
                  className: i(v.drawer, u[`position${t}`], h),
                  ref: b,
      ...
      function p(e) {
        ...
        return n.createElement(
          Y,
          {
            ...
            id: t,
            role: o,
            className: r(d, R.item, b && R.withIcon, {
              [R.isActive]: y,
              [R.isDisabled]: E || _,
              [R.hovered]: x,
            }),
            ...
            reference: function (e) {
              (Z.current = e), "function" == typeof L && L(e);
          ...
          b &&
            n.createElement("span", {
              ...
              className: r(R.icon, W && c["round-icon"], w),
              dangerouslySetInnerHTML: { __html: b },
            }),
          n.createElement(
            "span",
            { className: r(R.labelRow, h) },
            n.createElement("span", { className: r(R.label, m) }, T),
          ),
          (void 0 !== f || g) &&
            n.createElement(
              "span",
    ...
    20243: (e, t, o) => {
      ...
      function a(e, t) {
        ...
        if (!e.target) return;
        const n =
          null === (o = e.relatedTarget) || void 0 === o
            ? void 0
            : o.getAttribute("aria-activedescendant");
      ...
      function l(e) {
        ...
        const l = p(e.currentTarget).sort(n.navigationOrderComparator);
        ...
        if (-1 === m) return;
        const v = h(c),
          f = v.indexOf(document.activeElement),
          g = -1 !== f,
          b = (e) => {
            a && (0, r.becomeSecondaryElement)(a),
        ...
        switch ((0, n.mapKeyCodeToDirection)(o)) {
          case "inlinePrev":
            if (!v.length) return;
            e.preventDefault(),
              b(0 === f ? l[m] : g ? d(v, f, -1) : v[v.length - 1]);
            break;
          case "inlineNext":
            if (!v.length) return;
            e.preventDefault(),
              f === v.length - 1 ? b(l[m]) : b(g ? d(v, f, 1) : v[0]);
            break;
          case "blockPrev": {
            e.preventDefault();
            const t = d(l, m, -1);
    ...
    10838: (e, t, o) => {
      ...
      function d(e) {
        const { className: t, ...o } = e,
          [r, d] = (0, a.useRovingTabindexElement)(null);
    ...
    78135: (e, t, o) => {
      ...
      function c(e, t) {
        return (o) => {
          var c, d;
          const { contentWidth: u, contentHeight: p, availableHeight: h } = o,
          ...
          y === n.AutoStrict &&
            (h < m.y + m.height + b + p
              ? ((y = n.Top), (E = i.FromBottomToTop))
              : ((y = n.Bottom), (E = i.FromTopToBottom)));
          const x = y === n.Top ? -1 * b : b,
            _ = v === r.Right ? m.right : m.left,
            T = y === n.Top ? m.top : m.bottom,
            C = {
              x: _ - (f === s.FromRightToLeft ? u : 0) + g,
              y: T - (E === i.FromBottomToTop ? p : 0) + x,
            };
          return w && (C.overrideWidth = m.width), C;
        };
      }
    },
    81348: (e, t, o) => {
      ...
      const a = s,
        l = n.forwardRef((e, t) => {
          const {
            ...
            k = r(y, w.button, (b || T) && "apply-common-tooltip", {
              [w.isActive]: c,
              [w.isOpened]: d,
              [w.isInteractive]: (E || Boolean(v)) && !u && !x,
              [w.isDisabled]: Boolean(u || x),
              [w.isGrouped]: p,
              [w.hover]: h,
              [w.clicked]: m,
            }),
          ...
          super(e),
            ...
            (this._handleMenuFocus = (e) => {
              ...
              e.relatedTarget === this._wrapperRef &&
                ...
                null === (o = (t = this.props).onMenuFocus) ||
                  void 0 === o ||
                  o.call(t, e);
            }),
            ...
            (this._handleClick = (e) => {
              (h.enabled("skip_event_target_check") ||
            ...
            (this._handleKeyDown = (e) => {
              ...
              if (e.currentTarget.contains(e.target))
                ...
                switch (n) {
                  case 27: {
                    e.preventDefault();
                    const { shouldReturnFocus: o, isOpenedByButton: n } =
                      this.state;
                    this._handleToggleDropdown(!1),
                      o &&
                        n &&
                ...
                o &&
                  n.createElement(
                    ...
                    n.createElement(
                      ...
                      n.createElement(a.ToolWidgetCaret, { dropped: y }),
                    ),
                  ),
                this.state.isOpened &&
                  (f
                    ? n.createElement(p.MatchMedia, { rule: f }, (e) =>
          ...
          return m
            ...
            : n.createElement(
                s.PopupMenu,
                {
                  ...
                  minWidth: o,
                  onClose: this._handleClose,
                  position: (0, u.getPopupPositioner)(this._wrapperRef, h),
                  className: r,
                  maxHeight: i,
                  "data-name": t,
    ...
    20792: (e, t, o) => {
      "use strict";
      o.d(t, { DEFAULT_TOOLBAR_BUTTON_THEME: () => s, ToolbarButton: () => a });
      var n = o(50959),
        r = o(81348),
        i = o(50238);
      const s = r.DEFAULT_TOOL_WIDGET_BUTTON_THEME,
        a = (0, n.forwardRef)(function (e, t) {
          const { tooltip: o, ...s } = e,
            [a, l] = (0, i.useRovingTabindexElement)(t);
          return n.createElement(r.ToolWidgetButton, {
            "aria-label": o,
            ...s,
            tag: "button",
            ref: a,
    ...
    98945: (e, t, o) => {
      ...
      const s = (0, n.forwardRef)(function (e, t) {
        const { tooltip: o, ...s } = e,
          [a, l] = (0, r.useRovingTabindexElement)(t);
        return n.createElement(i.ToolWidgetIconButton, {
          "aria-label": o,
          ...s,
          tag: "button",
          ref: a,
    ...
    88811: (e, t, o) => {
      ...
      const c = (0, n.forwardRef)(function (e, t) {
          const { tooltip: o, tag: i, buttonRef: s, reference: c, ...d } = e,
            u = (0, r.useFunctionalRefObject)(null != c ? c : null);
          return n.createElement(a.ToolWidgetMenu, {
            "aria-label": o,
            ...d,
            ref: t,
            tag: null != i ? i : "button",
            reference: null != s ? s : u,
            "data-tooltip": o,
            onMenuKeyDown: l.handleAccessibleMenuKeyDown,
            onMenuFocus: (e) =>
              (0, l.handleAccessibleMenuFocus)(e, null != s ? s : u),
          });
        }),
        d = (0, n.forwardRef)(function (e, t) {
          const { tooltip: o, menuReference: a = null, ...l } = e,
            [d, u] = (0, i.useRovingTabindexElement)(null),
            p = (0, r.useFunctionalRefObject)(a);
