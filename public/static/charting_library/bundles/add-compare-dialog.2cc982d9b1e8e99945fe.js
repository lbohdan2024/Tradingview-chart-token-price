      ...
      function s(e) {
        const {
          ...
          f = a(
            ...
            o && c().checked,
            d && c().disabled,
            u && c().disableActiveStyles,
          );
        return n.createElement(
          "span",
          { className: f, ...h },
          n.createElement(r.Icon, { icon: v, className: c().icon }),
        );
      }
    },
    45601: (e, t, o) => {
    ...
    14283: (e, t, o) => {
      ...
      function T(e) {
        ...
        return n.createElement(
          ...
          n.createElement(S.SymbolSearchDialogContentItem, {
            ...
            onClick: function (t) {
              if (Boolean(a) && c && !s)
                return null == t || t.preventDefault(), void m(c);
      ...
      function V(e) {
        const { handleListWidth: t } = (0, d.ensureNotNull)(
          ...
          c = (0, p.useWatchedValueReadonly)({ watchedValue: r.isDataReady() }),
                      ...
                      n.createElement(
                        ...
                        C.map((e) =>
                          n.createElement(T, {
                            ...
                            className: s()(H.item, e.id === w && H.highlighted),
                            key: e.id,
                            id: e.id,
                            shortName: e.title,
                            logoId: e.logoId,
        ...
        function E(e, t) {
          null == t || t.preventDefault(), r.removeStudy(e);
        }
        function k(e) {
      ...
      function Y(e) {
        const {
          ...
          } = (0, w.useEnsuredContext)(b.SymbolSearchItemsDialogContext),
          {
            ...
            hoveredItemId: x,
            setHoveredItemId: I,
            selectedCompareOptionIndex: C,
            setSelectedCompareOptionIndex: E,
            selectedCompareIndex: k,
            setSelectedCompareIndex: D,
            selectedItemRef: M,
            clearInput: N,
            allowExtendTimeScale: _,
          } = (0, w.useEnsuredContext)(y),
          L = (0, p.useWatchedValueReadonly)({ watchedValue: S.studies() }),
          O = a[r],
          T = "compare" === s,
          A = "exchange" === s,
          R = T ? k : r,
        ...
        return (
          ...
          n.createElement(W.AdaptivePopupDialog, {
            ...
            className: c(
              X.dialog,
              !m && (h ? X.tabletDialog : X.desktopDialog),
            ),
            onKeyDown: function (e) {
              ...
              switch (a) {
                ...
                case 27:
                  return (
                    e.preventDefault(), A ? void d("symbolSearch") : void v()
                  );
              }
              if (!T && "good" !== g) return;
              switch ((0, j.mapKeyCodeToDirection)(a)) {
                case "blockPrev":
                  if ((e.preventDefault(), 0 === R)) return;
                  if (-1 === R) return void F(0);
                  F(R - 1);
                  break;
                case "blockNext":
                  if ((e.preventDefault(), R === z.length - 1)) return;
                  F(R + 1);
                  break;
                case "inlinePrev": {
                  const o = G();
        ...
        function G() {
          if (!O) return;
          const { id: e, isOffset: t, onExpandClick: o } = O;
            ...
            "" ===
              ...
              ? "symbolSearch" === a.current &&
                "" ===
                  (null ===
                    (l =
                      null === (r = null == t ? void 0 : t.current) ||
                      void 0 === r
                        ? void 0
                        : r.value) || void 0 === l
                    ? void 0
    ...
    41590: (e, t, o) => {
      ...
      function p(e) {
        const {
          ...
          f = (0, a.ensureNotNull)((0, n.useContext)(c.DrawerContext)),
          [g] = (0, n.useState)(() => (0, l.randomHash)()),
          b = (0, n.useRef)(null),
          S = (0, n.useContext)(s.CloseDelegateContext);
        return (
          (0, n.useLayoutEffect)(
            () => (
              ...
              return (
                ...
                null !== s.current &&
                  (i
                    ...
                    : (0, a.disableBodyScroll)(s.current, {
                        allowTouchMove: d(s),
                      })),
                () => {
                  c--,
                    null !== s.current &&
                      (i
                        ...
                        : (0, a.enableBodyScroll)(s.current));
                }
              );
          }, []),
          n.createElement("div", { ref: s, ...r }, o)
        );
      });
      function d(e) {
        return (t) => {
