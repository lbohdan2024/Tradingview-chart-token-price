  ...
  [3005],
  {
    ...
    67842: (e, t, n) => {
      ...
      var r = n(50959),
        ...
        i = n(39416);
      function a(e, t = []) {
        const { callback: n, ref: a = null } = (function (e) {
    ...
    42014: (e, t, n) => {
      ...
      const s = [
        ...
        { name: "M", label: r.t(null, { context: "interval" }, n(18193)) },
      ];
    },
    6190: (e, t, n) => {
      "use strict";
    ...
    39214: (e, t, n) => {
      "use strict";
      n.r(t), n.d(t, { HeaderToolbarRenderer: () => Ie });
      var r = n(50959),
        s = n(32227),
        i = n(50151),
        a = n(97754),
      ...
      var y = n(45601),
        ...
        _ = n(33644),
        w = n(45820);
      const M = { text: C.t(null, void 0, n(48161)) };
      function R(e) {
        return r.createElement(
          "div",
          { className: _.wrap },
          r.createElement(E.Icon, { className: _.icon, icon: w }),
          M.text,
        );
      }
      var k = n(61119),
      ...
      function N(e) {
        return r.createElement("div", {
          className: a(O.fadeRight, e.className, {
            [O.isVisible]: e.isVisible,
          }),
        });
      }
      function T(e) {
        return r.createElement(A, { ...e, className: O.scrollLeft });
      }
      function B(e) {
        return r.createElement(A, { ...e, className: O.scrollRight });
      }
      function A(e) {
        return r.createElement(
          "div",
          {
            className: a(e.className, { [O.isVisible]: e.isVisible }),
            onClick: e.onClick,
          },
          r.createElement(
            "div",
            { className: O.iconWrap },
            r.createElement(E.Icon, { icon: F, className: O.icon }),
          ),
        );
      }
      const D = (function (e = T, t = B, n = L, s = N) {
        var o;
        return (
          ((o = class extends r.PureComponent {
            ...
            animateTo(e, t = I.dur) {
              ...
              n &&
                ((0, V.isRtl)() && (e = (0, V.getLTRScrollLeftOffset)(n, e)),
                t <= 0
              ...
              return r.createElement(
                ...
                (d) =>
                  r.createElement(
                    ...
                    r.createElement(
                      "div",
                      { className: a(O.wrap, b ? O.wrapWithArrowsOuting : "") },
                      r.createElement(
                        "div",
                        {
                          className: a(O.scrollWrap, v, {
                            [O.noScrollBar]: !o,
                          }),
      ...
      var H = n(70412),
        ...
        z = n(6190),
        G = n(27082);
      const X = (0, q.registryContextType)(),
        U = d.enabled("widget");
      class Q extends r.PureComponent {
        constructor(e, t) {
          super(e, t),
            (this._handleMouseOver = (e) => {
              (0, H.hoverMouseEventFilter)(e) &&
                    ...
                    switch (e.type) {
                      ...
                      case "TradingViewStyledButton":
                        return r.createElement(
                          ...
                          { ...e.params, className: G.button, displayMode: n },
                        );
                      case "Dropdown":
            ...
            (this._fixLastGroup = (e, t, n) => {
              if (t === n.length - 1 && r.isValidElement(e) && e.type === b) {
                const t =
            ...
            (0, q.validateRegistry)(t, { tools: m.any.isRequired }),
        ...
        render() {
          ...
          return r.createElement(
            z.Toolbar,
            {
              className: a(G.inner, { [G.fake]: m }),
              onContextMenu: P.preventDefaultForContextMenu,
              "data-is-fake-main-panel": m,
              "aria-hidden": m,
            },
            r.createElement(
              D,
              {
                isVisibleFade: p.mobiletouch && C,
                isVisibleButtons: !p.mobiletouch && C && f,
              ...
              (c) =>
                r.createElement(
                  "div",
                  { className: G.content, ref: c, role: "none" },
                  r.createElement(
                    y.Measure,
                    { onResize: m ? this._handleInnerResize : null },
                    (c) =>
                      r.createElement(
                        "div",
                        ...
                        r.createElement(
                          ...
                          !o &&
                            r.Children.toArray([
                              ...
                              e.AlertReferral &&
                                !d.enabled("hide_alert_referral_tool") &&
                                r.createElement(
                                  b,
                                  { key: "alert-referral" },
                          ...
                          (function (e) {
                            ...
                            r.Children.toArray([
                              ...
                              r.createElement(b, {
                                removeSeparator: !0,
                                key: "gap-1",
                                className: a(G.fill, m && G.collapse),
                              }),
                              (e.Layout || e.SaveLoad) &&
                                r.createElement(
                                  b,
                              ...
                              t.showLaunchInPopupButton &&
                                e.OpenPopup &&
                                !d.enabled("hide_open_popup_button") &&
                                r.createElement(
                                  b,
                                  { key: "popup" },
                              ...
                              !o &&
                                e.Publish &&
                                !d.enabled("hide_publish_button") &&
                                r.createElement(
                                  b,
                                  {
                                    key: "publish",
                                    className: G.mobilePublish,
                                    removeSeparator: !0,
                                  },
                                  r.createElement(e.Publish, {
                                    id: m ? void 0 : x.PublishMobile,
                                  }),
                                ),
                              ...S,
                            ]),
      ...
      var K = n(64147),
        j = n(59063);
      class J extends j.CommonJsonStoreService {
        constructor(e, t, n = []) {
      ...
      var $ = n(10074),
        Z = n(97144);
      class ee extends j.AbstractJsonStoreService {
        constructor(e, t, n) {
      ...
      var te = n(82992),
        ...
        re = n(56840),
        se = n(21097);
      class ie extends j.AbstractJsonStoreService {
        constructor(e, t, n = []) {
          super(
            e,
            t,
      ...
      const ae = new ie(se.TVXWindowEvents, re);
      var oe = n(42014);
      class le {
        constructor(e) {
          (this._customIntervalsService = ae),
            (this._supportedIntervalsMayChange = new ne.Delegate()),
      ...
      class me {
        constructor(e = re) {
          (this._favorites = []),
            (this._favoritesChanged = new ne.Delegate()),
            (this._settings = e),
      ...
      var fe = n(85049);
      const ge = {
        [fe.ResolutionKind.Ticks]: !1,
        [fe.ResolutionKind.Seconds]: !1,
        [fe.ResolutionKind.Minutes]: !1,
        [fe.SpecialResolutionKind.Hours]: !1,
        [fe.ResolutionKind.Days]: !1,
        [fe.ResolutionKind.Range]: !1,
      };
      class Se extends j.CommonJsonStoreService {
        constructor(e, t, n = ge) {
          super(
            e,
            t,
      ...
      function Ee(e = []) {
        return (0, $.mergeResolutions)(
          e,
          d.enabled("star_some_intervals_by_default") ? ye : [],
        );
      }
      new ee(se.TVXWindowEvents, re, Ee()), new J(se.TVXWindowEvents, re, Ce());
      const _e = {
      ...
      class ke extends r.PureComponent {
        constructor(e) {
          ...
          const y = Ce(this.props.defaultFavoriteStyles);
          this._favoriteChartStylesService =
            h || new J(se.TVXWindowEvents, re, y);
          const C = Ee(this.props.defaultFavoriteIntervals);
          (this._favoriteIntervalsService =
            l || new ee(se.TVXWindowEvents, re, C)),
            (this._intervalsMenuViewStateService = new Se(
              se.TVXWindowEvents,
              re,
            )),
        ...
        componentDidUpdate(e, t) {
          ...
          n !== t.isVisible &&
            (h.emit("toggle_header", n), this._negotiateResizer()),
        ...
        render() {
          ...
          return r.createElement(
            q.RegistryProvider,
            { value: this._registry, validation: _e },
            r.createElement(
              m,
              null,
              r.createElement(
                "div",
                {
                  className: a(Me.toolbar, { [Me.isHidden]: !o }),
        ...
        _addCustomHTMLButton(e, t = "left") {
          const n = new K.WatchedValue(0),
            r = (0, we.parseHtmlElement)(
              `<div class="apply-common-tooltip ${Me.customButton}">`,
            ),
            s = {
              type: "Button",
              id: e,
      ...
      ke.defaultProps = { allowedModes: ["full", "medium"] };
      class Ie {
        constructor(e, t) {
          (this._component = null),
            ...
            (this._container = e),
            s.render(
              r.createElement(ke, { ...t, ref: this._handleRef }),
              this._container,
            );
        }
        destroy() {
