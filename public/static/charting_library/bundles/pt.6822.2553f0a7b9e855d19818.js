(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    94920: (t) => {
      t.exports = { en: ["ADJ"], pt: ["AJUSTES"] };
    },
    16755: (t) => {
      t.exports = { en: ["B-ADJ"], pt: ["B-ADJ"] };
    },
    82631: (t) => {
      t.exports = { en: ["SET"], pt: ["DEFINIR"] };
    },
    22233: (t) => {
      t.exports = { en: ["auto"], pt: ["auto"] };
    },
    4161: (t) => {
      t.exports = { en: ["log"], pt: ["log"] };
    },
    58221: (t) => {
      t.exports = { en: ["All data"], pt: ["Todos os dados"] };
    },
    19273: (t) => {
      t.exports = { en: ["Year to day"], pt: ["De ano para dia"] };
    },
    58426: (t) => {
      t.exports = {
    ...
    61206: (t) => {
      t.exports = { en: ["Maximize chart"], pt: ["Maximizar gráfico"] };
    },
    2031: (t) => {
      t.exports = {
    ...
    27665: (t) => {
      t.exports = { en: ["Sessions"], pt: ["Sessões"] };
    },
    31142: (t) => {
      t.exports = { en: ["Restore chart"], pt: ["Restaurar gráfico"] };
    },
    41888: (t) => {
      t.exports = {
    ...
    77073: (t) => {
      t.exports = { en: ["Timezone"], pt: ["Fuso Horário"] };
    },
    49545: (t) => {
      t.exports = {
