  ...
  [2306],
  {
    ...
    68976: (t) => {
      t.exports = {
        ...
        startIconWrap: "startIconWrap-D4RPB3ZC",
        endIconWrap: "endIconWrap-D4RPB3ZC",
        withStartIcon: "withStartIcon-D4RPB3ZC",
        withEndIcon: "withEndIcon-D4RPB3ZC",
    ...
    94720: (t, e, o) => {
      ...
      function g(t) {
        const {
          ...
          b = (function (t) {
            ...
            return (
              0 !== t &&
                (1 & t && (e = h(e, m()["no-corner-top-left"])),
                2 & t && (e = h(e, m()["no-corner-top-right"])),
                4 & t && (e = h(e, m()["no-corner-bottom-right"])),
                8 & t && (e = h(e, m()["no-corner-bottom-left"]))),
              e
            );
          })((0, d.getGroupCellRemoveRoundBorders)(u));
        return h(
          c,
          m().button,
          m()[o],
          ...
          b,
          p && m().grouped,
          p && !g && m().adjustPosition,
          p && u.isTop && m().firstRow,
          p && u.isLeft && m().firstCol,
          v && y && m().multilineContent,
          f && m().link,
          _,
        );
      }
      function v(t) {
        ...
        return c.createElement(
          ...
          null,
          l &&
            c.createElement(p.Icon, { icon: l, className: m().startIconWrap }),
          n && c.createElement("span", { className: m().content }, n),
          r &&
            !i &&
            c.createElement(p.Icon, { icon: r, className: m().endIconWrap }),
          d &&
            (function (t) {
              return (
                t.primaryText &&
      ...
      function w(t) {
        ...
        return {
          ...u,
          ...(0, b.filterDataProps)(t),
          ...(0, b.filterAriaProps)(t),
        };
      }
      function C(t) {
        const { reference: e, tooltipText: o, ...i } = t,
          {
            isGrouped: n,
            cellState: r,
            ...
            "data-overflow-tooltip-text":
              null != o
                ...
                : t.primaryText
                  ...
                  : (0, y.getTextForTooltip)(t.children),
          },
          c.createElement(v, { ...i }),
        );
      }
        ...
        return i.createElement(
          u.ToolWidgetMenu,
          {
            ...
            verticalDropDirection: f
              ? _.VerticalDropDirection.FromBottomToTop
              : void 0,
            horizontalDropDirection: f
              ? _.HorizontalDropDirection.FromLeftToRight
              : void 0,
            horizontalAttachEdge: f ? _.HorizontalAttachEdge.Left : void 0,
            verticalAttachEdge: f ? _.VerticalAttachEdge.Top : void 0,
            content: i.createElement(
              "div",
              { className: g.wrap },
              i.createElement(a.Icon, { className: g.icon, icon: o }),
              i.createElement(
                "div",
                { className: g.colorBg },
                i.createElement("div", {
                  className: r()(g.color, T && g.multicolor, S && g.white),
                  style: T ? void 0 : { backgroundColor: w },
                }),
              ),
            ),
            arrow: !1,
          ...
          i.createElement(d.ColorPicker, {
            ...
            onColorChange: function (t, e) {
              const o = w
                ...
                : 0;
              L((0, c.generateColor)(String(t), o, true)),
                e || (0, s.ensureNotNull)(C.current).close();
            },
            onOpacityChange: function (t) {
              L((0, c.generateColor)(w, (0, c.alphaToTransparency)(t), !0));
            },
            selectOpacity: void 0 !== x,
            selectCustom: !0,
            customColors: E,
    ...
    61259: (t, e, o) => {
      ...
      var i = o(50959),
        ...
        g = o(66611),
        v = o(66431);
      const y = (0, h.mergeThemes)(c.DEFAULT_POPUP_MENU_ITEM_THEME, v),
        f = [
          { value: 1, icon: p },
          { value: 2, icon: u },
          { value: 3, icon: m },
            ...
            content: i.createElement(
              ...
              w
                ? i.createElement(
                    ...
                    i.createElement(s.Icon, { icon: g }),
                  )
                : i.createElement(
                    "div",
                    { className: v.buttonWrap },
                    !_ && i.createElement(s.Icon, { icon: C }),
                    i.createElement(
                      "div",
                      { className: n(!_ && v.buttonLabel) },
                      `${b}px`,
                    ),
                  ),
            ),
          },
          f.map(({ value: t, icon: e }) =>
    ...
    35789: (t, e, o) => {
      ...
      var i = o(50959),
        ...
        d = Math.ceil,
        p = Math.max;
      const u = function (t, e, o) {
        e = (o ? (0, c.default)(t, e, o) : void 0 === e)
          ? 1
          : p((0, h.default)(e), 0);
        var i = null == t ? 0 : t.length;
        if (!i || e < 1) return [];
        for (var n = 0, r = 0, s = Array(d(i / e)); n < i; )
          s[r++] = (0, l.default)(t, n, (n += e));
        return s;
      };
      var m = o(24377),
        _ = o(50151),
      ...
      function x(t) {
        const { color: e, selected: r, onSelect: a, onSwatchRemove: l } = t,
          [c, h] = (0, i.useState)(!1),
          [d, p] = (0, b.useRovingTabindexElement)(null),
          u = Boolean(l) && !g.CheckMobile.any();
        return i.createElement(
          i.Fragment,
          null,
          i.createElement("button", {
            ...
            className: n(
              ...
              r && C.selected,
              !e && C.empty,
              String(e).toLowerCase() === f.white && C.white,
            ),
            onClick: function () {
              a(e);
            },
            onContextMenu: u ? m : void 0,
            tabIndex: p,
            "data-role": "swatch",
          }),
          u &&
      ...
      function T(t) {
        ...
        if (!e) return null;
        const a = o ? (0, m.parseRgb)(String(o)) : void 0,
          l = u(e, 10);
        return i.createElement(
          "div",
          ...
          l.map((t, e) =>
            i.createElement(
              "div",
              { className: C.row, "data-role": "row", key: e },
              t.map((t, o) =>
                i.createElement(x, {
                  key: String(t) + o,
                  color: t,
                  selected:
                    a && (0, m.areEqualRgb)(a, (0, m.parseRgb)(String(t))),
                  onSelect: c,
                  onSwatchRemove: s
                    ? () =>
                        (function (t, e) {
      ...
      class M extends i.PureComponent {
        constructor() {
          super(...arguments),
            ...
            (this._handlePosition = (t) => {
              ...
              o({
                h: e,
                s: (0, L.clamp)(n / i.width, 0, 1),
                v: (0, L.clamp)(1 - r / i.height, 0, 1),
              });
            }),
            (this._handleKeyDown = (t) => {
              const {
                ...
                r = (0, D.hashFromEvent)(t);
              if (!n || !k.includes(r)) return;
              if (37 === r || 39 === r) {
                return void n({
                  h: e,
                  s: (0, L.clamp)(37 === r ? o - N : o + N, 0, 1),
                  v: i,
                });
              }
              n({
        ...
        render() {
          ...
          return i.createElement(
            ...
            {
              tabIndex: 0,
              className: r()(W.accessible, t),
              onKeyDown: this._handleKeyDown,
            },
            i.createElement(
              "div",
              {
                className: W.saturation,
      ...
      class R extends i.PureComponent {
        constructor() {
          super(...arguments),
            ...
            (this._handlePosition = (t) => {
              ...
              if (!i) return;
              const n = (0, _.ensureNotNull)(
                  this._container,
                ).getBoundingClientRect(),
                r = t.clientY - n.top;
              i({ h: (0, L.clamp)(r / n.height, 0, 1), s: e, v: o });
            }),
            (this._handleKeyDown = (t) => {
              const {
                  hsv: { h: e, s: o, v: i },
              ...
              n({
                h: (0, L.clamp)(38 === r ? e - 0.01 : e + 0.01, 0, 1),
                s: o,
                v: i,
              });
            }),
        ...
        render() {
          ...
          return i.createElement(
            "div",
            {
              className: r()(I.hue, I.accessible, t),
              tabIndex: 0,
              onKeyDown: this._handleKeyDown,
            },
            i.createElement(
      ...
      var A = o(11988);
      const F = "#000000",
        V = s.t(null, { context: "Color Picker" }, o(55517));
        ...
        constructor(t) {
          super(t),
            ...
            (this._handleHSV = (t) => {
              ...
              this.setState({ color: e, inputColor: z(e), hsv: t }),
                this.props.onSelect(e);
            }),
            (this._handleInput = (t) => {
              const e = z(t.currentTarget.value);
              try {
                const t = P(e),
                  o = `#${e}`;
          ...
          const e = t.color || F;
          this.state = { color: e, inputColor: z(e), hsv: P(e) };
        }
        componentDidMount() {
          var t;
          g.CheckMobile.any() ||
        ...
        render() {
          ...
          return i.createElement(
            ...
            i.createElement(
              ...
              i.createElement(
                "div",
                { className: A.inputWrap },
                i.createElement("span", { className: A.inputHash }, "#"),
      ...
      var U = o(94996);
      const H = s.t(null, { context: "Color Picker" }, o(29619)),
          ...
          u
            ...
            : i.createElement(
                ...
                i.createElement(
                  ...
                  i.createElement("div", { className: U.separator }),
                  i.createElement(
                    T,
                    {
                      colors: l,
                ...
                s &&
                  i.createElement(
                    i.Fragment,
                    null,
                    i.createElement("div", { className: U.sectionTitle }, Z),
      ...
      function r(t, e) {
        return class extends i.PureComponent {
          render() {
            ...
            if (!o) return null;
            const s = i.createElement(t, { ...this.props, zIndex: 150 });
            return "parent" === r
              ? s
    ...
    33335: (t) => {
      t.exports = { mobile: "screen and (max-width: 567px)" };
    },
    78135: (t, e, o) => {
      "use strict";
      o.d(e, {
      ...
      function c(t, e) {
        return (o) => {
          var c, h;
          const { contentWidth: d, contentHeight: p, availableHeight: u } = o,
            m = (0, a.ensureNotNull)(t).getBoundingClientRect(),
            {
              horizontalAttachEdge: _ = l.horizontalAttachEdge,
          ...
          let b =
              null !== (c = e.verticalAttachEdge) && void 0 !== c
                ? c
                : l.verticalAttachEdge,
            w =
              null !== (h = e.verticalDropDirection) && void 0 !== h
                ? h
                : l.verticalDropDirection;
          b === i.AutoStrict &&
            (u < m.y + m.height + y + p
              ? ((b = i.Top), (w = r.FromBottomToTop))
              : ((b = i.Bottom), (w = r.FromTopToBottom)));
          const C = b === i.Top ? -1 * y : y,
            x = _ === n.Right ? m.right : m.left,
            T = b === i.Top ? m.top : m.bottom,
            S = {
              x: x - (g === s.FromRightToLeft ? d : 0) + v,
              y: T - (w === r.FromBottomToTop ? p : 0) + C,
            };
          return f && (S.overrideWidth = m.width), S;
        };
      }
    },
    81348: (t, e, o) => {
      ...
      const a = s,
        l = i.forwardRef((t, e) => {
          const {
            ...
            E = n(b, f.button, (y || T) && "apply-common-tooltip", {
              [f.isActive]: c,
              [f.isOpened]: h,
              [f.isInteractive]: (w || Boolean(_)) && !d && !C,
              [f.isDisabled]: Boolean(d || C),
              [f.isGrouped]: p,
              [f.hover]: u,
              [f.clicked]: m,
            }),
            P =
              a &&
              ("string" == typeof a
                ? i.createElement(r.Icon, { className: f.icon, icon: a })
                : i.cloneElement(a, {
    ...
    20626: (t, e, o) => {
      ...
      class v extends i.PureComponent {
          ...
          super(t),
            ...
            (this._handleMenuFocus = (t) => {
              ...
              t.relatedTarget === this._wrapperRef &&
                ...
                null === (o = (e = this.props).onMenuFocus) ||
                  void 0 === o ||
                  o.call(e, t);
            }),
            ...
            (this._handleOpen = () => {
              ...
              "div" !== this.props.tag &&
                ...
                null ===
                  (e =
                    null === (t = this.props.menuReference) || void 0 === t
                      ? void 0
                      : t.current) ||
                  void 0 === e ||
                  e.addEventListener(
                ...
                null === (o = this._controller.current) ||
                  void 0 === o ||
                  o.focus());
            }),
            (this._handleClick = (t) => {
              (u.enabled("skip_event_target_check") ||
                t.target instanceof Node) &&
                t.currentTarget.contains(t.target) &&
                (this._handleToggleDropdown(void 0, (0, m.isKeyboardClick)(t)),
                this.props.onClick &&
            ...
            (this._handleKeyDown = (t) => {
              ...
              if (t.currentTarget.contains(t.target))
                ...
                switch (i) {
                  case 27: {
                    t.preventDefault();
                    const { shouldReturnFocus: o, isOpenedByButton: i } =
                      this.state;
                    this._handleToggleDropdown(!1),
                      o &&
                        i &&
                        (null === (e = this._wrapperRef) ||
                          void 0 === e ||
                          e.focus());
                    break;
                  }
            ...
            ? i.createElement(
                ...
                o &&
                  i.createElement(
                    ...
                    i.createElement(
                      "div",
                      { className: _.arrowWrap },
                      i.createElement(a.ToolWidgetCaret, { dropped: b }),
                    ),
                  ),
                this.state.isOpened &&
                  (g
                    ? i.createElement(p.MatchMedia, { rule: g }, (t) =>
        ...
        focus() {
          var t;
          null === (t = this._wrapperRef) || void 0 === t || t.focus();
        }
        update() {
      ...
      v.defaultProps = { arrow: !0, closeOnClickOutside: !0, theme: _ };
    },
    17815: (t, e, o) => {
      "use strict";
      ...
      function E(t) {
        ...
        return i.createElement(
          f.ToolWidgetMenu,
          {
            className: x(n, S.dots),
            arrow: !1,
            title: e,
            drawerBreakpoint: w.Mobile,
            content: i.createElement(y.Icon, { icon: T }),
            "data-name": "more",
      ...
      class P extends s.FloatingToolbar {
        constructor(t) {
          super({
            ...
            (this._canBeShownValue = new _.WatchedValue(!1)),
    ...
    10540: (t, e, o) => {
      ...
      class _ {
        ...
        _getEventTarget() {
          var t;
          return null !== (t = this._rootElement) && void 0 !== t
            ? t
            : this._handle;
        }
        _dispatchEvent(t) {
      ...
      class f {
        constructor(t) {
          (this._items = []),
            ...
            (this._handleDragStart = (t) => {
              var e, o;
              const i = this._getAllItems()[t];
              if (!(i instanceof HTMLElement) || null !== this._helper) return;
              i.style.zIndex = "10";
              const n = this._options.source,
              ...
              (this._helper = {
                ...
                leftBorder:
                  s.left +
                  b(n, "padding-left") +
                  b(n, "border-left-width") -
                  r.left -
                  1,
                rightBorder:
                  s.right -
                  b(n, "padding-right") -
                  b(n, "border-right-width") -
                  r.right +
                  1,
                topBorder:
                  s.top +
                  b(n, "padding-top") +
                  b(n, "border-top-width") -
                  r.top -
                  1,
                bottomBorder:
                  s.bottom -
                  b(n, "padding-bottom") -
                  b(n, "border-bottom-width") -
                  r.bottom +
                  1,
              }),
                null === (o = (e = this._options).start) ||
                  void 0 === o ||
                  o.call(e, t);
            }),
            (this._handleDragMove = (t) => {
              ...
              if ("y" === c) {
                const t = (0, g.clamp)(d, e, o);
                s.style.transform = `translateY(${t}px)`;
              }
              if ("x" === c) {
                const t = (0, g.clamp)(h, i, n);
            ...
            (this._handleDragStop = () => {
              ...
              this._getAllItems()[this._helper.draggableIndex].style.zIndex =
                "";
              const o = this._applyNewItemsOrder();
              this._cleanup(),
                this._initBackends(),
                null !== o &&
                  (null === (e = (t = this._options).stop) ||
                    void 0 === e ||
                    e.call(t, o));
            }),
            (this._options = t),
        ...
        _getAllItems() {
          var t;
          return (
            (null === (t = this._items) || void 0 === t ? void 0 : t.length) ||
      ...
      class S {
        constructor(t) {
          (this._widget = document.createElement("div")),
            ...
            (this._options = t),
            (this._widget = (0, w.parseHtmlElement)(T)),
        ...
        show(t) {
          this.isVisible() ||
            ...
            this._widget.classList.contains("i-hidden")
              ...
              : (null == t || t(), this._widget.classList.remove("i-closed")),
        ...
        addWidget(t, e = {}) {
          ...
          (n.className = "tv-floating-toolbar__widget js-widget"),
            n.appendChild(t);
          const r =
            e.index === i ? null : this._content.childNodes.item(e.index);
          this._content.insertBefore(n, r),
            this._onWindowResize(),
            null === (o = this._sortable) || void 0 === o || o.updateList();
        }
        ...
        removeWidget(t) {
          ...
          o &&
            (this._content.removeChild(o),
            this._onWindowResize(),
            null === (e = this._sortable) || void 0 === e || e.updateList());
        }
        widgetsCount() {
        ...
        _getSavedPosition() {
          ...
          if ("device" === this._options.positionStorageType) {
            const t = d.TVLocalStorage.getItem(
    ...
    85497: (t, e, o) => {
      "use strict";
      o.d(e, { LineToolPropertiesWidgetBase: () => bt });
      var i = o(50959),
        n = o(32227),
        r = o(11542),
        s = o(45126),
      ...
      function M(t) {
        ...
        const a = s[0].properties().frozen,
          ...
          c = l
            ...
            : { tooltip: r.t(null, void 0, o(5837)), icon: N };
      ...
      function $(t, e) {
          ...
          n = (function (t, e) {
              ...
              i.push(
                new G.Action({
                  ...
                  options: {
                    ...
                    icon: o(36296),
                    shortcutHint:
                      Z.humanReadableModifiers(j.Modifiers.Mod) + n + " Drag",
            ...
            if (a.length > 0) {
              const e = {
                ...
                shortcutHint:
                  Z.humanReadableModifiers(j.Modifiers.Mod) + n + " C",
                onExecute: () => {
        ...
        if (
          (n.length && i.push(new G.Separator(), ...n),
          e.some((t) => t.isSynchronizable()))
        ) {
          const o = (0, H.createSyncDrawingActions)(t, e);
          o.length && i.push(new G.Separator(), ...o);
        }
        return (
          i.push(
            new G.Separator(),
            (0, H.createActionToggleVisibilityDataSources)(t, e),
          ),
          i
        );
      }
      ...
      function X(t) {
        ...
        return (
          (0, i.useEffect)(() => {
            var t;
            l.length &&
              (null === (t = h.current) || void 0 === t || t.update());
          }, [l]),
          i.createElement(
            O.ToolWidgetMenu,
            {
              ...
              onClick: _,
              title: e,
              content: i.createElement(A.Icon, { icon: K }),
              "data-name": "more",
              menuDataName: "more-menu",
              closeOnEsc: !0,
            },
            i.createElement(z.ActionsTable, { parentIsOpened: !0, items: l }),
          )
        );
      }
      function q(t) {
      ...
      function it(t) {
            ...
            () => [
              new G.Action({
                ...
                options: {
                  ...
                  active: Q.LineStyle.Solid === h,
                  onExecute: () => n.setProperty(e, Q.LineStyle.Solid, a),
                },
              }),
              new G.Action({
                ...
                options: {
                  ...
                  active: Q.LineStyle.Dashed === h,
                  onExecute: () => n.setProperty(e, Q.LineStyle.Dashed, a),
                },
              }),
              new G.Action({
                ...
                options: {
                  ...
                  active: Q.LineStyle.Dotted === h,
                  onExecute: () => n.setProperty(e, Q.LineStyle.Dotted, a),
                },
              }),
            ],
            [n, e, h],
        ...
        return i.createElement(
          O.ToolWidgetMenu,
          {
            className: c,
            arrow: !1,
            content: i.createElement(A.Icon, { icon: nt(h) }),
            title: s,
            "data-name": t["data-name"],
            menuDataName: `${t["data-name"]}-menu`,
            verticalDropDirection: l
              ? Y.VerticalDropDirection.FromBottomToTop
              : void 0,
            horizontalDropDirection: l
              ? Y.HorizontalDropDirection.FromRightToLeft
              : void 0,
            horizontalAttachEdge: l ? Y.HorizontalAttachEdge.Right : void 0,
            verticalAttachEdge: l ? Y.VerticalAttachEdge.Top : void 0,
          },
          i.createElement(z.ActionsTable, { items: d }),
        );
      }
      function nt(t) {
        switch (t) {
        ...
        return i.createElement(
          O.ToolWidgetMenu,
          {
            ...
            horizontalDropDirection: s
              ? Y.HorizontalDropDirection.FromRightToLeft
              : void 0,
            horizontalAttachEdge: s ? Y.HorizontalAttachEdge.Right : void 0,
            verticalAttachEdge: s ? Y.VerticalAttachEdge.Top : void 0,
            "data-name": t["data-name"],
            menuDataName: `${t["data-name"]}-menu`,
          },
      ...
      var at = o(72894),
        ...
        dt = o(35923);
      o(10892);
      const pt = new s.TranslatedString(
          "change line tool(s) font size",
          r.t(null, void 0, o(37453)),
        ),
        ut = new s.TranslatedString(
        ...
        mt =
          (new s.TranslatedString(
            ...
            r.t(null, void 0, o(89720)),
          ),
          new s.TranslatedString(
            "line tool(s) line style",
            r.t(null, { context: "line tool property name" }, o(64974)),
          )),
        _t = r.t(null, void 0, o(32514)),
        gt = r.t(null, void 0, o(67410)),
        vt = r.t(null, void 0, o(37117)),
        yt = r.t(null, void 0, o(92516)),
        ft = r.t(null, void 0, o(2573));
      class bt {
        constructor(t) {
          (this._isDrawingFinished = new l.WatchedValue(!0)),
            ...
            (this._floatingToolbar = new b.FloatingToolbar({
              defaultPosition: {
                top: at.HEADER_TOOLBAR_HEIGHT_EXPANDED + 15,
        ...
        _onSourceChanged(t) {
          ...
          if (
            ...
            this.activeChartWidget().model().model().dataSourceForId(e.id())
              ? (!e.userEditEnabled() ||
                  (!(0, ct.isLineDrawnWithPressedButton)(e.toolname) &&
        ...
        _propertyApplierImpl() {
          return (
            this._propertyApplier ||
              (this._propertyApplier = new dt.PropertyApplierWithoutSavingChart(
        ...
        _createRemoveButton() {
          const t = {
            component: R,
            props: { title: gt, activeChartWidget: this.activeChartWidget() },
        ...
        _createLineStyleButton(t) {
          const e = this.selectedSources().filter(lt.isLineTool);
        ...
        _createProperty(t, e, o, i) {
          ...
          if (t && t.visible())
            return this._isWidthProperty(t)
              ? new p.MultipleLineWidthsProperty([t])
              : new g.CollectibleColorPropertyDirectWrapper(
                  new p.MultipleLineColorsProperty([t]),
                );
        }
    ...
    36074: (t, e, o) => {
      ...
      var i = o(45126).TranslatedString,
        n = o(85497).LineToolPropertiesWidgetBase;
      ...
      var a = o(5880),
        ...
        _ = o.i18next(null, void 0, o(11989)),
        g = o.i18next(null, void 0, o(77753)),
        v = o.i18next(null, void 0, o(81956)),
        y = o.i18next(null, void 0, o(69715)),
        f = o.i18next(null, void 0, o(14097)),
        b = o.i18next(null, void 0, o(92516)),
        w = o.i18next(null, void 0, o(92409)),
        C = o.i18next(null, void 0, o(53002)),
        x = o.i18next(null, void 0, o(75056)),
        T = o.i18next(null, void 0, o(28736)),
