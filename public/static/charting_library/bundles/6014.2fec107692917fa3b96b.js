(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [6014],
  {
      ...
      function a(e) {
        ...
        return (
          (0, o.useIsomorphicLayoutEffect)(() => {
            const e = { click: t, mouseDown: i, touchEnd: a, touchStart: r },
              n = d ? d.current : u.current;
            return (0, s.addOutsideEventListener)(c.current, n, l, document, e);
          }, [t, i, a, r, l]),
          d || u
        );
      }
    ...
    67961: (e, t, i) => {
      "use strict";
      i.d(t, { OverlapManager: () => s, getRootOverlapManager: () => r });
      var n = i(50151);
      class o {
        constructor() {
          this._storage = [];
    ...
    28124: (e, t, i) => {
      ...
      const u = JSON.parse(
        ...
        c = (function () {
          ...
          return (
            e.forEach((e) => {
              const i = (0, d.ensureNotNull)(e.getAttribute("data-locale"));
              t[i] = { ...u[i], href: e.href };
            }),
            t
          );
      ...
      function g(e) {
        const [t] = (0, n.useState)({
          isOnMobileAppPage: (e) => (0, r.isOnMobileAppPage)(h[e]),
          isRtl: (0, l.isRtl)(),
          locale: ((i = i || window.locale), c[i]),
        });
        var i;
        return n.createElement(a.Provider, { value: t }, e.children);
      }
      function _(e, t, i = "legacy") {
        const a = n.createElement(g, null, e);
        if ("modern" === i) {
          ...
          return (
            ...
            {
              render(t) {
                e.render(n.createElement(g, null, t));
              },
              unmount() {
                e.unmount();
              },
        ...
        return (
          ...
          {
            render(e) {
              o.render(n.createElement(g, null, e), t);
            },
            unmount() {
    ...
    82206: (e, t, i) => {
      ...
      class u extends n.PureComponent {
        ...
        render() {
          const {
            ...
            g = (0, l.filterDataProps)(this.props),
            _ = this.props.style
          ...
          return n.createElement(
            ...
            n.createElement(a.Slot, { reference: this._handleSlot }),
          );
        }
        _createStyles() {
          const {
      ...
      class w {
        ...
        _moveDialog(e, t) {
          const i = this._dialog.getBoundingClientRect(),
            ...
            o = m(e, i.width, n ? 0 : -1 / 0, n ? window.innerWidth : 1 / 0),
            s = m(t, i.height, n ? 0 : -1 / 0, n ? window.innerHeight : 1 / 0);
      ...
      const M = (0, T.getLogger)("DialogEventDispatcher");
      class A {
        constructor() {
        ...
        dispatch(e) {
          if ("dialog-open" === e) {
            ...
            this._openSessionId = (0, C.randomHash)();
          }
        ...
        recalculateBounds() {
          ...
          if (this._isFullscreen) {
            ...
            const e = this._dialog.getBoundingClientRect(),
              o = i - 2 * n,
              s = m(e.left, e.width, 0, t),
              a = m(e.top, e.height, n, i);
            (this._dialog.style.top = "0px"),
              (this._dialog.style.left = "0px"),
      ...
      class L extends n.PureComponent {
        ...
        componentDidMount() {
          ...
          if (this.props.resizeHandler) this._resize = this.props.resizeHandler;
            ...
            const e = new k(n, { guard: o, calculateDialogPosition: a });
          ...
          if (!n.contains(document.activeElement)) {
            const e = (function (e) {
              ...
              const i = (0, p.getActiveElementSelectors)(),
                n = Array.from(e.querySelectorAll(i)).filter(
                  (0, p.createScopedVisibleElementFilter)(e),
                );
      ...
      const z = (0, h.makeOverlapable)(L, !0);
    },
    86431: (e, t, i) => {
      "use strict";
      ...
      function s(e, t) {
        return class extends n.PureComponent {
          render() {
            ...
            if (!i) return null;
            const a = n.createElement(e, { ...this.props, zIndex: 150 });
            return "parent" === s
              ? a
              : n.createElement(o.Portal, { shouldTrapFocus: t }, a);
          }
        };
      }
    },
    42842: (e, t, i) => {
      "use strict";
      i.d(t, { Portal: () => l, PortalContext: () => d });
      var n = i(50959),
        o = i(32227),
        s = i(25931),
        a = i(67961),
