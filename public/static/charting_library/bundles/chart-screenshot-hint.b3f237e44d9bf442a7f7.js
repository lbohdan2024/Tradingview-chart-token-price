(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [92],
  {
    ...
    64388: (e, t, n) => {
      ...
      function l(e) {
        ...
        return r.createElement(
          ...
          t && r.createElement("span", { className: o["visually-hidden"] }, t),
        );
      }
    ...
    1524: (e, t, n) => {
      "use strict";
      n.r(t), n.d(t, { ChartScreenshotHintRenderer: () => y });
      var r,
        i,
        a = n(50959),
        o = n(32227),
      ...
      const f = { danger: m, warning: m, success: g, default: h };
      function v(e) {
        const {
          informerIntent: t,
          content: n,
        ...
        return a.createElement(
          ...
          a.createElement(
            "div",
            { className: p().informerBody },
            n &&
              a.createElement(
                "div",
                { className: p().mainProblem },
                o &&
                  a.createElement(c.Icon, {
                    className: l(p().icon, x && p()["light-icon"]),
                    icon: null != m ? m : f[t],
                  }),
                a.createElement(
                  "div",
                  {
                    className: l(p()["text-wrap"], x && p()["light-text-wrap"]),
                  },
                  i &&
                    a.createElement(
                      "span",
          ...
          s &&
            a.createElement(u.CloseButton, {
              "aria-label": g,
              onClick: h,
              className: l(x && p()["light-close-button"], p()["close-button"]),
              size: x ? "xxsmall" : "xsmall",
              preservePaddings: !x,
            }),
        );
      }
        ...
        return a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(v, {
              content: t,
              informerIntent: i,
              className: l(C.notice, o && C.noticeShowed),
            }),
          ),
        );
      }
