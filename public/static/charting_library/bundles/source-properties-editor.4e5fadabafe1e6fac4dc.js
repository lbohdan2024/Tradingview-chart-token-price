  ...
  [6780],
  {
    ...
    38546: (e, t, i) => {
      ...
      const a = s.forwardRef(function (e, t) {
        const { id: i, tabs: a, activeTab: l, onChange: o, className: r } = e;
        return s.createElement(
          "div",
          { className: r, ref: t },
          s.createElement(n.UnderlineButtonTabs, {
            id: i,
            items: a,
            isActive: function (e) {
              return e.id === l;
    ...
    78890: (e, t, i) => {
      ...
      var s = i(50959),
        ...
        d = i(87075);
      const m = {
        reset: o.t(null, void 0, i(33533)),
        saveAsDefault: o.t(null, void 0, i(99687)),
        defaults: o.t(null, void 0, i(48572)),
      };
      var h;
      !(function (e) {
      ...
      class p extends s.PureComponent {
        render() {
          ...
          return s.createElement(
            ...
            {
              id: "property-actions",
              className: a()("normal" === e && d.defaultsButtonText),
    ...
    48531: (e, t, i) => {
      ...
      function u(e) {
        return e.isTabletWidth
          ? s.createElement(a.Icon, { className: r.themesButtonIcon, icon: c })
          : s.createElement(s.Fragment, null, n.t(null, void 0, i(93553)));
      }
      function d(e) {
        return s.createElement(
          o.MatchMedia,
    ...
    75892: (e, t, i) => {
      "use strict";
      i.r(t), i.d(t, { SourcePropertiesEditorRenderer: () => R });
      var s = i(50959),
        n = i(76422),
        a = i(50151),
        l = i(49483),
        ...
        I = i(56570),
        A = i(78746);
      const P = new T.TranslatedString(
      ...
      class k extends s.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._setTitle = (e) => {
              ...
              i.setProperty(
                ...
                e,
                s,
                x.lineToolsDoNotAffectChartInvalidation && (0, b.isLineTool)(t),
              );
            }),
          ...
          if (this._getActionPageById(this.props.activePageId))
            i = (0, a.ensureDefined)(this.props.activePageId);
          else {
        ...
        _renderChildren(e) {
          return ({ requestResize: t }) => {
            ...
            const { pages: i, source: n } = this.props,
              a = i.find((t) => t.id === e),
              l = (0, v.isStudy)(n)
            ...
            return s.createElement(
              ...
              s.createElement(
                ...
                { className: A.scrollable, onScroll: this._handleScroll },
      ...
      var B = i(29280),
        z = i(28124);
      class R extends B.DialogRenderer {
        constructor(e) {
          super(),
            (this._timeout = null),
            (this._handleClose = () => {
        ...
        show(e) {
          this.isVisible() ||
            ((this._rootInstance = (0, z.createReactRoot)(
              s.createElement(k, {
                source: this._source,
                onSubmit: this._handleSubmit,
        ...
        return (
          ...
          s.createElement(
            ...
            s.createElement(
              ...
              s.createElement("span", { className: d.ellipsis }, " ", f),
              p &&
                s.createElement(
                  s.Fragment,
                  null,
    ...
    66512: (e, t, i) => {
      "use strict";
      i.r(t), i.d(t, { SourcesPropertiesEditorRenderer: () => v });
      var s = i(50959),
        n = i(29280),
        a = i(28124),
        l = i(11542),
        ...
        h = i(38546),
        p = i(65119);
      const g = l.t(null, void 0, i(8954));
      function b(e) {
        const {
            propertyPages: t,
            onSubmit: i,
          ...
          x = f.model().lineToolsGroupModel().groupForLineTool(v[0]),
          S = !!(
            C &&
            x &&
            l &&
            v.every((e) => {
              ...
              return (
                (null == x ? void 0 : x.id) ===
                (null ===
                  (t = f.model().lineToolsGroupModel().groupForLineTool(e)) ||
                void 0 === t
                  ? void 0
                  : t.id)
              );
      ...
      class v extends n.DialogRenderer {
        constructor(e) {
          super(),
        ...
        _mount() {
          this._rootInstance = (0, a.createReactRoot)(
            s.createElement(b, {
    ...
    93081: (e, t, i) => {
      ...
      function v(e) {
        ...
        return a(
          ...
          b[`size-${t}`],
          i && b.selected,
          !n && b["disable-active-state-styles"],
          o && b["disable-focus-outline"],
          s && b.fake,
          l && b["enable-cursor-pointer"],
          r && b[`margin-${t}`],
      ...
      const f = (0, n.forwardRef)((e, t) => {
        const { size: i, overflowBehaviour: s } = (0, n.useContext)(p),
          a = (0, n.useContext)(g.CustomBehaviourContext),
          {
            active: o,
            fake: r,
            className: c,
      ...
      f.displayName = "UnderlineTabsBaseButton";
      ...
      function k(e) {
        ...
        return n.createElement(T.Icon, {
          icon: P(t),
          className: a(A["arrow-icon"], A[`size-${t}`], i && A.dropped),
        });
      }
      var B = i(456);
      function z(e) {
        const {
          ...
          v = (0, n.useRef)(null),
          C = (0, c.useMergedRefs)([d, v]),
          T = (function (e, t) {
            const i = (0, n.useRef)(N);
            return (
              (0, n.useEffect)(() => {
              ...
              (0, n.useCallback)(() => {
                ...
                return {
                  x: s.left,
                  y: s.top + s.height + n + 4,
                  indentFromWindow: { top: 4, bottom: 4, left: 4, right: 4 },
                };
              }, [t, e])
            );
          })(t, v);
        return n.createElement(S.PopupMenuDisclosureView, {
          buttonRef: v,
          listboxTabIndex: -1,
          isOpened: s,
          onClose: b,
          ...
          button: n.createElement(
            ...
            u,
            n.createElement(k, { size: t, isDropped: s }),
          ),
          popupChildren: r.map((e) =>
            n.createElement(x.PopupMenuItem, {
              key: e.id,
      ...
      const N = { xsmall: 0, small: 0, medium: 0, large: 0, xlarge: 0 };
      var D = i(5325),
        M = i(42707),
        F = i(86240),
        Y = i(7633);
      ...
      function V(e) {
        ...
        return n.createElement(
          "div",
          {
            className: a(W().underline, t && W().disabled),
            style: {
              transform: `translateX(${i}px) scaleX(${l})`,
              transitionDuration: `${s}ms`,
            },
          },
          n.createElement("div", {
            className: W().corner,
            style: { transform: `scaleX(${1 / l})` },
          }),
          n.createElement("div", {
            className: W().center,
      ...
      function q(e) {
        const {
            ...
            orientation: g,
            disabled: b,
            moreButtonContent: v = o.t(null, void 0, i(37117)),
            size: f = "small",
            onActivate: _,
            isActive: x,
            className: S,
          ...
          q = null != y ? y : !B,
          {
            ...
            moreButtonRef: Z,
            setItemRef: G,
          } = (0, r.useCollapsible)(s, D, x),
          Q = "collapse" === R ? J : s,
          ee = "collapse" === R ? K : [],
          te = (0, n.useCallback)((e) => ee.includes(e), [ee]),
          ie = (0, n.useRef)(new Map()),
          {
            isOpened: se,
            open: ne,
            close: ae,
          ...
          })(f),
          {
            ...
            scrollIntoViewOptions: { additionalScroll: oe },
          }),
          pe = s.find(x),
          ge = ee.find(he),
          be = (0, n.useCallback)(() => {
        ...
        (0, n.useEffect)(() => {
          N.current ? (N.current = !1) : (ge && !se && ne(), !ge && se && ae());
        }, [ge, se, ne, ae]);
        const Se = (function (e, t, i = []) {
          const [s, a] = (0, n.useState)(),
            l = (0, n.useRef)(),
            o = (0, n.useRef)(),
            r = (e) => {
              var t;
              ...
              if (void 0 === i) return;
              const s = void 0 === o.current || o.current === e ? 0 : 100;
              o.current = e;
              const { left: n, right: l, width: r } = e.getBoundingClientRect(),
                { left: c, right: u } = i.getBoundingClientRect(),
                d = (0, j.isRtl)() ? l - u : n - c;
              a({ translateX: d, scale: r, transitionDuration: s });
            };
          return (
            (0, n.useEffect)(() => {
              const e = (0, X.default)((e) => {
                const t = e[0].target;
                void 0 !== t && r(t);
              }, 50);
              l.current = new ResizeObserver(e);
            }, []),
            (0, n.useEffect)(() => {
              var i;
              if (void 0 === t) return;
              ...
              return void 0 !== s
                ? (r(s),
                  null === (i = l.current) || void 0 === i || i.observe(s),
                  () => {
                    var e;
        ...
        return n.createElement(
          p.Provider,
          { value: { size: f, overflowBehaviour: R } },
          n.createElement(
            "div",
            {
              ...ue,
              className: H({ size: f, overflowBehaviour: R, className: S }),
              style: T,
              "data-name": A,
            },
            n.createElement(
              ...
              {
                ...ce,
                className: l()(Y["underline-tabs"], {
                  [Y["make-grid-column"]]: O || W,
                  [Y["stretch-tabs"]]: O,
                  [Y["equal-tab-size"]]: W,
                }),
              },
              ...
              Se
                ? n.createElement(V, { ...Se, disabled: b })
      ...
      var J = i(38952);
      function K(e) {
        return n.createElement("a", { ...(0, J.renameRef)(e) });
      }
      (0, n.forwardRef)((e, t) => {
        var i;
        const { size: s, overflowBehaviour: a } = (0, n.useContext)(p),
          l = (0, n.useContext)(g.CustomBehaviourContext),
          {
            item: o,
            highlighted: r,
            handleItemRef: c,
          ...
          w = null !== (i = o.renderComponent) && void 0 !== i ? i : K;
        return n.createElement(
          w,
          {
            ...x,
