(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2157],
  {
    ...
    10772: (e, t, n) => {
      ...
      E.contextType = c.SubmenuContext;
    },
    5304: (e, t, n) => {
      "use strict";
      n.d(t, {
        ContextMenuItem: () => E,
        DEFAUL_CONTEXT_MENU_ITEM_THEME: () => g,
      });
      var o = n(50959),
        s = n(97754),
        r = n(70673),
    ...
    41590: (e, t, n) => {
      ...
      function m(e) {
        ...
        return (
          (0, o.useLayoutEffect)(
            () => (
              (0, s.ensureNotNull)(g.current).focus({ preventScroll: !0 }),
              w.subscribe(b, n),
              b.addDrawer(f),
              () => {
                b.removeDrawer(f), w.unsubscribe(b, n);
              }
            ),
            [],
          ),
    ...
    20243: (e, t, n) => {
      ...
      function l(e) {
        ...
        const v = m(c),
          ...
          f = -1 !== b,
          g = (e) => {
            i && (0, s.becomeSecondaryElement)(i),
        ...
        switch ((0, o.mapKeyCodeToDirection)(n)) {
          case "inlinePrev":
            if (!v.length) return;
            e.preventDefault(),
              g(0 === b ? l[p] : f ? u(v, b, -1) : v[v.length - 1]);
            break;
          case "inlineNext":
            if (!v.length) return;
            e.preventDefault(),
              b === v.length - 1 ? g(l[p]) : g(f ? u(v, b, 1) : v[0]);
            break;
          case "blockPrev": {
            e.preventDefault();
            const t = u(l, p, -1);
