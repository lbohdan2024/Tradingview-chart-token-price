  ...
  [2704],
  {
    ...
    57340: (e, t, i) => {
      ...
      const h = n.forwardRef((e, t) =>
        n.createElement(o.NavButton, { ...e, ref: t, icon: d(e.size) }),
      );
    },
    64388: (e, t, i) => {
      "use strict";
      ...
      function l(e) {
        ...
        return n.createElement(
          n.Fragment,
          null,
          n.createElement("span", { className: r.background }),
          n.createElement(s.Icon, {
            icon: i,
            className: r.icon,
            "aria-hidden": !0,
          }),
          t && n.createElement("span", { className: r["visually-hidden"] }, t),
        );
      }
      const c = (0, n.forwardRef)((e, t) => {
        ...
        return n.createElement(
          "button",
          { ...h, className: a({ ...e, children: d }), ref: t, type: o },
          n.createElement(l, { icon: i }, d),
        );
      });
      ...
      var d = i(21593),
        h = i(53017);
      (0, n.forwardRef)((e, t) => {
        const { icon: i, renderComponent: o, "aria-label": s, ...r } = e,
          c = null != o ? o : d.CustomComponentDefaultLink;
        return n.createElement(
          c,
          {
            ...r,
            className: a({ ...e, children: s, isLink: !0 }),
            reference: (0, h.isomorphicRef)(t),
          },
          n.createElement(l, { icon: i }, s),
        );
    ...
    53885: (e, t, i) => {
      "use strict";
      i.d(t, { getStyleClasses: () => r, isCircleLogoWithUrlProps: () => a });
      var n = i(97754),
        o = i(3196),
        s = i.n(o);
      function r(e, t) {
    ...
    21593: (e, t, i) => {
      "use strict";
      i.d(t, { CustomComponentDefaultLink: () => s });
      var n = i(50959),
        o = i(38952);
      function s(e) {
    ...
    43010: (e, t, i) => {
      "use strict";
      i.d(t, { useIsomorphicLayoutEffect: () => o });
      var n = i(50959);
      function o(e, t) {
    ...
    27267: (e, t, i) => {
      ...
      function n(e, t, i, n, o) {
        ...
        return (
          o.click && n.addEventListener("click", s, !1),
          o.mouseDown && n.addEventListener("mousedown", s, !1),
          o.touchEnd && n.addEventListener("touchend", s, !1),
          o.touchStart && n.addEventListener("touchstart", s, !1),
          () => {
      ...
      function r(e) {
        ...
        return (
          (0, o.useIsomorphicLayoutEffect)(() => {
            const e = { click: t, mouseDown: i, touchEnd: r, touchStart: a },
              n = c ? c.current : d.current;
            return (0, s.addOutsideEventListener)(h.current, n, l, document, e);
          }, [t, i, r, a, l]),
          c || d
        );
      }
    ...
    53017: (e, t, i) => {
      ...
      i.d(t, { isomorphicRef: () => o, mergeRefs: () => n });
    },
    52778: (e, t, i) => {
      "use strict";
      i.d(t, { OutsideEvent: () => o });
      var n = i(36383);
      function o(e) {
        const { children: t, ...i } = e;
        return t((0, n.useOutsideEvent)(i));
      }
    },
    67961: (e, t, i) => {
      "use strict";
      i.d(t, { OverlapManager: () => s, getRootOverlapManager: () => a });
      var n = i(50151);
      class o {
        constructor() {
          this._storage = [];
      ...
      function a(e = document) {
        ...
        if (null !== t) return (0, n.ensureDefined)(r.get(t));
        {
          const t = new s(e),
            i = (function (e) {
    ...
    79418: (e, t, i) => {
      ...
      var g = i(52092),
        ...
        v = i(11542),
        _ = i(57340);
      const x = n.createContext({ setHideClose: () => {} });
      var w = i(80822);
      function y(e) {
        const {
            title: t,
            ...
            className: p,
            unsetAlign: m,
            closeAriaLabel: g = v.t(null, void 0, i(47742)),
        ...
        return n.createElement(
          ...
          n.createElement(
            "div",
            { className: r()(w.container, p, (s || m) && w.unsetAlign) },
            d,
            n.createElement(
              "div",
      ...
      class k extends n.PureComponent {
        constructor() {
          super(...arguments),
            ...
            (this._embedResizerOverridesEnabled = b.enabled(
              ...
              if (!e.defaultPrevented) {
                if (
                  ...
                  if (null !== i) {
                    ...
                    const n = this._reference;
                    if (null !== n && (0, c.isTextEditingField)(i))
                      return void n.focus();
                    if (null == n ? void 0 : n.contains(i))
                      return (
                        this.props.onKeyboardClose &&
                          this.props.onKeyboardClose(),
                        void this._handleClose()
        ...
        render() {
          const {
            ...
            X = "after" !== g ? f : void 0,
            Y = "after" === g ? f : void 0,
            Z = "string" == typeof s ? s : R || "",
            J = (0, C.filterDataProps)(this.props),
            j = (0, E.mergeRefs)([this._handleReference, U]);
          return n.createElement(
            p.MatchMedia,
              ...
              n.createElement(
                ...
                (u) =>
                  n.createElement(
                    ...
                    {
                      rounded: !(u || N) && T,
                      className: r()(S.dialog, N && $ && S.bounded, e),
                      isOpened: o,
                      reference: j,
                      ...
                      calculateDialogPosition:
                        N && $ ? this._calculatePositionWithOffsets : void 0,
                      shadowed: q,
                      fixedBody: G,
                      onClick: V,
                      ...J,
                    ...
                    n.createElement(
                      ...
                      b &&
                        n.createElement(h.Separator, {
                          className: S.separator,
                        }),
                      n.createElement(m.PopupContext.Consumer, null, (e) =>
                        this._renderChildren(e, u || N),
                      ),
                    ),
                  ),
              ),
    ...
    69654: (e, t, i) => {
      ...
      function h(e) {
        const {
          ...
          iconClassName: f,
          cancelTitle: v = r.t(null, void 0, i(4543)),
          ..._
        } = e;
        return n.createElement(
          "div",
          { className: s()(d.container, o && d.mobile, m) },
          n.createElement(
            "div",
            {
              className: s()(
            ...
            h || n.createElement(u, { isMobile: o, ..._ }),
          ),
          t,
          n.createElement(a.Icon, {
            className: s()(d.icon, o && d.mobile, f),
            icon: o ? c : l,
          }),
          p &&
            (!o || "" !== _.value) &&
            n.createElement(
              "div",
              { className: s()(d.cancel, o && d.mobile), onClick: p },
              v,
            ),
        );
      }
      function u(e) {
        ...
        return n.createElement("input", {
          ...
          ref: i,
          type: "text",
          className: s()(t, d.input, o && d.mobile),
          autoComplete: "off",
          "data-role": "search",
          placeholder: p,
          value: r,
    ...
    41153: (e, t, i) => {
      "use strict";
      i.r(t), i.d(t, { UnitConversionRenderer: () => K });
      var n = i(50959),
        o = i(32227),
        s = i(27267),
        r = i(52092),
      ...
      const M = n.memo(
        function (e) {
          ...
          return n.createElement(
            ...
            m &&
              (void 0 !== i
                ? n.createElement(D.CircleLogo, {
                    logoUrl: i,
                    size: p ? "xsmall" : "xxxsmall",
                    className: v()(k.icon, x),
                  })
                : n.createElement("span", { className: v()(k.fakeIcon, x) })),
            n.createElement(
              "div",
              { className: v()(k.labelAndDescription, x) },
              n.createElement("span", { className: v()(k.label, x) }, w(t)),
              p && n.createElement("br", null),
              p &&
                n.createElement(
                  "span",
                  { className: v()(k.description, x) },
                  r ? w(r) : "",
                ),
            ),
            void 0 !== g &&
              n.createElement(
                ...
                {
                  className: v()(
                    k.action__favoriteIcon,
                    g && k.action__favoriteIcon_active,
                  ),
                },
          ...
          function w(e) {
            return n.createElement(A.HighlightedText, {
              text: e,
              rules: o,
              queryString: s,
              className: v()(c && k.highlighted, c && k.active),
            });
          }
        },
        (e, t) =>
      ...
      var N = i(51417),
        ...
        T = i(6419),
        B = i(6163);
      const P = (0, E.mergeThemes)(y.DEFAULT_MENU_THEME, B);
      function L(e) {
        const {
            title: t,
            sections: o,
          ...
          [f, y] = (0, n.useState)(() =>
            o.reduce((e, t, i) => (t.name && (e[t.id] = !0), e), {}),
          );
        function E(e) {
          const { id: t, ...i } = e;
        ...
        return n.createElement(
          w.PopupMenu,
          {
            ...g,
            onClose: s,
            className: v()(T.menu, p && T.withDescriptions),
            theme: P,
            maxHeight: p ? 313 : 280,
          ...
          n.createElement(
            ...
            n.createElement(
              ...
              n.createElement(x.Icon, { icon: N, className: T.icon }),
              n.createElement("input", {
                size: 1,
                type: "text",
                className: T.input,
                placeholder: _.t(null, void 0, i(8573)),
                autoComplete: "off",
                "data-role": "search",
                onChange: function (e) {
                  c(e.target.value);
          ...
          l
            ...
            : o.map((e, t) =>
                n.createElement(
                  n.Fragment,
                  { key: e.id },
                  Boolean(t) && n.createElement(C.PopupMenuSeparator, null),
                  e.name
                    ? n.createElement(
                        b.CollapsibleSection,
                        {
                          summary: e.name,
                          className: T.section,
                          open: f[e.id],
                          onStateChange: (t) => y({ ...f, [e.id]: t }),
                        },
                        e.actions.map(E),
                      )
                    : e.actions.map(E),
        ...
        return n.createElement(I.AdaptivePopupDialog, {
          ...
          render: function () {
            return n.createElement(
              n.Fragment,
              null,
              n.createElement(z.DialogSearch, {
                placeholder: _.t(null, void 0, i(8573)),
                onChange: g,
                reference: u,
              }),
      ...
      const H = {
        horizontalAttachEdge: g.HorizontalAttachEdge.Right,
        horizontalDropDirection: g.HorizontalDropDirection.FromRightToLeft,
      };
      function U(e) {
        const { element: t, ...i } = e,
          [o, s] = (0, n.useState)(y()),
          ...
          l = (0, n.useRef)(null),
          f = (0, n.useRef)(null),
          v = (0, n.useMemo)(() => (0, d.createRegExpList)(r), [r]),
          { activeIdx: _, setActiveIdx: x } = (0, h.useKeyboardNavigation)(
            l.current,
            o,
            function (e) {
              e && (e.onClick(), i.onClose());
            },
          );
        (0, p.useResetActiveIdx)(x, [o]),
          (0, u.useScrollToRef)(f, _),
          (0, n.useEffect)(() => {
            s(
              r
                ? (function (e, t, i) {
                    const n = e.reduce((e, t) => [...e, ...t.actions], []);
                    return (0, d.rankedSearch)({
                      data: n,
                      rules: i,
                      queryString: t,
                      primaryKey: "label",
        ...
        const w = (0, n.useMemo)(
          () => ({
            selectedId: Boolean(_ >= 0 && o[_]) ? o[_].id : "",
            selectedRef: f,
            search: r,
            setSearch: a,
            searchRef: l,
        ...
        return n.createElement(
          ...
          (e) =>
            e
              ? n.createElement(O, { ...i, ...w })
              : n.createElement(L, {
                  ...i,
                  ...w,
                  position: (0, g.getPopupPositioner)(t, H),
                  doNotCloseOn: t,
                }),
        );
        function y() {
          return i.sections.reduce((e, t) => (e.push(...t.actions), e), []);
        }
      }
      ...
      class K {
        constructor(e, t, i, n, c, d) {
          (this._rootElem = document.createElement("div")),
            (this._isOpened = !1),
            (this._handlerOutsideClickDestroy = null),
            (this._disableShowMenu = !0),
            (this.close = () => {
              var e;
              if (((this._isOpened = !1), this._disableShowMenu)) {
                const t = this._trackEventParamsGetter();
                W(t[0], this._isOpened, t[1], t[2], t[3]),
                  null === (e = this._handlerOutsideClickDestroy) ||
                    void 0 === e ||
                    e.call(this);
              }
              a.unsubscribe(
                r.CLOSE_POPUPS_AND_DIALOGS_COMMAND,
                this.close,
                this,
              ),
                null !== this._rootElem &&
                  (o.unmountComponentAtNode(this._rootElem),
                  l.favoriteCurrencyUnitConversionService
                    .getOnChange()
            ...
            (this._handlerOutsideClick = () => {
              var e;
              null === (e = this._handlerOutsideClickDestroy) ||
                void 0 === e ||
                e.call(this),
                (this._handlerOutsideClickDestroy = (0,
                s.addOutsideEventListener)(
            ...
            (this._title = e),
            (this._element = t),
            (this._disableShowMenu = n),
            (this._sectionsGetter = i),
            (this._menuClosedCallback = () => {
              (this._isOpened = !1), d();
            }),
            (this._trackEventParamsGetter = c),
            this._render(),
            l.favoriteCurrencyUnitConversionService
              .getOnChange()
              .subscribe(this, this._render),
            a.subscribe(r.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this.close, this);
        }
        _render() {
          if (((this._isOpened = !0), this._disableShowMenu)) {
            const e = this._trackEventParamsGetter();
            return (
              W(e[0], this._isOpened, e[1], e[2], e[3]),
              void this._handlerOutsideClick()
            );
          }
          const e = {
            title: this._title,
          ...
          o.render(n.createElement(U, { ...e }), this._rootElem);
        }
      }
    },
    63651: (e, t, i) => {
      "use strict";
      i.d(t, { useKeyboardNavigation: () => s });
      var n = i(50959),
        o = i(68335);
      function s(e, t, i, s = "keydown") {
        ...
        return (
            ...
            const n = (e) => {
              ...
              e.repeat ||
                (13 === (0, o.hashFromEvent)(e) &&
                  i(null !== (n = t[r]) && void 0 !== n ? n : null, e));
            };
            return (
          ...
          { activeIdx: r, setActiveIdx: a }
        );
      }
    },
    32470: (e, t, i) => {
      "use strict";
      i.d(t, { useResetActiveIdx: () => o });
      var n = i(50959);
      function o(e, t = []) {
        (0, n.useEffect)(() => {
          e(-1);
    ...
    59695: (e, t, i) => {
      "use strict";
      i.d(t, { CircleLogo: () => a, hiddenCircleLogoClass: () => r });
      var n = i(50959),
        o = i(53885),
        s = i(3196);
      const r = i.n(s)()["tv-circle-logo--visually-hidden"];
      function a(e) {
        var t, i;
        const s = (0, o.getStyleClasses)(e.size, e.className),
          r =
    ...
    82206: (e, t, i) => {
      ...
      class d extends n.PureComponent {
        ...
        render() {
          ...
          return n.createElement(
            ...
            n.createElement(r.Slot, { reference: this._handleSlot }),
          );
        }
        _createStyles() {
          const {
      ...
      class w {
        ...
        _dragStart(e) {
          ...
          const i = Math.round(t.left),
            n = Math.round(t.top);
          (this._dialog.style.transform = `translate(${i}px, ${n}px)`),
        ...
        _moveDialog(e, t) {
          const i = this._dialog.getBoundingClientRect(),
            { boundByScreen: n } = this._options,
            o = f(e, i.width, n ? 0 : -1 / 0, n ? window.innerWidth : 1 / 0),
            s = f(t, i.height, n ? 0 : -1 / 0, n ? window.innerHeight : 1 / 0);
      ...
      const k = (0, D.getLogger)("DialogEventDispatcher");
      class M {
        constructor() {
        ...
        dispatch(e) {
          if ("dialog-open" === e) {
            if (null !== this._openSessionId)
              return void k.logError("Multiple calls to open dialog");
          ...
          null !== this._openSessionId
            ...
            : k.logError("Empty open dialog session id");
        }
      }
      var N = i(84015),
        F = (i(56570), i(52036));
      ...
      const T = class {
        ...
        getDialogsTopLeftCoordinates() {
          const { clientWidth: e, clientHeight: t } =
            ...
            n = e / 2 - this._dialog.clientWidth / 2,
            o = t / 2 - i / 2 + this._getTopOffset();
          return { x: Math.round(n), y: Math.round(o) };
        }
        recalculateBounds() {
          var e;
          const { clientWidth: t, clientHeight: i } =
              this._getClientDimensions(),
          ...
          if (this._isFullscreen) {
            if (
              ...
              const { left: e, top: t, width: i, height: n } = o;
              (this._dialog.style.transform = `translate(${Math.round(e)}px, ${Math.round(t)}px)`),
                i &&
            ...
            const e = this._dialog.getBoundingClientRect(),
              o = i - 2 * n,
              s = f(e.left, e.width, 0, t),
              r = f(e.top, e.height, n, i);
            (this._dialog.style.top = "0px"),
              (this._dialog.style.left = "0px"),
      ...
      class B extends n.PureComponent {
        ...
        componentDidMount() {
          const { draggable: e, boundByScreen: t, onDragStart: i } = this.props,
            n = (0, s.ensureNotNull)(this._dialog);
          ...
          if (this.props.resizeHandler) this._resize = this.props.resizeHandler;
            ...
            const e = new T(n, { guard: o, calculateDialogPosition: r });
          ...
          if (
            ...
            if (this.props.onForceFocus) return void this.props.onForceFocus(n);
            n.focus();
          }
          if (!n.contains(document.activeElement)) {
            const e = (function (e) {
              ...
              const i = (0, g.getActiveElementSelectors)(),
                n = Array.from(e.querySelectorAll(i)).filter(
        ...
        _applyAppearanceAnimation(e) {
          if (this._resize && this._dialog) {
            const { x: t, y: i } = e,
              { x: n, y: o } = this._resize.getDialogsTopLeftCoordinates();
      ...
      const P = (0, u.makeOverlapable)(B, !0);
    },
    36189: (e, t, i) => {
      "use strict";
      ...
      var n = i(11542),
        ...
        c = i(98992);
      const d = {
        add: n.t(null, void 0, i(69207)),
        remove: n.t(null, void 0, i(85106)),
      };
      function h(e) {
        const { className: t, isFilled: i, isActive: n, onClick: h, ...u } = e;
    ...
    19785: (e, t, i) => {
              ...
              i.forEach((e) => {
                ...
                if (
                  ...
                  return (
                    (u = 4),
                    void (h =
                      null === (i = t.match(m)) || void 0 === i
                        ? void 0
                        : i.index)
                  );
                if ((0, o.isString)(t) && m.test(t))
                  return (
                    (u = 3),
                    void (h =
                      null === (r = t.match(m)) || void 0 === r
                        ? void 0
                        : r.index)
                  );
                if ((0, o.isString)(s) && m.test(s))
                  return (
                    (u = 2),
                    void (h =
                      null === (a = s.match(m)) || void 0 === a
                        ? void 0
                        : a.index)
                  );
                if ((0, o.isString)(s) && p.test(s))
                  return (
                    (u = 2),
                    void (h =
                      null === (l = s.match(p)) || void 0 === l
                        ? void 0
                        : l.index)
                  );
                if (Array.isArray(d))
                  for (const e of d)
                    if (m.test(e))
                      return (
                        (u = 1),
                        void (h =
                          null === (c = e.match(m)) || void 0 === c
                            ? void 0
                            : c.index)
                      );
              }),
              { matchPriority: u, matchIndex: h, item: e }
            );
          })
          .filter((e) => s || e.matchPriority)
          .sort((e, t) => {
      ...
      function r(e, t) {
        ...
        return (
          ...
          t &&
            t.hasOwnProperty(n) &&
            i.push({ fullMatch: t[n], re: t[n], fuzzyHighlight: !1 }),
          i
        );
      }
      function a(e, t, i) {
        ...
        return e && i
          ? (i.forEach((e) => {
              const { fullMatch: i, re: o, reserveRe: s } = e;
              (i.lastIndex = 0), (o.lastIndex = 0);
              const r = i.exec(t),
                a = r || o.exec(t) || (s && s.exec(t));
              if (((e.fuzzyHighlight = !r), a))
                if (e.fuzzyHighlight) {
                  let e = a.index;
                  ...
                  for (let e = 0; e < a[0].length; e++) n[a.index + e] = !0;
            }),
            n)
          : n;
      }
    ...
    24637: (e, t, i) => {
      "use strict";
      i.d(t, { HighlightedText: () => a });
      var n = i(50959),
        o = i(97754),
        s = i(19785),
        r = i(32248);
      function a(e) {
        const { queryString: t, rules: i, text: a, className: l } = e,
          c = (0, n.useMemo)(
            () => (0, s.getHighlightedChars)(t, a, i),
            [t, i, a],
          );
        return n.createElement(
          n.Fragment,
    ...
    86431: (e, t, i) => {
      "use strict";
      i.d(t, { makeOverlapable: () => s });
      var n = i(50959),
        o = i(42842);
      function s(e, t) {
        return class extends n.PureComponent {
          render() {
            const { isOpened: i, root: s } = this.props;
            if (!i) return null;
            const r = n.createElement(e, { ...this.props, zIndex: 150 });
            return "parent" === s
              ? r
              : n.createElement(o.Portal, { shouldTrapFocus: t }, r);
          }
        };
      }
    },
    ...
    42842: (e, t, i) => {
      "use strict";
      i.d(t, { Portal: () => l, PortalContext: () => c });
      var n = i(50959),
        o = i(32227),
        s = i(25931),
        r = i(67961),
    ...
    10381: (e, t, i) => {
      ...
      var n = i(50959),
        ...
        a = i(578);
      function l(e) {
        const { dropped: t, className: i } = e;
        return n.createElement(s.Icon, {
          className: o(i, r.icon, { [r.dropped]: t }),
          icon: a,
        });
      }
    },
    ...
    39706: (e, t, i) => {
      "use strict";
      i.d(t, { CollapsibleSection: () => l });
      var n = i(50959),
        o = i(97754),
        s = i.n(o),
        r = i(10381),
        a = i(48967);
      const l = (0, n.forwardRef)(function (e, t) {
        const {
          open: i,
          summary: o,
          children: l,
        ...
        return n.createElement(
          ...
          n.createElement(
            ...
            o,
            n.createElement(r.ToolWidgetCaret, {
              className: a.caret,
              dropped: Boolean(i),
            }),
          ),
    ...
    78135: (e, t, i) => {
      ...
      function c(e, t) {
        return (i) => {
          var c, d;
          const { contentWidth: h, contentHeight: u, availableHeight: p } = i,
            m = (0, a.ensureNotNull)(e).getBoundingClientRect(),
            {
              horizontalAttachEdge: g = l.horizontalAttachEdge,
              ...
              matchButtonAndListboxWidths: x = l.matchButtonAndListboxWidths,
            } = t;
          let w =
          ...
          w === n.AutoStrict &&
            (p < m.y + m.height + _ + u
              ? ((w = n.Top), (y = s.FromBottomToTop))
              : ((w = n.Bottom), (y = s.FromTopToBottom)));
          const E = w === n.Top ? -1 * _ : _,
            C = g === o.Right ? m.right : m.left,
            b = w === n.Top ? m.top : m.bottom,
            S = {
              x: C - (f === r.FromRightToLeft ? h : 0) + v,
              y: b - (y === s.FromBottomToTop ? u : 0) + E,
            };
          return x && (S.overrideWidth = m.width), S;
        };
      }
    },
    75556: (e, t, i) => {
      "use strict";
      i.r(t), i.d(t, { currencyActions: () => a });
      var n = i(50151),
        o = i(11542),
        s = i(8481),
        r = i(49992);
      function a(e, t, a) {
        ...
        const l = [],
          ...
          d = t.selectedCurrency,
          h = t.originalCurrencies,
          u = t.baseCurrencies,
          p = t.displayedValues,
          m = r.favoriteCurrencyUnitConversionService.get().currencies,
          g = { id: "first_section", actions: [] };
        if (h.size > 1) {
          const e = (0, s.createAction)(
            "Mixed",
            o.t(null, void 0, i(54215)),
            void 0,
            void 0,
        ...
        if (null !== d) {
          const e = (0, n.ensureNotNull)(f.item(d)),
            t = (0, s.createAction)(
              d,
              (0, n.ensureDefined)(p.get(d)),
              e.logoUrl,
              e.description,
              !0,
              () => {},
              m.has(d),
              () =>
                r.favoriteCurrencyUnitConversionService.toggle("currencies", d),
            );
          g.actions.push(t);
        }
        const v = f.filterConvertible(u, (e) => e !== d && h.has(e));
        for (const e of v) {
          const i = (0, n.ensureNotNull)(f.item(e.id));
          g.actions.push(
            (0, s.createAction)(
              e.id,
              e.code,
              ...
              m.has(e.id),
              () =>
                r.favoriteCurrencyUnitConversionService.toggle(
                  "currencies",
                  e.id,
                ),
            ),
        ...
        g.actions.length > 0 && l.push(g);
        const _ = f.filterConvertible(u, (e) => e !== d && !h.has(e)),
          x = [],
          w = [];
        for (const e of _) {
          const i = (0, n.ensureNotNull)(f.item(e.id)),
        ...
        return (
          (w.length > 0 || x.length > 0) &&
            l.push({ id: "second_section", actions: x.concat(w) }),
          l
        );
      }
    },
    49992: (e, t, i) => {
      "use strict";
      i.d(t, { favoriteCurrencyUnitConversionService: () => a });
      var n = i(56840),
        o = i(21097),
        s = i(59063);
      class r extends s.AbstractJsonStoreService {
        constructor(e, t) {
          super(
            e,
            t,
        ...
        add(e, t) {
          const i = this.get();
          i[e].add(t), this.set(i);
        }
        remove(e, t) {
          const i = this.get();
          i[e].delete(t) && this.set(i);
        }
        toggle(e, t) {
      ...
      const a = new r(o.TVXWindowEvents, n);
    },
    59363: (e, t, i) => {
      "use strict";
      i.r(t), i.d(t, { unitActions: () => a });
      var n = i(50151),
        o = i(11542),
        s = i(8481),
        r = i(49992);
      function a(e, t, a) {
        ...
        const l = [],
          ...
          u = t.names,
          p = t.descriptions,
          m = r.favoriteCurrencyUnitConversionService.get().units,
          g = { actions: [], id: "first_section" };
        if (h.size > 1) {
          const e = (0, s.createAction)(
            "Mixed",
            o.t(null, void 0, i(54215)),
        ...
        if (null !== d) {
          const e = (0, s.createAction)(
            d,
            (0, n.ensureDefined)(u.get(d)),
            void 0,
            (0, n.ensureDefined)(p.get(d)),
            !0,
            () => {},
            m.has(d),
            () => r.favoriteCurrencyUnitConversionService.toggle("units", d),
          );
          g.actions.push(e);
        }
        const v = f.unitsByGroups(t.availableGroups),
          _ = [],
          x = [];
        for (const e of v)
          for (const t of e.units) {
            const e = m.has(t.id);
            if (t.id === d || (!e && !h.has(t.id))) continue;
            const i = (0, s.createAction)(
              t.id,
              t.name,
              void 0,
              t.description,
              ...
              e,
              () =>
                r.favoriteCurrencyUnitConversionService.toggle("units", t.id),
            );
            e ? x.push(i) : _.push(i);
          }
        (_.length > 0 || x.length > 0) &&
          g.actions.push(
            ...x.sort((e, t) =>
