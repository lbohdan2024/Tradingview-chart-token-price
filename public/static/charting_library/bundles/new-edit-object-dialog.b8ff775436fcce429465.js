(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [6265],
  {
    ...
    81346: (e, t, l) => {
      "use strict";
      l.r(t), l.d(t, { EditObjectDialogRenderer: () => El });
      var n = l(50959),
        r = l(50151),
        i = l(11542),
        o = l(45126),
      ...
      class P extends n.PureComponent {
        constructor(e) {
          ...
          super(e),
            ...
            (this._handleSaveAsDefaults = () => {
              ...
              (0, v.isStudy)(e) && e.properties().saveDefaults();
            }),
          ...
          const { pages: l, initialActiveTab: r } = this.props,
            i =
              null !== (t = l.find((e) => e.id === r)) && void 0 !== t
                ? t
                : l[0];
          this.state = { activeTabId: i.id };
        }
        render() {
          const {
            title: e,
        ...
        _renderChildren() {
          return ({ requestResize: e }) => {
            ...
            const { pages: l, source: r, model: i } = this.props,
              { activeTabId: o } = this.state,
              s =
                null !== (t = l.find((e) => e.id === o)) && void 0 !== t
                  ? t
                  : l[0],
            ...
            return n.createElement(
              ...
              n.createElement(
                ...
                "Component" in s
                  ? n.createElement(s.Component, { source: r, model: i })
          ...
          return n.createElement(
            B.InputRow,
            {
              ...
              label: n.createElement(
                ...
                i.t(t.name, { context: "input" }, l(32856)),
              ),
              offset: d,
            },
            n.createElement(Q.ColorWithThicknessSelect, {
            ...
            s && a && o.plottype && o.trackPrice
              ? n.createElement(K, {
                  ...
                  disabled: !o.visible.value(),
                  className: ee.smallStyleControl,
      ...
      class oe extends n.PureComponent {
        render() {
          ...
          return n.createElement(
            ...
            c && n.createElement(re.PropertyTable.GroupSeparator, null),
          );
        }
      }
      ...
      class ae extends n.PureComponent {
        constructor(e) {
          super(e),
            (this._visible = new se.StudyPlotVisibleProperty(
              e.styleProp.display,
            ));
        }
        render() {
      ...
      class ce extends n.PureComponent {
        constructor(e) {
          super(e),
            (this._visible = new se.StudyPlotVisibleProperty(e.display));
        }
        render() {
        ...
        render() {
          ...
          return n.createElement(
            ...
            t
              ...
              : n.createElement(Q.ColorWithThicknessSelect, {
                  disabled:
                    u || (r && !(Array.isArray(r) ? r[0].value() : r.value())),
                  color: i,
                  transparency: o,
                  thickness: s,
                }),
            ...
            n.createElement(
              ...
              n.createElement(
                ...
                n.createElement(
                  ...
                  n.createElement(ce, {
                    id: e,
                    title: it((0, r.ensureNotNull)(a), e),
                    display: s,
                  }),
                ),
              ),
              ...
              n.createElement(re.PropertyTable.GroupSeparator, null),
            ),
          );
        }
      }
      ...
      const Te = {
        ...
        xe = Object.values(Te).sort((e, t) => e.order - t.order);
      class ke extends n.PureComponent {
        render() {
          ...
          return n.createElement(Se.Select, {
            id: e,
            disabled: o,
            className: l,
            menuItemClassName: r,
      ...
      const _e = new o.TranslatedString(
          "change char",
          i.t(null, void 0, l(86955)),
        ),
        Ie = new o.TranslatedString(
          "change location",
      ...
      class Re extends n.PureComponent {
        constructor() {
          super(...arguments),
            (this._onCharChange = (e) => {
              ...
              t((0, r.ensureDefined)(this.props.property.childs().char), i, _e);
            }),
        ...
        render() {
          ...
          return n.createElement(
            ...
            {
              grouped: a,
              label: n.createElement(ce, { id: t, title: l, display: h }),
            },
            !a &&
              !o &&
              n.createElement(Q.ColorWithThicknessSelect, {
            ...
            n.createElement(Pe.InputControl, {
              disabled: void 0 === p || 0 === h.value(),
              className: ee.smallStyleControl,
              value: (0, r.ensureDefined)(
                null !== (e = null == p ? void 0 : p.value()) && void 0 !== e
                  ? e
                  : i,
              ),
            ...
            n.createElement(ke, {
              id: (0, x.createDomId)(t, "shape-style-select"),
              disabled: 0 === h.value(),
              className: we(ee.defaultSelect, ee.additionalSelect),
              menuItemClassName: ee.defaultSelectItem,
      ...
      const Xe = [];
      Object.keys(Le.plotShapesData).forEach((e) => {
        const t = Le.plotShapesData[e];
        Xe.push({
          id: t.id,
          value: t.id,
          selectedContent: n.createElement(A.DisplayItem, { icon: je(t.icon) }),
          content: n.createElement(A.DropItem, {
            icon: je(t.icon),
            label: t.guiName,
          }),
      ...
      const Je = new o.TranslatedString(
          "change shape",
      ...
      class Ze extends n.PureComponent {
        constructor() {
          super(...arguments),
            (this._onPlotTypeChange = (e) => {
              const { setValue: t } = this.context;
              t(this.props.property.childs().plottype, e, Je);
            }),
            (this._onLocationChange = (e) => {
              const { setValue: t } = this.context;
              t(this.props.property.childs().location, e, $e);
            });
        }
        render() {
          const {
      ...
      const Ke = (0, l(31955).getLogger)("Chart.Study.PropertyPage"),
        Qe = i.t(null, void 0, l(22691)),
        et = i.t(null, void 0, l(71776)),
        tt = i.t(null, void 0, l(74406)),
        lt = i.t(null, void 0, l(32163)),
        nt = i.t(null, void 0, l(38408));
      class rt extends n.PureComponent {
        render() {
          var e, t, l;
          const { plot: i, palettes: o, study: s } = this.props,
            a = i.id,
            ...
            return h && h.palette && h.paletteProps
              ? n.createElement(ae, {
                  title:
                    null !==
                      (t =
                        null === (e = null == d ? void 0 : d[a]) || void 0 === e
                          ? void 0
                          : e.title) && void 0 !== t
                      ? t
                      : a,
              ...
              : n.createElement(he, {
                  ...
                  title: (0, r.ensureDefined)(
                    null === (l = null == d ? void 0 : d[a]) || void 0 === l
                      ? void 0
                      : l.title,
                  ),
                  property: p,
          ...
          if ("arrows" === u) {
            const e = this._getPlotSwitch(a, it(s, a), p.display);
            if (m) return e;
            const t = o.up,
              l = o.down;
            return t || l
          ...
          if ("chars" === u || "shapes" === u) {
            const e = (0, r.ensureDefined)(null == d ? void 0 : d[a]),
              t = e.title;
            return n.createElement(
              n.Fragment,
              null,
          ...
          if ((0, k.isOhlcPlot)(i)) {
            const e = i.target,
              ...
              l = (0, r.ensureDefined)(
                (0, r.ensureDefined)(s.metaInfo().ohlcPlots)[e],
              ),
              c = this._getPlotSwitch(a, l.title, t.display);
            if (m) return c;
            const d = o.wick && o.wick.palette && o.wick.paletteProps,
              p = o.border && o.border.palette && o.border.paletteProps;
            return n.createElement(
              n.Fragment,
              null,
              c,
              ...
              o.wick &&
                ...
                n.createElement(ae, {
                  title: lt,
                  plot: i,
                  palette: o.wick.palette,
                  paletteProps: o.wick.paletteProps,
                  styleProp: t,
                  showSeparator: !1,
                  showOnlyTitle: !0,
                  offset: !0,
                }),
              Boolean(!d && t.wickColor) &&
                n.createElement(ye, {
                  id: a,
                  isRGB: m,
                  title: lt,
              ...
              o.border &&
                o.border.palette &&
                o.border.paletteProps &&
                n.createElement(ae, {
                  title: nt,
                  plot: i,
                  palette: o.border.palette,
                  paletteProps: o.border.paletteProps,
                  styleProp: t,
                  showSeparator: !1,
                  showOnlyTitle: !0,
                  offset: !0,
                }),
              Boolean(!p && t.borderColor) &&
                n.createElement(ye, {
                  id: a,
                  isRGB: m,
                  title: nt,
          ...
          return Ke.logError("Unknown plot type: " + u), null;
        }
      ...
      class ct extends n.PureComponent {
        ...
        render() {
          ...
          return n.createElement(st.LineStyleSelect, {
            ...t,
            lineStyle: (0, D.getPropertyValue)(e),
            lineStyleChange: this._onLineStyleChange,
          });
        }
      }
      ct.contextType = I.StylePropertyContext;
      const dt = new o.TranslatedString(
        "change value",
          ...
          return n.createElement(
            ...
            n.createElement(
              ...
              n.createElement(
                ...
                n.createElement(ot.FloatInputComponent, {
      ...
      pt.contextType = I.StylePropertyContext;
      ...
      const vt = new o.TranslatedString(
        ...
        yt = new o.TranslatedString(
          "change placement",
          i.t(null, void 0, l(81891)),
        ),
        gt = new o.TranslatedString(
          "change values visibility",
          i.t(null, void 0, l(9344)),
        ),
        bt = [
          {
            value: ht.HHistDirection.LeftToRight,
            content: i.t(null, void 0, l(11626)),
          },
          {
            value: ht.HHistDirection.RightToLeft,
            content: i.t(null, void 0, l(50421)),
          },
        ],
        ft = i.t(null, void 0, l(4622)),
        wt = i.t(null, void 0, l(10783)),
        Ct = i.t(null, void 0, l(60092)),
        Pt = i.t(null, void 0, l(77753));
        ...
        render() {
          ...
          return n.createElement(
            ...
            n.createElement(
              ...
              n.createElement(mt.IntegerInputComponent, {
            ...
            n.createElement(
              ...
              n.createElement(Se.Select, {
                id: "hhist-graphic-placement-select",
                disabled: !s.value(),
                className: ee.defaultSelect,
                menuItemClassName: ee.defaultSelectItem,
                items: bt,
                value: r.value(),
      ...
      St.contextType = I.StylePropertyContext;
      class Et extends n.PureComponent {
        render() {
          ...
          return n.createElement(
            B.InputRow,
            { label: n.createElement(V, { id: e, title: e, visible: o }) },
            n.createElement(Q.ColorWithThicknessSelect, {
              disabled: !o.value(),
              color: l,
      ...
      class kt extends n.PureComponent {
        render() {
          ...
          return Object.keys(s).map((t, i) => {
            var s, a, c, d;
            const p = (0, r.ensureDefined)(
              null === (s = o[e]) || void 0 === s ? void 0 : s.childs()[t],
            );
                ...
                : "hhists" === e
                  ? n.createElement(St, {
                      ...
                      hHistInfo: (0, r.ensureDefined)(
                        null === (d = l.graphics.hhists) || void 0 === d
                          ? void 0
                          : d[t],
                      ),
                      property: p,
      ...
      var _t = l(66045);
      const It = new o.TranslatedString(
          "change font size",
      ...
      class Dt extends n.PureComponent {
        ...
        render() {
          ...
          return n.createElement(_t.FontSizeSelect, {
            ...t,
            fontSizes: Rt,
            fontSize: e.value(),
      ...
      const Lt = new o.TranslatedString(
          "change visibility",
          i.t(null, void 0, l(1924)),
        ),
        Vt = i.t(null, void 0, l(62791)),
        Bt = i.t(null, void 0, l(5119)),
        Nt = {
          Traditional: new Set([
            "S5/R5",
            "S4/R4",
      ...
      class zt extends n.PureComponent {
        ...
        render() {
          ...
          return n.createElement(
            ...
            n.createElement(
              ...
              {
                labelAlign: "adaptive",
                label: n.createElement("span", null, Vt),
              },
              n.createElement(
                "div",
                { className: ee.block },
                n.createElement(
                  "div",
                  { className: we(ee.wrapGroup, ee.additionalSelect) },
                  n.createElement(Dt, {
        ...
        _renderColors() {
          const { levelsStyle: e, inputs: t } = this.props.property.childs(),
            ...
            { kind: s } = t.childs(),
            a = (0, r.ensureDefined)(Nt[s.value()]);
          return l
            .childNames()
            .filter((e) => a.has(e))
            .map((e) =>
      ...
      zt.contextType = I.StylePropertyContext;
      const At = i.t(null, void 0, l(10783)),
        ...
        Ft = i.t(null, void 0, l(67972)),
        Ht = i.t(null, void 0, l(60092)),
        Ot = i.t(null, void 0, l(4622)),
        Ut = i.t(null, void 0, l(73033)),
        Gt = i.t(null, { context: "input" }, l(49191)),
        Yt = i.t(null, { context: "input" }, l(76542));
      class jt extends n.PureComponent {
        ...
        render() {
          ...
          const { metaInfo: d } = this.props,
            ...
            { hhists: v, horizlines: y, polygons: g } = p.childs(),
            b = (0, r.ensureDefined)(d.graphics.hhists),
            f = Object.keys(b),
            w = v.childs()[f[0]],
            C = w.childs().visible,
            P = f.map((e) => v.childs()[e].childs().showValues),
            S = w.childs().percentWidth,
            E = w.childs().direction,
            T = f.map((e) => v.childs()[e].childs().valuesColor),
            x = null === (e = y.childs()) || void 0 === e ? void 0 : e.vahLines,
            k =
              null === (t = d.graphics.horizlines) || void 0 === t
                ? void 0
                : t.vahLines,
            _ = null === (o = y.childs()) || void 0 === o ? void 0 : o.valLines,
            I =
              null === (s = d.graphics.horizlines) || void 0 === s
                ? void 0
                : s.valLines,
            D = y.childs().pocLines,
            L = (0, r.ensureDefined)(
              null === (a = d.graphics.horizlines) || void 0 === a
                ? void 0
                : a.pocLines,
            ),
            N = u.childs().developingPoc,
            z = new se.StudyPlotVisibleProperty(N.childs().display),
            A = (0, r.ensureDefined)(
              null === (c = d.styles) || void 0 === c
                ? void 0
                : c.developingPoc,
            ),
            M = u.childs().developingVAHigh,
            W = new se.StudyPlotVisibleProperty(M.childs().display),
            F = u.childs().developingVALow,
            H = new se.StudyPlotVisibleProperty(F.childs().display),
            O = d.graphics.polygons && d.graphics.polygons.histBoxBg;
          return n.createElement(
            n.Fragment,
            null,
            n.createElement(
            ...
            n.createElement(
              ...
              n.createElement(
                re.PropertyTable.Cell,
                { placement: "first" },
                n.createElement("div", { className: ee.childRowContainer }, Ot),
              ),
              n.createElement(
                re.PropertyTable.Cell,
                { placement: "last" },
            ...
            n.createElement(
              ...
              n.createElement(
                re.PropertyTable.Cell,
                { placement: "first" },
                n.createElement("div", { className: ee.childRowContainer }, At),
              ),
              n.createElement(
                re.PropertyTable.Cell,
                { placement: "last" },
                    ...
                    return n.createElement(
                      B.InputRow,
                      {
                        ...
                        label: n.createElement(
                          ...
                          (o &&
                            i.t(o.titles[r], { context: "input" }, l(32856))) ||
                            "",
                        ),
                      },
                      n.createElement(Q.ColorWithThicknessSelect, {
            ...
            n.createElement(
              ve,
              {
                ...
                visible: D.childs().visible,
                thickness: D.childs().width,
              },
              n.createElement(ct, {
                id: "poc-lines-line-style-select",
                disabled: !D.childs().visible.value(),
                className: ee.smallStyleControl,
                lineStyle: D.childs().style,
              }),
            ),
            N &&
              n.createElement(
                ve,
                {
                  id: "developingPoc",
                  title:
                    (A.title && i.t(A.title, { context: "input" }, l(32856))) ||
                    "",
                  color: N.childs().color,
                  visible: z,
                  thickness: N.childs().linewidth,
                },
                n.createElement(ct, {
                  id: "developing-poc-line-style-select",
                  disabled: !z.value(),
                  className: ee.smallStyleControl,
                  lineStyle: N.childs().linestyle,
                }),
              ),
            M &&
              F &&
              n.createElement(
                ve,
                {
                  id: "developingPoc",
                  title: Ut,
                  color: [M.childs().color, F.childs().color],
                  visible: [W, H],
                  thickness: [M.childs().linewidth, F.childs().linewidth],
                },
                n.createElement(ct, {
                  id: "developing-VA-line-style-select",
                  disabled: !W.value() && !H.value(),
                  className: ee.smallStyleControl,
                  lineStyle: [M.childs().linestyle, F.childs().linestyle],
                }),
              ),
            g &&
              n.createElement(
                B.InputRow,
                {
                  label: n.createElement(
                    "div",
                    null,
                    (O && i.t(O.name, { context: "input" }, l(32856))) || "",
                  ),
                },
                n.createElement(Q.ColorWithThicknessSelect, {
      ...
      const Jt = {
        ...
        PivotPointsStandard: function () {
          ...
          return n.createElement(zt, { property: e });
        },
        VbPVisible: Xt,
        VbPAnchored: Xt,
      };
      ...
      $t.contextType = qt.ModelContext;
      var Zt = l(65388);
      const Kt = new o.TranslatedString(
          "change precision",
          i.t(null, void 0, l(61863)),
        ),
        Qt = i.t(null, void 0, l(16564)),
        el = i.t(null, void 0, l(59766)),
        tl = [{ value: "default", content: Qt }];
      for (let e = 0; e <= 8; e++) tl.push({ value: e, content: e.toString() });
      class ll extends n.PureComponent {
        constructor() {
          super(...arguments),
            (this._onChange = (e) => {
              const { setValue: t } = this.context,
      ...
      ll.contextType = I.StylePropertyContext;
      const nl = new o.TranslatedString(
          "change min tick",
          i.t(null, void 0, l(26476)),
        ),
        rl = i.t(null, void 0, l(16564)),
        il = i.t(null, void 0, l(64075)),
        ol = [
        ...
        sl = [{ id: "tick-default", value: "default", content: rl }];
      ...
      class al extends n.PureComponent {
        constructor() {
          super(...arguments),
            (this._onChange = (e) => {
              const { setValue: t } = this.context,
      ...
      al.contextType = I.StylePropertyContext;
      var cl = l(73146),
        dl = l(86067);
      class pl extends n.PureComponent {
        render() {
          const {
            id: e,
            isRGB: t,
            ...
            t
              ...
              : n.createElement(
                  ...
                  i &&
                    n.createElement(
                      "div",
                      { className: Ce()(i && o && ee.additionalSelect) },
                      n.createElement(Q.ColorWithThicknessSelect, {
                        disabled:
                          r && !(Array.isArray(r) ? r[0].value() : r.value()),
                        color: i,
      ...
      pl.contextType = I.StylePropertyContext;
      const ul = i.t(null, void 0, l(79468)),
        hl = i.t(null, { context: "input" }, l(49191)),
        ml = i.t(null, { context: "input" }, l(76542)),
        vl = i.t(null, void 0, l(89702));
      class yl extends n.PureComponent {
        ...
        render() {
          ...
          const l = e.properties(),
            ...
            u = (0, cl.createAdapter)(e).canOverrideMinTick();
          return n.createElement(
            re.PropertyTable,
            null,
            this._plotsElement(),
            ...
            _.StudyMetaInfo.isScriptStrategy(t) &&
              n.createElement(ut, { orders: i.orders }),
            (p || d) &&
              n.createElement(
                re.PropertyTable.Row,
                null,
                n.createElement(re.PropertyTable.GroupSeparator, { size: 1 }),
                n.createElement(dl.GroupTitleSection, { title: vl, name: vl }),
                p &&
                  n.createElement(ll, {
                ...
                if (
                  ...
                  if (t.palette) {
                    const e = this._findPalettesByTargetId(t.id),
                      i = (0, r.ensureDefined)(e.main),
                      o = e.secondary;
                    return n.createElement(oe, {
                      key: t.id,
                      title: t.title,
                      area: t,
                      palette: (0, r.ensureDefined)(i.palette),
                      paletteProps: (0, r.ensureDefined)(i.paletteProps),
                      secondaryPalette: null == o ? void 0 : o.palette,
                      secondaryPaletteProps:
                        null == o ? void 0 : o.paletteProps,
                      styleProp: l,
                    });
                  }
                  return null;
        ...
        _graphicsElement() {
          ...
          return (
            ...
            Object.keys(t).map((t, l) =>
              n.createElement(kt, { key: t, graphicType: t, study: e }),
            )
          );
        }
      ...
      function gl(e) {
        return (0, I.bindPropertyContext)(yl, {
          ...e,
          property: e.study.properties(),
        });
      }
      class bl extends n.PureComponent {
        render() {
          return n.createElement(
      ...
      var fl = l(57717),
        ...
        Pl = l(19466),
        Sl = l(28124);
      class El extends wl.DialogRenderer {
        constructor(e, t, l, n) {
          super(),
            (this._timeout = null),
            (this._handleClose = () => {
        ...
        show(e = {}) {
          ...
          let o = [];
          const u = new E.MetaInfoHelper(r);
          ...
          const h =
            ...
            "inputs";
          let m = (0, s.clean)(r.shortDescription, !0);
          const y =
            null !== (t = o.find((e) => e.id === h)) && void 0 !== t ? t : o[0];
          (this._rootInstance = (0, Sl.createReactRoot)(
            n.createElement(P, {
              title: m,
              model: this._model,
              source: this._source,
        ...
        _createVisibilitiesPropertyPage() {
          ...
          return (0, fl.createPropertyPage)(
    ...
    93081: (e, t, l) => {
      ...
      function R(e) {
        ...
        return r.createElement(S.Icon, {
          icon: I(t),
          className: i(_["arrow-icon"], _[`size-${t}`], l && _.dropped),
        });
      }
      var D = l(456);
      function L(e) {
        ...
        return r.createElement(P.PopupMenuDisclosureView, {
          ...
          popupChildren: a.map((e) =>
            r.createElement(C.PopupMenuItem, {
              key: e.id,
              className: u ? D["link-item"] : void 0,
              onClick: v,
              onClickArg: e,
              isActive: h(e),
              label: e.label,
      ...
      const B = { xsmall: 0, small: 0, medium: 0, large: 0, xlarge: 0 };
      var N = l(5325),
        z = l(42707),
        A = l(86240),
        M = l(7633);
      ...
      function Y(e) {
        ...
        return r.createElement(
          "div",
          {
            className: i(G().underline, t && G().disabled),
            style: {
      ...
      function j(e) {
        const {
          ...
          j = null != T ? T : !D,
          {
            ...
            moreButtonRef: Z,
            setItemRef: K,
          } = (0, a.useCollapsible)(n, N, C),
          Q = "collapse" === V ? X : n,
          ee = "collapse" === V ? q : [],
          te = (0, r.useCallback)((e) => ee.includes(e), [ee]),
          ...
          })(b),
          {
            ...
            isRtl: O.isRtl,
            itemsRefs: le,
            isDisclosureOpened: ne,
            scrollIntoViewOptions: { additionalScroll: se },
          }),
          me = n.find(C),
          ve = ee.find(he),
          ye = (0, r.useCallback)(() => {
        ...
        (de.ref = (0, c.useMergedRefs)([de.ref, J])),
          (ce.ref = (0, c.useMergedRefs)([ce.ref, $])),
          (ce.onKeyDown = (0, d.createSafeMulticastEventHandler)(
            (0, h.useKeyboardEventHandler)([
              (0, h.useKeyboardClose)(ne, be),
              (0, h.useKeyboardActionHandler)(
                [13, 32],
                fe,
                (0, r.useCallback)(() => Boolean(ve), [ve]),
              ),
            ]),
            ce.onKeyDown,
          ));
        ...
        (0, r.useEffect)(() => {
          B.current ? (B.current = !1) : (ve && !ne && re(), !ve && ne && ie());
        }, [ve, ne, re, ie]);
        const Pe = (function (e, t, l = []) {
          const [n, i] = (0, r.useState)(),
            ...
            a = (e) => {
              ...
              if (void 0 === l) return;
              const n = void 0 === s.current || s.current === e ? 0 : 100;
              s.current = e;
              const { left: r, right: o, width: a } = e.getBoundingClientRect(),
                { left: c, right: d } = l.getBoundingClientRect(),
                p = (0, O.isRtl)() ? o - d : r - c;
              i({ translateX: p, scale: a, transitionDuration: n });
            };
          return (
            (0, r.useEffect)(() => {
            ...
            (0, r.useEffect)(() => {
              ...
              return void 0 !== n
                ? (a(n),
                  null === (l = o.current) || void 0 === l || l.observe(n),
                  () => {
                    var e;
        ...
        return r.createElement(
          m.Provider,
          { value: { size: b, overflowBehaviour: V } },
          r.createElement(
            "div",
            {
              ...de,
              className: W({ size: b, overflowBehaviour: V, className: P }),
              style: S,
              "data-name": _,
            },
            r.createElement(
              ...
              {
                ...ce,
                className: o()(M["underline-tabs"], {
                  [M["make-grid-column"]]: U || G,
                  [M["stretch-tabs"]]: U,
                  [M["equal-tab-size"]]: G,
                }),
              },
              ...
              Pe
                ? r.createElement(Y, { ...Pe, disabled: y })
      ...
      var X = l(38952);
      function q(e) {
        return r.createElement("a", { ...(0, X.renameRef)(e) });
      }
      (0, r.forwardRef)((e, t) => {
        var l;
        const { size: n, overflowBehaviour: i } = (0, r.useContext)(m),
          o = (0, r.useContext)(v.CustomBehaviourContext),
          {
            ...
            fake: u,
            className: h,
            enableActiveStateStyles: y = o.enableActiveStateStyles,
          ...
          E = null !== (l = s.renderComponent) && void 0 !== l ? l : q;
        return r.createElement(
          E,
          {
            ...C,
    ...
    10428: (e, t, l) => {
      ...
      function c(e) {
        ...
        return r.createElement(
          "span",
          {
            className: o()(a.switchView, a[t], n && a.disabled, l && a.checked),
          },
      ...
      function m(e) {
        ...
        return r.createElement(
          "span",
          { className: i(a, o && h().checked, h().switcher) },
          r.createElement("input", {
            ...T,
            type: "checkbox",
            className: i(h().input, d && h().activeStylesEnabled),
            role: w,
            "aria-checked": o,
            checked: o,
            onKeyDown: (e) => {
              var t;
              13 === (0, p.hashFromEvent)(e) &&
          ...
          r.createElement(
            "span",
            { className: i(h().thumbWrapper, h()[n]) },
            r.createElement(c, { checked: o, size: l, disabled: u }),
          ),
        );
      }
      !(function (e) {
      ...
      function w(e) {
        const {
          ...
          [C, P] = (0, y.useRovingTabindexElement)(null),
          S = o()(h.label, l && !c && h.labelOn),
          E = o()(
            t,
            h.wrapper,
            l && h.wrapperWithOnLabel,
            s && h.wrapperWithDescription,
          );
        return r.createElement(
          "label",
          {
            className: o()(E, w && h.withIcon, b.accessible),
            htmlFor: n,
            ref: d,
            onKeyDown: function (e) {
              ...
              (13 !== t && 32 !== t) ||
                (e.preventDefault(),
                C.current instanceof HTMLElement && C.current.click());
            },
            tabIndex: P,
            "data-role": "menuitem",
          ...
          void 0 !== w &&
            r.createElement(v.Icon, { className: h.icon, icon: w }),
          r.createElement(
            "div",
            { className: h.labelRow },
            r.createElement("div", { className: S }, i),
            s && r.createElement("div", { className: h.labelHint }, s),
          ),
          r.createElement(
            "div",
    ...
    26434: (e, t, l) => {
      ...
      const p = new r.TranslatedString(
        ...
        D = n.t(null, void 0, l(65188)),
        L = n.t(null, void 0, l(42562)),
        V = n.t(null, void 0, l(56796)),
        B = n.t(null, void 0, l(72942)),
        N = n.t(null, void 0, l(835)),
        z = n.t(null, void 0, l(43154)),
        A = new r.TranslatedString("ticks", n.t(null, void 0, l(3539))),
        ...
        $ = new r.TranslatedString("weeks", n.t(null, void 0, l(45537))),
        Z = new r.TranslatedString("weeks from", n.t(null, void 0, l(92859))),
        K = new r.TranslatedString("weeks to", n.t(null, void 0, l(44127))),
      ...
      function ae(e, t, l) {
        ...
        n.push(r, c, d);
        const A = (0, o.createRangePropertyDefinition)(
            {
              checked: (0, o.convertToDefinitionProperty)(
                e,
                t.weeks,
        ...
        return n.push(A, M), { definitions: n };
      }
      function ce(e, t) {
        const l = [];
        if (i.enabled("tick_resolution")) {
