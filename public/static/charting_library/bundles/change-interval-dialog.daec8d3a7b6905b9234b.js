(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2077],
  {
    ...
    67029: (e, t, n) => {
      "use strict";
      n.d(t, { ControlSkeleton: () => R, InputClasses: () => g });
      var o = n(50959),
        r = n(97754),
        s = n(50151),
        l = n(38528),
      ...
      function m(e, t, n, o) {
        const {
          ...
          C = h(null != s ? s : (0, u.getGroupCellRemoveRoundBorders)(n));
        return r(
          d().container,
          d()[`container-${c}`],
          d()[`intent-${i}`],
      ...
      function f(e, t, n) {
        ...
        const l = h(null != s ? s : (0, u.getGroupCellRemoveRoundBorders)(t));
      ...
      function v(e, t) {
        ...
        return o.createElement(
          ...
          w,
          b,
          o.createElement("span", { className: f(e, M, P) }),
        );
      }
      v.displayName = "ControlSkeleton";
      const R = o.forwardRef(v);
    },
    78274: (e, t, n) => {
      "use strict";
      n.d(t, {
    ...
    31261: (e, t, n) => {
      ...
      function R(e) {
        ...
        const {
          ...
          W = (0, l.createSafeMulticastEventHandler)(
            C.onFocus,
            function (e) {
              n && !w.current && (0, i.selectAllContent)(e.currentTarget);
            },
            s,
          ),
          P = (0, l.createSafeMulticastEventHandler)(C.onBlur, h),
          x = (0, o.useCallback)(
            (e) => {
              (g.current = e),
                m &&
        ...
        return o.createElement(v, {
          ...
          onContainerFocus: function (e) {
            p.current === e.target && null !== g.current && g.current.focus();
          },
          onFocus: W,
          onBlur: P,
          reference: x,
          containerReference: (0, a.useMergedRefs)([p, f]),
          onMouseDown: b,
          onMouseUp: S,
        });
      }
    ...
    48027: (e, t, n) => {
      ...
      function s(e) {
        const {
          ...
          [a, u] = (0, r.useFocus)(void 0, i),
          c = (0, o.createSafeMulticastEventHandler)(i ? void 0 : u.onFocus, t),
          d = (0, o.createSafeMulticastEventHandler)(i ? void 0 : u.onBlur, n);
        return {
          ...e,
    ...
    71090: (e, t, n) => {
      ...
      var o = n(50959),
        ...
        d = n(9745),
        h = n(85508);
      const m = l.t(null, void 0, n(51998)),
        f = l.t(null, void 0, n(96941));
      function g(e) {
      ...
      var R = n(5362);
      function C(e) {
        const { initVal: t, selectOnInit: r, onClose: d } = e,
          h = (0, o.useRef)(null),
          [m, f] = (0, o.useState)(t.toUpperCase()),
          C = (0, o.useMemo)(() => v.Interval.parse(m), [m]),
          D = (function (e, t) {
            return (0, o.useMemo)(() => {
              if (!t.isValid() || !(0, p.intervalIsSupported)(e)) return !1;
              const n = v.Interval.normalize(e);
              return null !== n && (0, p.isResolutionMultiplierValid)(n);
            }, [e, t]);
          })(m, C),
          N = (0, o.useMemo)(() => {
            if (!D) return null;
            return (0, p.getTranslatedResolutionModel)(C.value()).hint;
          }, [D, C]);
        return (
          (0, o.useLayoutEffect)(() => {
            var e, t;
          ...
          o.createElement(
            c.PopupDialog,
            {
              ...
              onKeyDown: function (e) {
                27 === e.keyCode && (null == d || d());
              },
            },
            o.createElement(
              "div",
              { className: R.dialogInner },
              o.createElement(
                "div",
                { className: R.titleWrapper },
                o.createElement(
                  "div",
                  { className: R.title },
                  l.t(null, void 0, n(2569)),
                ),
                o.createElement(g, {
                  className: R.infoHint,
                  isSecondsEnabled: (0, p.isSecondsEnabled)(),
                }),
              ),
              o.createElement(
                "form",
                {
                  ...
                  onSubmit: function (e) {
                    e.preventDefault();
                    const t = u.linking.interval.value(),
                      n = v.Interval.normalize(m);
                    n && t !== n && D && u.linking.interval.setValue(n);
                    null == d || d();
                  },
                },
                o.createElement(i.InputControl, {
                  className: s()(R.inputWrapper, a.InputClasses.FontSizeLarge),
              ...
              D
                ? o.createElement("div", { className: R.hint }, N)
                : o.createElement(
                    "div",
                    { className: s()(R.hint, R.error) },
                    l.t(null, void 0, n(60731)),
                  ),
            ),
          )
        );
      ...
      function w(e) {
        if (
          D.dialogsOpenerManager.isOpened("ChangeIntervalDialog") ||
          D.dialogsOpenerManager.isOpened("SymbolSearch")
        )
          return;
        const t = document.createElement("div"),
          { initVal: n, selectOnInit: r, onClose: s } = e,
          l = o.createElement(C, {
            initVal: n,
            selectOnInit: r,
            onClose: function () {
              i.unmount(),
                D.dialogsOpenerManager.setAsClosed("ChangeIntervalDialog"),
                null == s || s();
            },
          }),
          i = (0, N.createReactRoot)(l, t);
        D.dialogsOpenerManager.setAsOpened("ChangeIntervalDialog");
      }
    },
    85508: (e) => {
      e.exports =
