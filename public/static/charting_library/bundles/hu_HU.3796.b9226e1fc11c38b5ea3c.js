(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    92389: (e) => {
      e.exports = { en: ["Clone, Copy"], hu_HU: ["Clone, Copy"] };
    },
    47742: (e) => {
    ...
    80996: (e) => {
      e.exports = { en: ["Local drawings"], hu_HU: ["Local drawings"] };
    },
    37117: (e) => {
    ...
    84212: (e) => {
      e.exports = { en: ["No drawings yet"], hu_HU: ["Nincs még rajz"] };
    },
    92931: (e) => {
      e.exports = { en: ["Synced globally"], hu_HU: ["Synced globally"] };
    },
    41870: (e) => {
      e.exports = { en: ["Synced in layout"], hu_HU: ["Synced in layout"] };
    },
    8182: (e) => {
      e.exports = {
    ...
    93277: (e) => {
      e.exports = { en: ["hide objects"], hu_HU: ["hide objects"] };
    },
    10370: (e) => {
      e.exports = {
    ...
    36044: (e) => {
      e.exports = { en: ["move objects"], hu_HU: ["move objects"] };
    },
    51382: (e) => {
      e.exports = { en: ["show {title}"], hu_HU: ["show {title}"] };
    },
    23771: (e) => {
      e.exports = { en: ["show objects"], hu_HU: ["show objects"] };
    },
    79688: (e) => {
