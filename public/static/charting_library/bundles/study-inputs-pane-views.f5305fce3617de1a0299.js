...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    36036: (e, t, i) => {
      i.d(t, { LineAnchorRenderer: () => v, anchor: () => _ });
      var n = i(14314),
        r = i(86441),
        s = i(34026),
        o = i(50151),
      ...
      class v extends h.BitmapCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          t.length && this._drawPoints(e, t, i, y, P),
            n.length && this._drawPoints(e, n, r, m, f);
        }
        _drawPoints(e, t, i, n, r) {
          const {
            ...
            h = u.radius;
          let p = Math.max(1, Math.floor((u.strokeWidth || 2) * a));
          u.selected && (p += Math.max(1, Math.floor(a / 2)));
          const g = Math.max(1, Math.floor(a));
          let P = Math.round(h * a * 2);
          P % 2 != g % 2 && (P += 1);
          const y = (g % 2) / 2,
            f = (0, c.interactionTolerance)().anchor;
            ...
            if (
              ...
              if (
                (n(
                  ...
                  _({
                    ...o,
                    x: Math.round(o.x * a) + y,
                    y: Math.round(o.y * d) + y,
                  }),
                  P / 2,
                  p,
                ),
                ...
                if (o.subtract(u.currentPoint).length() <= h + f) {
                  const e = Math.max(1, Math.floor(u.selectedStrokeWidth * a));
                  let t = Math.round(h * a * 2);
                  t % 2 != g % 2 && (t += 1);
                  r(
                    s,
                    _({
    ...
    63006: (e, t, i) => {
      i.r(t), i.d(t, { StudyInputPriceAxisPaneView: () => s });
      var n = i(57596),
        r = i(98558);
      class s extends r.PriceAxisView {
        ...
        _updateRendererData(e, t, i) {
          ...
          (i.background = o),
            ...
            (i.coordinate = s),
            (e.text = this._formatPrice(r)),
            (e.visible = !0);
        }
      }
    },
    35581: (e, t, i) => {
      i.r(t), i.d(t, { StudyInputTimeAxisPaneView: () => s });
      var n = i(57596),
        r = i(66156);
    ...
    99549: (e, t, i) => {
      ...
      var n = i(86441),
        ...
        l = i(36036),
        d = i(50546);
      const u = r.colorsPalette["color-cold-gray-500"],
      ...
      class h extends d.StudyInputsPaneView {
          ...
          this._inputs.forEach((i, r) => {
            ...
            if (Array.isArray(i)) {
              const e = "time" === i[0].type ? i[0] : i[1],
                ...
                r = this._getInputValue(t.id);
              null !== n &&
                null !== r &&
                ((d = this._convertTimeToCoordinate(n)),
                (u = this._convertPriceToCoordinate(r)),
                (c = !1));
            } else {
            ...
            if (null !== d && null !== u) {
              const e = new n.Point(d, u);
              (e.activeItem = h),
                (e.square = c),
                (e.pointIndex = r),
                (e.hitTarget = o.HitTarget.MovePoint),
                (e.cursorType = s),
                this._points.push(
                  (0, l.anchor)({
                    x: d,
                    ...
                    square: c,
                    pointIndex: r,
                    hitTarget: o.HitTarget.MovePoint,
                    cursorType: s,
                    possibleMovingDirections:
                      ((p = Array.isArray(i) ? i[0].type : i.type),
                      "price" === p ? 2 : 1),
                  }),
                );
            }
        ...
        _createStudyAnchor(e, t, i) {
          const n = (0, s.lastMouseOrTouchEventInfo)().isTouch,
            ...
            o = this._inputs.indexOf(this._model.activeItemBeingMoved()),
            a = this._model.crossHairSource(),
            l =
            ...
            d = {
              ...
              currentPoint: a.currentPoint(),
              linePointBeingEdited: -1 !== o ? o : null,
              radius: n ? 13 : 6,
              strokeWidth: n ? 2 : 1,
          ...
          return (
            this._editable || (d.disableInteractions = !0), r.setData(d), r
          );
        }
          ...
          this._inputs.forEach((e) => {
            if (Array.isArray(e)) {
              ...
              if (null !== n && null !== r) {
                ...
                null !== e &&
                  null !== s &&
                  (this._renderer.append(e), this._renderer.append(s));
              }
            } else {
