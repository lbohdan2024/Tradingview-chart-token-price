(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [139],
  {
    ...
    9038: (t, e, r) => {
      "use strict";
      r.d(e, { useLightButtonClasses: () => c });
      var o = r(50959),
        i = r(97754),
        a = r(17946),
        l = r(27011),
        n = r(86332);
      const s = o.createContext({ isInButtonGroup: !1, isGroupPrimary: !1 }),
        c = (t, e, r) => {
          const c = (0, o.useContext)(a.CustomBehaviourContext),
            {
              className: d,
              isSelected: u,
              children: h,
            ...
            E = (0, o.useContext)(n.ControlGroupContext),
            { isInButtonGroup: H, isGroupPrimary: V } = (0, o.useContext)(s);
          return i(
            d,
            t.lightButton,
            b && t.link,
            _ && t.active,
            u && t.selected,
            (0, l.isIconOnly)(h, v) && t.noContent,
            !!A && t.withStartSlot,
            (p || !!k) && t.withEndSlot,
            r && t.withGrouped,
            m && t[m],
      ...
      function u(t) {
        ...
        return o.createElement(
          ...
          v &&
            o.createElement(
              "span",
              { className: i(d().slot, d().startSlot) },
              v,
            ),
          !(0, l.isIconOnly)(p, r) &&
            o.createElement(
              "span",
              {
                ...
                "data-overflow-tooltip-text":
                  null != h ? h : (0, a.getTextForTooltip)(p),
              },
              u || c
                ? o.createElement(
                    o.Fragment,
          ...
          m &&
            o.createElement("span", { className: i(d().slot, d().endSlot) }, m),
          e &&
            ((t) =>
              o.createElement(n.Icon, {
                className: i(d().caret, t && d().activeCaret),
                icon: s,
              }))(g),
        );
      }
    ...
    81200: (t, e, r) => {
      ...
      const y = {
        ghost: {
          1: (0, h.enabled)("hide_image_invalid_symbol") ? void 0 : p,
          2: (0, h.enabled)("hide_image_invalid_symbol") ? void 0 : m,
        },
        ...
        return a.createElement(
          "div",
          {
            ...
            className: c()(
              ...
              !n && C.errorCard_limitWidth,
            ),
          },
          p &&
            a.createElement(d.Icon, { icon: p, className: C.errorCard__icon }),
          l
            ? a.createElement("div", {
      ...
      function w(t) {
        ...
        return (
          a.useEffect(() => {
            const t = p.current;
            if (t) {
              const e = new ResizeObserver((0, n.default)(g, 150));
        ...
        function g() {
          ...
          e < c ? v(0) : t.clientWidth < l || e < s ? v(1) : v(2);
        }
      }
      class b {
        constructor() {
