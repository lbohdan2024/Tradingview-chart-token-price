(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    4543: (a) => {
      a.exports = { en: ["Cancel"], pl: ["Anuluj"] };
    },
    47742: (a) => {
      a.exports = { en: ["Close menu"], pl: ["Zamknij menu"] };
    },
    69207: (a) => {
      a.exports = { en: ["Add to favorites"], pl: ["Dodaj do ulubionych"] };
    },
    30448: (a) => {
      a.exports = {
    ...
    79825: (a) => {
      a.exports = { en: ["Load layout"], pl: ["Załaduj układ"] };
    },
    11478: (a) => {
      a.exports = { en: ["Layout name"], pl: ["Nazwa układu"] };
    },
    21329: (a) => {
      a.exports = {
    ...
    8573: (a) => {
      a.exports = { en: ["Search"], pl: ["Szukaj"] };
    },
    85106: (a) => {
      a.exports = { en: ["Remove from favorites"], pl: ["Usuń z ulubionych"] };
    },
    30502: (a) => {
      a.exports = {
