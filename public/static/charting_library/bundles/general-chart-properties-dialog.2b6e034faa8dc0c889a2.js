(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7078],
  {
    ...
    22265: (e, t, n) => {
      "use strict";
      n.d(t, { DialogSidebarItem: () => u, DialogSidebarWrapper: () => h });
      var i,
        l = n(50959),
        a = n(97754),
        o = n.n(a),
      ...
      function u(e) {
        const {
          ...
          f = (function () {
            if (_ && v) return null == i ? void 0 : i.bold;
            return a
              ? null == i
                ? void 0
                : i.bold
        ...
        return l.createElement(
          ...
          i && l.createElement(s.Icon, { className: m.icon, icon: f }),
          !C &&
            l.createElement(
              "span",
              {
    ...
    56080: (e, t, n) => {
      "use strict";
      n.r(t), n.d(t, { GeneralChartPropertiesDialogRenderer: () => he });
      var i = n(11542),
        l = n(50959),
        a = n(94720),
        o = n(5978),
        ...
        T = n(85662),
        y = (n(21251), n(3615));
      const _ = i.t(null, void 0, n(6113));
      var C = n(50655),
        f = n(34585),
        S = n(38068),
        k = n(51768),
      ...
      function M(e) {
        const {
          ...
          c = l.useCallback(() => {
            (0, T.loadTheme)(n, { themeName: t, standardTheme: !1 }).then(
              () => {
      ...
      var P = n(95276),
        B = n(20243),
        I = n(44996);
      const x = i.t(null, void 0, n(93553)),
        D = i.t(null, void 0, n(96413)),
        N = (0, f.appendEllipsis)(i.t(null, void 0, n(76266))),
        L = i.t(null, void 0, n(77571)),
        R = p.enabled("chart_template_storage");
        ...
        constructor(e) {
          super(e),
            ...
            (this._handleApplyDefaults = () => {
              ...
              const n = (0, T.getCurrentTheme)().name;
              (0, T.loadTheme)(t, {
                themeName: n,
                standardTheme: !0,
                applyOverrides: !0,
                  ...
                  () =>
                    (async function (e, t, i) {
                      const [l, a] = await Promise.all([
                        Promise.all([n.e(6302), n.e(7648)]).then(
                          n.bind(n, 57351),
                        ),
                        (0, T.getThemeNames)(),
                      ]);
                      l.showThemeSaveDialog(e, t, a, i);
                    })(
                      e.model().theme(),
                      this._syncThemeList,
            ...
            (this._syncThemeList = () => {
              R &&
                (0, T.getThemeNames)().then((e) => {
                  this.setState({ themes: e });
                });
            }),
            (this._handleListboxFocus = (e) => {
              e.target instanceof HTMLElement &&
                (0, B.handleAccessibleMenuFocus)(e, this._reference);
            }),
            (this._handleRenameClose = () => {
              var e;
                ...
                (e) =>
                  l.createElement(
                    P.ControlDisclosure,
                    {
                      ...
                      onListboxKeyDown: B.handleAccessibleMenuKeyDown,
                    },
      ...
      const q = (0, l.forwardRef)((e, t) => {
        const [n, i] = (0, X.useRovingTabindexElement)(t),
          { className: a } = e;
        return l.createElement(K.DialogSidebarItem, {
          ...e,
          className: G()(U.accessible, a),
          tag: "button",
          reference: n,
          tabIndex: i,
        });
      ...
      function Q(e) {
        const { mode: t, className: n, ...i } = e,
          { isMobile: a, isTablet: o } = (0, O.getSidebarMode)(t),
          s = G()(U.container, o && U.isTablet, a && U.isMobile, n);
      ...
      var Z = n(48199),
        ...
        ee = n(30744);
      function te(e) {
        return l.createElement(Z.BackButton, {
          className: ee.backButton,
          size: "medium",
          "aria-label": i.t(null, { context: "input" }, n(41256)),
          preservePaddings: !0,
        ...
        constructor(e) {
          ...
          super(e),
            ...
            (this._renderApplyToAllButton = () =>
              l.createElement(
                d.MatchMedia,
                { rule: V.DialogBreakpoints.TabletNormal },
          ...
          const { pages: n, activePageId: i } = e,
            a = n.filter((e) => e.visible.value());
          let o =
            null !== (t = a.find((e) => e.id === i)) && void 0 !== t ? t : null;
          if (!o) {
            const e = h().getValue(le),
              t = a.find((t) => t.id === e);
            o = t || (a.length > 0 ? a[0] : null);
          }
          this.state = {
            activePage: o,
            visiblePages: a,
      ...
      var oe = n(76422),
        ...
        re = n(19466),
        ce = n(28124);
      const me = i.t(null, void 0, n(71262));
    ...
    38068: (e, t, n) => {
      ...
      var i = n(50959),
        ...
        c = n(15965);
      function m(e) {
        const { tooltip: t, onClick: n, ...l } = e,
          [m, h] = (0, o.useRovingTabindexElement)(null);
        return i.createElement(
          "button",
          {
            ...
            tabIndex: h,
            onClick: n,
            className: a()(c.button, l.isActive && c.active),
            type: "button",
          },
          i.createElement(s.RemoveButton, {
            "aria-label": t,
            ...l,
            "data-tooltip": t,
            icon: r,
