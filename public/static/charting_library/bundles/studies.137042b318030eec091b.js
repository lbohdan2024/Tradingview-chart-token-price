  ...
  [7539],
  {
    83943: (e, s, t) => {
      ...
      var i = t(50151),
        ...
        _ = t(44672),
        b = t(16638);
      const S = new n.PriceFormatter(),
        y = "sessions";
      class g extends d.CustomSourceBase {
        constructor(e, s, t) {
          super(e, s),
            ...
            (this._properties = new h.DefaultProperty({
              defaultName: "sessions",
            })),
            (0, l.applyDefaultsOverrides)(
              this._properties.childs().graphics,
              void 0,
              !1,
              y,
            ),
            ...
            s.timeScale().onReset().subscribe(this, this._clearData),
            s
              .timeScale()
              .logicalRangeChanged()
              .subscribe(
                this,
                this.updateAllViews.bind(this, (0, _.viewportChangeEvent)()),
              ),
            s
              .mainSeries()
              .sessionIdProxyProperty()
              .subscribe(this, this._updateVisibleOfPreAndPostMarketBackground),
            s
              .mainSeries()
              .properties()
              .childs()
            ...
            this._updateVisibleOfPreAndPostMarketBackground(
              s.mainSeries().properties().childs().sessionId,
            );
        }
        applyOverrides(e) {
          (0, l.applyPropertiesOverrides)(
            this._properties.childs().graphics,
            void 0,
            !1,
            e,
        ...
        restart() {
          this._clearData(),
            u.enabled("stop_study_on_restart") && this.stop(),
            this.start();
        }
        isStarted() {
        ...
        updateAllViews(e) {
          this._paneViews.forEach((s) => s.update(e));
        }
        updateViewsForPane(e, s) {
          this.updateAllViews(s);
        }
        destroy() {
          (this._destroyed = !0),
        ...
        state(e) {
          const s = { properties: this._properties.state() };
          return (
            e &&
              null !== this._metaInfo &&
              (s.data = {
        ...
        restoreState(e, s) {
          e.oldState &&
            (e = (function (e, s) {
              const t = { properties: { graphics: e.state.graphics } };
              return (
                void 0 !== e.data &&
                  void 0 !== e.metaInfo &&
                  s &&
          ...
          this._migrateOutOfSessionProperty(t),
            this._properties.mergeAndFire(t),
            this._removeDuplicateProperties(),
            this._updateVisibleOfPreAndPostMarketBackground(
              this._model.mainSeries().properties().childs().sessionId,
            ),
            void 0 !== e.data &&
              s &&
              (this._loadStudyGraphics(e.data.graphics),
              this._setMetaInfo(new r.StudyMetaInfo(e.data.metaInfo)),
        ...
        async _requestAndProcessMetaInfo() {
          ...
          const e = await (0, b.studyMetaInfoRepository)().findById({
            type: "java",
          ...
          this._destroyed ||
            (null === this._loadedGraphics &&
              (this._setMetaInfo(e),
              null !== this._metaInfo &&
                ((this._studySource = new a.StudyDataSource(
        ...
        _loadStudyGraphics(e) {
          const s = e.backgrounds;
          if (void 0 !== s) {
            const e = s.findIndex((e) => "inSession" === e.styleId);
            -1 !== e && s.splice(e, 1);
          }
          this._loadedGraphics = (0, o.loadStudyGraphics)(e);
        }
        _setMetaInfo(e) {
          const s = e.graphics.backgrounds;
          void 0 !== s && void 0 !== s.inSession && delete s.inSession,
            (this._metaInfo = e);
        }
        _updateVisibleOfPreAndPostMarketBackground(e) {
          const s = !(0, c.isRegularSessionId)(e.value());
          this._outOfSessionVisibilityProperty().setValue(s),
            this._preMarketVisibilityProperty().setValue(s),
            this._postMarketVisibilityProperty().setValue(s);
        }
        _clearData() {
        ...
        _onPropertiesChanged() {
          this._processHibernate(),
            this.updateAllViews((0, _.sourceChangeEvent)(this.id()));
        }
        _processHibernate() {
          if (null !== this._studySource) {
            const e = this._canBeHibernated(),
              s = this._isHibernated(),
              t = this._studySource.isStarted();
            !s && e && t
              ? this._studySource.stop()
              : !s || e || t || this._studySource.start();
          }
        }
        _canBeHibernated() {
          ...
          return e.isDWM() || (!s && !this._vertLinesVisibleProperty().value());
        }
        _isHibernated() {
          return (
            this._isStarted &&
        ...
        _removeDuplicateProperties() {
          this._properties.hasChild("properties") &&
            ...
            (0, h.allowSavingDefaults)(!0),
            this._properties.childChanged(null, ""),
            (0, h.allowSavingDefaults)(!1));
        }
        _migrateOutOfSessionProperty(e) {
          const s = e.graphics.backgrounds;
          if (void 0 !== s) {
            const t = s.outOfSession;
            t.color ===
              (0, i.ensureDefined)(
                p.sessionsPreferencesDefault.graphics.backgrounds,
              ).outOfSession.color ||
              "postMarket" in s ||
              ((e.graphics.backgrounds = {
                ...s,
                postMarket: { color: t.color, transparency: t.transparency },
                preMarket: { color: t.color, transparency: t.transparency },
              }),
              "visible" in t &&
                ((e.graphics.backgrounds.preMarket.visible = t.visible),
                (e.graphics.backgrounds.postMarket.visible = t.visible)));
          }
        }
      }
    },
