(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5715],
  {
    ...
    75725: (e, t, n) => {
      "use strict";
      n.d(t, { FullSessionScheduleRenderer: () => g });
      var s = n(50959),
        r = n(97754),
        i = n(50151),
        a = n(11542),
      ...
      function g(e) {
        const {
          ...
          l = (0, o.useWatchedValueReadonly)({ watchedValue: e.sessionDays }),
          d = (0, o.useWatchedValueReadonly)({ watchedValue: e.now }),
        ...
        return s.createElement(
          ...
          s.createElement(
            ...
            i
              ...
              : s.createElement(D, { sessionDay: c }),
            s.createElement(
              "div",
          ...
          s.createElement(p, { sessionDays: l, currentTimeMark: d }),
          s.createElement(
            "div",
            { className: r(u.timezone, a, i && u.largePadding) },
            `${f}: ${n}`,
          ),
        );
      }
    ...
    60697: (e, t, n) => {
      "use strict";
      n.d(t, { FullSessionScheduleViewModel: () => re });
      var s = n(63950),
        r = n(37265),
        i = n(2740),
        a = n(64147),
      ...
      var k = n(11542);
      f.Months.JANUARY,
        k.t(null, void 0, n(200)),
        f.Months.FEBRUARY,
        k.t(null, void 0, n(81069)),
        f.Months.MARCH,
        k.t(null, void 0, n(93878)),
        f.Months.APRIL,
        k.t(null, void 0, n(28896)),
        f.Months.MAY,
        k.t(null, void 0, n(25734)),
        f.Months.JUNE,
        k.t(null, void 0, n(61487)),
        f.Months.JULY,
        k.t(null, void 0, n(6608)),
        f.Months.AUGUST,
        k.t(null, void 0, n(11081)),
        f.Months.SEPTEMBER,
        k.t(null, void 0, n(32179)),
        f.Months.OCTOBER,
        k.t(null, void 0, n(37997)),
        f.Months.NOVEMBER,
        k.t(null, void 0, n(4607)),
        f.Months.DECEMBER,
        k.t(null, void 0, n(90082)),
        f.Months.JANUARY,
        k.t(null, void 0, n(62310)),
        f.Months.FEBRUARY,
        k.t(null, void 0, n(2507)),
        f.Months.MARCH,
        k.t(null, void 0, n(92767)),
        f.Months.APRIL,
        k.t(null, void 0, n(27072)),
        f.Months.MAY,
        k.t(null, { context: "short" }, n(13132)),
        f.Months.JUNE,
        k.t(null, void 0, n(429)),
        f.Months.JULY,
        k.t(null, void 0, n(53786)),
        f.Months.AUGUST,
        k.t(null, void 0, n(46450)),
        f.Months.SEPTEMBER,
        k.t(null, void 0, n(6816)),
        f.Months.OCTOBER,
        k.t(null, void 0, n(12179)),
        f.Months.NOVEMBER,
        k.t(null, void 0, n(26899)),
        f.Months.DECEMBER,
        k.t(null, void 0, n(32084)),
        f.WeekDays.SUNDAY,
        k.t(null, void 0, n(61480)),
        f.WeekDays.MONDAY,
        k.t(null, void 0, n(19573)),
        f.WeekDays.TUESDAY,
        k.t(null, void 0, n(82160)),
        f.WeekDays.WEDNESDAY,
        k.t(null, void 0, n(94226)),
        f.WeekDays.THURSDAY,
        k.t(null, void 0, n(79137)),
        f.WeekDays.FRIDAY,
        k.t(null, void 0, n(3570)),
        f.WeekDays.SATURDAY,
        k.t(null, void 0, n(30348));
      const A = {
        [f.WeekDays.SUNDAY]: k.t(null, void 0, n(77493)),
        [f.WeekDays.MONDAY]: k.t(null, void 0, n(37150)),
        [f.WeekDays.TUESDAY]: k.t(null, void 0, n(11916)),
        [f.WeekDays.WEDNESDAY]: k.t(null, void 0, n(11532)),
        [f.WeekDays.THURSDAY]: k.t(null, void 0, n(71388)),
        [f.WeekDays.FRIDAY]: k.t(null, void 0, n(22928)),
        [f.WeekDays.SATURDAY]: k.t(null, void 0, n(32273)),
      };
      f.WeekDays.SUNDAY,
        k.t(null, { context: "day_of_week" }, n(75005)),
        f.WeekDays.MONDAY,
        k.t(null, { context: "day_of_week" }, n(30961)),
        f.WeekDays.TUESDAY,
        k.t(null, { context: "day_of_week" }, n(9135)),
        f.WeekDays.WEDNESDAY,
        k.t(null, { context: "day_of_week" }, n(92578)),
        f.WeekDays.THURSDAY,
        k.t(null, { context: "day_of_week" }, n(8765)),
        f.WeekDays.FRIDAY,
        k.t(null, { context: "day_of_week" }, n(97349)),
        f.WeekDays.SATURDAY,
        k.t(null, { context: "day_of_week" }, n(94748));
      var E = n(58683);
      function S(e) {
        for (
          (0, y.assert)(
      ...
      function _(e) {
        return { value: e, title: S(u(e)), isFirstOrLastPoint: !0 };
      }
      function R(e) {
        return 3 !== e.type;
      }
      function b(e, t) {
        return { dayIndex: e, entries: t.filter(R) };
      }
      function x(e, t, n, s = t) {
        const r = n(t),
          i = e[r];
      ...
      function L(e, t, n, s, r) {
        ...
        const d = u(i),
          c = u(o);
        return P(_(a !== r ? 0 : i), _(l !== r ? 1 : o), 3, W(a, d, l, c));
      }
      ...
      function V(e) {
        ...
        for (let n = 1; n < e.entries.length; n++) {
          ...
          if (r.start.value !== s.end.value) {
            const n = O(s, e.dayIndex, r, e.dayIndex, e.dayIndex);
            t.push(n);
          }
        }
      ...
      function B(e, t) {
        const n = (0, c.default)(t.entries),
          s = t.dayIndex,
          r = (0, y.ensureDefined)(d(e.entries));
        return 0 === r.start.value ? [] : [O(n, s, r, e.dayIndex, e.dayIndex)];
      }
      function C(e, t) {
        const n = d(t.entries),
          s = t.dayIndex,
          r = (0, y.ensureDefined)((0, c.default)(e.entries));
        return 1 === r.end.value ? [] : [O(r, e.dayIndex, n, s, e.dayIndex)];
      }
      function $(e, t) {
        var n, s;
        const i = {
          thisDay: b(e, t[e].entries),
          prevDay: N(t, e),
          nextDay: T(t, e),
        };
        return null !==
          (s =
            null !==
              ...
              : (function ({ thisDay: e, prevDay: t, nextDay: n }) {
                  ...
                  const i = e.entries,
                    a = (0, y.ensureDefined)(d(i)),
                    o = (0, y.ensureDefined)((0, c.default)(i));
                  return [
                    0 !== a.start.value ? L(0, s, a.start.value, s, s) : void 0,
                    ...V(e),
                    1 !== o.end.value ? L(o.end.value, s, 1, s, s) : void 0,
                  ].filter(r.isExistent);
                })(i)) && void 0 !== s
          ? s
          : (function (e) {
      ...
      function z(e, t, n, s) {
        const [r, i] = e[t],
          a = l(r),
          o = l(i);
        return P(_(a), _(o), n, s);
      }
      function H(e, t, n, s) {
        let r = e;
        const a = t + n;
        let o;
        if (a <= i.minutesPerDay) o = [[t, a]];
        else {
        ...
        const u = (function (e, t) {
            const n = (0, y.ensureDefined)(d(e))[0],
              s = (0, y.ensureDefined)((0, c.default)(e))[1],
              r = e.map((e) => e[1] - e[0]).reduce((e, t) => e + t);
            return W(
              t,
              n,
              s === i.minutesPerDay ? t : h(t, Math.floor(l(n + r))),
              s,
            );
          })(o, r),
          v = [];
      ...
      const Z = (function (e) {
        ...
        return s;
      })(m.map((e) => [e, { title: A[e], isActive: !1, entries: [] }]));
      function j(e) {
        return (t, n) => {
          return (
            (s = (0, y.ensureDefined)(e(t))),
            (r = (0, y.ensureDefined)(e(n))),
      ...
      const G = j(d),
        q = j(c.default);
      function K(e, t) {
        return H(e.sessionStartDayOfWeek(), e.start(), e.length(), t);
      }
      function Q(e, t) {
        t.forEach((t) =>
          (function (e, t, n) {
      ...
      function te(e, t) {
        ...
        for (const e of Array.from(r.keys())) {
          X(
            i,
            (0, y.ensureDefined)(r.get(e)).getEntriesForWeekByCalendar(
              (0, y.ensureNotNull)(t),
            ),
            e,
          );
        ...
        return (
          (function (e) {
            const t = new Map();
            for (const n of m) t.set(n, $(n, e));
            for (const n of m) e[n].entries = (0, y.ensureDefined)(t.get(n));
          })(i),
          (function (e) {
            for (const t of m) {
              const n = e[t].entries,
                s = (0, y.ensureDefined)(d(n));
              ee(s, (0, y.ensureDefined)((0, c.default)(e[p(t)].entries))) &&
                (s.start.isFirstOrLastPoint = !1);
              const r = (0, y.ensureDefined)((0, c.default)(n));
              ee(r, (0, y.ensureDefined)(d(e[g(t)].entries))) &&
          ...
          (function (e) {
            for (const t of m) {
              ...
              const s = p(t),
                r = g(t),
                i = (0, y.ensureDefined)((0, c.default)(n)),
                a = (0, y.ensureDefined)(d(n));
              a.start.isFirstOrLastPoint ||
                (a.showStartForLastEntry = q(n, e[s].entries)),
                i.end.isFirstOrLastPoint ||
                  (i.showEndForFirstEntry = G(n, e[r].entries));
            }
          })(i),
      ...
      var ne;
      function se(e) {
        return i.get_cal_from_unix_timestamp_ms(
      ...
      class re {
        ...
        _updateEntriesBySubSessions(e) {
          ...
          const { newSessionsDays: t, newTodaySession: n } = te(
            e,
            null === e ? null : se(e),
          );
        ...
        _updateTodayWithOffsets() {
          ...
          const t = this._currentTime.value(),
            n = l(i.get_minutes_from_midnight(se(e)));
