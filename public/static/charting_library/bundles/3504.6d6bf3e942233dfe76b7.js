(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [3504],
  {
    ...
    53885: (e, t, o) => {
      "use strict";
      o.d(t, { getStyleClasses: () => r, isCircleLogoWithUrlProps: () => a });
      var n = o(97754),
        i = o(3196),
        l = o.n(i);
      function r(e, t) {
        return n(l()["tv-circle-logo"], l()[`tv-circle-logo--${e}`], t);
      }
      function a(e) {
        return (
          "logoUrl" in e &&
    ...
    36383: (e, t, o) => {
      ...
      function r(e) {
        ...
        return (
          (0, i.useIsomorphicLayoutEffect)(() => {
            const e = { click: t, mouseDown: o, touchEnd: r, touchStart: a },
              n = c ? c.current : d.current;
            return (0, l.addOutsideEventListener)(h.current, n, s, document, e);
          }, [t, o, r, a, s]),
          c || d
        );
      }
    ...
    67961: (e, t, o) => {
      "use strict";
      o.d(t, { OverlapManager: () => l, getRootOverlapManager: () => a });
      var n = o(50151);
      class i {
        constructor() {
          this._storage = [];
      ...
      function a(e = document) {
        ...
        if (null !== t) return (0, n.ensureDefined)(r.get(t));
        {
          ...
          return r.set(o, t), t.setContainer(o), e.body.appendChild(o), t;
        }
      }
      var s;
      !(function (e) {
      ...
      const n = (() => {
        ...
        return () => {
          ...
          if (void 0 === e) {
            ...
            (l.style.width = "100%"), o.appendChild(l);
        ...
        return (
          (0, n.useLayoutEffect)(() => {
            const e = (0, i.ensureNotNull)(t.current),
              o = () => {
                const o = (0, l.queryTabbableElements)(e).sort(
                  l.navigationOrderComparator,
                );
                if (
                  0 === o.length ||
                  (o[0].parentElement &&
                    !u(o[0].parentElement, (0, i.ensureNotNull)(t.current)))
                ) {
                  const n = (function (e) {
                    const o = h(e)
                      .sort(l.navigationOrderComparator)
                      .find((e) => u(e, (0, i.ensureNotNull)(t.current)));
                    if (!o) return null;
          ...
          [
            ...
            function (t) {
              ...
              const g = (0, l.mapKeyCodeToDirection)(o);
              switch (g) {
                case "inlinePrev":
                ...
                case "blockNext":
                  ((o) => {
                    ...
                    if (!l) return;
                    const r = Array.from(l.children).indexOf(
                      document.activeElement,
                    );
                    if (-1 === r) return;
                    const a =
                      n[
                        "blockNext" === o ? n.indexOf(l) + 1 : n.indexOf(l) - 1
                      ];
                    if (!a) return;
                    t.preventDefault();
                    const s = Array.from(a.children);
                    s.length && (!e && r <= s.length - 1 ? v(s[r]) : v(s[0]));
                  })(g);
              }
            },
          ]
    ...
    59695: (e, t, o) => {
      "use strict";
      o.d(t, { CircleLogo: () => a, hiddenCircleLogoClass: () => r });
      var n = o(50959),
        i = o(53885),
        l = o(3196);
      const r = o.n(l)()["tv-circle-logo--visually-hidden"];
      function a(e) {
        var t, o;
      ...
      function u(e) {
            ...
            () =>
              (function (e) {
                function t(t) {
                  ...
                  return n.createElement(l, { ...r, ref: o });
                }
        ...
        return n.createElement(
          X,
          {
            ...
            id: t,
            role: o,
            className: i(d, K.item, w && K.withIcon, {
              [K.isActive]: L,
              [K.isDisabled]: T || y,
              [K.hovered]: b,
            }),
            ...
            reference: function (e) {
              (G.current = e), "function" == typeof S && S(e);
          ...
          w &&
            n.createElement("span", {
              ...
              className: i(K.icon, R && c["round-icon"], x),
              dangerouslySetInnerHTML: { __html: w },
            }),
          n.createElement(
            "span",
            { className: i(K.labelRow, v) },
            n.createElement("span", { className: i(K.label, g) }, z),
          ),
          (void 0 !== f || p) &&
            n.createElement(
              "span",
    ...
    42842: (e, t, o) => {
      "use strict";
      o.d(t, { Portal: () => s, PortalContext: () => c });
      var n = o(50959),
        i = o(32227),
        l = o(25931),
        r = o(67961),
    ...
    10838: (e, t, o) => {
      ...
      function d(e) {
        ...
        return n.createElement(s.PopupMenuItem, {
          ...o,
          ...
          L,
          {
            ...
            className: i(
              ...
              h && a,
              {
                ...
                "common-tooltip-vertical": Boolean(b) && "vertical" === x,
                [m.isActive]: h,
                [m.isGrayed]: u,
                [m.isHidden]: v,
                [m.isTransparent]: g,
            ...
            onClick: f,
            onKeyDown: p,
            "data-role": z ? void 0 : "button",
            ref: t,
            tabIndex: T,
            "data-tooltip-hotkey": w,
            "aria-pressed": z ? h : void 0,
            "data-tooltip": b,
          },
          n.createElement(
            "div",
            ...
            d &&
              ("string" == typeof d
                ? n.createElement(l.Icon, { className: m.icon, icon: d })
                : n.createElement("span", { className: m.icon }, d)),
            s,
          ),
        );
      });
    ...
    2627: (e, t, o) => {
      ...
      var c = o(98523),
        d = o(68335),
        h = o(17402);
      const u = (0, d.humanReadableModifiers)(d.Modifiers.Shift, !1),
        v = (0, d.humanReadableModifiers)(d.Modifiers.Alt, !1),
        g = (0, d.humanReadableModifiers)(d.Modifiers.Mod, !1),
        m = { keys: [u], text: i.t(null, void 0, o(23369)) },
        f = { keys: [u], text: i.t(null, void 0, o(13798)) },
        p = { keys: [u], text: i.t(null, void 0, o(10539)) },
        w = {
          ...
          LineToolEllipse: { hotKey: (0, l.hotKeySerialize)(f) },
          LineToolExtended: {},
          LineToolFibChannel: {},
          LineToolFibCircles: { hotKey: (0, l.hotKeySerialize)(f) },
          LineToolFibRetracement: {},
          LineToolFibSpeedResistanceArcs: {},
          LineToolFibSpeedResistanceFan: { hotKey: (0, l.hotKeySerialize)(p) },
          LineToolFibSpiral: {},
          LineToolFibTimeZone: {},
          LineToolFibWedge: {},
          LineToolFlagMark: {},
      ...
      Object.entries(w)
        .map(([e, t]) => {
          var o, i;
          const l =
            null !== (o = r.lineToolsIcons[e]) && void 0 !== o
              ? o
              : a.drawingToolsIcons[e];
          (0, n.assert)(!!l, `Icon is not defined for drawing "${e}"`);
          const d =
    ...
    26744: (e, t, o) => {
      ...
      var n = o(52033),
        i = o(37265),
        l = o(56840);
      const r = ["LineToolBalloon", null, null].filter(i.isExistent),
        a = !1;
      var s, c;
      !(function (e) {
        function t() {
          ...
          if (0 === d.length && c && "undefined" != typeof window) {
            const e = JSON.parse(
              null !==
                (n =
                  null === (t = window.urlParams) || void 0 === t
                    ? void 0
                    : t.favorites) && void 0 !== n
                ? n
                : "{}",
            ).drawingTools;
            e && Array.isArray(e) && d.push(...e);
          }
          d.forEach((t, n) => {
            const i = t.tool || t;
            o(i)
              ? r.includes(i)
                ? (s = !0)
                : e.favorites.push(i)
              : a && a.includes(i) && e.hiddenToolsPositions.set(i, n);
          }),
            s && i(),
        ...
        (function (e) {
          ...
          (e.favoriteAdded = new n.Delegate()),
            ...
            (e.favorite = function (e) {
              return e < 0 || e >= o() ? "" : s.favorites[e];
            }),
            (e.addFavorite = function (o, n) {
              return (
            ...
            (e.removeFavorite = function (t, o) {
              const n = s.favoriteIndex(t);
              if (-1 === n) return !1;
              s.favorites.splice(n, 1);
            ...
            (e.isFavorite = i),
            (e.moveFavorite = function (n, i, l) {
              if (i < 0 || i >= o() || !t(n)) return !1;
              const r = s.favoriteIndex(n);
              if (-1 === r || i === r) return !1;
              const a = s.hiddenToolsPositions;
              return (
                a.forEach((e, t) => {
                  r < e && i > e ? e-- : i < e && r > e && e++, a.set(t, e);
                }),
                s.favorites.splice(r, 1),
                s.favorites.splice(i, 0, n),
                s.saveFavorites(l),
