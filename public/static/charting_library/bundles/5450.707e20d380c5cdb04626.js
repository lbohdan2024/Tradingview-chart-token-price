  ...
  [5450],
  {
    73174: (e, t, i) => {
      ...
      function f(e, t) {
        return {
          ...
          info: {
            typeX: 0,
            minX: new c.WatchedValue(-5e4),
            maxX: new c.WatchedValue(15e3),
    ...
    26434: (e, t, i) => {
      ...
      const p = new r.TranslatedString(
          ...
          n.t(null, void 0, i(98596)),
        ),
        u = new r.TranslatedString(
          "change {title} visibility on seconds",
          n.t(null, void 0, i(41315)),
        ),
        h = new r.TranslatedString(
          "change {title} seconds from",
          n.t(null, void 0, i(86780)),
        ),
        y = new r.TranslatedString(
          "change {title} seconds to",
          n.t(null, void 0, i(6573)),
        ),
        P = new r.TranslatedString(
          "change {title} visibility on minutes",
          n.t(null, void 0, i(78219)),
        ),
        f = new r.TranslatedString(
          "change {title} minutes from",
          n.t(null, void 0, i(59820)),
        ),
        g = new r.TranslatedString(
          "change {title} minutes to",
          n.t(null, void 0, i(38011)),
        ),
        w = new r.TranslatedString(
          "change {title} visibility on hours",
          n.t(null, void 0, i(68715)),
        ),
        m = new r.TranslatedString(
          "change {title} hours from",
          n.t(null, void 0, i(8306)),
        ),
        b = new r.TranslatedString(
          "change {title} hours to",
          n.t(null, void 0, i(67233)),
        ),
        _ = new r.TranslatedString(
          "change {title} visibility on days",
          n.t(null, void 0, i(56402)),
        ),
        v = new r.TranslatedString(
          "change {title} days from",
          n.t(null, void 0, i(91201)),
        ),
        S = new r.TranslatedString(
          "change {title} days to",
          n.t(null, void 0, i(96135)),
        ),
        T = new r.TranslatedString(
          "change {title} visibility on weeks",
          n.t(null, void 0, i(71084)),
        ),
        C = new r.TranslatedString(
          "change {title} weeks from",
          n.t(null, void 0, i(32481)),
        ),
        D = new r.TranslatedString(
          "change {title} weeks to",
          n.t(null, void 0, i(18678)),
        ),
        V = new r.TranslatedString(
          "change {title} visibility on months",
          n.t(null, void 0, i(67583)),
        ),
        W = new r.TranslatedString(
          "change {title} months from",
          n.t(null, void 0, i(99122)),
        ),
        k = new r.TranslatedString(
          "change {title} months to",
          n.t(null, void 0, i(10518)),
        ),
        x =
          (new r.TranslatedString(
            "change {title} visibility on ranges",
            n.t(null, { replace: { ranges: "ranges" } }, i(55616)),
          ),
          n.t(null, void 0, i(24821))),
        I = n.t(null, void 0, i(65188)),
        M = n.t(null, void 0, i(42562)),
        U = n.t(null, void 0, i(56796)),
        A = n.t(null, void 0, i(72942)),
        L = n.t(null, void 0, i(835)),
        R = n.t(null, void 0, i(43154)),
        F = new r.TranslatedString("ticks", n.t(null, void 0, i(3539))),
        N = new r.TranslatedString("seconds", n.t(null, void 0, i(751))),
        Y = new r.TranslatedString("seconds from", n.t(null, void 0, i(35801))),
        E = new r.TranslatedString("seconds to", n.t(null, void 0, i(73419))),
        X = new r.TranslatedString("minutes", n.t(null, void 0, i(18726))),
        H = new r.TranslatedString("minutes from", n.t(null, void 0, i(22476))),
        $ = new r.TranslatedString("minutes to", n.t(null, void 0, i(67649))),
        j = new r.TranslatedString("hours", n.t(null, void 0, i(2359))),
        O = new r.TranslatedString("hours from", n.t(null, void 0, i(82267))),
        z = new r.TranslatedString("hours to", n.t(null, void 0, i(15600))),
        B = new r.TranslatedString("days", n.t(null, void 0, i(35813))),
        q = new r.TranslatedString("days from", n.t(null, void 0, i(59215))),
        G = new r.TranslatedString("days to", n.t(null, void 0, i(89919))),
        J = new r.TranslatedString("weeks", n.t(null, void 0, i(45537))),
        K = new r.TranslatedString("weeks from", n.t(null, void 0, i(92859))),
        Q = new r.TranslatedString("weeks to", n.t(null, void 0, i(44127))),
        Z = new r.TranslatedString("months", n.t(null, void 0, i(95300))),
        ee = new r.TranslatedString("months from", n.t(null, void 0, i(17250))),
        te = new r.TranslatedString("months to", n.t(null, void 0, i(2828))),
    ...
    18009: (e, t, i) => {
      ...
      const y = o.t(null, void 0, i(40091)),
        ...
        w = o.t(null, void 0, i(21429)),
        m = o.t(null, { context: "linetool point" }, i(80166));
      class b {
        constructor(e, t) {
        ...
        _createInputsPropertyPage() {
          ...
          return null !== e ? (0, a.createPropertyPage)(e, "inputs", w) : null;
        }
        ...
        _coordinatesPropertyDefinitions() {
          ...
          return (
            e.forEach((e, s) => {
              const l = t[s].childs();
              if (!l) return;
              const d = (0, a.getCoordinateXMetaInfo)(this._propertyApplier, l);
              r.push(
                (0, o.createCoordinatesPropertyDefinition)(
                  { x: d.property },
                  {
                    id: (0, c.removeSpaces)(`${this._source.name()}Point${s}`),
                    title: n
      ...
      class r {
        ...
        setProperty(e, t, i) {
          this._undoModelSupplier().setProperty(
            ...
            t,
            i,
            n.lineToolsDoNotAffectChartInvalidation,
          );
        }
        beginUndoMacro(e) {
        ...
        setWatchedValue(e, t, i) {
          this._undoModelSupplier()
            .undoHistory()
            .setWatchedValue(e, t, i, n.lineToolsDoNotAffectChartInvalidation);
        }
      }
    },
    1183: (e, t, i) => {
