(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [1583],
  {
      ...
      class p extends u.LineSourcePaneView {
        ...
        _updateImpl(e) {
          ...
          const t = this._source.properties().childs(),
            ...
            [l, h, c, u, p] = this._points,
            g = {
              points: [l, h, this._points.length < 3 ? h : c],
              color: "rgba(0, 0, 0, 0)",
          ...
          if (
            (this._mainTriangleRenderer.setData(g),
          ...
          const f = (0, d.getNumericFormatter)();
          if (this._points.length >= 3) {
            const e = o(l.add(c).scaled(0.5), f.format(this._abRetracement));
            this._xbLabelRenderer.setData(e),
              i.append(this._xbLabelRenderer),
              this._xbTrend.setData(a(l, c)),
              i.append(this._xbTrend);
          }
          if (this._points.length >= 4) {
            this._bcRetracementTrend.setData(a(h, u)),
              i.append(this._bcRetracementTrend);
            const e = o(h.add(u).scaled(0.5), f.format(this._bcRetracement));
            this._acLabelRenderer.setData(e), i.append(this._acLabelRenderer);
          }
          if (this._points.length >= 5) {
            const e = o(c.add(p).scaled(0.5), f.format(this._cdRetracement));
            this._bdLabelRenderer.setData(e),
              i.append(this._bdLabelRenderer),
              this._xdRetracementTrend.setData(a(l, p)),
              i.append(this._xdRetracementTrend);
            const t = o(l.add(p).scaled(0.5), f.format(this._xdRetracement));
            this._xdLabelRenderer.setData(t),
              i.append(this._xdLabelRenderer),
              this._bdTrend.setData(a(c, p)),
          ...
          h.y > l.y
            ...
            this._textRendererXLabel.setData(v),
          ...
          if (
            ...
            this._textRendererALabel.setData(T),
    ...
    76441: (e, t, i) => {
      ...
      class _ extends c.LineSourcePaneView {
        ...
        _updateImpl(e) {
          ...
          this._polylineRenderer.setData(p), i.append(this._polylineRenderer);
          const g = o(d, "A");
          h.y > d.y
          ...
          const f = (0, s.getNumericFormatter)();
          if (this._points.length >= 3) {
            this._abRetracementTrend.setData(a(d, c)),
              i.append(this._abRetracementTrend);
            const e = d.add(c).scaled(0.5),
              ...
              l = o(e, f.format(s));
            this._abLabelRenderer.setData(l), i.append(this._abLabelRenderer);
          }
          if (this._points.length >= 4) {
            this._cdRetracementTrend.setData(a(h, _)),
              i.append(this._cdRetracementTrend);
            const e = h.add(_).scaled(0.5),
              [, t, n, r] = this._source.points(),
              s =
                Math.round(
                  1e3 * Math.abs((r.price - n.price) / (n.price - t.price)),
              ...
              l = o(e, f.format(s));
            this._cdLabelRenderer.setData(l), i.append(this._cdLabelRenderer);
          }
          this.addAnchors(i), (this._renderer = i);
        }
      }
    ...
    15190: (e, t, i) => {
      ...
      class _ extends c.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e) {
          ...
          const T = 1 - Math.sqrt(3) / 2;
          if (
            ((v = (0, s.scalingMatrix)(1, (c * T) / l)),
            (e = (0, s.transformPoint)(v, e)),
            (p = (0, s.transformPoint)(v, p)),
            e.y * p.y < 0)
          )
      ...
      class p extends l.LineSourcePaneView {
        ...
        _updateImpl(e) {
          ...
          const h = [],
            c = i.points[0],
            u = (0, a.anchor)({ x: c.x, y: c.y, pointIndex: 0 });
          h.push(u);
          const _ = i.points[1],
            p = (0, a.anchor)({ x: _.x, y: _.y, pointIndex: 1 });
          if (2 === i.points.length) return void this.addAnchors(d);
          h.push(p);
          let g = i.points[2];
          const x = (0, n.distanceToLine)(c, _, g).distance,
            f = _.subtract(c),
            v = c.add(_).scaled(0.5),
            T = new r.Point(-f.y, f.x).normalized();
          g = v.add(T.scaled(x));
          const w = v.add(T.scaled(-x)),
            R = f.length(),
            m = f.x / R,
            y = f.y / R;
          let b = Math.acos(m);
          ...
          (L = (0, s.transformPoint)(P, L)),
            (P = (0, s.rotationMatrix)(-b)),
            (L = (0, s.transformPoint)(P, L)),
            (P = (0, s.scalingMatrix)(1, R / (2 * x))),
            (L = (0, s.transformPoint)(P, L));
          const S = (0, a.anchor)({
            x: L.y >= 0 ? g.x : w.x,
            y: L.y >= 0 ? g.y : w.y,
            pointIndex: 2,
            cursorType: (0, l.thirdPointCursorType)(c, _),
          });
    ...
    34823: (e, t, i) => {
      ...
      class u extends l.MediaCoordinatesPaneRenderer {
        constructor(e) {
          super(), (this._data = e);
        }
        setData(e) {
        ...
        hitTest(e) {
          ...
          const o = i.scaled(1 / n),
            a = t.addScaled(o, s),
            l = e.subtract(a),
            c = (0, h.interactionTolerance)().line,
      ...
      class x extends r.LineSourcePaneView {
        constructor(e, t) {
          super(e, t),
            ...
            (this._textRenderer = new o.TextRenderer(this._textRendererData)),
            (this._arrowRenderer = new u(this._arrowRendererData)),
            (this._ellipseRenderer = new p.EllipseRendererSimple(
              this._ellipseRendererData,
            ));
        }
        renderer(e) {
          ...
          const i = this._getSource().properties().childs();
          return (
        ...
        _updateImpl(e) {
          ...
          if (
            ...
            (this._textRendererData.font = g.CHART_FONT_FAMILY),
            ...
            if (
              ...
              const e = new a.Point(t[0].x - 9, t[0].y - 9),
                n = new a.Point(t[0].x + 9, t[0].y + 9);
      ...
      class p extends u.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e) {
          ...
          const t =
            ...
            i = this._data.points[0].y - (this._geometryCache.innerHeight + 9),
            n = (0, l.box)(
              new l.Point(t, i),
              new l.Point(
                t + this._geometryCache.innerWidth,
                i + this._geometryCache.innerHeight,
              ),
            );
          return (0, d.pointInBox)(e, n)
            ? new _.HitTestResult(_.HitTarget.MovePoint, {
                areaName: _.AreaName.Text,
              })
            : null;
        }
        _drawImpl(e) {
        ...
        _updateImpl(e) {
          ...
          const t = this._source.properties().childs(),
            i = {
              ...
              backgroundColor: (0, s.generateColor)(
                t.backgroundColor.value(),
                t.transparency.value(),
              ),
              font: (0, r.makeFont)(t.fontsize.value(), o.CHART_FONT_FAMILY),
              fontSize: t.fontsize.value(),
              label: t.text.value(),
            };
          if ((this._balloonRenderer.setData(i), 1 === i.points.length)) {
            const e = new g.CompositeRenderer();
            return (
              e.append(this._balloonRenderer),
              e.append(
                new x.SelectionRenderer({
                  points: i.points,
                  bgColors: this._lineAnchorColors(i.points),
                  visible: this.areAnchorsVisible(),
                  barSpacing: this._model.timeScale().barSpacing(),
                  hittestResult: _.HitTarget.MovePoint,
                }),
              ),
    ...
    52666: (e, t, i) => {
      "use strict";
      i.r(t), i.d(t, { BarsPatternPaneView: () => v });
      var n = i(86441),
        r = i(19625),
        s = i(51056),
        o = i(19063),
        ...
        p = i(27916),
        g = i(67467);
      const x = r.colorsPalette["color-cold-gray-500"],
        f = {
      ...
      class v extends p.LineSourcePaneView {
        constructor() {
          super(...arguments),
        ...
        _updateImpl(e) {
          ...
          const r = this._source.priceScale(),
            u =
              null !==
                (i =
                  null === (t = this._source.ownerSource()) || void 0 === t
                    ? void 0
                    : t.firstValue()) && void 0 !== i
                ? i
                : null;
          if (!r || r.isEmpty() || null === u) return;
          const _ = this._source.points(),
          ...
          if (v > 0 && 2 === _.length) {
            const e = this._source.properties().childs(),
              t = e.mode.value(),
              i = e.color.value(),
              l = Math.abs((this._points[0].x - this._points[1].x) / (v - 1)),
              d = this._source.getScale(),
              x = (e) => r.priceToCoordinate(e, u) * d,
              [{ index: w }, { index: R }] = _,
              m = w < R ? this._points[0] : this._points[1],
              [y, b] = this._source.points(),
              L = w < R ? y.index : b.index,
              P = m.x,
              S = m.y - x(this._source.firstPatternPrice());
            if (
              ...
              const e = f[t];
              for (let t = 0; t < v; t++) {
                const r = Math.round(P + t * l + 0.5),
                  s = e(p[t]).map(
                    (e, t) =>
                      new n.Point(r + (2 * t - 1), Math.round(x(e)) + S),
                  ),
                  o = new c.RectangleRenderer();
                o.setData({
                  points: s,
                  color: i,
                  backcolor: i,
              ...
              T.append(this.createLineAnchor({ points: this._points }, 0));
            } else {
              const e = f[t],
                n = p.map((t, i) => {
                  const n = Math.round(P + i * l + 0.5);
                  return {
                    timePointIndex: L + i,
                    center: n,
                    left: NaN,
              ...
              T.append(
                new h.PaneRendererLine({
                  barSpacing: l,
                  items: n,
                  lineColor: (0, o.generateColor)(i, 10),
                ...
                T.append(this.createLineAnchor({ points: this._points }, 1));
            }
          } else
            this._vertLineRenderer1.setData({
              ...
              T.append(this._vertLineRenderer1),
              ...
              T.append(this._vertLineRenderer2),
      ...
      class p extends s.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e) {
          ...
          if (4 === t.points.length) {
            const i = (0, u.interactionTolerance)().curve,
              [n, r, s, a] = t.points,
              d = a.subtract(n),
              h = s.subtract(d.scaled(0.25)),
              _ = s.add(d.scaled(0.25)),
              p = r.subtract(s),
              g = a.subtract(p.scaled(0.25)),
              x = a.add(p.scaled(0.25));
            if (
              (0, l.quadroBezierHitTest)(s, n, h, e, i) ||
              (0, l.cubicBezierHitTest)(s, _, g, a, e, i) ||
              (0, l.quadroBezierHitTest)(a, r, x, e, i)
            )
              return new o.HitTestResult(o.HitTarget.MovePoint);
            let f = (0, c.hitTestExtendedPoints)(e, i, t.extendLeftPoints);
            return (
              null === f &&
                (f = (0, c.hitTestExtendedPoints)(e, i, t.extendRightPoints)),
              f
            );
          }
          return null;
        ...
        _drawImpl(e) {
          ...
          (t.lineCap = "round"),
            (t.strokeStyle = this._data.color),
            (t.lineWidth = this._data.lineWidth),
            (0, _.setLineStyle)(t, this._data.lineStyle);
          ...
          if (2 === this._data.points.length)
            t.beginPath(),
              ...
              this._data.leftEnd === h.LineEnd.Arrow &&
                (0, d.drawArrow)(n, i, t, t.lineWidth, a.dpr1PixelRatioInfo),
              this._data.rightEnd === h.LineEnd.Arrow &&
                (0, d.drawArrow)(i, n, t, t.lineWidth, a.dpr1PixelRatioInfo);
          else {
            const e = this._data.points[2],
              r = this._data.points[3],
              s = r.subtract(i),
              o = e.subtract(s.scaled(0.25)),
              l = e.add(s.scaled(0.25)),
              u = n.subtract(e),
              _ = r.subtract(u.scaled(0.25)),
              p = r.add(u.scaled(0.25));
            this._data.fillBack &&
              ...
              t.bezierCurveTo(l.x, l.y, _.x, _.y, r.x, r.y),
              t.quadraticCurveTo(p.x, p.y, n.x, n.y),
              t.fill()),
              t.beginPath(),
              (0, c.buildExtendedSegments)(t, this._data.extendLeftPoints),
              t.moveTo(i.x, i.y),
              t.quadraticCurveTo(o.x, o.y, e.x, e.y),
              t.bezierCurveTo(l.x, l.y, _.x, _.y, r.x, r.y),
              t.quadraticCurveTo(p.x, p.y, n.x, n.y),
              (0, c.buildExtendedSegments)(t, this._data.extendRightPoints),
              this._data.leftEnd === h.LineEnd.Arrow &&
                (0, d.drawArrow)(o, i, t, t.lineWidth, a.dpr1PixelRatioInfo),
              this._data.rightEnd === h.LineEnd.Arrow &&
                (0, d.drawArrow)(p, n, t, t.lineWidth, a.dpr1PixelRatioInfo),
              t.stroke();
          }
        }
      }
        ...
        _updateImpl(e) {
          ...
          if (4 === this._source.points().length) {
            const n = (0, f.ensureNotNull)(
              ...
              h = s.subtract(o),
              c = a.add(h.scaled(0.25)),
              {
                mediaSize: { width: u, height: _ },
              } = e;
            t.extendLeft.value() &&
              (i = this._extendSegmentLeft(o, n, d, u, _)),
              t.extendRight.value() &&
                (r = this._extendSegmentRight(a, s, c, u, _));
          }
          const s = this._points.slice(),
          ...
          this._bezierCubicRenderer.setData(a);
          const l = new g.CompositeRenderer();
          l.append(this._bezierCubicRenderer),
            this.addAnchors(l),
            (this._renderer = l);
        }
          ...
          return (
            (0, x.cacheIsValid)(
              ...
              (this._extendedSegmentLeftCache = {
                ...
                width: n,
                height: r,
                segment: (0, l.extendQuadroBezier)(e, t, i, n, r),
              }),
      ...
      class p extends r.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e) {
          if (null !== this._data && 3 === this._data.points.length) {
            ...
            return (
              null === c && (c = u(e, t, this._data.extendRightSegments)), c
            );
          }
          return null;
        }
    ...
    31463: (e, t, i) => {
      ...
      var n = i(86441),
        ...
        f = i(64034),
        v = i(36696);
      class T extends x.MediaCoordinatesPaneRenderer {
        constructor(e) {
          super(),
            (this._data = null),
        ...
        hitTest(e) {
          ...
          if (t.subtract(e).length() < 3)
            return new h.HitTestResult(h.HitTarget.ChangePoint);
        ...
        _drawImpl(e) {
          ...
          const f = (0, g.calcTextHorizontalShift)(n, s);
          ...
          for (const e of this._data.textData.lines)
            n.fillText(e.text, T, v), (v += this._data.textData.fontSize);
        }
        _calcTextSize() {
          if (null === this._data || this._data.points.length < 2) return null;
        ...
        _drawSelectionIfNeeded(e) {
          ...
          if (t.selectionHighlight) {
            const n = this.positionToCoordinate(!1, t.selectionHighlight.start),
              ...
              s = this.getTextInfo();
            (0, v.drawSelection)(e, f.dpr1PixelRatioInfo, {
      ...
      let w = null;
      class R extends l.InplaceTextLineSourcePaneView {
        constructor(e, t, i, n, r) {
          super(e, t, i, n, r),
            (this._renderer = new o.CompositeRenderer()),
            (this._textWidthCache = new d.TextWidthCache()),
            (this._calloutRenderer = new T(
              new h.HitTestResult(
        ...
        _updateImpl(e) {
          ...
          const t = this._source.properties().childs(),
            ...
            a = this._fontStyle(),
            l = t.wordWrap.value() ? t.wordWrapWidth.value() : void 0,
            d = (0, u.wordWrap)(
              this._textData(),
              a,
                    ...
                    Math.max(
                      ...
                      (function (e, t) {
                        if (null === w) {
                          ...
                          (e.width = 0),
                            (e.height = 0),
                            (w = (0, r.ensureNotNull)(e.getContext("2d")));
                        }
                        return (w.font = t), w.measureText(e).width;
                      })(t.text, a),
                    ),
                  0,
                );
          ...
          if (
            ...
            this._renderer.append(this.createLineAnchor({ points: [i] }, 0)),
            void 0 !== l)
          ) {
            const e = p.points[1],
              t = (0, c.anchor)({
    ...
    38401: (e, t, i) => {
      ...
      class u {
        ...
        draw(e, t) {
          ...
          e.save();
          const { horizontalPixelRatio: a, verticalPixelRatio: l } = t,
            d = Math.max(1, Math.floor(a)),
            h = (d % 2) / 2,
            c = Math.round(i.x * a) + h,
            u = Math.round(i.y * l) + h,
            _ = Math.round(c + n * a),
            p = Math.max(1, Math.floor(r * a)),
            g = _ - c - p;
          g > 0 &&
            ((e.fillStyle = o),
            e.beginPath(),
            ...
            e.fill());
          const x = Math.max(d / 2, _ - c - p / 2);
          (e.strokeStyle = s),
            (e.lineWidth = p),
            e.beginPath(),
            e.moveTo(c + x, u),
            e.arc(c, u, x, 0, 2 * Math.PI, !1),
            e.stroke(),
            e.restore();
        }
        hitTest(e) {
          if (null === this._data) return null;
          const { center: t, radius: i, backgroundHitTarget: n } = this._data,
            r = (0, c.interactionTolerance)().curve;
          if (!(0, h.pointInCircle)(e, t, i + r)) return null;
          const o =
            i > r && (0, h.pointInCircle)(e, t, i - r)
              ? null != n
                ? n
                : s.HitTarget.MovePointBackground
              : s.HitTarget.MovePoint;
          return new s.HitTestResult(o);
        }
      }
      class _ extends l.InplaceTextLineSourcePaneView {
        constructor(e, t, i, n, o) {
          super(e, t, i, n, o),
            (this._circleRenderer = new u()),
            (this._renderer = new r.CompositeRenderer()),
            (this._textRenderer = new d.LineToolTextRenderer(
              void 0,
              new s.HitTestResult(
                s.HitTarget.MovePoint,
                (0, l.inplaceEditHandlers)(
            ...
            this._source.setAdditionalCursorData(() => {
              ...
              return {
                color: this._source.editableTextStyle().cursorColor,
                rotationPoint:
                  null !== (e = this._textRenderer.rotation()) && void 0 !== e
                    ? e
                    : void 0,
        ...
        _updateImpl(e) {
          ...
          this._circleRenderer.setData({
            center: r,
            radius: Math.sqrt((l.x - r.x) ** 2 + (l.y - r.y) ** 2),
            color: i.color.value(),
            lineWidth: i.linewidth.value(),
            backColor: i.fillBackground.value()
              ? i.backgroundColor.value()
              : "transparent",
          ...
          if (
            ...
            const {
              ...
              a = r.subtract(l).length() * Math.sqrt(2);
            this._textRenderer.setData({
              points: [r],
              text: this._textData(),
              color: this._textColor(),
              ...
              bold: i.value(),
              italic: s.value(),
              wordWrapWidth: d ? void 0 : a,
              maxHeight: d ? void 0 : a,
              offsetX: 0,
              offsetY: 0,
              horzAlign: "center",
              vertAlign: "middle",
              forceTextAlign: !0,
              decorator: d ? o.PlusTextRendererDecorator.instance() : void 0,
              ...this._inplaceTextHighlight(),
            });
            let c = !1;
            if (
              (d &&
                this._textRenderer.measure().width > a &&
                (this._textRenderer.updateData({ text: "" }),
                (c = this._textRenderer.measure().width > a)),
              !c)
            ) {
          ...
          const c = [(0, a.anchor)({ ...l, pointIndex: 1 })];
          h ||
            c.unshift(
              (0, a.anchor)({
                ...r,
                pointIndex: 0,
                hitTarget: s.HitTarget.MovePoint,
              }),
            ),
    ...
    39157: (e, t, i) => {
      ...
      class p extends u.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e) {
          ...
          const {
            ...
            r = t.x,
            s = t.y - n,
            a = (0, h.box)(new h.Point(r, s), new h.Point(r + i, s + n));
          return (0, c.pointInBox)(e, a)
            ? new o.HitTestResult(o.HitTarget.MovePoint, {
                areaName: o.AreaName.Text,
              })
            : null;
        }
        _drawImpl(e) {
          ...
          const t = e.context,
            ...
            d = i.y - r;
          t.translate(l, d),
            (0, _.drawRoundRect)(t, 0, 0, n, r, [a, a, a, 2]),
            (t.fillStyle = s),
            t.fill(),
            (t.strokeStyle = o),
            (t.lineWidth = 2),
      ...
      class g extends a.InplaceTextLineSourcePaneView {
        constructor(e, t, i, n, r) {
          super(e, t, i, n, r),
            (this._commentRenderer = new p()),
        ...
        _updateImpl(e) {
          ...
          const { height: n, width: o } = e.mediaSize;
          this._labelRenderer.isOutOfScreen(o, n)
            ? this.closeTextEditor()
            : this._updateInplaceText(this._labelRenderer.getTextInfo());
          const a = this._labelRenderer.measure(),
            l = {
              points: this._points,
              borderColor: t.borderColor.value(),
          ...
          this._commentRenderer.setData(l),
            this._renderer.append(this._commentRenderer),
            1 === l.points.length &&
              this._renderer.append(
                this.createLineAnchor({ points: l.points }, 0),
              ),
    ...
    6074: (e, t, i) => {
      ...
      class c extends o.LineSourcePaneView {
        constructor() {
          super(...arguments),
            (this._coordinates = []),
            (this._trendRenderer = new s.TrendLineRenderer()),
        ...
        _updateImpl(e) {
          ...
          const n = this._source.points()[0],
            ...
            o = s ? s.index - n.index : 1;
          if (((this._coordinates = []), 0 === o)) return;
          const c = t.visibleBarsStrictRange();
          if (null === c) return;
          if (o > 0) {
            for (let e = n.index; e <= c.lastBar(); e += o)
              this._coordinates.push(t.indexToCoordinate(e));
          } else {
            for (let e = n.index; e >= c.firstBar(); e += o)
              this._coordinates.push(t.indexToCoordinate(e));
          }
              ...
              this.createLineAnchor(
                {
                  points: [
                    (0, l.anchor)({
                      x: this._points[0].x,
                      y: i.height() / 2,
                      hitTarget: d.HitTarget.MovePoint,
                    }),
                  ],
                },
                1,
      ...
      class a extends o.LineSourcePaneView {
        ...
        _updateCustomTextRenderer(e, t) {
          ...
          if (i.visible.value() && i.text.value().length > 0) {
            ...
            return (
              this._customTextrenderer.setData(f),
    ...
    93955: (e, t, i) => {
      "use strict";
      i.r(t), i.d(t, { DateAndPriceRangePaneView: () => m });
      var n = i(50151),
        r = i(86441),
        s = i(11542),
        o = i(63273),
        ...
        g = i(15938),
        x = i(27436);
      const f = new p.TimeSpanFormatter(),
        v = (0, c.getPercentageFormatter)(),
        T = (0, c.getVolumeFormatter)(),
        w = s.t(null, void 0, i(41643)),
        R = s.t(null, { context: "study" }, i(24261));
      class m extends x.DateAndPriceRangeBasePaneView {
        constructor() {
          super(...arguments),
        ...
        _updateImpl(e) {
          ...
          l.fillBackground &&
            ...
            (this._backgroundRenderer.setData({
              ...
              fillBackground: !0,
              transparency: l.backgroundTransparency.value(),
              extendLeft: !1,
              extendRight: !1,
            }),
            this._renderer.append(this._backgroundRenderer));
          const [d, h] = this._points;
          l.drawBorder.value() &&
            (this._borderRenderer.setData({
              points: this._points,
              color: l.borderColor.value(),
              linewidth: l.borderWidth.value(),
              fillBackground: !1,
              extendLeft: !1,
              extendRight: !1,
              backcolor: "",
          ...
          const p = l.drawBorder.value() ? l.borderWidth.value() / 2 : 0,
            {
              mediaSize: { width: x, height: m },
            } = e,
            y = this._updateCustomTextRenderer(m, x),
            b = Math.round((d.y + h.y) / 2),
            L = new r.Point(d.x + Math.sign(h.x - d.x) * p, b),
            P = new r.Point(h.x + Math.sign(d.x - h.x) * p, b);
          this._distanceLineRenderer.setData({
            ...
            rightend:
              Math.abs(d.x - h.x) >= 25 * l.linewidth.value()
                ? _.LineEnd.Arrow
                : _.LineEnd.Normal,
            excludeBoundaries: y ? [y] : void 0,
          }),
            this._renderer.append(this._distanceLineRenderer);
          const S = Math.round((d.x + h.x) / 2),
            M = new r.Point(S, d.y + Math.sign(h.y - d.y) * p),
            C = new r.Point(S, h.y + Math.sign(d.y - h.y) * p);
          this._distancePriceRenderer.setData({
            ...
            leftend: _.LineEnd.Normal,
            rightend:
              Math.abs(M.y - C.y) >= 25 * l.linewidth.value()
                ? _.LineEnd.Arrow
                : _.LineEnd.Normal,
            excludeBoundaries: y ? [y] : void 0,
          }),
            this._renderer.append(this._distancePriceRenderer);
          const I = this._source.points()[0].price,
            A = this._source.points()[1].price,
            D = A - I,
            k = (100 * D) / Math.abs(I),
            ...
            W = this._model.timeScale().indexToUserTime(B);
          let O = "";
          if (E && W) {
            const e = (W.valueOf() - E.valueOf()) / 1e3;
            O = ", " + (0, o.startWithLTR)(f.format(e));
          }
          const V = this._model.mainSeries().symbolInfo(),
            F = V && (0, c.getPipFormatter)(V),
            Y = (0, n.ensureNotNull)(this._source.ownerSource()).formatter(),
            j =
              (null !==
                (i =
                  null === (t = Y.formatChange) || void 0 === t
                    ? void 0
                    : t.call(Y, A, I)) && void 0 !== i
                ? i
                : Y.format(D)) +
              " (" +
              v.format(Math.round(100 * k) / 100) +
              ") " +
              (F ? F.format(D) : "");
          let U = (0, o.forceLTRStr)(j) + "\n" + w.format({ count: z }) + O;
          const Q = this._source.volume();
          let q;
          Number.isNaN(Q) || (U += `\n${R} ${T.format(Q)}`),
            (q =
              A > I
                ? new r.Point(0.5 * (d.x + h.x), h.y - 2 * l.fontsize.value())
                : new r.Point(
                    0.5 * (d.x + h.x),
                    h.y + 0.7 * l.fontsize.value(),
                  ));
          const X = { x: 0, y: 10 },
            Z = l.fontsize.value(),
            G = {
              ...
              fontsize: Z,
              backgroundRoundRect: 4,
              boxPaddingHorz: 0.4 * Z + Z / 3,
              boxPaddingVert: 0.2 * Z + Z / 3,
            };
          (null === (s = l.fillLabelBackground) || void 0 === s
            ? void 0
            : s.value()) &&
            ((G.boxShadow = {
              shadowColor: l.shadow.value(),
              shadowBlur: 4,
              shadowOffsetY: 1,
            }),
            (G.backgroundColor = l.labelBackgroundColor.value())),
            this._textRenderer.setData(G);
          const J = this._textRenderer.measure(),
            $ = (0, a.calculateLabelPosition)(J, d, h, X, m);
          this._textRenderer.setPoints([$]),
            this._renderer.append(this._textRenderer),
    ...
    33406: (e, t, i) => {
      ...
      var n = i(86441),
        ...
        p = i(15938),
        g = i(27436);
      const x = (0, _.getVolumeFormatter)(),
        f = r.t(null, void 0, i(41643)),
        v = r.t(
          null,
          {
            context: "study",
      ...
      class T extends g.DateAndPriceRangeBasePaneView {
        constructor() {
          super(...arguments),
        ...
        _updateImpl(e) {
          ...
          const i = this._source.properties().childs(),
            ...
            [l, d] = this._points,
            _ = r ? 0 : Math.min(l.y, d.y),
            g = a ? this._height() : Math.max(l.y, d.y);
          i.fillBackground.value() &&
            (this._backgroundRenderer.setData({
              points: [new n.Point(l.x, _), new n.Point(d.x, g)],
              color: "white",
              linewidth: 0,
          ...
          T(this._leftBorderRenderer, new n.Point(l.x, _), new n.Point(l.x, g)),
            T(
              this._rightBorderRenderer,
              new n.Point(d.x, _),
              new n.Point(d.x, g),
            );
          const w = Math.round((l.y + d.y) / 2),
            R = new n.Point(l.x, w),
            m = new n.Point(d.x, w),
            {
              mediaSize: { width: y, height: b },
            } = e,
            L = this._updateCustomTextRenderer(b, y);
          this._distancePriceRenderer.setData({
            points: [R, m],
            color: i.linecolor.value(),
            linewidth: i.linewidth.value(),
            ...
            leftend: c.LineEnd.Normal,
            rightend:
              Math.abs(R.x - m.x) >= 15 * i.linewidth.value()
                ? c.LineEnd.Arrow
                : c.LineEnd.Normal,
          ...
          const P = this._source.points()[0].index,
            S = this._source.points()[1].index,
            M = S - P,
            C = this._model.timeScale().indexToUserTime(P),
            I = this._model.timeScale().indexToUserTime(S);
          let A = "";
          if (C && I) {
            const e = (I.valueOf() - C.valueOf()) / 1e3;
            A = ", " + (0, s.startWithLTR)(new u.TimeSpanFormatter().format(e));
          }
          const D = this._source.volume(),
            k = Number.isNaN(D) ? "" : `\n${v} ${x.format(D)}`,
            N = f.format({ count: (0, s.forceLTRStr)(M.toString()) }) + A + k,
            B = { x: 0, y: 10 },
            H = i.fontsize.value(),
            z = {
              text: N,
              ...
              fontsize: H,
              backgroundRoundRect: 4,
              boxPaddingHorz: 0.4 * H + H / 3,
              boxPaddingVert: 0.2 * H + H / 3,
            };
          (null === (t = i.fillLabelBackground) || void 0 === t
            ? void 0
            : t.value()) &&
            ((z.boxShadow = {
              shadowColor: i.shadow.value(),
              shadowBlur: 4,
              shadowOffsetY: 1,
            }),
            (z.backgroundColor = i.labelBackgroundColor.value())),
            this._textRenderer.setData(z);
          const E = this._textRenderer.measure(),
            W = (0, o.calculateLabelPosition)(E, l, d, B, b);
          this._textRenderer.setPoints([W]),
            this._renderer.append(this._textRenderer),
            this._renderer.append(this._customTextrenderer),
            this.addAnchors(this._renderer);
        }
    ...
    41376: (e, t, i) => {
      "use strict";
      i.r(t), i.d(t, { DisjointChannelPaneView: () => p });
      var n = i(50151),
        r = i(86441),
        s = i(49483),
        o = i(62317),
      ...
      class p extends u.LineSourcePaneView {
        ...
        _updateImpl(e) {
          ...
          const [a, l, d] = this._source.points(),
            u = i.formatPrice(a.price, o),
            p = i.formatPrice(l.price, o);
          let g, x;
          if (d) {
            g = i.formatPrice(d.price, o);
            const e = l.price - a.price;
            x = i.formatPrice(d.price + e, o);
          }
          if (this._points.length < 2) return;
          ...
          let w, R;
          if (this._points.length >= 3) {
            w = (0, r.point)(T.x, this._points[2].y);
            const e = T.y - v.y;
            if (((R = (0, r.point)(v.x, w.y + e)), f.fillBackground.value())) {
            ...
            f.labelVisible.value() &&
              f.labelText.value() &&
              this._renderer.append(this._getLabelTextRenderer(v, T, R, w));
          }
          const m = (e, t) => ({
              points: [e, t],
          ...
          if (
            (this._trendLineRendererPoints12.setData(m(v, T)),
            this._renderer.append(this._trendLineRendererPoints12),
            y(this._p1LabelRenderer, this._p2LabelRenderer, v, T, u, p),
            !w || !R)
          )
            return void this.addAnchors(this._renderer);
          this._trendLineRendererPoints43.setData(m(R, w)),
          ...
          const b = [
            ...
            (0, _.anchor)({
              ...w,
              cursorType: h.PaneCursorType.VerticalResize,
              pointIndex: 2,
              square: !0,
            }),
            (0, _.anchor)({ ...R, pointIndex: 3 }),
          ];
          this._model.lineBeingCreated() === this._source && b.pop(),
            this._renderer.append(this.createLineAnchor({ points: b }, 0)),
            v && T && this._addAlertRenderer(this._renderer, [v, T]);
        }
    ...
    98424: (e, t, i) => {
      ...
      class v extends n.LineSourcePaneView {
        constructor(e, t) {
          super(e, t),
            (this._renderer = null),
            (this._polylineRenderer = new x.PolygonRenderer());
        }
        renderer(e) {
          return this._invalidated && this._updateImpl(e), this._renderer;
        }
        _updateImpl(e) {
          ...
          const i = this._source.properties().childs(),
            ...
            h =
              null === (t = this._source.ownerSource()) || void 0 === t
                ? void 0
                : t.firstValue();
          if (!n || n.isEmpty() || d.isEmpty() || null == h) return;
          const c = new r.CompositeRenderer();
          if (i.showWave.value()) {
            const e = {
              points: this._points,
              color: (0, o.generateColor)(i.color.value(), 0),
              linewidth: i.linewidth.value(),
            ...
            this._polylineRenderer.setData(e), c.append(this._polylineRenderer);
          }
          const u = this.areAnchorsVisible() ? 0 : 1;
          let x = 1;
          ...
          let v = 0;
          this._model.lineBeingCreated() === this._source && (v = 1);
          const T = (0, o.resetTransparency)(i.color.value());
          for (let e = 0; e < this._points.length - v; e++, x = -x) {
            if (e < u) continue;
          ...
          for (let e = 0; e < this._points.length; e++)
            w.push((0, g.anchor)({ ...this._points[e], pointIndex: e }));
    ...
    75649: (e, t, i) => {
      ...
      class v extends x.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e) {
          ...
          const a = (0, n.distanceToLine)(i, s, o).distance,
            l = s.subtract(i),
            d = i.add(s).scaled(0.5),
          ...
          let x = Math.acos(_);
          p < 0 && (x = -x);
          let v = (0, g.translationMatrix)(-d.x, -d.y);
          e = (0, g.transformPoint)(v, e);
          let T = (0, g.transformPoint)(v, this._data.points[2]);
          (v = (0, g.rotationMatrix)(-x)),
            (e = (0, g.transformPoint)(v, e)),
            (T = (0, g.transformPoint)(v, T)),
            (v = (0, g.scalingMatrix)(1, u / (2 * a))),
            (e = (0, g.transformPoint)(v, e)),
            (T = (0, g.transformPoint)(v, T));
          const w = e.length(),
            R = (0, f.interactionTolerance)().curve;
          return Math.abs(w - 0.5 * u) <= R
            ? new h.HitTestResult(h.HitTarget.MovePoint)
            : !this._data.noHitTestOnBackground && w <= 0.5 * u
              ? new h.HitTestResult(
                  null !== (t = this._data.backgroundHitTarget) && void 0 !== t
                    ? t
        ...
        _drawImpl(e) {
          ...
          let x = this._data.points[2],
            f = (0, g.translationMatrix)(-d.x, -d.y);
          (x = (0, g.transformPoint)(f, x)),
            (f = (0, g.rotationMatrix)(-p)),
            (x = (0, g.transformPoint)(f, x)),
            (f = (0, g.scalingMatrix)(1, c / (2 * a))),
            (x = (0, g.transformPoint)(f, x)),
      ...
      class T extends _.InplaceTextLineSourcePaneView {
        constructor(e, t, i, n, r) {
          super(e, t, i, n, r),
            (this._ellipseRenderer = new v()),
            (this._renderer = null),
            (this._textRenderer = new p.LineToolTextRenderer(
              void 0,
              new h.HitTestResult(
                h.HitTarget.MovePoint,
        ...
        _updateImpl(e) {
          ...
          const s = new l.CompositeRenderer();
          ...
          let _ = i.points[2];
          const p = (0, n.distanceToLine)(a, c, _).distance,
            g = c.subtract(a),
            x = a.add(c).scaled(0.5),
            f = new r.Point(-g.y, g.x).normalized();
          _ = x.add(f.scaled(p));
          const v = x.add(f.scaled(-p)),
            T = this._placeHolderMode();
          ((t.showLabel.value() && t.text.value()) ||
            T ||
            this._isTextEditMode()) &&
            this._updateTextRenderer([a, c, _, v], T, e) &&
            s.append(this._textRenderer);
          const w = (0, u.thirdPointCursorType)(a, c),
            R = [
              (0, d.anchor)({ ...a, pointIndex: 0 }),
              (0, d.anchor)({ ...c, pointIndex: 1 }),
              (0, d.anchor)({ ..._, pointIndex: 2, cursorType: w }),
              (0, d.anchor)({ ...v, pointIndex: 3, cursorType: w }),
            ];
          s.append(this.createLineAnchor({ points: R }, 0)),
            (this._renderer = s);
        }
        _updateTextRenderer([e, t, i, n], o, l) {
          if (t.subtract(e).length() < 1e-5 || n.subtract(i).length() < 1e-5)
            return !1;
          const d = (0, s.intersectLines)(
          ...
          if (
            (this._textRenderer.setData({
              ...
              bold: u.value(),
              italic: _.value(),
              wordWrapWidth: o ? void 0 : g,
              maxHeight: o ? void 0 : n.subtract(i).length() / p,
              ...
              vertAlign: "middle",
              forceTextAlign: !0,
              decorator: o ? c.PlusTextRendererDecorator.instance() : void 0,
              ...this._inplaceTextHighlight(),
            }),
            o &&
              this._textRenderer.measure().width > g &&
              (this._textRenderer.updateData({ text: "" }),
              this._textRenderer.measure().width > g))
          )
            return !1;
          this._textRenderer.setCursorType(this._textCursorType());
          const {
            mediaSize: { width: x, height: f },
          } = l;
          return (
            this._textRenderer.isOutOfScreen(x, f)
              ? this.closeTextEditor()
              : this._updateInplaceText(this._textRenderer.getTextInfo()),
            !0
          );
      ...
      class h extends s.LineSourcePaneView {
        ...
        _updateImpl(e) {
          ...
          const s = i.adapter(),
            o = i.model().timeScale(),
            a =
              null === (t = i.model().paneForSource(i)) || void 0 === t
                ? void 0
                : t.executionsPositionController();
          if (!a) return;
          const l = a.getXYCoordinate(s, o, n[0].index);
          !isFinite(l.y) ||
            l.y < 0 ||
            l.y > e.mediaSize.height ||
            l.x < 0 ||
            (this._executionRenderer.setData({
              point: new r.Point(l.x, l.y),
              arrowColor: s.getArrowColor(),
              arrowHeight: s.getArrowHeight(),
              direction: s.getDirection(),
              tooltip: s.getTooltip(),
              arrowSpacing: s.getArrowSpacing(),
              fontHeight: d.fontHeight(s.getFont()),
              text: s.getText(),
    ...
    23033: (e, t, i) => {
      "use strict";
      i.d(t, { FibHorizontalLevelsPaneViewBase: () => S });
      var n = i(50151),
        r = i(86441),
        s = i(11542),
        o = i(69186),
      ...
      class h {
        ...
        static instance() {
          ...
          return (
            (this._instance =
              null !== (e = this._instance) && void 0 !== e ? e : new h()),
            this._instance
          );
        }
      }
      ...
      function f(e, t, i, n) {
        if (null !== e && "middle" === t) {
          const t = (0, l.getTextBoundaries)(e, i, n);
          if (t) return [t];
        }
        return [];
      }
      ...
      function T(e) {
          ...
          return (function (e) {
            ...
            switch (n) {
              case "left":
                ...
                break;
              case "center":
                if (y(d, s)) return { hideText: !0 };
                !(function (e, t, i, n) {
                  const s = i - n / 2,
                    o = null == e ? void 0 : e.rect.width,
                    a = null == t ? void 0 : t.rect.width;
        ...
        if (i) {
          ...
          if (v(a) < v(l)) {
            const n = t.x + t.width + g.labelEdgeOffset - e.x;
            n > 0 && o.setPoint((0, r.point)(i.x - n, i.y));
          } else {
            const n = e.x + e.width + g.labelEdgeOffset - t.x;
            n > 0 && o.setPoint((0, r.point)(i.x + n, i.y));
          }
        }
        return { hideText: !1 };
      ...
      const L = s.t(null, void 0, i(6060));
      function P(e) {
        if (!e) return;
        ...
        if ("middle" !== i) {
          const s = (0, n.ensureDefined)(t.points)[0],
            o =
              ("top" === i ? 1 : -1) *
              ((0, l.fontSize)(t) + (0, l.lineSpacing)(t));
          e.setData({
            ...t,
            vertAlign: "middle",
            points: [(0, r.point)(s.x, s.y + o)],
          });
        }
      }
      class S extends g.LineToolPaneViewFibWithLabels {
        constructor() {
          super(...arguments), (this._renderer = new _.CompositeRenderer());
        }
        renderer(e) {
          return this._invalidated && this._updateImpl(e), this._renderer;
        }
        _addLevels(e) {
          ...
          let { left: S, right: M } = e;
          S === M && (w && (S -= 1), R && (M += 1));
          const { width: C, height: I } = i,
            A =
              this._model.hoveredSource() === this._source
                ? null === (t = this._model.lastHittestData()) || void 0 === t
                  ? void 0
                  : t.activeItem
                : null,
            D = [],
            k = [],
            N = this._model.selection().isSelected(this._source),
            B = this._textCursorType();
          for (let e = 0; e < s.length; e++) {
            const t = s[e],
              ...
              z =
                this._isTextEditMode() &&
                this._inplaceEditLevelIndex === t.index,
              E = !H && !z,
              W = E ? "center" : x,
              O = E ? "middle" : v,
              V = _ === W && g === O,
            ...
            const Q = c && (H || (Y && N) || z),
              q = Q && !H && !z;
            !Q ||
              (q && (0, o.lastMouseOrTouchEventInfo)().isTouch) ||
              ((j = q
                ? d.PlusTextRendererDecorator.instance()
                : V && l
                  ? h.instance()
                  : void 0),
              (U = (0, n.ensureDefined)(this._textRenderers[t.index])),
              this._updateRendererLabel(
                {
                  ...F,
                  ...(z ? this._inplaceTextHighlight() : {}),
                  horzAlign: W,
                  vertAlign: O,
                  color: z ? this._textColor() : F.color,
                  decorator: j,
                },
                U,
                z ? this._textData() : t.text || L,
              ),
              U.setCursorType(B));
            const X = j === h.instance(),
              Z = this._updateLabelForLevel({
                ...F,
                price: t.price,
                horzAlign: _,
                vertAlign: g,
                boxPaddingRight: X ? 0 : void 0,
              });
            let G = !1;
            if (null !== U && null !== Z) {
              const e = g === O;
            ...
            if (m) {
              ...
              if (
                ...
                const e = [...f(Z, g, C, I), ...f(G ? null : U, O, C, I)],
                  n = {
                    points: [i, y],
                    color: t.color,
                ...
                r.setData(n),
                  r.setHitTest(
                    new u.HitTestResult(
                      ...
                      { snappingPrice: t.price, activeItem: t.index },
                      t.index,
                    ),
                  ),
                  D.push(r);
            ...
            null === Z || Z.isOutOfScreen(C, I) || k.push(Z),
              G || null === U || U.isOutOfScreen(C, I) || k.push(U);
          }
          for (const e of D) this._renderer.append(e);
          y && this._renderer.append(y);
          for (const e of k) this._renderer.append(e);
      ...
      class u extends d.InplaceTextLineSourcePaneView {
        constructor(e, t, i, r, l) {
          super(e, t, i, r, l),
            ...
            (this._numericFormatter = (0, a.getNumericFormatter)()),
            (this._percentageFormatter = (0, a.getPercentageFormatter)()),
            (this._textRenderers = {}),
          ...
          if (i && r && l) {
            for (let t = 1; t <= e.levelsCount(); t++) {
              ...
              this._textRenderers[t] = new h.LineToolTextRenderer(void 0, e);
            }
            this._source.setAdditionalCursorData(
              () => {
                const e = (0, n.ensureDefined)(
        ...
        _updateLabelForLevel(e) {
          var t, i, n, r, s;
          const o = this._labelsRenderers[e.levelIndex];
          ...
          const d = this._source.properties(),
            h = Boolean(
              null === (i = d.showCoeffs) || void 0 === i ? void 0 : i.value(),
            ),
            c = Boolean(
              null === (n = d.showPrices) || void 0 === n ? void 0 : n.value(),
            );
          if (!h && !c) return null;
          const u = d["level" + e.levelIndex].coeff.value();
          let _ = "";
          if (h) {
            _ +=
              null !==
                (s =
                  null === (r = d.coeffsAsPercents) || void 0 === r
                    ? void 0
                    : r.value()) &&
              void 0 !== s &&
              s
                ...
                : this._numericFormatter.format(u);
          }
          return (
            c && (_ += " (" + a.formatPrice(e.price, l) + ")"),
            this._updateRendererLabel(e, o, _),
            o
          );
        }
        _updateRendererLabel(e, t, i) {
          ...
          const f = !(
              (o.x > this._model.timeScale().width() && !_) ||
              (a.x < 0 && !p)
            ),
          ...
          switch (R) {
            case "left":
              (w = o.y), _ ? (T = f ? 0 : a.x) : ((T = o.x), (R = "right"));
              break;
            case "right":
              (w = a.y),
                p
                  ? (T = f ? this._model.timeScale().width() : o.x)
                  : ((T = a.x), (R = "left"));
              break;
            default:
              (T = ((_ && f ? 0 : o.x) + (p && f ? v : a.x)) / 2),
                (w = (o.y + a.y) / 2);
              break;
          }
          return (
            t.setData({
              points: [new r.Point(T, w)],
              text: i,
              color: d,
              vertAlign: u,
              horzAlign: R,
              ...
              fontSize:
                null !==
                  (s =
                    null === (n = x.labelFontSize) || void 0 === n
                      ? void 0
                      : n.value()) && void 0 !== s
                  ? s
                  : 12,
      ...
      class u extends d.LineToolPaneViewFibWithLabels {
        ...
        _updateImpl(e) {
          ...
          const x = this._source.levelsCount(),
            f = (0, n.ensureNotNull)(this._norm),
            {
              mediaSize: { width: v, height: T },
            } = e;
          for (let e = 1; e < x; e++) {
            const t = (0, n.ensureDefined)(
            ...
            if (!s) break;
            const o = f.scaled(t.coeff.value()),
              a = p.add(o),
              w = g.add(o),
              R = f.scaled(s.coeff.value()),
              m = p.add(R),
              y = g.add(R),
              b = t.color.value(),
              L = _.extendLeft.value(),
              P = _.extendRight.value(),
              S = _.levelsStyle.childs().linestyle.value(),
              M = _.levelsStyle.childs().linewidth.value(),
              C = l.coordinateToPrice(a.y, d),
            ...
            null !== I &&
              (u.append(I),
              (A =
                null !== (i = (0, h.getTextBoundaries)(I, v, T)) && void 0 !== i
                  ? i
                  : void 0));
            const D = {
                line1: { color: b, lineStyle: S, lineWidth: M, points: [a, w] },
                line2: { color: b, lineStyle: S, lineWidth: M, points: [m, y] },
                extendLeft: L,
                extendRight: P,
                backColor: (0, r.generateColor)(b, _.transparency.value(), !0),
                skipTopLine: !0,
          ...
          if (null !== w) {
            const e = (0, n.ensureDefined)(
              this._source.properties().child("level" + w),
            ).childs();
            if (e.visible.value()) {
              const t = f.scaled(e.coeff.value()),
                i = p.add(t),
                n = g.add(t),
                r = l.coordinateToPrice(i.y, d),
                o = this._updateLabelForLevel({
                  levelIndex: w,
                  leftPoint: i,
                  rightPoint: n,
                  price: r,
              ...
              null !== o &&
                (u.append(o),
                (c =
                  null !== (a = (0, h.getTextBoundaries)(o, v, T)) &&
                  void 0 !== a
                    ? a
                    : void 0));
              const x = {
                ...
                leftend: s.LineEnd.Normal,
                rightend: s.LineEnd.Normal,
                excludeBoundaries: c ? [c] : void 0,
              };
              this._lastLevelTrendRenderer.setData(x),
    ...
    83201: (e, t, i) => {
      "use strict";
      i.r(t), i.d(t, { FibCirclesPaneView: () => c });
      var n = i(50151),
        r = i(86441),
        s = i(72609),
        o = i(91046),
      ...
      class c extends s.LineToolPaneViewFibWithLabels {
        ...
        _updateImpl(e) {
          ...
          for (let e = 1; e <= p; e++) {
            const t = (0, n.ensureDefined)(_.child(`level${e}`)).childs();
            if (!t.visible.value()) continue;
            const i = t.coeff.value(),
              s = t.color.value(),
              a = [];
            a.push(new r.Point(o.x - 0.5 * l * i, o.y - 0.5 * c * i)),
              a.push(new r.Point(o.x + 0.5 * l * i, o.y + 0.5 * c * i));
            const d = new r.Point(o.x, o.y + 0.5 * c * i);
            u.push({
              color: s,
              points: a,
              labelPoint: d,
          ...
          const g = _.childs().fillBackground.value(),
            x = _.childs().transparency.value();
          for (let e = 0; e < u.length; e++) {
            const t = u[e];
            this._renderer.append(
              new d.EllipseRendererSimple(
                {
                  points: t.points,
                  color: t.color,
                  linewidth: t.linewidth,
                  backcolor: t.color,
                  wholePoints: e > 0 ? u[e - 1].points : void 0,
                  fillBackground: g,
                  transparency: x,
                },
                new a.HitTestResult(a.HitTarget.MovePoint, void 0, t.index),
              ),
            );
          ...
          const f = _.childs().trendline.childs();
          f.visible.value() &&
      ...
      class d extends l.FibHorizontalLevelsPaneViewBase {
        ...
        _updateImpl(e) {
          ...
          if (
            ...
            return;
          const i = this._source.priceScale();
          if (!i || i.isEmpty() || this._model.timeScale().isEmpty()) return;
          const s =
            null === (t = this._source.ownerSource()) || void 0 === t
              ? void 0
              : t.firstValue();
          if (null == s) return;
          const [l, d] = this._source.points(),
          ...
          const u = this._points[0],
            ...
            p = Math.min(u.x, _.x),
            g = Math.max(u.x, _.x),
            x = h.fillBackground.value(),
            f = h.transparency.value(),
            v = h.extendLinesLeft.value(),
            T = h.extendLines.value(),
            w = i.isLog() && h.fibLevelsBasedOnLogScale.value(),
            {
              mediaSize: { width: R },
            } = e,
            m = !((p > R && !v) || (g < 0 && !T));
          this._levels = [];
          const y = c ? l.price : d.price,
            b = c ? d.price : l.price,
            L = b - y,
            P = i.priceToCoordinate(y, s),
            S = { price: y, coordinate: P },
            M = { price: L, coordinate: i.priceToCoordinate(b, s) - P },
            C = this._source.levelsCount();
          for (let e = 1; e <= C; e++) {
            const t = h["level" + e].childs();
            if (!t || !t.visible.value()) continue;
            const n = t.coeff.value(),
              r = (0, a.fibLevelCoordinate)(S, M, n, i, s, w),
              o = (0, a.fibLevelPrice)(S, M, n, i, s, w);
            this._levels.push({
              color: t.color.value(),
              text: t.text.value(),
              y: r,
              price: o,
              linewidth: h.levelsStyle.childs().linewidth.value(),
              linestyle: h.levelsStyle.childs().linestyle.value(),
              index: e,
            });
          }
          if (x && m)
            for (let e = 0; e < this._levels.length; e++)
              if (e > 0 && x) {
                const t = this._levels[e - 1],
                  i = {
                    points: [
                      new n.Point(p, this._levels[e].y),
                      new n.Point(g, t.y),
                    ],
          ...
          D.visible.value() &&
            ...
            this._addLevels({
              ...
              left: I,
              right: A,
              showLabel: h.showCoeffs.value() || h.showPrices.value(),
              showText: h.showText.value(),
              horzLabelsAlign: h.horzLabelsAlign.value(),
              vertLabelsAlign: h.vertLabelsAlign.value(),
              horzTextAlign: h.horzTextAlign.value(),
              vertTextAlign: h.vertTextAlign.value(),
              extendLeft: v,
              extendRight: T,
              fontSize: h.labelFontSize.value(),
              isOnScreen: m,
              trendLineRenderer: k,
            }),
            this.addAnchors(this._renderer),
        ...
        _updateImpl(e) {
          ...
          for (let e = 1; e <= _; e++) {
            ...
            const s = i.coeff.value(),
              o = i.color.value(),
              a = Math.abs(d.subtract(l).length() * s),
              c = (0, r.sign)(d.y - l.y),
              u = new n.Point(l.x, l.y + c * h * Math.abs(s));
            this._levels.push({
              color: o,
              radius: a,
              dir: c,
          ...
          const p = new o.CompositeRenderer(),
            g = c.fillBackground.value(),
            x = c.transparency.value();
          for (let e = 0; e < this._levels.length; e++) {
            const t = this._levels[e],
              i = {
                ...
                fillBackground: g,
                hittestOnBackground: !0,
                fullCircles: c.fullCircles.value(),
                radius2: e > 0 ? this._levels[e - 1].radius : void 0,
              },
              n = new s.HitTestResult(s.HitTarget.MovePoint, void 0, t.index);
            p.append(new u(i, n));
            const r = this._updateLabelForLevel({
      ...
      class p extends u.LineSourcePaneView {
        constructor(e, t) {
          ...
          for (let e = 0; e < this._source.hLevelsCount(); e++)
            this._leftTextRenderers.push(new h.TextRenderer()),
              this._rightTextRenderers.push(new h.TextRenderer());
          for (let e = 0; e < this._source.vLevelsCount(); e++)
            this._topTextRenderers.push(new h.TextRenderer()),
              this._bottomTextRenderers.push(new h.TextRenderer());
        }
        renderer(e) {
          return this._invalidated && this._updateImpl(e), this._renderer;
        }
        _updateImpl(e) {
          ...
          if (
            ...
            return;
          if (this._points.length < 2) return;
          const h = this._source.points()[0],
            u = this._source.points()[1],
            p = this._source.properties().childs(),
            g = p.reverse.value(),
            x = [],
            f = g ? u.price - h.price : h.price - u.price,
            v = g ? h.price : u.price;
          for (let e = 1; e <= this._source.hLevelsCount(); e++) {
            ...
            const s = r.coeff.value(),
              o = r.color.value(),
              a = v + s * f,
              l = t.priceToCoordinate(a, i);
            x.push({ coeff: s, color: o, y: l, index: e });
          }
          const T = [],
            w = g ? u.index - h.index : h.index - u.index,
            R = g ? h.index : u.index;
          for (let e = 1; e <= this._source.vLevelsCount(); e++) {
            ...
            T.push({ coeff: n, color: r, x: o, index: e });
          }
          const m = new l.CompositeRenderer(),
            y = this._points[0],
            b = this._points[1],
            L = Math.min(y.x, b.x),
            P = Math.min(y.y, b.y),
            S = Math.max(y.x, b.x),
            M = Math.max(y.y, b.y),
            C = p.grid.childs().color.value(),
            I = p.grid.childs().linewidth.value(),
            A = p.grid.childs().linestyle.value(),
            D = (0, s.getNumericFormatter)();
          for (let e = 0; e < x.length; e++) {
            const t = new r.Point(L, x[e].y),
              i = new r.Point(S, x[e].y);
            if (p.grid.childs().visible.value()) {
              const e = {
                  points: [t, i],
                  color: C,
                  linewidth: I,
              ...
              n.setData(e), m.append(n);
            }
            if (p.showLeftLabels.value()) {
              const i = {
                points: [t],
                text: D.format(x[e].coeff),
                color: x[e].color,
                vertAlign: "middle",
                horzAlign: "right",
                font: _.CHART_FONT_FAMILY,
              ...
              this._leftTextRenderers[e].setData(i),
                m.append(this._leftTextRenderers[e]);
            }
            if (p.showRightLabels.value()) {
              const t = {
                points: [i],
                text: D.format(x[e].coeff),
                color: x[e].color,
              ...
              this._rightTextRenderers[e].setData(t),
                m.append(this._rightTextRenderers[e]);
            }
          }
          for (let e = 0; e < T.length; e++) {
            const t = new r.Point(T[e].x, P),
              i = new r.Point(T[e].x, M);
            if (p.grid.childs().visible.value()) {
              const e = {
                  points: [t, i],
                  color: C,
            ...
            if (p.showTopLabels.value()) {
              const i = {
                points: [t],
                text: D.format(T[e].coeff),
                color: T[e].color,
                vertAlign: "bottom",
                horzAlign: "center",
                font: _.CHART_FONT_FAMILY,
              ...
              this._topTextRenderers[e].setData(i),
                m.append(this._topTextRenderers[e]);
            }
            if (p.showBottomLabels.value()) {
              const t = {
                points: [i],
                text: D.format(T[e].coeff),
                color: T[e].color,
              ...
              this._bottomTextRenderers[e].setData(t),
                m.append(this._bottomTextRenderers[e]);
            }
          }
          const k = p.fillBackground.value(),
            N = p.transparency.value();
          for (let e = 0; e < x.length; e++) {
            const t = new r.Point(b.x, x[e].y);
            if (e > 0 && k) {
              const i = {
                  p1: y,
                  p2: t,
                  p3: y,
                  p4: new r.Point(b.x, x[e - 1].y),
                  color: x[e].color,
                  transparency: N,
                  hittestOnBackground: !0,
                  extendLeft: !1,
          ...
          for (let e = 0; e < T.length; e++) {
            const t = new r.Point(T[e].x, b.y);
            if (e > 0 && k) {
              const i = {
                  p1: y,
                  p2: t,
                  p3: y,
                  p4: new r.Point(T[e - 1].x, b.y),
                  color: T[e].color,
                  transparency: N,
                  hittestOnBackground: !0,
                  extendLeft: !1,
            ...
            }
            {
              const i = {
                ...
                n = new c.TrendLineRenderer();
              n.setData(i);
              const r = { type: "v", index: T[e].index };
              n.setHitTest(
    ...
    39029: (e, t, i) => {
      ...
      class _ extends o.LineSourcePaneView {
        constructor() {
          super(...arguments),
            (this._trendLineRenderer = new s.TrendLineRenderer()),
    ...
    18449: (e, t, i) => {
      ...
      class p extends u.LineSourcePaneView {
        ...
        _updateImpl(e) {
          ...
          if (i.isEmpty()) return;
          const [a, d] = this._source.points(),
            u = this._source.properties().childs(),
            p = a.index;
          if (null === i.visibleBarsStrictRange()) return;
          this._levels = [];
          const g = d ? d.index - a.index : 1;
          for (let e = 1; e <= this._source.levelsCount(); e++) {
            const t = u["level" + e].childs();
            if (!t.visible.value()) continue;
            const n = Math.round(p + t.coeff.value() * g),
              r = {
                index: e,
                x: i.indexToCoordinate(n),
                color: t.color.value(),
          ...
          if (u.fillBackground.value()) {
            const e = u.transparency.value();
          ...
          let v = u.horzLabelsAlign.value();
          v = "left" === v ? "right" : "right" === v ? "left" : "center";
          const T = u.vertLabelsAlign.value();
          for (let e = 0; e < this._levels.length; e++) {
            let i;
            const o = this._levels[e].color;
            if (u.showLabels.value()) {
              let r;
              switch (T) {
                case "top":
                  ...
                  break;
                case "middle":
                  r = new n.Point(this._levels[e].x, 0.5 * f);
                  break;
                default:
                  r = new n.Point(this._levels[e].x, f);
              }
              const a = {
                  points: [r],
                ...
                l = this._textRenderers[e];
              l.setData(a),
                this._needLabelExclusionPath(l) &&
                  (i =
                    null !== (t = (0, s.getTextBoundaries)(l, x, f)) &&
                    void 0 !== t
                      ? t
                      : void 0),
            ...
            const a = {
              ...
              d = new l.HitTestResult(
                l.HitTarget.MovePoint,
                void 0,
                this._levels[e].index,
              ),
              h = new r.VerticalLineRenderer();
            h.setData(a), h.setHitTest(d), this._renderer.append(h);
          }
          if (2 === this._points.length) {
            const e = u.trendline.childs(),
              t = {
                points: [this._points[0], this._points[1]],
                color: e.color.value(),
                linewidth: e.linewidth.value(),
                ...
                this.createLineAnchor(
                  {
                    points: [
                      (0, _.anchor)({
                        x: this._points[0].x,
                        y: f / 2,
                        hitTarget: l.HitTarget.MovePoint,
                      }),
                    ],
                  },
                  0,
    ...
    84417: (e, t, i) => {
      ...
      class c extends s.LineToolPaneViewFibWithLabels {
        ...
        _updateRenderer(e = NaN, t = NaN) {
          ...
          const _ = u.pointIndex,
            p = s.subtract(r).length(),
          ...
          const x = [r, s];
          this._model.lineBeingCreated() !== this._source && x.push(u),
            i.append(this.createLineAnchor({ points: x }, 0)),
            (this._renderer = i);
        }
      }
    },
    36134: (e, t, i) => {
      "use strict";
      i.r(t), i.d(t, { FlagMarkPaneView: () => u });
      var n,
        r = i(27916),
        s = i(95201),
        o = i(11064),
        ...
        h = i(75919);
      !(function (e) {
        (e[(e.Width = 20)] = "Width"), (e[(e.Height = 22)] = "Height");
      })(n || (n = {}));
      class c extends h.MediaCoordinatesPaneRenderer {
        ...
        doesIntersectWithBox(e) {
          return null !== this._data && (0, l.pointInBox)(this._data.point, e);
        }
        _drawImpl(e) {
          if (null === this._data) return;
          const t = e.context;
          t.translate(
            ...
            (t.fillStyle = "#434651"),
            (0, d.drawRoundRect)(t, 0, 0, 2, 22, 1),
            t.fill(),
            (t.fillStyle = this._data.color),
            t.beginPath(),
            t.moveTo(6.87, 0),
    ...
    73050: (e, t, i) => {
      "use strict";
      i.r(t), i.d(t, { FlatBottomPaneView: () => _ });
      var n = i(50151),
        r = i(86441),
        s = i(49483),
        o = i(62317),
      ...
      class _ extends c.LineSourcePaneView {
        ...
        _updateImpl(e) {
          ...
          const [a, l] = this._source.points(),
            d = i.formatPrice(a.price, o),
            c = i.formatPrice(l.price, o);
          let _;
          if (3 === this._source.points().length) {
            const e = this._source.points()[2];
            _ = i.formatPrice(e.price, o);
          }
          if (this._points.length < 2) return;
          ...
          if (3 === this._points.length) {
            if (
              ((x = (0, r.point)(g.x, this._points[2].y)),
              (f = (0, r.point)(p.x, x.y)),
            ...
            v.labelVisible.value() &&
              v.labelText.value() &&
              this._renderer.append(this._getLabelTextRenderer(p, g, f, x));
          }
          const T = (e, t) => ({
            points: [e, t],
          ...
          if (
            (this._trendLineRendererPoints12.setData(T(p, g)),
            this._renderer.append(this._trendLineRendererPoints12),
          ...
          if (
            (w(this._p1LabelRenderer, this._p2LabelRenderer, p, g, d, c),
            !x || !f)
          )
            return void this.addAnchors(this._renderer);
          this._trendLineRendererPoints43.setData(T(f, x)),
            this._renderer.append(this._trendLineRendererPoints43),
            w(
              this._p3LabelRenderer,
              this._p4LabelRenderer,
          ...
          const R = [
            (0, u.anchor)({ ...p }),
            (0, u.anchor)({ ...g }),
            (0, u.anchor)({ ...x, pointIndex: 2 }),
            (0, u.anchor)({ ...f, pointIndex: 3 }),
          ];
          this._model.lineBeingCreated() === this._source && R.pop(),
            this._renderer.append(this.createLineAnchor({ points: R }, 0)),
    ...
    73017: (e, t, i) => {
      "use strict";
      i.r(t), i.d(t, { GannComplexPaneView: () => _ });
      var n,
        r = i(86441),
        s = i(27916),
        o = i(91046),
      ...
      class _ extends s.LineSourcePaneView {
        ...
        _updateImpl(e) {
          ...
          this._prepareLevels(t, _),
            this._prepareFanLines(t, _),
            this._prepareArcs(t, _),
            this._prepareLabels(t, _);
          const p = [n, r];
          u.lineBeingCreated() === s && p.pop(),
            t.append(this.createLineAnchor({ points: p }, 0)),
            (this._renderer = t);
        }
        _initRenderers() {
        ...
        _prepareLabels(e, t) {
          const { p1: i, p2: n, isLabelsVisible: s, reversed: o } = t;
          if (!s) return;
          ...
          o && ((d = -d), (h = -h));
          const c = new r.Point(i.x, n.y),
            _ = (0, u.forceLTRStr)(l.formatter().format(d)),
            p = this._getLabelData(c, _);
          ...
          const g = new r.Point(n.x, i.y),
            x = (0, u.forceLTRStr)(h.toString()),
            f = this._getLabelData(g, x);
          (f.horzAlign = h > 0 ? "left" : "right"),
            (f.vertAlign = d > 0 ? "top" : "bottom"),
            (f.offsetX = 10),
            (f.offsetY = d > 0 ? 10 : 8),
            (f.forceTextAlign = !0),
            this._indexDiffTextRenderer.setData(f),
            e.append(this._indexDiffTextRenderer);
          const v = a.getScaleRatio();
          if (null === v) return;
          const T = a.getScaleRatioFormatter(),
            w = (0, u.forceLTRStr)(T.format(v)),
    ...
    79890: (e, t, i) => {
      ...
      class u extends h.LineSourcePaneView {
        constructor(e, t) {
          ...
          for (let t = 0; t < e.levelsCount(); t++)
            this._textRenderers.push(new l.TextRenderer());
        }
        renderer(e) {
          return this._invalidated && this._updateImpl(e), this._renderer;
        }
        _updateImpl(e) {
          ...
          for (let e = 1; e <= this._source.levelsCount(); e++) {
            const t = "level" + e,
              n = this._source.properties().child(t).childs();
            if (!n.visible.value()) continue;
            const r = n.coeff1.value(),
              s = n.coeff2.value(),
              o = r / s,
              a = n.color.value(),
              d = r + "/" + s;
          ...
          const g = new o.CompositeRenderer(),
            ...
            f = p.transparency.value();
          for (let e = 0; e < h.length; e++) {
            const t = new n.Point(h[e].x, h[e].y);
            if (x)
              if (h[e].index < 4) {
                const r = {
                    p1: i,
    ...
    57736: (e, t, i) => {
      "use strict";
      i.r(t), i.d(t, { GannFixedPaneView: () => c });
      var n,
        r = i(86441),
        s = i(27916),
        o = i(91046),
      ...
      class c extends s.LineSourcePaneView {
        ...
        _updateImpl(e) {
          ...
          this._prepareLevels(l, x),
            this._prepareFanLines(l, x),
            this._prepareArcs(l, x);
          const f = [d, o[1]];
          g.lineBeingCreated() === t && f.pop(),
            l.append(this.createLineAnchor({ points: f }, 0)),
            (this._renderer = l);
        }
        _initRenderers() {
          const e = this._getSource(),
    ...
    10349: (e, t, i) => {
      "use strict";
      var n = i(86441).Point,
        r = i(27916).LineSourcePaneView,
        s = i(17330).TextRenderer,
        o = i(62189).RectangleRenderer,
        a = i(91046).TrendLineRenderer,
        l = i(95201).CompositeRenderer,
        d = i(43290).getNumericFormatter,
        h = i(49857).LineEnd,
        c = i(15938);
      t.GannSquarePaneView = class extends r {
        constructor(e, t) {
          ...
          for (var i = 0; i < e.hLevelsCount(); i++)
            this._leftLabelRenderers.push(new s()),
              this._rightLabelRenderers.push(new s());
          for (i = 0; i < e.vLevelsCount(); i++)
            this._topLabelRenderers.push(new s()),
              this._bottomLabelRenderers.push(new s());
        }
        renderer(e) {
          return this._invalidated && this._updateImpl(e), this._renderer;
        }
        _updateImpl(e) {
          ...
          var t = this._source.points()[0],
            ...
            r = (C = this._source.properties()).reverse && C.reverse.value();
          this._hlevels = [];
          for (
            var s = r ? t.price - i.price : i.price - t.price,
              u = r ? i.price : t.price,
              _ = this._source.ownerSource().firstValue(),
              p = 1;
            p <= this._source.hLevelsCount();
            p++
          ) {
            if ((R = C["hlevel" + p]).visible.value()) {
              var g = R.coeff.value(),
                x = R.color.value(),
                f = u + g * s,
                v = this._source.priceScale().priceToCoordinate(f, _);
              this._hlevels.push({ coeff: g, color: x, y: v });
            }
          }
          this._vlevels = [];
          var T = r ? t.index - i.index : i.index - t.index,
            w = r ? i.index : t.index;
          for (p = 1; p <= this._source.vLevelsCount(); p++) {
            var R;
            if ((R = C["vlevel" + p]).visible.value()) {
              (g = R.coeff.value()), (x = R.color.value());
              var m = Math.round(w + g * T),
                y = this._model.timeScale().indexToCoordinate(m);
              this._vlevels.push({ coeff: g, color: x, x: y });
            }
          }
          if (((this._hfans = []), (this._vfans = []), C.fans.visible.value()))
            for (p = 1; p <= this._source.hLevelsCount(); p++) {
              (m = Math.round(w + C["hlevel" + p].coeff.value() * T)),
                (f = u + C["vlevel" + p].coeff.value() * s);
              this._hfans.push(this._model.timeScale().indexToCoordinate(m)),
                this._vfans.push(
                  this._source.priceScale().priceToCoordinate(f, _),
                );
            }
          var b = new l();
          if (this._points.length < 2)
            return this.addAnchors(b), void (this._renderer = b);
          (t = this._points[0]), (i = this._points[1]);
          var L = Math.min(t.x, i.x),
            P = Math.min(t.y, i.y),
            S = Math.max(t.x, i.x),
            M = Math.max(t.y, i.y),
            C = this._source.properties(),
            I = this._source.properties().fillHorzBackground.value(),
            A = this._source.properties().horzTransparency.value(),
            D = this._source.properties().fillVertBackground.value(),
            k = this._source.properties().vertTransparency.value();
          const N = d();
          for (p = 0; p < this._hlevels.length; p++) {
            if (p > 0 && I) {
              var B = this._hlevels[p - 1],
                H = {
                  points: [
                  ...
                  linewidth: 0,
                  backcolor: this._hlevels[p].color,
                  fillBackground: !0,
                  transparency: A,
                  extendLeft: !1,
                  extendRight: !1,
                };
              (F = new o(!0)).setData(H), b.append(F);
            }
            var z = {
              points: [
                (t = new n(L, this._hlevels[p].y)),
                (i = new n(S, this._hlevels[p].y)),
              ],
            ...
            if (
              ((Y = new a()).setData(z), b.append(Y), C.showLeftLabels.value())
            ) {
              var E = {
                  points: [t],
                  text: N.format(this._hlevels[p].coeff),
                  color: this._hlevels[p].color,
                  vertAlign: "middle",
                  horzAlign: "right",
                  font: c.CHART_FONT_FAMILY,
                ...
                W = this._leftLabelRenderers[p];
              W.setData(E), b.append(W);
            }
            if (C.showRightLabels.value()) {
              var O = {
                ...
                V = this._rightLabelRenderers[p];
              V.setData(O), b.append(V);
            }
          }
          for (p = 0; p < this._vlevels.length; p++) {
            (t = new n(this._vlevels[p].x, P)),
              (i = new n(this._vlevels[p].x, M));
            if (p > 0 && D) {
              var F;
              (B = this._vlevels[p - 1]),
                (H = {
                  points: [new n(B.x, P), i],
                  color: this._vlevels[p].color,
                  linewidth: 0,
                  backcolor: this._vlevels[p].color,
                  fillBackground: !0,
                  transparency: k,
                  extendLeft: !1,
                  extendRight: !1,
            ...
            if (
              ((Y = new a()).setData(z), b.append(Y), C.showTopLabels.value())
            ) {
              var j = {
                  points: [t],
                  text: N.format(this._vlevels[p].coeff),
                  color: this._vlevels[p].color,
                  vertAlign: "bottom",
                  horzAlign: "center",
                  font: c.CHART_FONT_FAMILY,
                ...
                U = this._topLabelRenderers[p];
              U.setData(j), b.append(U);
            }
            if (C.showBottomLabels.value()) {
              var Q = {
                ...
                q = this._bottomLabelRenderers[p];
              q.setData(Q), b.append(q);
            }
          }
          var X = this;
          function Z(e, t, i) {
            var r = new n(L, P),
              ...
              l = new n(S, M),
              d = {
                width: X._model.timeScale().width(),
                height: X._source.priceScale().height(),
            ...
            for (var u = 0; u < t.length; ++u) {
              var _ = i ? M : t[u],
                ...
                T = new n(x, p),
                w = new n(g, p);
              c([o, T]), c([l, w]), c([r, f]), c([s, v]);
            }
          }
          Z(b, this._hfans, !0), Z(b, this._vfans, !1);
          var G = new n(this._points[0].x, this._points[1].y);
          G.pointIndex = 2;
          var J = new n(this._points[1].x, this._points[0].y);
          (J.pointIndex = 3),
            b.append(
              this.createLineAnchor({ points: [...this._points, G, J] }, 0),
            ),
            (this._renderer = b);
        }
      };
    ...
    14049: (e, t, i) => {
      ...
      class p extends u.LineSourcePaneView {
        ...
        _updateImpl(e) {
          var t, i;
          super._updateImpl(e), (this._renderer = null), (this._segments = []);
          ...
          if (
            ...
            return;
          const p = this._source.points(),
            g = this._source.properties().childs(),
            x = g.candleStyle.childs(),
            f = x.upColor.value(),
            v = x.downColor.value(),
            T = x.borderUpColor.value(),
            w = x.borderDownColor.value();
          this._segments = this._source
            .segments()
            .map((e, t) => {
              if (t >= this._points.length - 1) return null;
              let i = this._points[t],
                r = this._points[t + 1],
                s = p[t].price,
                o = p[t + 1].price,
                a = 1;
              i.x > r.x &&
                ...
                (a = -1));
              const l = i.x,
                d = this._model.timeScale().coordinateToIndex(l),
                h = n.priceToCoordinate(s, u),
                c = n.priceToCoordinate(o, u),
                _ = e.bars(),
                g = (c - h) / (_.length - 1),
                x = [];
              let R = a > 0 ? 0 : _.length - 1;
              const m = a > 0 ? _.length : -1;
              for (let e = 0; R !== m; R += a, e++) {
                const t = h + e * g,
                  i = n.coordinateToPrice(t, u),
                  r = _[R],
                  s = r.c >= r.o;
                x.push({
                  open: n.priceToCoordinate(i + r.o, u),
                  high: n.priceToCoordinate(i + r.h, u),
                  low: n.priceToCoordinate(i + r.l, u),
                  close: n.priceToCoordinate(i + r.c, u),
                  color: s ? f : v,
                  borderColor: s ? T : w,
                  hollow: !1,
                  center: NaN,
              ...
              return this._model.timeScale().fillBarBorders(x), { bars: x };
            })
            .filter(s.notNull);
          ...
          const m = x.drawWick.value(),
            y = x.drawBorder.value(),
            b = x.borderColor.value(),
            L = x.wickColor.value(),
            P = new a.CompositeRenderer();
          P.setGlobalAlpha(1 - g.transparency.value() / 100);
          ...
          for (let e = 0; e < this._segments.length; e++) {
            const t = {
              ...
              borderColor: b,
              wickColor: L,
              barWidth: (0, l.optimalBarWidth)(S),
              hittest: new o.HitTestResult(o.HitTarget.MovePoint),
              isPriceScaleInverted: n.isInverted(),
            };
            P.append(new c.PaneRendererCandles(t));
          }
          R.append(P), this.addAnchors(R), (this._renderer = R);
        }
      }
    },
    29634: (e, t, i) => {
      ...
      class g extends u.LineSourcePaneView {
        ...
        _updateImpl(e) {
          let t, i;
          super._updateImpl(e), (this._renderer = null);
          const [r, o, a, l, c, u, g] = this._points;
          if (this._points.length >= 5) {
            const e = (0, n.intersectLineSegments)(a, c, r, o);
            if (null !== e) {
              const i = c.subtract(a);
              t = a.add(i.scaled(e));
            }
            if (7 === this._points.length) {
              const e = (0, n.intersectLineSegments)(a, c, u, g);
              if (null !== e) {
                const t = c.subtract(a);
                i = a.add(t.scaled(e));
              }
            }
          }
          ...
          if (
            (this._polyLineRenderer.setData(w),
      ...
      class p extends _.InplaceTextLineSourcePaneView {
        ...
        _updateImpl(e) {
          ...
          const {
            ...
            x = a.text.value(),
            f = this._isTextEditMode(),
            v = this._placeHolderMode();
          let T,
            w = !1;
          if (
            ((null === (t = a.showLabel) || void 0 === t
              ? void 0
              : t.value()) &&
              x) ||
            v ||
            ...
            const e = a.vertLabelsAlign.value(),
              t = a.horzLabelsAlign.value();
            let r = 0,
              s = 0;
            "left" === t
              ? (s = 3)
              : "right" === t
                ? ((s = p), (r = 3))
                : ((s = p / 2), (w = !0));
            const d = new n.Point(s, this._points[0].y);
            this._labelRenderer.setData({
              ...
              forceTextAlign: !0,
              decorator: v ? c.PlusTextRendererDecorator.instance() : void 0,
              ...this._inplaceTextHighlight(),
            }),
              this._labelRenderer.setCursorType(this._textCursorType()),
              ...
              this._needLabelExclusionPath(this._labelRenderer) &&
                (T =
                  null !==
                    (i = (0, o.getTextBoundaries)(this._labelRenderer, p, g)) &&
                  void 0 !== i
                    ? i
                    : void 0),
              (_ = this._labelRenderer.isOutOfScreen(p, g)),
              _
                ? this.closeTextEditor()
                : this._updateInplaceText(this._labelRenderer.getTextInfo());
          }
          ...
          this._lineRenderer.setData(R),
            this._lineRenderer.setHitTest(
              new r.HitTestResult(r.HitTarget.MovePoint, {
                snappingPrice: this._source.points()[0].price,
              }),
            );
          const m = R.linewidth / 2 + 1;
          if (
            ((_ = _ && (R.y < -m || R.y > g + m)),
            l.insert(this._lineRenderer, 0),
            !_)
          ) {
            if (1 === this._points.length && !this._isTextEditMode()) {
              ...
              l.append(this.createLineAnchor({ points: [e] }, 0));
            }
    ...
    66451: (e, t, i) => {
      ...
      class x extends d.LineSourcePaneView {
        ...
        _updateImpl(e) {
          ...
          let d,
            h = this._points[0].clone();
          if (i.showLabel.value() && 1 === this._points.length) {
            const s = i.vertLabelsAlign.value(),
              l = i.horzLabelsAlign.value(),
              c = 0;
            let u = 0;
            const _ = i.text.value(),
              p = i.bold.value(),
              g = i.italic.value(),
              x = a.CHART_FONT_FAMILY,
              f = i.fontsize.value();
            if ("right" === l) {
              const e = this._labelRenderer.measure().width,
                t = this._model.timeScale().width();
              h.x + e + 3 >= t
                ? (h = h.add((0, r.point)(e + 3, 0)))
                : ((h = (0, r.point)(t, h.y)), (u = 3));
            } else
              "center" === l &&
                (h = (0, r.point)(
                  (h.x + this._model.timeScale().width()) / 2,
                  h.y,
                ));
            const v = {
              points: [h],
            ...
            if (
              ...
              d =
                null !==
                  (t = (0, o.getTextBoundaries)(this._labelRenderer, i, n)) &&
                void 0 !== t
                  ? t
                  : void 0;
            }
          ...
          this._horzRayRenderer.setData(c),
            n.append(this._horzRayRenderer),
            this.addAnchors(n),
            1 === this._points.length &&
              this._addAlertRenderer(n, [c.points[0]]),
            (this._renderer = n);
        }
      }
    },
    ...
    15852: (e, t, i) => {
      "use strict";
      i.r(t), i.d(t, { InplaceTextCursorPaneView: () => d });
      var n = i(50151);
      class r {
        constructor(e) {
        ...
        draw(e, t) {
          const {
            ...
            color: a,
            alpha: l,
          } = (0, n.ensureNotNull)(this._data);
          if (void 0 === i) return;
          e.save();
          const { horizontalPixelRatio: d, verticalPixelRatio: h } = t;
          if (r && 0 !== r.angle) {
            const t = r.x * d,
              i = r.y * h;
            e.translate(t, i), e.rotate(r.angle), e.translate(-t, -i);
          }
          const c = this._positionToCoordinate(i),
            u = Math.round(c.x * d),
            _ = Math.round(c.y * h),
            p = Math.max(Math.floor(d), 1),
            g = Math.round(s * h) + o;
          (e.globalAlpha = null != l ? l : 1),
            (e.fillStyle = a),
            e.fillRect(u, _, p, g),
            e.restore();
        }
      ...
      function a(e) {
        return {
          isActive: (t) => t - e < o,
          data: (t) => {
            const i = Math.min(t - e, o);
            return { alpha: s.easingFunc.linear(i / o) < 0.5 ? 0 : 1 };
          },
        };
      }
      var l = i(62288);
      class d {
        ...
        _startAnimation() {
          this._animationTimeout = setTimeout(() => {
            (this._animation = a(performance.now())),
              this._continueAnimationIfNeeded();
          }, 300);
        }
        _stopAnimation() {
        ...
        _animationStepData() {
          ...
          return (
            this._animation.isActive(e) || (this._animation = a(e)),
            this._animation.data(e)
          );
        }
        _continueAnimationIfNeeded() {
          null !== this._animation &&
            this._model.invalidate(l.InvalidationMask.cursor());
        }
      }
    },
    32211: (e, t, i) => {
      "use strict";
      i.d(t, {
        InplaceTextLineSourcePaneView: () => p,
        inplaceEditHandlers: () => _,
      });
      var n = i(50151),
        r = i(11542),
        s = i(19063),
        ...
        h = i(69186),
        c = i(72791);
      const u = r.t(null, void 0, i(6060));
      function _(e) {
        const t = (0, d.ignoreClickOrTapOnDblClickOrDblTapHandlers)({
          clickOrTap: (t, i) => {
        ...
        return {
          ...
          clickHandler: t.clickOrTap,
          tapHandler: t.clickOrTap,
          doubleClickHandler: t.doubleClickOrDoubleTap,
          doubleTapHandler: t.doubleClickOrDoubleTap,
        };
      }
      class p extends a.LineSourcePaneView {
        constructor(e, t, i, n, r) {
          super(e, t),
            (this._textInfo = new o.WatchedObject({})),
            (this._isTextEditModeActivated = !1),
            (this._textWasEdited = !1),
            (this._showTextEditor = i),
            (this._hideTextEditor = n),
            (this._onSelectionChangeCb = r),
            (this._editableTextSpawn = this._source.editableText().spawn()),
            this._editableTextSpawn.subscribe(() => (this._textWasEdited = !0));
        }
        destroy() {
        ...
        closeTextEditor() {
          ...
          (this._textWasEdited = !1),
            (this._isTextEditModeActivated = !1),
            null === (e = this._hideTextEditor) || void 0 === e || e.call(this);
        }
        _placeHolderMode(e) {
          var t;
          return (
            ...
            (!e ||
              (null === (t = this._model.lastHittestData()) || void 0 === t
                ? void 0
                : t.areaName) !== l.AreaName.AnchorPoint) &&
            !(0, h.lastMouseOrTouchEventInfo)().isTouch &&
        ...
        _tryActivateEditMode(e, t) {
          const i = (0, n.ensureNotNull)(
            t.target && t.target.closest(".chart-gui-wrapper"),
          );
        ...
        _textData() {
          return this._text() || (this._textWasEdited ? "​" : u);
        }
        _textColor() {
        ...
        _activateEditMode(e) {
          ...
          null === (t = this._showTextEditor) ||
            ...
            t.call(
              ...
              (e) => {
                var t;
                return null === (t = this._onSelectionChangeCb) || void 0 === t
                  ? void 0
                  : t.call(this, e);
              },
            ),
    ...
    27916: (e, t, i) => {
      "use strict";
      i.d(t, { LineSourcePaneView: () => p, thirdPointCursorType: () => _ });
      var n = i(19625),
        r = i(50151),
        s = i(69186),
        o = i(56468),
      ...
      class p {
        ...
        createLineAnchor(e, t) {
          ...
          const i = (0, s.lastMouseOrTouchEventInfo)().isTouch,
        ...
        _updateImpl(e) {
          ...
          for (let e = 0; e < t.length; e++) {
            const i = t[e],
              n = this._source.pointToScreenPoint(i);
            if (!n) return;
            const r = n;
            (r.pointIndex = e), this._points.push(r);
          }
          2 === this._points.length &&
    ...
    52898: (e, t, i) => {
      ...
      function b(e) {
        const {
          ...
          { horizontalPixelRatio: h, verticalPixelRatio: c } = i,
          u = (Math.max(1, Math.floor(h)) % 2) / 2,
          _ = Math.round(a.x * h) + u,
          p = 0 === d ? Math.max(1, 1 * Math.floor(h)) : 0,
          g = Math.round(n * h) + p / 2,
          x = Math.round(r * c) + p / 2,
          f = Math.round(o * c) - p,
          v = Math.round(s * h) - p,
          T = Math.round(12 * h),
          w = Math.round(10 * c),
        ...
        if (
          ...
          const e = x,
            i = x - w;
          t.lineTo(R - P, e),
            t.arcTo(R, e, R + b, e - L, P),
            t.lineTo(_ - 1.2 * b, i + 1.2 * L),
            t.arcTo(_, i, _ + 1.2 * b, i + 1.2 * L, 1.2 * b),
            t.lineTo(m - b, e - L),
            t.arcTo(m, e, m + P, e, P);
        }
        if (
          (t.lineTo(g + v - P, x),
          t.arcTo(g + v, x, g + v, x + P, P),
          t.lineTo(g + v, x + f - P),
          t.arcTo(g + v, x + f, g + v - P, x + f, P),
          "bottom" === l)
        ) {
          const e = x + f,
            i = e + w;
          t.lineTo(m + P, e),
            t.arcTo(m, e, m - b, e + L, P),
            t.lineTo(_ + 1.2 * b, i - 1.2 * L),
            t.arcTo(_, i, _ - 1.2 * b, i - 1.2 * L, 1.2 * b),
            t.lineTo(R + b, e + L),
            t.arcTo(R, e, R - P, e, P);
      ...
      const L = (0, R.svgRenderer)(y);
      class P {
        constructor(e) {
          (this._data = null),
            (this._tooltipHitTest = new c.HitTestResult(c.HitTarget.MovePoint, {
              ...e,
        ...
        draw(e, t) {
          ...
          const { horizontalPixelRatio: i, verticalPixelRatio: n } = t,
            r = (Math.max(1, Math.floor(i)) % 2) / 2,
            s = (Math.max(1, Math.floor(n)) % 2) / 2,
            { point: o, markerColor: a } = this._data,
            l = Math.round(o.x * i) + r,
            d = Math.round(o.y * n) + s,
            h = L.viewBox();
          (e.fillStyle = a),
            L.render(e, {
              targetViewBox: {
        ...
        hitTest(e, t) {
          if (null !== this._data) {
            const {
              ...
              d = L.viewBox(),
              h = (0, x.box)(
                (0, x.point)(a - d.width / 2, l - d.height),
                (0, x.point)(a + d.width / 2, l),
              );
            if ((0, f.pointInBox)(e, h))
            ...
            if (o) {
              ...
              if ((0, f.pointInBox)(e, t)) return this._tooltipHitTest;
              const o = t.min.y < h.min.y ? t.max.y : h.max.y,
                a = t.min.y < h.min.y ? h.min.y : t.min.y,
                l = (0, x.box)(
                  (0, x.point)(h.min.x - 8, o),
                  (0, x.point)(h.max.x + 8, a),
                );
              if ((0, f.pointInBox)(e, l))
                return new c.HitTestResult(c.HitTarget.MovePoint);
            }
          }
          return null;
        ...
        positionToCoordinate(e, t) {
          const i = (0, s.ensureNotNull)(this._data),
            n = this.getTextInfo(),
            {
              ...
              y: o,
              lineNumber: a,
            } = (0, m.getSymbolCoordinatesInfo)({
              symbolPosition: t,
              textWidth: n.textRight - n.textLeft,
              textByLines: i.linesIncludingHidden,
              lineHeight: i.fontSize,
              lineSpacing: i.lineSpacing,
              font: i.font,
              textAlign: n.textAlign,
            });
          return { x: r + n.textLeft, y: o + n.textTop, lineNumber: a };
        }
        _drawTooltipOn(e, t) {
          e.save();
          const i = (0, s.ensureNotNull)(this._data),
          ...
          e.font = o;
          const { horizontalPixelRatio: L, verticalPixelRatio: P } = t;
          if (l) {
            e.fillStyle = l;
            let i = !1;
            h &&
          ...
          d &&
            ((e.lineWidth = Math.max(1, 1 * Math.floor(L))),
            (e.strokeStyle = d),
            b({
              ctx: e,
              renderingInfo: t,
          ...
          const S = _ + 12 + (0, T.calcTextHorizontalShift)(e, u);
          let M = p + 12 + a / 2;
          (0, T.drawScaled)(e, L, P, () => {
            if (y) {
              const t = this.positionToCoordinate(!1, y.start),
                n = this.positionToCoordinate(!1, y.end),
                r = this.getTextInfo();
              (0, m.drawSelection)(e, w.dpr1PixelRatioInfo, {
                lines: i.linesIncludingHidden,
                selectionStart: t,
                selectionEnd: n,
                left: r.textLeft,
                right: r.textRight,
            ...
            for (const t of R) e.fillText(t, S, M), (M += a + x);
          }),
            e.restore();
        }
      }
      const S = (0, a.generateColor)(
        (0, o.getHexColorByName)("color-black"),
        80,
      );
      class M extends g.InplaceTextLineSourcePaneView {
        constructor(e, t, i, n, r) {
          super(e, t, i, n, r),
            (this._renderer = null),
            (this._textWidthCache = new p.TextWidthCache()),
            (this._noteRenderer = new P(
        ...
        _updateImpl(e) {
          super._updateImpl(e), (this._renderer = null);
          const t = this._getSource(),
            i = this._source.isFixed()
              ? [(0, s.ensureDefined)(t.fixedPoint())]
              : this._points;
          if (i.length < 1) return;
          const n = new d.CompositeRenderer(),
            r = this.isLabelVisible(),
            o = this._source.properties().childs(),
            p = (0, l.makeFont)(
              o.fontSize.value(),
              u.CHART_FONT_FAMILY,
              o.italic.value() ? "italic" : void 0,
              o.bold.value() ? "bold" : void 0,
            );
          let g, x;
          o.drawBackground.value() &&
            ((g = (0, a.generateColor)(
              o.backgroundColor.value(),
              o.backgroundTransparency.value(),
            )),
            (x = S));
          const f = Math.min(236, e.mediaSize.width),
            v = f - 24,
            T = i[0],
            { mediaSize: w } = e,
            R = (0, _.wordWrap)(
            ...
            m = R.filter((e) => !e.hidden).map((e) => e.text),
            y = o.fontSize.value();
          let b = m.length * y + 24;
          m.length > 1 && (b += 5 * (m.length - 1));
          let P = Math.round(T.x - f / 2);
          const M = L.viewBox();
          let C = Math.round(T.y - M.height - b - 13);
          const I = T.x < 24 || T.x + 24 > w.width;
          let A = I ? null : "top";
          C < 10 ? (C = T.y + 13) : I || (A = "bottom"),
            P < 10 ? (P = 10) : P + f + 10 > w.width && (P = w.width - f - 10),
            this._noteRenderer.setData({
              linesIncludingHidden: R,
              lines: m,
              font: p,
              fontSize: y,
              backgroundColor: g,
              boxShadowColor: x,
              borderColor: o.drawBorder.value()
                ? o.borderColor.value()
                : void 0,
    ...
    92281: (e, t, i) => {
      ...
      var n = i(86441),
        ...
        c = i(91920),
        u = i(31352);
      const _ = o.t(null, void 0, i(67710)),
        p = o.t(null, void 0, i(95931));
      class g extends l.MediaCoordinatesPaneRenderer {
        constructor(e) {
          super(),
            (this._data = null),
            (this._cache = {}),
        ...
        hitTest(e) {
          ...
          if (this._adapter.getBlocked() && e.x >= t.left && e.x < t.right)
            return new d.HitTestResult(d.HitTarget.Custom, {});
          if (
          ...
          return this._adapter.getEditable() &&
            ...
            ? this._adapter.hasModifyCallback()
              ? new d.HitTestResult(d.HitTarget.Custom, {
              ...
              : new d.HitTestResult(d.HitTarget.Regular)
        ...
        _drawImpl(e) {
          ...
          const t = e.context,
            ...
            { left: o, right: a } = (0, u.orderLineLocation)(
              this._adapter,
              i,
              s,
            ),
        ...
        _height() {
          return Math.max(
            ...
            1 +
              Math.max(
                c.fontHeight(this._adapter.getBodyFont()),
                c.fontHeight(this._adapter.getQuantityFont()),
              ),
          );
        }
        _bodyWidth(e) {
        ...
        _drawLines(e, t, i, n, r) {
          e.save(),
            ...
            (0, a.setLineStyle)(e, this._adapter.getLineStyle()),
            (e.lineWidth = this._adapter.getLineWidth()),
            (0, a.drawLine)(e, i, n, r, n),
            this._adapter.getExtendLeft() && (0, a.drawLine)(e, 0, n, t, n),
            e.restore();
        }
        ...
        _drawCancelButton(e, t, i, r) {
          ...
          (0, a.drawPoly)(
            e,
            [new n.Point(t + h, i + c), new n.Point(l - h, d - c)],
            !0,
          ),
            (0, a.drawPoly)(
              e,
              [new n.Point(l - h, i + c), new n.Point(t + h, d - c)],
              !0,
            );
        }
      }
      var x = i(11064);
      class f extends r.LineSourcePaneView {
        constructor(e, t) {
          super(e, t),
            (this._renderer = new s.CompositeRenderer()),
    ...
    86595: (e, t, i) => {
      ...
      class u extends h.LineSourcePaneView {
        constructor() {
          super(...arguments),
            (this._channelRenderer = new d.ParallelChannelRenderer()),
            (this._labelTextRenderer = new c.TextRenderer()),
            (this._renderer = null);
        }
        renderer(e) {
          return this._invalidated && this._updateImpl(e), this._renderer;
        ...
        _updateImpl(e) {
          ...
          if (3 === this._points.length) {
            ...
            (h = s.add((0, n.point)(0, e))),
              (c = d.add((0, n.point)(0, e))),
              i.showMidline.value() &&
                ((u = s.add(h).scaled(0.5)), (_ = d.add(c).scaled(0.5)));
          }
          const p = i.linewidth.value(),
            g = i.linestyle.value(),
            x = i.linecolor.value(),
            f = {
              line1: { color: x, lineStyle: g, lineWidth: p, points: [s, d] },
              line2:
                null === h || null === c
                  ? void 0
                  : { color: x, lineStyle: g, lineWidth: p, points: [h, c] },
              middleLine:
                null === u || null === _
                  ? void 0
                  : {
                      color: i.midlinecolor.value(),
                      lineStyle: i.midlinestyle.value(),
                      lineWidth: i.midlinewidth.value(),
                      points: [u, _],
                    },
              extendLeft: i.extendLeft.value(),
              extendRight: i.extendRight.value(),
              fillBackground: i.fillBackground.value(),
              backColor: (0, r.generateColor)(
                i.backgroundColor.value(),
          ...
          this._channelRenderer.setData(f);
          const v = new a.CompositeRenderer();
          v.append(this._channelRenderer);
          const T = this._getLabelTextRenderer(s, d, h, c);
          T && v.append(T);
          const w = [];
          this._points[0] && w.push(this._points[0]),
            this._points[1] && w.push(this._points[1]),
            h &&
              c &&
              (w.push((0, l.anchor)({ ...h, pointIndex: 2 })),
              w.push((0, l.anchor)({ ...c, pointIndex: 3 })),
              w.push(
                (0, l.anchor)({
                  ...h.add(c).scaled(0.5),
                  pointIndex: 4,
              ...
              w.push(
                (0, l.anchor)({
                  ...w[0].add(w[1]).scaled(0.5),
                  pointIndex: 5,
                  square: !0,
                  cursorType: o.PaneCursorType.VerticalResize,
                }),
              ));
          const R = 3 === this._points.length && !h;
          if (
            (this._model.lineBeingCreated() !== this._source ||
              R ||
              (w.pop(), w.pop()),
            v.append(this.createLineAnchor({ points: w }, 0)),
            this._points.length >= 2)
          ) {
            const e = this._points;
            this._addAlertRenderer(v, [e[0], e[1]]);
          }
          this._renderer = v;
        }
        _getLabelTextRenderer(e, t, i, n) {
    ...
    4086: (e, t, i) => {
      ...
      class d extends l.LineSourcePaneView {
        ...
        _updateImpl(e) {
          ...
          if (
            (3 === this._points.length
              ? ((this._medianPoint = this._points[1]
                  .add(this._points[2])
                  .scaled(0.5)),
                (this._medianPoint.pointIndex = 3))
              : 2 === this._points.length
          ...
          if (
            (this._medianRenderer.setData(d),
            t.append(this._medianRenderer),
            this._points.length < 3)
          )
            return this.addAnchors(t), void (this._renderer = t);
          ...
          this._sideRenderer.setData(h), t.append(this._sideRenderer);
          let c = 0;
          const u = this._points[2].subtract(this._points[1]).scaled(0.5),
            _ = i.fillBackground.value(),
            p = i.transparency.value();
          for (let e = 0; e <= 8; e++) {
            const i = "level" + e,
            ...
            if (s.childs().visible.value()) {
              const i = this._medianPoint.addScaled(
                ...
                l = this._medianPoint.addScaled(u, -s.childs().coeff.value());
              if (_) {
                {
                  const e = {
                      p1: this._points[0],
                      p2: i,
                      p3: this._points[0],
                      p4: this._medianPoint.addScaled(u, c),
              ...
              c = s.childs().coeff.value();
              {
                ...
                l.setData(r),
                  l.setHitTest(
                    new n.HitTestResult(n.HitTarget.MovePoint, void 0, e),
                  ),
                  t.append(l);
              }
              {
    ...
    38420: (e, t, i) => {
      "use strict";
      var n = i(27916).LineSourcePaneView,
        r = i(91920),
        s = i(56468).HitTestResult,
        o = i(56468).HitTarget,
        a = i(63273),
        l = i(34585).appendEllipsis,
        d = i(75919).MediaCoordinatesPaneRenderer,
        h = i(31352).orderLineLocation;
      const { setLineStyle: c, drawLine: u, drawPoly: _ } = i(37743),
        { LINESTYLE_SOLID: p } = i(51056);
      class g extends d {
        constructor(e, t) {
    ...
    75872: (e, t, i) => {
      "use strict";
      i.r(t), i.d(t, { PredictionPaneView: () => k });
      var n,
        r = i(27147),
        s = i(50151),
        o = i(11542),
      ...
      const S = (0, R.makeFont)(14, w.CHART_FONT_FAMILY, "normal"),
        M = (0, R.makeFont)(14, w.CHART_FONT_FAMILY, "bold"),
        C = (0, R.makeFont)(11, w.CHART_FONT_FAMILY, "normal"),
        I = (0, R.makeFont)(12, w.CHART_FONT_FAMILY, "normal"),
        A = (0, R.makeFont)(10, w.CHART_FONT_FAMILY, "normal");
      class D extends b.MediaCoordinatesPaneRenderer {
        constructor() {
          super(...arguments),
            (this._data = null),
        ...
        _drawBalloon(e, t, i, n, r, s = 20) {
          ...
          if (r === P.Direction.Down) {
            const r = new f.Point(t.x - s, t.y - 6 - 5 - n);
            return (
              e.moveTo(r.x + 3, r.y),
        ...
        _drawTargetLabel(e, t) {
          ...
          const x = this._data.points[1],
            f = x.x + this._targetWidth - t.width + 5;
          this._targetRectLeftOffset = Math.max(
            20,
            Math.min(this._targetWidth - 15, f),
          );
          const v =
              this._data.direction === P.Direction.Up
                ? P.Direction.Down
                : P.Direction.Up,
            w = this._drawBalloon(
              e,
          ...
          const R = 2 + w.x + 4,
            m = 2 + w.y + 3,
            b = this._targetWidth - 8 - 4;
          (e.font = S), (e.textAlign = (0, d.isRtl)() ? "right" : "left");
          const L = (0, T.calcTextHorizontalShift)(e, b - h - c);
          e.fillText(n, R + L, m);
          const I = (0, T.calcTextHorizontalShift)(e, b - l);
          e.fillText(r, R + l + c + I, m), (e.font = C);
          const A = m + 14 + 3,
            D = (0, T.calcTextHorizontalShift)(e, b - _ - g - p);
          e.fillText(s, R + D, A);
          const k = (0, T.calcTextHorizontalShift)(e, b - u - p - g - _);
          this._data.clockWhite &&
            e.drawImage(this._data.clockWhite, R + u + p + k, A + 1);
          const N = (0, T.calcTextHorizontalShift)(e, b - u - g);
          if ((e.fillText(a, R + u + g + 2 * p + N, A), !this._data.status))
            return void e.restore();
          let B, H, z, E;
          if (((e.font = M), this._data.status === P.AlertStatus.Success))
            (B = o.t(null, void 0, i(26409))),
              (H = this._data.successBackground),
              (z = this._data.successTextColor),
              (E = this._data.successIcon);
          else
            (B = o.t(null, void 0, i(47545))),
              (H = this._data.failureBackground),
              (z = this._data.failureTextColor),
              (E = this._data.failureIcon);
          const W = 18,
            O = this._target1BoldTextWidthCache.measureText(e, B),
            V = Math.round((this._targetWidth - O) / 2),
            F = (0, T.calcTextHorizontalShift)(e, O);
          (e.fillStyle = H),
            this._data.direction === P.Direction.Up
              ? ((0, y.drawRoundRect)(
                  e,
                ...
                e.fill(),
                (e.fillStyle = z),
                e.fillText(B, w.x + V + F, w.y - W + 1),
                E &&
                  e.drawImage(
                    E,
                    w.x + V - E.width - 4,
                    w.y - W - 2 + Math.abs(W - E.height) / 2,
                  ))
              : ((0, y.drawRoundRect)(
                  e,
                  w.x - 1,
                  w.y + this._targetHeight + 2,
                  this._targetWidth + 2,
                  W,
                  5,
                ),
                e.fill(),
                (e.fillStyle = z),
                e.fillText(B, w.x + V + F, w.y + this._targetHeight + 5),
                E &&
                  e.drawImage(
                    E,
                    w.x + V - E.width - 4,
                    w.y + this._targetHeight + 10 - Math.abs(W - E.height) / 2,
                  )),
            e.restore();
        }
        _drawStartLabel(e, t) {
          ...
          const a = (0, T.calcTextHorizontalShift)(
              e,
        ...
        _targetLabelHitTest(e) {
          ...
          const i = this._data.direction === P.Direction.Up ? -1 : 1,
            n = this._data.points[1],
        ...
        _sourceLabelHitTest(e) {
          if (
            ...
            return null;
          const t = this._data.direction === P.Direction.Up ? 1 : -1,
            i = this._data.points[0],
      ...
      class k extends x.LineSourcePaneView {
        constructor(e, t) {
          super(e, t),
            ...
            (this._predictionRenderer = new D()),
        ...
        _updateImpl(e) {
          ...
          const n = (0, s.ensureNotNull)(
            ...
            a = t[1],
            g = t[0],
            x = (0, d.forceLTRStr)(n.format(a.price)),
            f = a.price - g.price,
            v = (f / Math.abs(g.price)) * 100,
            T = (0, d.forceLTRStr)(
              `${n.format(f)} (${(0, c.getPercentageFormatter)().format(v)})`,
            ),
            w = this._model.timeScale();
          let R = w.indexToUserTime(g.index),
            m = w.indexToUserTime(a.index);
          g.time &&
            a.time &&
            ((R = (0, r.default)(g.time)
          ...
          const y = this._model.mainSeries().isDWM(),
            b = p.Interval.parse(this._model.mainSeries().interval()),
            L = b.isSeconds() || b.isTicks();
          let P = "",
            S = "";
          if (m && R) {
            const e = y
            ...
            const t = (m.valueOf() - R.valueOf()) / 1e3;
            P = `${o.t(null, { context: "dates" }, i(71682))} ${(0, d.startWithLTR)(new _.TimeSpanFormatter().format(t))}`;
          }
          const M = n.format(g.price);
          let C = "";
          const I = w.indexToUserTime(g.index);
          if (I) {
            const e = y
              ? ""
              : ` ${new u.TimeFormatter(L ? u.hourMinuteSecondFormat : u.hourMinuteFormat).format(I)}`;
            C = `${new h.DateFormatter().format(I)}${e}`;
          }
          const A =
              this._model.lineBeingCreated() !== this._source &&
            ...
            N = {
              ...
              targetBackColor: (0, l.generateColor)(
                D.targetBackColor.value(),
                k,
              ),
              targetStrokeColor: (0, l.generateColor)(
                D.targetStrokeColor.value(),
                k,
              ),
              targetTextColor: D.targetTextColor.value(),
              sourceBackColor: (0, l.generateColor)(
                D.sourceBackColor.value(),
                k,
              ),
              sourceStrokeColor: (0, l.generateColor)(
                D.sourceStrokeColor.value(),
                k,
              ),
              sourceTextColor: D.sourceTextColor.value(),
              successBackground: (0, l.generateColor)(
                D.successBackground.value(),
                k,
              ),
              successTextColor: D.successTextColor.value(),
              failureBackground: (0, l.generateColor)(
                D.failureBackground.value(),
                k,
              ),
              failureTextColor: D.failureTextColor.value(),
              intermediateBackColor: D.intermediateBackColor.value(),
              intermediateTextColor: D.intermediateTextColor.value(),
              sourceLine1: M,
              sourceLine2: C,
          ...
          this._predictionRenderer.setData(N),
    ...
    97105: (e, t, i) => {
      ...
      var n = i(86441),
        ...
        a = i(27916).LineSourcePaneView,
        l = i(11064).SelectionRenderer,
        d = i(56468).HitTestResult,
        h = i(56468).HitTarget,
        c = i(95201).CompositeRenderer,
        u = i(19063),
        _ = i(7114).calcTextHorizontalShift,
        p = i(63273).isRtl,
        g = i(75919).MediaCoordinatesPaneRenderer,
        x = i(15938);
      class f extends g {
        constructor(e, t) {
          super(),
      ...
      t.PriceLabelPaneView = class extends a {
        ...
        _updateImpl(e) {
          if (
            ...
            var t = this._source.points()[0].price,
              i = this._source.priceScale();
            if (!i || i.isEmpty()) return;
            var n = this._source.ownerSource().firstValue();
            this._priceLabel = i.formatPrice(t, n);
          }
          var r = {};
          if (
            ...
            (r.fontFamily = x.CHART_FONT_FAMILY),
            ...
            var s = new c();
            return (
              s.append(this._priceLabelRenderer),
              s.append(
                new l({
                  points: r.points,
    ...
    1174: (e, t, i) => {
      "use strict";
      i.r(t), i.d(t, { PriceNotePaneView: () => R });
      var n,
        r,
        s = i(50151),
        o = i(86441),
      ...
      class w {
        constructor() {
          (this._data = null),
            (this._priceLabelRenderer = new d.TextRenderer(
              void 0,
              new x.HitTestResult(x.HitTarget.MovePoint, {
                areaName: x.AreaName.Style,
                activeItem: 1,
              }),
            )),
            (this._hittest = new x.HitTestResult(x.HitTarget.MovePoint, {
              areaName: x.AreaName.Style,
            }));
        }
        setData(e) {
        ...
        draw(e, t) {
          ...
          const { horizontalPixelRatio: n, verticalPixelRatio: r } = t,
            s = Math.round(i.points[0].x * n),
            o = Math.round(i.points[0].y * r),
            a = Math.round(i.points[1].x * n),
            l = Math.round(i.points[1].y * r);
          (e.lineCap = "round"),
            (0, f.setLineStyle)(e, u.LINESTYLE_SOLID),
            (e.strokeStyle = i.lineColor),
            (e.fillStyle = i.lineColor),
            (e.lineWidth = Math.round(1 * n));
          const d = (0, v.fillScaledRadius)(2, n);
          (0, f.createCircle)(e, s, o, d),
            e.fill(),
            void 0 !== i.excludeBoundaries &&
              (e.save(), (0, _.addExclusionArea)(e, t, i.excludeBoundaries)),
            (0, f.drawLine)(e, s, o, a, l),
            void 0 !== i.excludeBoundaries && e.restore(),
            this._priceLabelRenderer.draw(e, t);
          const h = 1 * n;
          (e.strokeStyle = i.circleBorderColor), (e.lineWidth = h);
          const c = d + h / 2;
          (0, f.createCircle)(e, s, o, c), e.stroke(), e.restore();
        }
        hitTest(e) {
          const t = this._data;
          if (null === t) return null;
          const i = (0, g.lastMouseOrTouchEventInfo)().isTouch ? 20 : 3;
          return (0, c.distanceToSegment)(t.points[0], t.points[1], e)
            .distance <= i
            ? this._hittest
            : this._priceLabelRenderer.hitTest(e);
        }
      }
      class R extends h.LineSourcePaneView {
        constructor() {
          super(...arguments),
            (this._renderer = new l.CompositeRenderer()),
        ...
        _updateImpl(e) {
          ...
          if (null === r) return;
          const l = this._source.properties().childs(),
            h = this._model.dark().value()
              ? a.colorsPalette["color-cold-gray-900"]
              : a.colorsPalette["color-white"],
            c = this._source.points()[0].price,
            u = {
              text: i.formatPrice(c, r),
              points: n,
          ...
          if (l.showLabel && l.showLabel.value()) {
            ...
            _ =
              "left" === c
                ...
                : "right" === c
                  ? a.clone()
                  : new o.Point((i.x + r.x) / 2, (i.y + r.y) / 2);
            const g = Math.atan((a.y - s.y) / (a.x - s.x)),
              x = {
                points: [_],
                text: l.text.value(),
                color: l.textColor.value(),
            ...
            if (
              (this._customLabelRenderer.setData(x),
          ...
          this._renderer.append(this._priceNoteRenderer),
            this._priceNoteRenderer.setData(u),
            this._renderer.append(this.createLineAnchor({ points: n }, 0));
        }
      }
    },
    64661: (e, t, i) => {
      ...
      var n = i(50151),
        ...
        _ = i(15938),
        p = i(27436);
      const g = (0, h.getPercentageFormatter)();
      class x extends p.DateAndPriceRangeBasePaneView {
        constructor() {
          super(...arguments),
        ...
        _updateImpl(e) {
          ...
          l.fillBackground.value() &&
            (this._backgroundRenderer.setData({
              points: [new r.Point(v, x.y), new r.Point(T, f.y)],
              color: "white",
              linewidth: 0,
              backcolor: l.backgroundColor.value(),
              fillBackground: !0,
          ...
          const y = Math.round((x.x + f.x) / 2),
            b = new r.Point(y, x.y),
            L = new r.Point(y, f.y),
            {
              mediaSize: { width: P, height: S },
            } = e,
            M = this._updateCustomTextRenderer(S, P);
          this._distanceRenderer.setData({
            ...
            leftend: u.LineEnd.Normal,
            rightend:
              Math.abs(b.y - L.y) >= 15 * l.linewidth.value()
                ? u.LineEnd.Arrow
                : u.LineEnd.Normal,
          ...
          const C = this._source.points()[0].price,
            ...
            N = k && (0, h.getPipFormatter)(k),
            B = (0, n.ensureNotNull)(this._source.ownerSource()).formatter(),
            H =
              null !==
                (i =
                  null === (t = B.formatChange) || void 0 === t
                    ? void 0
                    : t.call(B, I, C)) && void 0 !== i
                ? i
                : B.format(A),
            z = (0, s.forceLTRStr)(
              H + " (" + g.format(D) + ") " + (N ? N.format(A) : ""),
            );
          let E;
          E =
            I > C
              ? new r.Point(0.5 * (x.x + f.x), f.y - 2 * l.fontsize.value())
              : new r.Point(0.5 * (x.x + f.x), f.y + 0.7 * l.fontsize.value());
          const W = { x: 0, y: 10 },
            O = l.fontsize.value(),
            V = {
              points: [E],
          ...
          (null === (a = l.fillLabelBackground) || void 0 === a
            ? void 0
            : a.value()) &&
            ((V.boxShadow = {
              shadowColor: l.shadow.value(),
            ...
            (V.backgroundColor = l.labelBackgroundColor.value())),
            this._labelRenderer.setData(V);
          const F = this._labelRenderer.measure(),
            Y = (0, o.calculateLabelPosition)(F, x, f, W, S);
          this._labelRenderer.setPoints([Y]),
            this._renderer.append(this._labelRenderer),
            this._renderer.append(this._customTextrenderer),
            this.addAnchors(this._renderer);
        }
    ...
    31869: (e, t, i) => {
      ...
      class l extends r.FibWedgePaneView {
        ...
        _getPoints() {
          ...
          return (n = t.add(o.scaled(s))), (n.pointIndex = r), [t, i, n];
        }
        _updateRenderer(e = NaN, t = NaN) {
          if (this._points.length < 2) return;
    ...
    41883: (e, t, i) => {
      "use strict";
      i.r(t), i.d(t, { RectanglePaneView: () => g });
      var n = i(86441),
        r = i(19063),
        s = i(15938),
        o = i(62189),
      ...
      class g extends _.InplaceTextLineSourcePaneView {
        constructor(e, t, i, n, r) {
          super(e, t, i, n, r),
            (this._rectangleRenderer = new o.RectangleRenderer()),
            (this._renderer = null),
            (this._textRenderer = new p.LineToolTextRenderer(
              void 0,
              new d.HitTestResult(
        ...
        _updateImpl(e) {
          ...
          if (
            ...
            return;
          const o = this._getSource().properties().childs(),
            l = {
              points: this._points,
              color: o.color.value(),
              linewidth: o.linewidth.value(),
              backcolor: o.fillBackground.value()
                ? (0, r.generateColor)(
                    o.backgroundColor.value(),
            ...
            h = new a.CompositeRenderer();
          h.append(this._rectangleRenderer);
          const _ = this._points[0],
            p = this._points[1],
            g = this._placeHolderMode();
          let x = !1;
          if (
            ((null === (t = o.showLabel) || void 0 === t
              ? void 0
              : t.value()) &&
              o.text.value()) ||
            g ||
            ...
            const t = Math.min(_.x, p.x),
              i = Math.max(_.x, p.x),
              r = Math.min(_.y, p.y),
              a = Math.max(_.y, p.y);
            let l, d, c, f;
            const v = o.fontSize.value() / 3;
            let T,
              w,
              R = 0;
            switch (o.vertLabelsAlign.value()) {
              case "middle":
                (f = (r + a) / 2), (d = "middle"), (R = v);
                break;
              case "top":
                (f = a), (d = "top");
                break;
            ...
            "middle" === d && ((T = i - t - 2 * R), (w = a - r)),
              this._textRenderer.setData({
                points: [new n.Point(c, f)],
                text: this._textData(),
                color: this._textColor(),
                ...
                horzAlign: l,
                vertAlign: d,
                wordWrapWidth: g ? void 0 : T,
                maxHeight: g ? void 0 : w,
                offsetX: 0,
                offsetY: 0,
                boxPaddingVert: v,
                boxPaddingHorz: R,
                ...
                decorator: g ? u.PlusTextRendererDecorator.instance() : void 0,
                ...this._inplaceTextHighlight(),
              });
            let m = !1;
            if (
              (void 0 !== T &&
                g &&
                this._textRenderer.measure().width > T &&
                (this._textRenderer.updateData({ text: "" }),
                (m = this._textRenderer.measure().width > T)),
              !m)
            ) {
              this._textRenderer.setCursorType(this._textCursorType());
              const {
              ...
              this._textRenderer.isOutOfScreen(t, i)
                ? this.closeTextEditor()
                : this._updateInplaceText(this._textRenderer.getTextInfo()),
                h.append(this._textRenderer),
                (x = !0);
            }
          }
          if (o.middleLine.childs().showLine.value()) {
            let t;
            if (
              x &&
              "middle" === o.vertLabelsAlign.value() &&
              (0, c.needTextExclusionPath)(this._textRenderer)
            ) {
              const {
                mediaSize: { width: n, height: r },
              } = e;
              t =
                null !==
                  (i = (0, c.getTextBoundaries)(this._textRenderer, n, r)) &&
                void 0 !== i
                  ? i
                  : void 0;
            }
        ...
        _addAnchors(e, t, i) {
          const n = e.x - t.x,
            ...
            o =
              s < 0
                ? l.PaneCursorType.DiagonalNeSwResize
                : l.PaneCursorType.DiagonalNwSeResize,
            a =
              s < 0
                ? l.PaneCursorType.DiagonalNwSeResize
                : l.PaneCursorType.DiagonalNeSwResize,
            d = [
              (0, h.anchor)({ ...e, cursorType: o }),
              (0, h.anchor)({ ...t, cursorType: o }),
              (0, h.anchor)({ x: e.x, y: t.y, pointIndex: 2, cursorType: a }),
              (0, h.anchor)({ x: t.x, y: e.y, pointIndex: 3, cursorType: a }),
              (0, h.anchor)({
                x: e.x,
                y: 0.5 * (e.y + t.y),
                pointIndex: 4,
                square: !0,
                cursorType: l.PaneCursorType.HorizontalResize,
              }),
              (0, h.anchor)({
                x: t.x,
                y: 0.5 * (e.y + t.y),
              ...
              (0, h.anchor)({
                ...
                pointIndex: 6,
                square: !0,
                cursorType: l.PaneCursorType.VerticalResize,
              }),
              (0, h.anchor)({
                x: 0.5 * (e.x + t.x),
                y: t.y,
          ...
          super._updateImpl(e),
            (this._data = (function (e, t) {
              ...
              for (let r = 0; r < d.length; r++) {
                if (1 != (1 & x[r].display.value())) continue;
                const o = (0, n.ensureNotNull)(d[r]).startPrice,
                  a = (0, n.ensureNotNull)(d[r]).endPrice;
                if (void 0 === o || void 0 === a) continue;
                const l = s.priceToCoordinate(o, f),
                  _ = s.priceToCoordinate(a, f),
                  v = new c.Point(h, l),
                  T = new c.Point(p, _),
                  w = x[r].color.value(),
                  R = x[r].linewidth.value(),
                  m = x[r].linestyle.value(),
                  y = {
                    points: [v, T],
              ...
              const v = (0, n.ensureNotNull)(t.downLine());
              if (g.styles.showPearsons.value() && void 0 !== v.startPrice) {
                const e = s.priceToCoordinate(v.startPrice, f),
                  n = new c.Point(h, e);
                i.pearsons = {
                  points: [n],
                  text: "" + t.pearsons(),
            ...
            const i = l[e].color,
              ...
              h = {
                line1: {
                  ...
                  lineStyle: o,
                  lineWidth: n,
                  points: [l[e].points[0], l[e].points[1]],
                },
                line2: {
                  color: i,
                  lineStyle: o,
                  lineWidth: n,
                  points: [l[e - 1].points[0], l[e - 1].points[1]],
                },
                extendLeft: !1,
                extendRight: d,
                backColor: (0, r.generateColor)(l[e].color, p),
                skipLines: !0,
                fillBackground: !0,
              },
              c = new a.ParallelChannelRenderer(
                new s.HitTestResult(s.HitTarget.Regular),
              );
            c.setData(h), t.append(c);
          }
          const g = this._getTransparencyResetLines();
          for (let e = 0; e < l.length; e++) {
            const n = new d.TrendLineRenderer();
            n.setData(g[e]),
              n.setHitTest(new s.HitTestResult(s.HitTarget.Regular)),
              t.append(n),
              0 !== e && (i = i.concat(l[e].points));
          }
          this._data.pearsons &&
    ...
    1971: (e, t, i) => {
      "use strict";
      i.r(t), i.d(t, { RiskRewardPaneView: () => C });
      var n = i(86441),
        r = i(50151),
        s = i(11542),
        o = i(27916),
        ...
        w = i(36036),
        R = i(51056);
      const m = s.t(null, void 0, i(76250)),
        y = s.t(null, { context: "line_tool_position" }, i(18741)),
        b = s.t(null, { context: "line_tool_position" }, i(72630)),
        L = s.t(null, void 0, i(36825)),
        P = s.t(null, void 0, i(79463)),
        S = s.t(null, void 0, i(72274)),
        M = s.t(null, void 0, i(10780));
      class C extends o.LineSourcePaneView {
        constructor() {
          super(...arguments),
        ...
        _updateImpl(e) {
          ...
          if (n.length < 2 || this._points.length < 2) return;
          const s = (0, r.ensureNotNull)(this._source.ownerSource()),
            o = null == s ? void 0 : s.barsProvider().bars();
          if (!o || o.isEmpty()) return;
          if (null === o.last()) return;
          const a = 4 === n.length,
            l = this._source.lastBarData();
          if (!l) return;
          const d = l.closePrice,
            h = this._source.stopPrice(),
            c = this._source.profitPrice(),
            _ = this._source.calculatePL(d),
            p = s.symbolSource().symbolInfo();
          if (!p) return;
          const x = s.firstValue();
          if (null === x) return;
          const v = this._points[g.RiskRewardPointIndex.Entry].y,
            T = i.priceToCoordinate(h, x),
            R = i.priceToCoordinate(c, x),
            m = i.priceToCoordinate(l.closePrice, x),
            y = t.indexToCoordinate(l.index),
            b = this._points[g.RiskRewardPointIndex.Entry].x,
            L = this._points[g.RiskRewardPointIndex.ActualEntry]
              ? this._points[g.RiskRewardPointIndex.ActualEntry].x
              : this._points[g.RiskRewardPointIndex.Close].x,
            P = this._points[g.RiskRewardPointIndex.ActualClose]
              ? this._points[g.RiskRewardPointIndex.ActualClose].x
              : this._points[g.RiskRewardPointIndex.Close].x,
            S = this._points[g.RiskRewardPointIndex.Close].x,
          ...
          const B = [
            ...
            (0, w.anchor)({
              ...
              pointIndex: 1,
              square: !0,
              snappingIndex: l.index,
              cursorType: f.PaneCursorType.HorizontalResize,
            }),
            (0, w.anchor)({
              x: b,
              y: T,
              ...
              square: !0,
              snappingPrice: C,
              cursorType: f.PaneCursorType.VerticalResize,
            }),
            (0, w.anchor)({
              x: b,
              y: R,
        ...
        _createBackgroundRenderers(e, t) {
          const i = this._source.properties().childs();
          {
            const t = {
              ...
              extendLeft: !1,
              extendRight: !1,
              backgroundHitTarget: h.HitTarget.MovePoint,
            };
        ...
        _createLinesRenderers(e, t) {
          ...
          if (this._points[g.RiskRewardPointIndex.ActualEntry]) {
            const t = {
              points: [
                this._points[g.RiskRewardPointIndex.ActualEntry],
                e.isClosed
                  ? this._points[g.RiskRewardPointIndex.ActualClose]
                  : new n.Point(e.closeBar, e.closeLevel),
              ],
              color: this._source.properties().childs().linecolor.value(),
              linewidth: 1,
              linestyle: R.LINESTYLE_DASHED,
              extendleft: !1,
              extendright: !1,
              leftend: p.LineEnd.Normal,
              rightend: p.LineEnd.Arrow,
            };
          ...
          }
          {
            const t = new n.Point(
                e.left,
                this._points[g.RiskRewardPointIndex.Entry].y,
              ),
              i = new n.Point(
                e.edge,
                this._points[g.RiskRewardPointIndex.Entry].y,
        ...
        _addCenterLabel(e, t, i) {
          const n = this._source.properties().childs(),
            r = {
              ...
              backgroundColor: (0, _.resetTransparency)(i.color),
        ...
        _creareMiddleLabel(e, t, i) {
          ...
          let T = "",
            w = "";
          const R = (0, u.getNumericFormatter)().format(
          ...
          if (this._points[1]) {
            ...
            if (e.formatChange) {
              const t = Math.max(l, s),
                i = Math.min(l, s);
              w = d >= 0 ? e.formatChange(t, i) : e.formatChange(i, t);
            } else w = e.format(d);
          }
          const P = g.qty.value() / g.lotSize.value(),
            S =
              "futures" === i.type ||
              (0, v.hasCryptoTypespec)(i.typespecs || [])
                ? Math.round(1e3 * P) / 1e3
                : Math.floor(P);
          if (g.compact.value())
            (T += w ? w + " ~ " : ""), (T += S + "\n"), (T += R);
          else {
            const e = _ ? b : y;
            (T += w ? m.format({ status: e, pnl: w }) + ", " : ""),
              (T += M.format({ qty: "" + S }) + "\n"),
              (T += L.format({ ratio: R }) + " ");
          }
          let C = g.linecolor.value();
          return (
            d < 0
              ? (C = g.stopBackground.value())
              : d > 0 && (C = g.profitBackground.value()),
        ...
        _createStopLabel(e, t, i) {
          ...
          const w = p.formatter(),
            R =
              null !==
                (o =
                  null === (s = w.formatChange) || void 0 === s
                    ? void 0
                    : s.call(w, Math.max(a, l), Math.min(a, l))) && void 0 !== o
                ? o
                : w.format(g),
            m = (0, u.getPercentageFormatter)(),
            y = m.format(f);
          return (
            (T = _.compact.value()
              ? R + " (" + y + ") " + _.amountStop.value()
              : P.format({
                  stopChange: (0, x.forceLTRStr)(R),
                  stopChangePercent: (0, x.forceLTRStr)(m.format(f)),
                  stopChangePip: i ? (0, x.forceLTRStr)(i.format(g)) : "",
                  amount: (0, x.forceLTRStr)("" + _.amountStop.value()),
                })),
            this._addCenterLabel(t, this._stopLabelRenderer, {
              p: v,
              txt: T,
              color: _.stopBackground.value(),
              vertAlign: l < a ? "bottom" : "top",
              offsetY: 0,
            })
          );
        }
        _createTargetLabel(e, t, i) {
          ...
          const {
            ...
            f = Math.abs(a - l),
            v = Math.round((1e4 * f) / l) / 100,
            T = new n.Point((h + c) / 2, _);
          let w = "";
          const R = g.formatter(),
            m =
              null !==
                (o =
                  null === (s = R.formatChange) || void 0 === s
                    ? void 0
                    : s.call(R, Math.max(a, l), Math.min(a, l))) && void 0 !== o
                ? o
                : R.format(f),
            y = (0, u.getPercentageFormatter)(),
            b = y.format(v);
          return (
            (w = p.compact.value()
              ? m + " (" + b + ") " + p.amountTarget.value()
              : S.format({
                  profitChange: m,
                  profitChangePercent: (0, x.forceLTRStr)(y.format(v)),
                  profitChangePip: i ? (0, x.forceLTRStr)(i.format(f)) : "",
                  amount: (0, x.forceLTRStr)("" + p.amountTarget.value()),
                })),
            this._addCenterLabel(t, this._profitLabelRenderer, {
              p: T,
              txt: w,
              color: p.profitBackground.value(),
              vertAlign: l < d ? "top" : "bottom",
              offsetY: 0,
            })
          );
        }
        _createLabelsRenderers(e, t, i, s) {
          ...
          const a = this._creareMiddleLabel(e, t, i),
            l = this._createStopLabel(e, t, s),
            d = this._createTargetLabel(e, t, s),
            h = [
              this._profitLabelRenderer,
              this._stopLabelRenderer,
              this._middleLabelRenderer,
            ...
            c = e.edge - e.left,
            u = this._anchorRadius();
          if (
            c - h - u <= 8 &&
            (d && ((d.offsetY += u + 8), this._profitLabelRenderer.setData(d)),
            l && ((l.offsetY += u + 8), this._stopLabelRenderer.setData(l)),
            a)
          ) {
            let t;
            if (
              null === (o = this._source.priceScale()) || void 0 === o
                ? void 0
                : o.isLog()
            ) {
            ...
            const i = e.profitLevel < e.stopLevel ? 1 : -1,
              s = (0, r.ensureDefined)(a.points)[0].add(
                new n.Point(
                  0,
                  i *
                    t *
                    (0.5 * this._middleLabelRenderer.measure().height + u + 8),
                ),
              );
            (a.points = [s]), this._middleLabelRenderer.setData(a);
          }
        }
      }
    },
    78270: (e, t, i) => {
      ...
      var n = i(86441).Point,
        ...
        s = i(27916).LineSourcePaneView,
        o = i(27916).thirdPointCursorType,
        a = i(91046).TrendLineRenderer,
        l = i(74011).PolygonRenderer,
        d = i(95201).CompositeRenderer,
        h = i(49857).LineEnd;
      const { LINESTYLE_SOLID: c } = i(51056);
          ...
          if (
            ...
            if (2 === this._points.length) {
              ((f = {}).points = this._points),
                ...
                (f.rightend = h.Normal);
              var x = new a();
              x.setData(f), u.append(x);
            } else if (3 === this._points.length) {
              var f,
                v = g.subtract(p),
                T = new n(v.y, -v.x).normalized().scaled(this._distance),
                w = T.scaled(-1);
              (t = p.add(T)),
                (i = g.add(T)),
                (s = p.add(w)),
                ...
                (f.linestyle = c),
                (f.filled = !0),
                (f.backcolor = _.backgroundColor.value()),
                (f.fillBackground = _.fillBackground.value()),
                (f.transparency = _.transparency.value()),
            ...
            if (
              (R.push(p),
              this._points.length >= 2 && R.push(g),
              3 === this._points.length)
            ) {
              var m = o(p, g);
              (t.pointIndex = 2),
            ...
            u.append(this.createLineAnchor({ points: R }, 0)),
              (this._renderer = u);
          }
        }
        renderer(e) {
    ...
    3646: (e, t, i) => {
      ...
      function L(e) {
        ...
        return t ? i.y : i.y + (e.labelHeight + y(e.plate)) * e.direction;
      }
      function P(e) {
        const {
        ...
        return t ? i.y + y(e.plate) * n : i.y + e.labelHeight * n;
      }
      !(function (e) {
      ...
      class S {
        ...
        hitTest(e) {
          ...
          const [t, i] = (function (e, t) {
            const i = (0, m.lastMouseOrTouchEventInfo)().isTouch ? 20 : 3,
              { anchorCoordinates: n, plate: r } = e,
              s =
                (0, T.distanceToSegment)(
                  new o.Point(n.x, b(e)),
                  new o.Point(n.x, L(e)),
                  t,
                ).distance < i;
            ...
            if (!s && void 0 !== r) {
              const s = e.inverseAnchorPosition
                ? e.anchorCoordinates.y + r.circleRadius * e.direction
                : e.anchorCoordinates.y +
                  (e.labelHeight + r.poleTailHeight + r.circleRadius) *
                    e.direction;
              a =
                r.circleRadius > 0 &&
                (0, w.pointInCircle)(
          ...
          if (t || i) {
            ...
            return (
              i && (e.areaName = h.AreaName.Style),
              new h.HitTestResult(h.HitTarget.MovePoint, e)
            );
          }
          return null;
        }
        draw(e, t) {
          ...
          const { poleColor: i, emojiRadius: n } = this._data,
            { horizontalPixelRatio: r, verticalPixelRatio: s } = t,
            o = Math.max(1, Math.floor(r)),
            a = o % 2 ? 0.5 : 0;
          e.beginPath(), (e.strokeStyle = i), (e.lineWidth = o);
          const l = Math.round(this._data.anchorCoordinates.x * r) + a;
          e.moveTo(l, Math.round(b(this._data) * s)),
            e.lineTo(l, Math.round(L(this._data) * s)),
            void 0 !== this._data.plate &&
              0 !== this._data.plate.poleTailHeight &&
              (e.moveTo(l, Math.round(P(this._data) * s)),
              e.lineTo(
                l,
                Math.round(
                  (function (e) {
            ...
            void 0 !== this._data.plate &&
              (function (e, t, i, n, r) {
                const { horizontalPixelRatio: s, verticalPixelRatio: o } = r,
                  {
                    ...
                    poleTailHeight: l,
                    circleBorderColor: d,
                    circleBackgroundColor: h,
                  } = i;
                (e.strokeStyle = d), (e.fillStyle = h);
                const c = (0, R.fillScaledRadius)(a, s),
                  u = Math.round(t.anchorCoordinates.x * s),
                  _ = t.inverseAnchorPosition
                    ? Math.round(t.anchorCoordinates.y * o) +
                      Math.round(a * o) * t.direction
                    : Math.round(t.anchorCoordinates.y * o) +
                      Math.round((t.labelHeight + l + a) * o) * t.direction,
                  p = u + (Math.max(1, Math.floor(s)) % 2) / 2,
                  g = _ + (Math.max(1, Math.floor(o)) % 2) / 2;
                if (
                  ((e.shadowOffsetY = 1),
                  (e.shadowColor = i.shadowColor),
                  (e.shadowBlur = 4),
                  e.beginPath(),
                  e.arc(p, g, c, 0, 2 * Math.PI, !0),
                  e.closePath(),
                  e.fill(),
                  (e.shadowColor = "transparent"),
                  t.svgRenderer)
                ) {
                  const i = 2 * (0, R.fillScaledRadius)(n, s);
                ...
                const x = Math.round(i.circleBorderWidth * s),
                  f = (0, R.strokeScaledRadius)(a, s, x);
                if (
                  ((e.lineWidth = x),
                  e.beginPath(),
                  e.arc(p, g, f, 0, 2 * Math.PI, !0),
                  e.closePath(),
                  e.stroke(),
      ...
      !(function (e) {
        ...
        (function (e) {
          (e[(e.CircleRadius = 35)] = "CircleRadius"),
            ...
            (e[(e.HoveredCircleBorderWidth = 1)] = "HoveredCircleBorderWidth"),
            (e[(e.SelectedCircleBorderWidth = 2)] =
              "SelectedCircleBorderWidth"),
            (e[(e.LabelOffset = 10)] = "LabelOffset"),
            (e[(e.SourceLabelSize = 24)] = "SourceLabelSize"),
            (e[(e.LabelVertPadding = 6)] = "LabelVertPadding");
        })(s || (s = {}));
      const M = {
          circleBorderColor: (0, a.getHexColorByName)("color-cold-gray-900"),
          labelBackgroundColor: (0, a.getHexColorByName)("color-cold-gray-900"),
          labelBorderColor: (0, a.getHexColorByName)("color-cold-gray-800"),
          labelTextColor: (0, a.getHexColorByName)("color-cold-gray-200"),
          poleColor: (0, a.getHexColorByName)("color-cold-gray-500"),
          shadowColor: "rgba(0,0,0,0.4)",
          selectionColor: (0, a.getHexColorByName)("color-tv-blue-500"),
        },
        C = {
          circleBorderColor: (0, a.getHexColorByName)("color-white"),
          labelBackgroundColor: (0, a.getHexColorByName)("color-white"),
          labelBorderColor: (0, a.getHexColorByName)("color-cold-gray-150"),
          labelTextColor: (0, a.getHexColorByName)("color-cold-gray-900"),
          poleColor: (0, a.getHexColorByName)("color-cold-gray-500"),
      ...
      class A extends x.InplaceTextLineSourcePaneView {
        constructor(e, t, i, n, r) {
          super(e, t, i, n, r),
            (this._renderer = new u.CompositeRenderer()),
            (this._emojiCache = null),
            (this._destroyed = !1),
            (this._signpostRenderer = new S(e.isPhantom())),
            (this._labelRenderer = new f.LineToolTextRenderer(
              void 0,
              new h.HitTestResult(
                h.HitTarget.MovePoint,
                (0, x.inplaceEditHandlers)(
                  this._tryActivateEditMode.bind(this, null),
                ),
              ),
            )),
          ...
          if (
            ...
            const e = this._points[0],
              t = (0, _.anchor)({
                ...
                square: !0,
                cursorType: c.PaneCursorType.VerticalResize,
              });
        ...
        _updateTimelineRenderer(e, t) {
          var i;
          const { poleStartY: n, inverse: r, direction: s } = e,
            o = this._source.properties().childs(),
            a = this._getCurrentColorTheme(),
            l = {
              emojiRadius: 16,
              poleColor: a.poleColor,
              svgRenderer:
                null === (i = this._emojiCache) || void 0 === i
                  ? void 0
                  : i.emojiSvgRenderer,
              poleStartY: n,
              itemIndex: 1,
          ...
          o.showImage.value() &&
            ...
            this._signpostRenderer.setData(l);
        }
        async _updateEmoji() {
          var e;
          ...
          const i = (0, d.getTwemojiUrl)(t, "svg"),
            n = new AbortController(),
            r = { emoji: t, abortController: n };
          this._emojiCache = r;
          const s = await (0, l.fetch)(i, { signal: n.signal }).then((e) =>
            e.text(),
          );
          !this._destroyed &&
            r.abortController &&
            ((r.emojiSvgRenderer = (0, p.svgRenderer)(s)),
            this._model.updateSource(this._source));
        }
        _updateLabelTextRenderer(e, t) {
          const i = this._source.properties().childs(),
            n = this._getCurrentColorTheme(),
            {
            ...
            { height: h, width: c } = e.mediaSize;
          let u = (0, g.positionToCoordinate)(i.position.value(), h, a, r);
          u >= -1e-10 &&
            u <= h + 1e-10 &&
            (u = Math.min(h - 2, Math.max(2, u)));
          const _ = {
            ...this._inplaceTextHighlight(),
            text: this._textData(),
            fontSize: i.fontSize.value(),
            ...
            offsetX: 0,
            offsetY: 0,
            points: [new o.Point(s, u)],
            forceCalculateMaxLineWidth: !0,
            vertAlign: -1 === r ? "bottom" : "top",
            horzAlign: "center",
          ...
          const p = this._labelRenderer.measure().height;
          let x = { x: s, y: u };
          if (l) {
            if (i.showImage.value()) {
              const e = 70 + (i.text.value() ? 10 : 0);
              this._labelRenderer.setData({
                ..._,
                points: [new o.Point(s, u + e * d)],
              });
            }
          } else {
            const { poleStartY: e } = t,
              i = 1 === d ? Math.min(e - p, u) : Math.max(e + p, u);
            u !== i &&
              (this._labelRenderer.setData({
                ..._,
                points: [new o.Point(s, i)],
              }),
              (x = { x: s, y: i }));
          }
          return (
            this._labelRenderer.setCursorType(this._textCursorType()),
            this._labelRenderer.isOutOfScreen(c, h)
              ? this.closeTextEditor()
              : this._updateInplaceText(this._labelRenderer.getTextInfo()),
            x
          );
        ...
        _getCurrentColorTheme() {
          return this._model.dark().value() ? M : C;
        }
        _getBasePosition() {
          ...
          const r = this._model.mainSeries(),
            ...
            o =
              e === r
                ? (0, g.getSeriesPosition)(r, s)
                : (0, g.getNoDataPosition)(s, t, i, n);
          if (!o) return null;
    ...
    68498: (e, t, i) => {
      ...
      var n = i(86441),
        ...
        c = i(75919),
        u = i(56468);
      const _ = (0, h.getHexColorByName)("color-tv-blue-600");
      class p extends c.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e) {
          if (null === this._data) return null;
          const { size: t, angle: i, point: n } = this._data,
            s = (0, r.rotationMatrix)(-i),
            o = (0, r.transformPoint)(s, e.subtract(n));
          return Math.abs(o.y) <= t / 2 && Math.abs(o.x) <= t / 2
      ...
      class g extends d.LineSourcePaneView {
        ...
        _updateImpl(e) {
          ...
          this._iconRenderer.setData(s);
          const {
            mediaSize: { width: o, height: a },
          } = e;
          this._iconRenderer.isOutOfScreen(a, o) ||
            this._renderer.append(this._iconRenderer);
          const h = this._points[0],
            c = this._source.getAnchorLimit();
          let u = new n.Point(Math.max(c, i) / 2, 0),
            _ = new n.Point(0, Math.max(c, i) / 2);
          const p = (0, r.rotationMatrix)(t.angle.value());
          (u = (0, r.transformPoint)(p, u)), (_ = (0, r.transformPoint)(p, _));
          const g = h.add(u),
            x = h.subtract(u),
            f = (0, d.thirdPointCursorType)(g, x),
            v = [
              (0, l.anchor)({ ...g, pointIndex: 0, nonDiscreteIndex: !0 }),
              (0, l.anchor)({ ...x, pointIndex: 1, nonDiscreteIndex: !0 }),
              (0, l.anchor)({
                ...h.add(_),
                pointIndex: 2,
                nonDiscreteIndex: !0,
          ...
          this._renderer.append(this.createLineAnchor({ points: v }, 0));
        }
    ...
    13589: (e, t, i) => {
      ...
      var n = i(50151),
        ...
        u = i(32211),
        _ = i(62689);
      class p extends u.InplaceTextLineSourcePaneView {
        constructor(e, t, i, n, r, s, o, a, l, d, h) {
          super(e, t, l, d, h),
            (this._noSelection = !1),
            (this._renderer = null),
            (this._offsetX = i),
        ...
        _updateImpl(e) {
          ...
          const t = this._getSource(),
            i = t.priceScale();
          if (!i || i.isEmpty()) return;
          const u = t.properties().childs(),
            _ = this._getModel(),
            p = {
              text: this._textData(),
              color: this._textColor(),
              fontSize: u.fontsize.value(),
              boxPadding: u.fontsize.value() / 6,
              font: s.CHART_FONT_FAMILY,
          ...
          (p.points = t.isFixed()
            ...
            : this._points),
            u.fillBackground &&
              u.fillBackground.value() &&
              (p.backgroundColor = u.backgroundColor.value()),
            u.drawBorder &&
              u.drawBorder.value() &&
              (p.borderColor = u.borderColor.value()),
            u.wordWrap &&
              u.wordWrap.value() &&
              (p.wordWrapWidth = u.wordWrapWidth.value()),
            (p.bold = u.bold && u.bold.value()),
            (p.italic = u.italic && u.italic.value());
          if (
            (_.selection().isSelected(t) &&
              ((p.highlightBorder = !0),
              (p.highlightBorderColor = u.color.value())),
            !t.isFixed() && u.fixedSize && !u.fixedSize.value())
          ) {
            p.scaleX = _.timeScale().barSpacing() / t.barSpacing();
            const e = (0, n.ensureNotNull)(i.priceRange());
            let r = i.height() / e.length();
            const s = i.logFormula();
            t.isPriceDencityLog() &&
              !i.isLog() &&
              (r =
                i.height() /
                ((0, d.toLog)(e.maxValue(), s) -
                  (0, d.toLog)(e.minValue(), s))),
              !t.isPriceDencityLog() &&
                i.isLog() &&
                (r =
                  i.height() /
                  ((0, d.fromLog)(e.maxValue(), s) -
                    (0, d.fromLog)(e.minValue(), s)));
            const o = t.priceDencity();
            void 0 !== o && (p.scaleY = r / o),
              (void 0 === o || void 0 === p.scaleY || p.scaleY <= 0) &&
                delete p.scaleY;
          }
          this._textRenderer.setData(p),
            this._textRenderer.setCursorType(this._textCursorType());
          const {
            mediaSize: { width: g, height: x },
          } = e;
          if (this._textRenderer.isOutOfScreen(g, x))
            return void this.closeTextEditor();
          const f = 1 === p.points.length;
          if (
            (this._updateInplaceText(this._textRenderer.getTextInfo()),
            f && void 0 !== this._recalculateSourcePointsOnFirstUpdate)
          ) {
            this._renderer = null;
            const e = this._textRenderer.measure();
            return (
          ...
          if (!f || this._noSelection) this._renderer = this._textRenderer;
          else {
            ...
            if (p.wordWrapWidth) {
              ...
              e.append(this.createLineAnchor({ points: i }, 1));
            }
            if (!this._isTextEditMode()) {
              const i = new r.Point(t.x + n / 2, t.y + s);
              (i.pointIndex = 0),
                e.append(
                  new l.SelectionRenderer({
                    ...
                    visible: this.areAnchorsVisible(),
                    hittestResult: c.HitTarget.MovePoint,
                    barSpacing: _.timeScale().barSpacing(),
                  }),
                );
            }
            this._renderer = e;
      ...
      class r extends n.TextRenderer {
        getTextInfo() {
          ...
          return {
            ...
            fontSize: n.fontSize,
            centerRotation:
              null !== (e = this.centerTextRotation()) && void 0 !== e
                ? e
                : void 0,
          };
        }
        ...
        _updateImpl(e) {
          ...
          const s = this._source.properties().childs(),
            ...
            h = (e, t) => ({
              ...
              offsetX: 0,
              offsetY: 0,
              bold: s.bold && s.bold.value(),
              italic: s.italic && s.italic.value(),
              fontsize: s.fontsize.value(),
              backgroundColor: s.color.value(),
              backgroundRoundRect: 4,
            }),
            u = (e, t) => ({
              points: [e, t],
          ...
          this._polyLineRenderer.setData(_), d.append(this._polyLineRenderer);
          const p = (0, o.getNumericFormatter)();
          if (!isNaN(t)) {
            const e = new a.TrendLineRenderer();
            e.setData(u(this._points[1], this._points[3])), d.append(e);
            const i = h(
              this._points[1].add(this._points[3]).scaled(0.5),
              p.format(t),
            );
            this._retrace1LabelRenderer.setData(i),
              d.append(this._retrace1LabelRenderer);
          }
          if (!isNaN(i)) {
            const e = new a.TrendLineRenderer();
            e.setData(u(this._points[3], this._points[5])), d.append(e);
            const t = h(
              this._points[5].add(this._points[3]).scaled(0.5),
              p.format(i),
            );
            this._retrace12LabelRenderer.setData(t),
              d.append(this._retrace12LabelRenderer);
          }
    ...
    80485: (e, t, i) => {
      ...
      class c extends s.LineSourcePaneView {
        ...
        _updateImpl(e) {
          ...
          if (0 === l) return;
          let x = Math.min(d.x, c.x);
          const f = [];
          for (let e = o; x > -u; e -= l)
            (x = g.indexToCoordinate(e)), f.push(x);
          x = Math.max(d.x, c.x);
          for (let e = a; x < g.width(); e += l)
            (x = g.indexToCoordinate(e)), f.push(x);
          for (let e = 0; e < f.length; e++) {
            const t = {
                point: new n.Point(f[e], d.y),
                width: u,
                height: u,
    ...
    82595: (e, t, i) => {
      "use strict";
      i.r(t), i.d(t, { TrendAnglePaneView: () => w });
      var n = i(50151),
        r = i(86441),
        s = i(5531),
        o = i(34026),
      ...
      var T = i(90139);
      class w extends T.TrendToolWithStatsPaneView {
        constructor(e, t) {
          super(e, t),
        ...
        _updateImpl(e) {
          ...
          const i = this._source,
            n = i.angle();
          if (this._points.length > 0 && null !== n) {
            const e = Math.cos(n),
              t = -Math.sin(n),
              s = new r.Point(e, t);
            (this._secondPoint = this._points[0].addScaled(s, i.distance())),
              (this._middlePoint = this._source.calcMiddlePoint(
                this._points[0],
                this._secondPoint,
              ));
          ...
          if (!c || c.isEmpty() || u.isEmpty()) return;
          ...
          T.showBarsRange.value() ||
            T.showPriceRange.value() ||
            T.showPercentPriceRange.value() ||
            T.showPipsPriceRange.value() ||
            ((this._label = null),
            this._labelData && (this._labelData.text = ""));
          const w = T.linecolor.value(),
            R = {
              points: [f, this._secondPoint],
              color: w,
              linewidth: T.linewidth.value(),
              linestyle: T.linestyle.value(),
          ...
          let y = !1;
          T.statsPosition.value() === h.StatsPosition.Auto &&
            (y = (0, r.equalPoints)(f, v)
              ? !(0, o.pointInBox)(f, m)
              : null ===
                (0, s.intersectLineSegmentAndBox)((0, r.lineSegment)(f, v), m));
          if (
            (this.isHoveredSource() ||
              this.isSelectedSource() ||
              T.alwaysShowStats.value()) &&
            !y &&
            2 === this._points.length
          ) {
          ...
          const b =
            ...
            T.showMiddlePoint.value();
          this._middlePoint &&
            this._renderer.append(
              new _.SelectionRenderer({
                points: [
                  (0, x.anchor)({ ...this._middlePoint, pointIndex: 0 }),
                ],
          ...
          const L = {
            point: f,
            angle: null !== (t = i.angle()) && void 0 !== t ? t : 0,
            color: T.linecolor.value(),
            size: 50,
          };
          this._angleRenderer.setData(L),
            this._renderer.append(this._angleRenderer);
          const P = Math.round((180 * L.angle) / Math.PI) + "º",
            S = {
              points: [new r.Point(f.x + 50, f.y)],
              text: (0, a.forceLTRStr)(P),
              color: T.textcolor.value(),
              horzAlign: "left",
              font: p.CHART_FONT_FAMILY,
              offsetX: 5,
          ...
          const M = (0, x.anchor)({ ...this._secondPoint, pointIndex: 1 });
          this._renderer.append(this.createLineAnchor({ points: [f, M] }, 0));
        }
      }
    },
    90413: (e, t, i) => {
      ...
      class d extends l.FibHorizontalLevelsPaneViewBase {
        ...
        _updateImpl(e) {
          ...
          if (3 === this._source.points().length) {
            ...
            let o = !1;
            l.reverse && l.reverse.value() && (o = l.reverse.value()),
              (this._levels = []);
            const d = o ? n.price : r.price,
              h = o ? r.price : n.price,
              c = d - h;
            let u, _, p;
            const g = e.isLog() && l.fibLevelsBasedOnLogScale.value();
            if (g) {
              u = e.priceToCoordinate(d, i);
              (_ = u - e.priceToCoordinate(h, i)),
                (p = e.priceToCoordinate(s.price, i));
            }
            const x = { price: s.price, coordinate: p },
              f = { price: c, coordinate: _ },
              v = this._source.levelsCount();
            for (let t = 1; t <= v; t++) {
              const n = l["level" + t].childs();
              if (!n.visible.value()) continue;
              const r = n.coeff.value(),
                s = n.color.value(),
                o = n.text.value(),
                d = (0, a.fibLevelCoordinate)(x, f, r, e, i, g),
                h = (0, a.fibLevelPrice)(x, f, r, e, i, g);
              this._levels.push({
                color: s,
                price: h,
                y: d,
          ...
          d.visible.value() &&
            ((h = this._trendLineRendererPoints23),
            h.setData({
              points: [s, c],
              color: d.color.value(),
              linewidth: d.linewidth.value(),
          ...
          const u = Math.min(c.x, s.x),
            _ = Math.max(c.x, s.x),
            p = l.fillBackground.value(),
            g = l.transparency.value(),
            x = l.extendLinesLeft.value(),
            f = l.extendLines.value();
          if (p)
            for (let e = 0; e < this._levels.length; e++)
              if (e > 0 && p) {
                const t = this._levels[e - 1],
                  i = {
                    points: [
                      new n.Point(u, this._levels[e].y),
                      new n.Point(_, t.y),
                    ],
                    color: this._levels[e].color,
                    linewidth: 0,
          ...
          this._addLevels({
            ...
            left: u,
            right: _,
            showLabel: l.showCoeffs.value() || l.showPrices.value(),
            showText: l.showText.value(),
            horzLabelsAlign: l.horzLabelsAlign.value(),
            vertLabelsAlign: l.vertLabelsAlign.value(),
            horzTextAlign: l.horzTextAlign.value(),
            vertTextAlign: l.vertTextAlign.value(),
            extendLeft: x,
            extendRight: f,
            fontSize: l.labelFontSize.value(),
            isOnScreen: !0,
            trendLineRenderer: h,
          }),
            this.addAnchors(this._renderer),
    ...
    57175: (e, t, i) => {
      "use strict";
      i.r(t), i.d(t, { TrendBasedFibTimePaneView: () => _ });
      var n = i(86441),
        r = i(95173),
        s = i(17330),
        o = i(62189),
      ...
      class _ extends u.LineSourcePaneView {
        ...
        _updateImpl(e) {
          ...
          if (3 === this._source.points().length) {
            ...
            if (e.isEmpty()) return;
            const [t, n, r] = this._source.points();
            if (((this._levels = []), n.index === t.index)) return;
            const s = n.index - t.index,
              o = r.index;
            if (null === e.visibleBarsStrictRange()) return;
            for (let t = 1; t <= this._source.levelsCount(); t++) {
          ...
          if (this._points.length < 2) return;
          const a = new d.CompositeRenderer(),
            [u, _] = this._points,
            p = i.trendline.childs();
          if (p.visible.value()) {
            const e = {
              points: [u, _],
              color: p.color.value(),
          ...
          if (p.visible.value()) {
            ...
            this._trendLineRendererPoints23.setData(e),
              a.append(this._trendLineRendererPoints23);
          }
          const {
            mediaSize: { width: x, height: f },
          } = e;
          if (i.fillBackground.value()) {
            const e = i.transparency.value();
            for (let t = 1; t < this._levels.length; t++) {
              const i = this._levels[t - 1],
                r = {
                  points: [
                    new n.Point(i.x, 0),
                    new n.Point(this._levels[t].x, f),
                  ],
                  color: this._levels[t].color,
                  linewidth: 0,
                  backcolor: this._levels[t].color,
                ...
                s = new o.RectangleRenderer(!0);
              s.setData(r), a.append(s);
            }
          }
          let v = i.horzLabelsAlign.value();
          v = "left" === v ? "right" : "right" === v ? "left" : "center";
          const T = i.vertLabelsAlign.value(),
            w = i.showCoeffs.value();
          for (let e = 0; e < this._levels.length; e++) {
            let i;
            if (w) {
              let r;
            ...
            const o = {
              ...
              h = new r.VerticalLineRenderer();
            h.setData(o), h.setHitTest(d), a.append(h);
          }
    ...
    29710: (e, t, i) => {
      "use strict";
      i.r(t), i.d(t, { TrendLinePaneView: () => v });
      var n = i(50151),
        r = i(86441),
        s = i(34026),
        o = i(5531),
        ...
        x = i(90139),
        f = i(32211);
      class v extends x.TrendToolWithStatsPaneView {
        constructor(e, t, i, n, r) {
          super(e, t, i, n, r),
            (this._trendRenderer = new _.TrendLineRenderer()),
            (this._labelRenderer = new d.LineToolTextRenderer(
              void 0,
              new g.HitTestResult(
                g.HitTarget.MovePoint,
            ...
            this._source.setAdditionalCursorData(() => {
              ...
              return {
                color: this._source.editableTextStyle().cursorColor,
                rotationPoint:
                  null !== (e = this._labelRenderer.rotation()) && void 0 !== e
                    ? e
                    : void 0,
                ...this._labelRenderer.getTextInfo(),
              };
            }, this._labelRenderer.positionToCoordinate.bind(this._labelRenderer));
        }
        _getPointsForStats() {
          return [
            this._points[0],
        ...
        _updateImpl(e) {
          ...
          const n = this._source.priceScale(),
            d = this._model.timeScale();
          if (!n || n.isEmpty() || d.isEmpty()) return;
          const _ = this._model.timeScale().visibleBarsStrictRange();
          if (null === _) return;
          const x = this._source.points();
          ...
          T.showPriceRange.value() ||
            ...
            T.showPipsPriceRange.value() ||
            T.showBarsRange.value() ||
            T.showDateTimeRange.value() ||
            T.showDistance.value() ||
            T.showAngle.value() ||
            ((this._label = null),
            this._labelData && (this._labelData.text = ""));
          const w = this._points[0],
            R = this._points[1],
            {
              mediaSize: { width: m, height: y },
            } = e;
          let b;
          const L = T.text.value(),
            P = this._isTextEditMode(),
            S = this._placeHolderMode(!0);
          if (
            ((null === (t = T.showLabel) || void 0 === t
              ? void 0
              : t.value()) &&
              L) ||
            S ||
            ...
            const e = w.x < R.x ? w : R,
              t = e === w ? R : w,
              n = T.vertLabelsAlign.value(),
              s = T.horzLabelsAlign.value();
            let o;
            o =
              "left" === s
                ? e.clone()
                : "right" === s
                  ? t.clone()
                  : new r.Point((w.x + R.x) / 2, (w.y + R.y) / 2);
            const a = Math.atan((t.y - e.y) / (t.x - e.x));
            this._labelRenderer.setData({
              points: [o],
              text: this._textData(),
              color: this._textColor(),
              ...
              forceTextAlign: !0,
              angle: a,
              decorator: S ? h.PlusTextRendererDecorator.instance() : void 0,
              ...this._inplaceTextHighlight(),
            }),
              this._labelRenderer.setCursorType(this._textCursorType()),
              this._renderer.append(this._labelRenderer),
              this._needLabelExclusionPath(this._labelRenderer) &&
                (b =
                  null !==
                    (i = (0, l.getTextBoundaries)(this._labelRenderer, m, y)) &&
                  void 0 !== i
                    ? i
                    : void 0),
              this._labelRenderer.isOutOfScreen(m, y)
                ? this.closeTextEditor()
                : this._updateInplaceText(this._labelRenderer.getTextInfo());
          }
          const M = T.linecolor.value(),
            C = {
              points: this._points,
              color: M,
              linewidth: T.linewidth.value(),
          ...
          this._trendRenderer.setData(C),
            this._renderer.insert(this._trendRenderer, 0);
          const I = (0, r.box)(new r.Point(0, 0), new r.Point(m, y));
          let A = !1;
          T.statsPosition.value() === c.StatsPosition.Auto &&
            (A = (0, r.equalPoints)(w, R)
              ? !(0, s.pointInBox)(w, I)
              : null ===
                (0, o.intersectLineSegmentAndBox)((0, r.lineSegment)(w, R), I));
          if (
            (((this.isHoveredSource() || this.isSelectedSource()) &&
              this.isEditMode()) ||
              T.alwaysShowStats.value()) &&
          ...
          if (this._middlePoint && !P) {
            const e =
              (this.isHoveredSource() || this.isSelectedSource()) &&
              T.showMiddlePoint.value();
            this._renderer.append(
              new u.SelectionRenderer({
                points: [this._middlePoint],
                bgColors: this._lineAnchorColors([this._middlePoint]),
                color: M,
                visible: e && this.areAnchorsVisible(),
                hittestResult: g.HitTarget.Regular,
                barSpacing: 0,
              }),
            );
          }
          this.addAnchors(this._renderer),
            C.points.length >= 2 &&
              this._addAlertRenderer(this._renderer, C.points);
        }
      }
    },
    90139: (e, t, i) => {
      "use strict";
      i.d(t, { TrendToolWithStatsPaneView: () => Y });
      var n = i(50151),
        r = i(86441),
        s = i(5531),
        o = i(11542),
      ...
      const b = 18,
        L = new (class {
          constructor(e, t) {
            (this._icons = new Map()),
              (this._onAllIconsLoaded = new R.Delegate()),
            ...
            e.forEach((e) => {
              ...
              n.set(e.theme, new m(e.imageData, t, i)),
      ...
      class S {
        constructor(e, t, i) {
          (this._fontSize = 0),
            ...
            (this._textWidthCache = new w.TextWidthCache()),
            (this._textSizeCache = t),
            (this._data = e),
            (this._fontSize = e.fontSize ? e.fontSize : 12),
            (this._lineSpacing =
              (0, v.isNumber)(this._data.lineSpacing) && this._data.lineSpacing
        ...
        draw(e, t) {
          ...
          if (this._rect) {
            if (
              ...
              let s = 0;
              const o = Math.ceil((b - this._fontSize) / 2),
        ...
        hitTest(e) {
          return 0 === this._data.points.length
            ? null
            : (this._preRender(),
              this._boundingBox && (0, _.pointInBox)(e, this._boundingBox)
                ? this._hittest
                : null);
        }
        _preRender() {
          ...
          const e = (function () {
              if (null !== y) return y;
              const e = (0, T.createDisconnectedCanvas)(
                document,
                (0, u.size)({ width: 0, height: 0 }),
              );
              return (y = (0, T.getPrescaledContext2D)(e)), y;
            })(),
        ...
        _drawIcon(e, t, i, r, s, o) {
          const { horizontalPixelRatio: a, verticalPixelRatio: l } = o,
            d = `${r}${this._data.isDark}${a}_${l}`;
          let h = P.get(d);
          if (!h) {
            (h = document.createElement("canvas")),
              ...
              (h.style.width = "18px"),
              (h.style.height = "18px");
            const e = (0, n.ensureNotNull)(h.getContext("2d"));
            e.setTransform(1, 0, 0, 1, 0, 0), p.isEdge || e.scale(a, l);
            const t = L.getIcon(r, s ? "dark" : "light");
            t.ready() && (e.drawImage(t.image(), 0, 0), P.set(d, h));
          }
          e.drawImage(h, t - 0.5, i - 0.5, b, b);
        }
      }
      var M,
        C = i(15938),
      ...
      var D = M.fontSize,
        k = M.lineSpacing,
        N = M.paddingTopBottom;
      const B = (0, A.getLogger)("Chart.LineToolTrendLine");
      function H(e, t) {
        return (
          !(!e && !t) &&
          (Boolean(e) !== Boolean(t) ||
      ...
      class E {
        constructor(e) {
          (this._sourcesToRow = new Map()),
            ...
            (this._currentSymbol = ""),
            (this._renderingInfo = e);
          const t = k,
            i = D + t;
          (this._maxRowHeight = 3 * i - t + 2 * N + 2), this._recreateCanvas();
        }
        destroy() {
        ...
        updateSource(e, t) {
          ...
          if (
            !(function (e, t) {
              ...
              if (H(i.p1, r.p1)) return !1;
              if (H(i.p2, r.p2)) return !1;
              if (
                i.dark !== r.dark ||
              ...
              return (
                !z(i.leftUserTime, r.leftUserTime) &&
                !z(i.rightUserTime, r.rightUserTime)
              );
            })(o, a)
          ) {
            const e = t();
        ...
        _effectiveState(e) {
          ...
          return {
            p1: Object.assign({}, p),
            p2: Object.assign({}, g),
            leftUserTime: p ? x.timeScale().indexToUserTime(p.index) : null,
            rightUserTime: g ? x.timeScale().indexToUserTime(g.index) : null,
            props: e.properties(),
            showBars: s,
            showTimeRange: o,
            showDistance: a,
        ...
        _repaintSource(e, t, i) {
          (i.points[0] = new r.Point(0, 0)),
            delete i.horzAlign,
            delete i.vertAlign;
          const { horizontalPixelRatio: s, verticalPixelRatio: o } =
            this._renderingInfo;
          (0, T.drawScaled)(this._ctx, s, o, () => {
            this._ctx.translate(0.5, this.topByRow(t) + 0.5),
              this._ctx.clearRect(0, 0, this._currentWidth, this._maxRowHeight);
            const r = new S(i, { widths: [] }).draw(
              this._ctx,
              this._renderingInfo,
            );
        ...
        _recreateCanvas() {
          ...
          const { horizontalPixelRatio: e, verticalPixelRatio: t } =
            this._renderingInfo;
          (this._canvas.width = this._currentWidth * e),
            (this._canvas.height =
              this._maxRowHeight * this._actualCapacity * t),
            (this._ctx = (0, n.ensureNotNull)(this._canvas.getContext("2d"))),
            (this._ctx.font = `${D}px ${C.CHART_FONT_FAMILY}`),
            this._sourcesToRow.clear(),
            this._rowsToSources.clear();
        }
      }
      ...
      !(function (e) {
        (e[(e.Offset = 8)] = "Offset"),
          ...
          (e[(e.LineSpacing = 16)] = "LineSpacing"),
          (e[(e.RectRadius = 4)] = "RectRadius"),
          (e[(e.TextPadding = 10)] = "TextPadding"),
          (e[(e.PaddingTopBottom = 13)] = "PaddingTopBottom"),
          (e[(e.PaddingLeftRight = 10)] = "PaddingLeftRight");
      })(W || (W = {})),
        (function (e) {
          (e.Background = "rgba(227,242,253,0.9)"), (e.Text = "#2A2E39");
        })(O || (O = {})),
        (function (e) {
          (e.Background = "rgba(67,70,81,0.9)"), (e.Text = "#F8F9FD");
        })(V || (V = {}));
      class Y extends F.InplaceTextLineSourcePaneView {
        constructor(e, t, i, n, r) {
          super(e, t, i, n, r),
            (this._renderer = new l.CompositeRenderer()),
        ...
        getCacheRects(e, t) {
          const i = this._createCacheIfRequired(e),
            ...
            h = a === I.StatsPosition.Auto ? I.StatsPosition.Center : a;
          let c = l[h].x + 10,
            u = l[h].y;
          const _ =
            ...
            (this._points[1].y > this._points[0].y &&
              this._points[1].x > this._points[0].x);
          _ ? (u -= 10 + d.height) : (u += 10);
          const { mediaSize: p } = e;
          a !== I.StatsPosition.Auto ||
            (0, r.equalPoints)(
              l[I.StatsPosition.Left],
              l[I.StatsPosition.Right],
            ) ||
            (c < 0 ? (c = 0) : c + d.width > p.width && (c = p.width - d.width),
            u < 0
              ? (u = 0)
              : u + d.height > p.height && (u = p.height - d.height),
            (0, s.intersectLineSegmentAndBox)(
              ...
              ((u = _ ? l[h].y + 10 : l[h].y - 10 - d.height),
              (c = Math.min(l[I.StatsPosition.Center].x, p.width) - d.width)));
          return {
            cacheRect: d,
            targetRect: {
              left: Math.floor(c),
        ...
        _createCacheIfRequired(e) {
          return (
            (null !== this._cache &&
              null !== this._renderingInfo &&
              (0, c.equalRenderingInfos)(e, this._renderingInfo)) ||
        ...
        _priceRange() {
          ...
          const [i, r] = this._source.points(),
            ...
            h = (0, n.ensureNotNull)(this._source.ownerSource());
          let c;
          if (this._source.priceScale() && (o || a || l)) {
            ...
            if (o || a) {
              ...
              if (a) {
                const e = (0, d.getPercentageFormatter)().format(100 * l);
                c.push(o ? `(${e})` : e);
              }
              n.push(c.join(" "));
            }
            const u = this._model.mainSeries().symbolInfo(),
              _ = u && (0, d.getPipFormatter)(u);
            l && _ && n.push(_.format(s)), (c = n.join(", "));
          }
          return c;
        }
        _statLabelData() {
            ...
            if (
              ...
              x &&
                ...
                (l += o
                  ...
                  .format({ count: (0, a.forceLTRStr)(String(u)) }))),
              f)
            ) {
              ...
              if (i && n) {
                const e = (n.valueOf() - i.valueOf()) / 1e3,
                  t = (0, a.startWithLTR)(new h.TimeSpanFormatter().format(e));
                t && (l += x ? " (" + t + ")" : t);
              }
            }
            v &&
              (l && (l += ", "),
              (l += o.t(null, void 0, i(44994)).format({
                number: (0, a.forceLTRStr)(
                  (0, d.getNumericFormatter)().format(Math.round(Number(p))),
                ),
              }))),
              l && s.push("barsRange");
          }
          if (T) {
            ...
            void 0 !== p &&
              p > 0 &&
              void 0 !== _ &&
              ((_ = _.normalized()), (e = Math.acos(_.x)), _.y > 0 && (e = -e)),
              "number" != typeof e ||
                isNaN(e) ||
                ((c = Math.round((180 * e) / Math.PI) + "º"), s.push("angle"));
          }
          this._label =
            [(0, a.forceLTRStr)(g), l, c].filter((e) => null != e).join("\n") ||
            null;
          const w = this._model.dark().value(),
            R = w ? "rgba(67,70,81,0.9)" : "rgba(227,242,253,0.9)",
            m = w ? "#F8F9FD" : "#2A2E39",
            y = {
    ...
    41123: (e, t, i) => {
      ...
      class _ extends c.LineSourcePaneView {
        ...
        _updateImpl(e) {
          super._updateImpl(e), (this._renderer = null);
          const [t, i, a, l] = this._points;
          let d, c, _;
          if (4 === this._points.length) {
            if (Math.abs(a.x - t.x) < 1 || Math.abs(l.x - i.x) < 1) return;
            let e = Math.min(t.x, i.x);
            (e = Math.min(e, a.x)), (e = Math.min(e, l.x));
            const n = (a.y - t.y) / (a.x - t.x),
              s = t.y + (e - t.x) * n,
              o = (l.y - i.y) / (l.x - i.x),
              h = i.y + (e - i.x) * o;
            if (Math.abs(n - o) < 1e-6) return;
            (c = new r.Point(e, s)), (_ = new r.Point(e, h));
            const u = (i.y - t.y + (t.x * n - i.x * o)) / (n - o);
            if (u < e) {
              let e = Math.max(t.x, i.x);
              (e = Math.max(e, a.x)),
                (e = Math.max(e, l.x)),
                (c = new r.Point(e, t.y + (e - t.x) * n)),
                (_ = new r.Point(e, i.y + (e - i.x) * o));
            }
            const p = t.y + (u - t.x) * n;
            d = new r.Point(u, p);
          }
          ...
          if (
            (this._trendLineRendererPoints01.setData(f(t, i)),
            g.append(this._trendLineRendererPoints01),
            this._points.length >= 3 &&
              (this._trendLineRendererPoints12.setData(f(i, a)),
              g.append(this._trendLineRendererPoints12)),
            4 === this._points.length &&
              (this._trendLineRendererPoints23.setData(f(a, l)),
              g.append(this._trendLineRendererPoints23),
              d))
          ) {
            const e = {
              points: [(0, n.ensureDefined)(c), (0, n.ensureDefined)(_), d],
              color: p.color.value(),
              linewidth: p.linewidth.value(),
              backcolor: p.backgroundColor.value(),
              fillBackground: p.fillBackground.value(),
    ...
    86448: (e, t, i) => {
      "use strict";
      var n = i(27916).LineSourcePaneView,
        r = i(95201).CompositeRenderer,
        s = i(1161).TriangleRenderer;
      t.TrianglePaneView = class extends n {
        ...
        _updateImpl(e) {
          ...
          (t.points = this._points),
            (t.color = this._source.properties().color.value()),
            (t.linewidth = this._source.properties().linewidth.value()),
            (t.backcolor = this._source.properties().backgroundColor.value()),
            (t.fillBackground = this._source
              .properties()
              .fillBackground.value()),
            (t.transparency = this._source.properties().transparency.value()),
            this._triangleRenderer.setData(t);
          var i = new r();
          i.append(this._triangleRenderer),
            this.addAnchors(i),
            (this._renderer = i);
        }
      };
    ...
    63307: (e, t, i) => {
      "use strict";
      i.r(t), i.d(t, { VertLinePaneView: () => p });
      var n = i(86441),
        r = i(95201),
        s = i(17330),
        o = i(72791),
      ...
      class p extends u.InplaceTextLineSourcePaneView {
        constructor(e, t, i, n, r, s) {
          super(e, t, n, r, s),
            ...
            (this._renderer = null),
            (this._pane = i),
            (this._labelRenderer = new _.LineToolTextRenderer(
              void 0,
              new c.HitTestResult(
                c.HitTarget.MovePoint,
                (0, u.inplaceEditHandlers)(
        ...
        additionalCursorData() {
          var e;
          const t = this._labelRenderer.getTextInfo();
          return {
            color: this._source.editableTextStyle().cursorColor,
        ...
        _updateImpl(e) {
          ...
          if (
            ...
            return;
          const {
              mediaSize: { width: a, height: u },
            } = e,
            _ = this._source.properties().childs(),
            p = new r.CompositeRenderer(),
            g = _.text.value(),
            x = this._isTextEditMode(),
            f = this._placeHolderMode();
          let v,
            T = !0,
            w = !1;
          if (1 === this._points.length) {
            const e = new n.Point(this._points[0].x, u / 2);
            this._addAlertRenderer(p, [e]);
          }
          if (
            this._source.model().paneForSource(this._source) === this._pane &&
            (((null === (t = _.showLabel) || void 0 === t
              ? void 0
              : t.value()) &&
              g) ||
              f ||
            ...
            if ("horizontal" === _.textOrientation.value()) {
              ...
              switch (
                ((e = -Math.PI / 2), (t = 0), _.horzLabelsAlign.value())
              ) {
                case "left":
                  o = "bottom";
                  break;
            ...
            this._labelRenderer.setData({
              ...
              this._needLabelExclusionPath(this._labelRenderer) &&
                (v =
                  null !==
                    (i = (0, s.getTextBoundaries)(this._labelRenderer, a, u)) &&
                  void 0 !== i
                    ? i
                    : void 0),
              (T = this._labelRenderer.isOutOfScreen(a, u)),
              T
                ? this.closeTextEditor()
                : this._updateInplaceText(this._labelRenderer.getTextInfo());
          }
          ...
          if (
            ...
            if (1 === this._points.length && !this._isTextEditMode()) {
              ...
              p.append(this.createLineAnchor({ points: e }, 0));
            }
            this._renderer = p;
          }
        }
    ...
    28081: (e, t, i) => {
      ...
      class o {
        ...
        draw(e, t) {
          ...
          const { horizontalPixelRatio: n, verticalPixelRatio: r } = t,
            s = this._cacheProvider.getCacheCanvas(t);
          e.drawImage(
            s,
    ...
    62317: (e, t, i) => {
      ...
      function f(e, t) {
        const [i, n] = t.points;
        return (
          t.extendleft || (e = x(e, i.x, n.x)),
          t.extendright || (e = x(e, n.x, i.x)),
          e
        );
      }
    },
        ...
        if (e.x === t.x) {
          ...
          if (null !== x && (0 !== x || p !== l))
            if (d > 0 && (e.y >= l || (i && e.y > t.y))) {
              const t =
                e.y >= l
                  ? Math.sqrt(Math.pow(e.x - x, 2) + Math.pow(e.y - l, 2)) % d
                  : d -
                    (Math.sqrt(Math.pow(e.x - x, 2) + Math.pow(e.y - l, 2)) %
                      d);
              (h = Math.cos(Math.atan(s)) * t),
                (c = s * h),
                u.push(new n.Point(x + Math.sign(s) * h, l + Math.sign(s) * c));
            } else u.push(new n.Point(x, l));
        }
    ...
    36036: (e, t, i) => {
      "use strict";
      i.d(t, { LineAnchorRenderer: () => w, anchor: () => p });
      var n = i(14314),
        r = i(86441),
        s = i(34026),
        o = i(50151),
      ...
      class _ extends r.Point {
        constructor(e) {
          super(e.x, e.y), (0, n.default)(this, this, e);
        }
      }
      function p(e) {
        return new _(e);
      ...
      function g(e, t, i, n) {
        const r = i + n / 2;
        (0, a.drawRoundRect)(e, t.x - r, t.y - r, 2 * r, 2 * r, (i + n) / 2),
          e.closePath(),
          (e.lineWidth = n);
      }
      function x(e, t, i, n) {
        (e.globalAlpha = 0.2), g(e, t, i, n), e.stroke(), (e.globalAlpha = 1);
      }
      function f(e, t, i, n) {
        g(e, t, i - n, n), e.fill(), e.stroke();
      }
      function v(e, t, i, n) {
        (e.globalAlpha = 0.2),
          e.beginPath(),
      ...
      class w extends u.BitmapCoordinatesPaneRenderer {
        constructor(e) {
          super(), (this._data = null != e ? e : null);
        }
        setData(e) {
        ...
        hitTest(e) {
          ...
          if (null === this._data || this._data.disableInteractions)
            return null;
          const { radius: n, points: r } = this._data,
            s = (0, c.interactionTolerance)().anchor;
          for (let o = 0; o < r.length; ++o) {
            const a = r[o];
            if (a.subtract(e).length() <= n + s)
              return new d.HitTestResult(
                null !== (t = a.hitTarget) && void 0 !== t
                  ? t
                  : d.HitTarget.ChangePoint,
                {
                  pointIndex: a.pointIndex,
                  cursorType:
                    null !== (i = a.cursorType) && void 0 !== i
                      ? i
                      : h.PaneCursorType.Default,
                  activeItem: a.activeItem,
                  snappingPrice: a.snappingPrice,
                  snappingIndex: a.snappingIndex,
                  nonDiscreteIndex: a.nonDiscreteIndex,
                  areaName: d.AreaName.AnchorPoint,
                  possibleMovingDirections: a.possibleMovingDirections,
                },
              );
          }
          return null;
        ...
        doesIntersectWithBox(e) {
          return (
            null !== this._data &&
            this._data.points.some((t) => (0, s.pointInBox)(t, e))
          );
        }
        _drawImpl(e) {
          ...
          t.length && this._drawPoints(e, t, i, f, x),
            n.length && this._drawPoints(e, n, r, T, v);
        }
        _drawPoints(e, t, i, n, r) {
          const {
            ...
            u = h.radius;
          let _ = Math.max(1, Math.floor((h.strokeWidth || 2) * a));
          h.selected && (_ += Math.max(1, Math.floor(a / 2)));
          const g = Math.max(1, Math.floor(a));
          let x = Math.round(u * a * 2);
          x % 2 != g % 2 && (x += 1);
          const f = (g % 2) / 2,
            v = (0, c.interactionTolerance)().anchor;
            ...
            if (
              ...
              if (
                (n(
                  ...
                  p({
                    ...o,
                    x: Math.round(o.x * a) + f,
                    y: Math.round(o.y * d) + f,
                  }),
                  x / 2,
                  _,
                ),
                ...
                if (o.subtract(h.currentPoint).length() <= u + v) {
    ...
    90241: (e, t, i) => {
      "use strict";
      i.d(t, { ParallelChannelRenderer: () => g });
      ...
      class g extends u.MediaCoordinatesPaneRenderer {
        constructor(e, t) {
          super(),
            ...
            (this._hittestResult =
              e || new h.HitTestResult(h.HitTarget.MovePoint)),
            (this._backHittestResult =
              t || new h.HitTestResult(h.HitTarget.MovePointBackground));
        }
        setData(e) {
          (this._data = e),
            (this._backgroundPolygon = null),
        ...
        hitTest(e, t) {
          ...
          const { line1: i, line2: n, middleLine: r } = this._data,
            s = t.mediaSize,
            a = (0, c.interactionTolerance)().line;
        ...
        _getClippedLine(e, t, i) {
          ...
          if (void 0 === n) {
            const { lineWidth: r, lineStyle: o, points: a } = e,
              ...
              h = (0, p.intersectLineWithViewport)(
                a[0],
                a[1],
                l,
                d,
        ...
        _getBackgroundPolygonImpl(e, t) {
          ...
          return (
            (o = x(o, i, n, s)),
            e.extendRight || (o = x(o, n, s, r)),
            (o = x(o, s, r, i)),
            e.extendLeft || (o = x(o, r, i, n)),
            o
          );
        }
      }
    ...
    13075: (e, t, i) => {
      ...
      class r {
        ...
        static instance() {
          ...
          return (
            (this._instance =
              null !== (e = this._instance) && void 0 !== e ? e : new r()),
            this._instance
          );
        }
      }
    ...
    1161: (e, t, i) => {
      ...
      class _ extends o.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          const _ = [],
            p = i.getLineDash().reduce((e, t) => e + t, 0);
          [
            [s, o],
            [o, a],
            [a, s],
