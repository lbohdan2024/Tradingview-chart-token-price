(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [361],
  {
    ...
    27317: (e, t, n) => {
        ...
        constructor(e) {
          super(e),
            ...
            (this._handleMeasure = ({
              ...
              var n, o, s, i, a, u, c, d, h, p, m, f;
              if (this.state.isMeasureValid && !t) return;
              const { position: v } = this.props,
                _ = (0, r.ensureNotNull)(this._containerRef);
              ...
              const { width: S, height: W } = g,
                ...
                w =
                  null !==
                    (s =
                      null === (o = null == R ? void 0 : R.indentFromWindow) ||
                      void 0 === o
                        ? void 0
                        : o.left) && void 0 !== s
                    ? s
                ...
                E =
                  b -
                  (null !== (i = R.overrideWidth) && void 0 !== i ? i : S) -
                  (null !==
                    (u =
                      null === (a = null == R ? void 0 : R.indentFromWindow) ||
                      void 0 === a
                        ? void 0
                        : a.right) && void 0 !== u
                    ? u
                    : 0),
                O = (0, l.clamp)(R.x, w, Math.max(w, E)),
                N =
                  (null !==
                    (d =
                      null === (c = null == R ? void 0 : R.indentFromWindow) ||
                      void 0 === c
                        ? void 0
                        : c.top) && void 0 !== d
                    ? d
                ...
                D =
                  C -
                  (null !== (h = R.overrideHeight) && void 0 !== h ? h : W) -
                  (null !==
                    (m =
                      null === (p = null == R ? void 0 : R.indentFromWindow) ||
                      void 0 === p
                        ? void 0
                        : p.bottom) && void 0 !== m
                    ? m
                    : 0);
              let P = (0, l.clamp)(R.y, N, Math.max(N, D));
              if (
                (R.forbidCorrectYCoord &&
                  P < R.y &&
                  ((x -= R.y - P), (P = R.y)),
                t &&
                  void 0 !== this.props.closeOnScrollOutsideOffset &&
                  R.y <= this.props.closeOnScrollOutsideOffset)
              )
                return void this._handleGlobalClose(!0);
              const k =
                null !== (f = R.overrideHeight) && void 0 !== f
                  ? f
                  : y
                    ? x
                    : void 0;
              this.setState(
                {
                  appearingMenuHeight: t ? this.state.appearingMenuHeight : k,
              ...
              o.createElement(
                ...
                o.createElement(
                  "div",
                  {
                    ...
                    "aria-describedby": c,
                    "aria-invalid": d,
                    className: i()(g, _.menuWrap, !O && _.isMeasuring),
                    style: {
                      height: R,
                      left: E && E.x,
                      minWidth: v,
                  ...
                  o.createElement(
                    ...
                    o.createElement(C, { className: _.menuBox }, h),
                  ),
                ),
              ),
              o.createElement(u.Slot, { reference: this._handleSlot }),
            ),
          );
        }
        update(e) {
      ...
      function C(e) {
        const t = (0, r.ensureNotNull)((0, o.useContext)(p.SubmenuContext)),
          n = o.useRef(null);
        return o.createElement(
          "div",
          {
    ...
    20520: (e, t, n) => {
      ...
      function h(e) {
        const {
          ...
          b = (0, o.useContext)(a.CloseDelegateContext),
          M = o.useContext(d),
          x = (0, o.useContext)(u),
              ...
              o.createElement(
                ...
                o.createElement(
                  l.Menu,
                  {
                    ...
                    ref: t,
                    "data-name": g,
                    limitMaxWidth: M.setMenuMaxWidth,
                  },
                  n,
                ),
              ),
