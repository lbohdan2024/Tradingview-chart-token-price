...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    57717: (e, t, i) => {
      i.r(t), i.d(t, { createPropertyPage: () => n });
      var r = i(64147);
    ...
    52305: (e, t, i) => {
      ...
      function s(e) {
        const t = new r.LimitedPrecisionNumericFormatter(e, !0);
        return (e) => {
          if (null === e) return e;
    ...
    23351: (e, t, i) => {
        ...
        const r = new Map(),
          ...
          s = {
            ...
            subscribe: (t, i) => {
              ...
              r.set(i, n), e.subscribe(t, n);
            },
            unsubscribe: (t, i) => {
              const n = r.get(i);
              n && (e.unsubscribe(t, n), r.delete(i));
            },
            unsubscribeAll: (t) => {
      ...
      function o(e, t, i, o, s, p, l) {
        const c = n(t.weakReference(), o, p),
          a = void 0 !== o ? (void 0 !== o[1] ? o[1] : o[0]) : (e) => e,
          u = null != s ? s : (r) => e.setProperty(t, a(r), i);
        return (
          (c.setValue = (e) => {
            var t;
            l &&
    ...
    59411: (e, t, i) => {
      ...
      function l(e, t) {
        ...
        return (
          void 0 !== i.properties.style && (i.styleValues = o),
    ...
    4116: (e, t, i) => {
      ...
      i.d(t, {
        ...
        convertFromWVToDefinitionProperty: () => G,
        convertToDefinitionProperty: () => Y.convertToDefinitionProperty,
        ...
        createEmojiPropertyDefinition: () => z,
        createLeveledLinePropertyDefinition: () => a,
        createLinePropertyDefinition: () => s.createLinePropertyDefinition,
        createNumberPropertyDefinition: () => d,
        createOptionalTwoColorsPropertyDefinition: () => E,
        createOptionsPropertyDefinition: () =>
          f.createOptionsPropertyDefinition,
        createPropertyDefinitionsCheckableListOptionsGroup: () => H,
        createPropertyDefinitionsGeneralGroup: () => N,
        createPropertyDefinitionsLeveledLinesGroup: () => _,
        createRangePropertyDefinition: () => O,
        createSelectionCoordinatesPropertyDefinition: () => C,
        createSessionPropertyDefinition: () => x,
        createStudyInputsPropertyDefinition: () => W,
        createSymbolPropertyDefinition: () => A,
        createTextPropertyDefinition: () => S,
        createTransparencyPropertyDefinition: () => R,
        createTwoColorsPropertyDefinition: () => V,
        createTwoOptionsPropertyDefinition: () => y,
        destroyDefinitions: () => pe,
        ...
        isCheckableListOptionsDefinition: () => se,
        isColorDefinition: () => re,
        isLineDefinition: () => ie,
        isOptionsDefinition: () => oe,
        isPropertyDefinition: () => ee,
        isPropertyDefinitionsGroup: () => te,
        isTwoColorDefinition: () => ne,
        makeProxyDefinitionProperty: () => Y.makeProxyDefinitionProperty,
      });
      var s = i(59411),
        p = i(51056);
      ...
      function a(e, t) {
        ...
        return (
          ...
          void 0 !== i.properties.width && (i.widthValues = c),
          i
        );
      }
      var u;
      ...
      const T = [
          { id: "bottom", value: "bottom", title: D.t(null, void 0, i(97118)) },
          { id: "middle", value: "middle", title: D.t(null, void 0, i(68833)) },
          { id: "top", value: "top", title: D.t(null, void 0, i(27567)) },
        ],
        m = [
          { id: "left", value: "left", title: D.t(null, void 0, i(11626)) },
          { id: "center", value: "center", title: D.t(null, void 0, i(24197)) },
          { id: "right", value: "right", title: D.t(null, void 0, i(50421)) },
        ],
        g = [
          {
            id: "horizontal",
            value: "horizontal",
            title: D.t(null, void 0, i(95406)),
          },
          {
            id: "vertical",
            value: "vertical",
            title: D.t(null, void 0, i(69526)),
          },
        ],
        ...
        w = [1, 2, 3, 4],
        L = D.t(null, void 0, i(25485)),
        k = D.t(null, void 0, i(67781));
      function S(e, t) {
        const i = {
          propType: "text",
          properties: e,
      ...
      function N(e, t, i, r) {
        return {
          ...
          visible: r,
          groupType: "general",
          definitions: new M.WatchedValue(e),
        };
      }
      function H(e, t, i, r, n) {
        return {
          ...
          definitions: new M.WatchedValue(t),
      ...
      function F(e, t, i) {
        const r = new Map(),
          ...
          s = {
            ...
            setValue: (t) => {
              var i;
              null === (i = e.setValue) || void 0 === i || i.call(e, o(t));
            },
            subscribe: (t, i) => {
              const n = () => {
                i(s);
            ...
            unsubscribe: (t, i) => {
              ...
              if (void 0 !== n) {
                const t = n.get(i);
                void 0 !== t && (e.unsubscribe(t), n.delete(i));
              }
            },
            unsubscribeAll: (t) => {
              const i = r.get(t);
      ...
      function G(e, t, i, r) {
        ...
        return (n.setValue = (r) => e.setWatchedValue(t, o(r), i)), n;
      }
      function j(e, t) {
        return (function (e, t, i, r) {
          const n = new Map(),
            o = {
              subscribe: (i, r) => {
                const o = (e) => i(t(e));
                n.set(i, o), e.subscribe(o, r);
              },
              unsubscribe: (t) => {
                if (t) {
                  const i = n.get(t);
                  i && (e.unsubscribe(i), n.delete(t));
      ...
      function U(e, t) {
        const i = (0, Y.makeProxyDefinitionProperty)(t.weakReference());
        return (i.setValue = (t) => e.setPriceScaleSelectionStrategy(t)), i;
      }
      function B(e, t, i, r) {
        const n = (0, Y.makeProxyDefinitionProperty)(t.weakReference());
        return (
          (n.setValue = (t) => {
            const n = { lockScale: t };
            e.setPriceScaleMode(n, i, r);
          }),
          n
        );
      }
      function q(e, t, i, r) {
        const n = (0, Y.makeProxyDefinitionProperty)(t.weakReference(), r);
        return (
          (n.setValue = (r) => {
      ...
      function X(e, t) {
        if ((0, K.isHexColor)(e)) {
          const i = (0, J.parseRgb)(e);
          return (0, J.rgbaToString)((0, J.rgba)(i, (100 - t) / 100));
        }
        return e;
      }
      function Z(e, t, i, r, n) {
        let o;
        if (null !== i) {
          const e = (0, Q.combineProperty)(
            X,
            t.weakReference(),
            i.weakReference(),
          );
          o = (0, Y.makeProxyDefinitionProperty)(e.ownership());
        } else
          o = (0, Y.makeProxyDefinitionProperty)(t.weakReference(), [
            () => X(t.value(), 0),
            (e) => e,
          ]);
        return (
          (o.setValue = (i) => {
            n && e.beginUndoMacro(r),
              e.setProperty(t, i, r),
              n && e.endUndoMacro();
          }),
          o
      ...
      function $(e, t, i, r, n, o) {
        ...
        var p, l;
        const c = (0, Y.convertToDefinitionProperty)(e, t, n, s);
        o && (c.setValue = o);
        const a = new Map();
        (c.subscribe = (e, i) => {
          const r = (e) => {
          ...
          a.set(i, r), t.subscribe(e, r);
        }),
          (c.unsubscribe = (e, i) => {
            const r = a.get(i);
            r && (t.unsubscribe(e, r), a.delete(i));
          });
        const u = {};
        return (
          r.subscribe(u, () => {
