(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4804],
  {
    ...
    94720: (e, t, n) => {
      ...
      function f(e) {
        const {
          ...
          })((0, d.getGroupCellRemoveRoundBorders)(h));
        return u(
          c,
          m().button,
          m()[n],
          ...
          b,
          p && m().grouped,
          p && !f && m().adjustPosition,
          p && h.isTop && m().firstRow,
          p && h.isLeft && m().firstCol,
          y && v && m().multilineContent,
          w && m().link,
          g,
        );
      }
      function y(e) {
        ...
        return c.createElement(
          ...
          s && c.createElement("span", { className: m().content }, s),
          o &&
            !r &&
            c.createElement(p.Icon, { icon: o, className: m().endIconWrap }),
          d &&
            (function (e) {
              return (
                e.primaryText &&
      ...
      function R(e) {
        const { reference: t, tooltipText: n, ...r } = e,
          ...
          } = (0, c.useContext)(w.ControlGroupContext),
          a = f({
            ...r,
            isGrouped: s,
            cellState: o,
            ...
            "data-overflow-tooltip-text":
              null != n
                ...
                : e.primaryText
                  ...
                  : (0, v.getTextForTooltip)(e.children),
          },
          c.createElement(y, { ...r }),
        );
      }
    ...
    64388: (e, t, n) => {
      ...
      function l(e) {
        ...
        return r.createElement(
          r.Fragment,
          null,
          r.createElement("span", { className: i.background }),
          r.createElement(o.Icon, {
            icon: n,
            className: i.icon,
            "aria-hidden": !0,
          }),
          t && r.createElement("span", { className: i["visually-hidden"] }, t),
        );
      }
      ...
      var u = n(21593),
        d = n(53017);
      (0, r.forwardRef)((e, t) => {
        const { icon: n, renderComponent: s, "aria-label": o, ...i } = e,
    ...
    67029: (e, t, n) => {
      "use strict";
      n.d(t, { ControlSkeleton: () => v, InputClasses: () => g });
      var r = n(50959),
        s = n(97754),
        o = n(50151),
        i = n(38528),
      ...
      function p(e) {
        ...
        return (
          0 !== e &&
            (1 & e && (t = s(t, d()["no-corner-top-left"])),
            2 & e && (t = s(t, d()["no-corner-top-right"])),
            4 & e && (t = s(t, d()["no-corner-bottom-right"])),
            8 & e && (t = s(t, d()["no-corner-bottom-left"]))),
          t
        );
      }
      function h(e, t, n, r) {
        const {
          ...
          w = p(null != o ? o : (0, c.getGroupCellRemoveRoundBorders)(n));
        return s(
          d().container,
          d()[`container-${u}`],
          d()[`intent-${a}`],
      ...
      function m(e, t, n) {
        ...
        const i = p(null != o ? o : (0, c.getGroupCellRemoveRoundBorders)(t));
        return s(d().highlight, d().shown, d()[`size-${n}`], i);
      }
      const g = {
      ...
      function y(e, t) {
        const {
          ...
          z = (function (e, t = null, n) {
            const s = (0, r.useRef)(null),
              o = (0, r.useRef)(null),
              i = (0, r.useCallback)(() => {
                if (null === s.current || null === o.current) return;
                const [e, t, n] = o.current;
                null !== t && s.current.addEventListener(e, t, n);
              }, []),
              a = (0, r.useCallback)(() => {
                if (null === s.current || null === o.current) return;
                const [e, t, n] = o.current;
                null !== t && s.current.removeEventListener(e, t, n);
              }, []),
              l = (0, r.useCallback)((e) => {
                a(), (s.current = e), i();
              }, []);
        ...
        return r.createElement(
          ...
          R,
          x,
          r.createElement("span", { className: m(e, _, S) }),
        );
      }
    ...
    78274: (e, t, n) => {
      ...
      function l(e) {
        ...
        return r.createElement(
          "span",
          { className: s(i()["inner-slot"], i()["inner-middle-slot"], t) },
          n,
        );
      }
      function c(e) {
    ...
    31261: (e, t, n) => {
      ...
      function v(e) {
        ...
        const {
          ...
          P = (0, i.createSafeMulticastEventHandler)(
            w.onFocus,
            function (e) {
              n && !R.current && (0, a.selectAllContent)(e.currentTarget);
            },
            o,
          ),
          S = (0, i.createSafeMulticastEventHandler)(w.onBlur, p),
          E = (0, r.useCallback)(
            (e) => {
              (g.current = e),
                h &&
    ...
    48027: (e, t, n) => {
      ...
      function o(e) {
        const {
          ...
          [l, c] = (0, s.useFocus)(void 0, a),
          u = (0, r.createSafeMulticastEventHandler)(a ? void 0 : c.onFocus, t),
          d = (0, r.createSafeMulticastEventHandler)(a ? void 0 : c.onBlur, n);
        return {
          ...e,
    ...
    26996: (e, t, n) => {
      ...
      function l(e) {
        ...
        return s.createElement(
          "span",
          { className: o(a().loader, r && a().static, t) },
      ...
      class m extends o.PureComponent {
        constructor(e) {
          if (
            ...
            (this._handleKeyDown = (e) => {
              ...
              switch (e.which) {
                ...
                case r.UpArrow:
                  ...
                  if (!a && u.length && e.which === r.DownArrow) {
                  ...
                  if (void 0 === i) {
                    ...
                    d = 0;
                  } else d = u.indexOf(i) + (e.which === r.UpArrow ? -1 : 1);
                  d < 0 && (d = 0), d > u.length - 1 && (d = u.length - 1);
                  const p = u[d];
                  this.setState({ active: p });
                  const h = document.getElementById(p);
                  h && this._scrollIfNotVisible(h, this._suggestionsElement);
                  break;
                case r.Escape:
                ...
                case r.Enter:
                  let m = i;
                  t &&
                    (a && m ? this.setState(this._valueToQuery(m)) : (m = l)),
                    void 0 !== m &&
                      (this._close(),
                      a || this._blur(),
                      m !== n
            ...
            (this._scrollIfNotVisible = (e, t) => {
              const n = t.scrollTop,
                ...
                s = e.offsetTop,
                o = s + e.clientHeight;
              s <= n ? e.scrollIntoView(!0) : o >= r && e.scrollIntoView(!1);
            }),
          ...
          this.state = {
            ...
            active: e.value,
            queryValue:
              g(e.source)[e.value] || (e.allowUserDefinedValues ? e.value : ""),
          };
        }
        componentDidMount() {
          this.props.suggestionsInPortal &&
          ...
          return o.createElement(
            ...
            (e) =>
              o.createElement(
                "div",
                {
                  className: i(p.autocomplete, "js-dialog-skip-escape"),
                  ref: e,
                },
        ...
        static getDerivedStateFromProps(e, t) {
          const { allowUserDefinedValues: n, value: r, source: s } = e;
          if (r === t.valueFromProps && t.isOpened) return null;
          const o = n ? r : "" === r ? "" : g(s)[r] || t.queryValue;
          return { ...t, valueFromProps: r, active: r, queryValue: o };
        }
        _renderSuggestions() {
        ...
        _suggestions(e) {
          const { filter: t = h } = this.props,
            n = g(this.props.source),
            r = {};
          return (
            Object.keys(n)
              .filter((r) => t(e, n[r]))
        ...
        _renderSuggestionsItems() {
          const e = this._suggestions(this.state.queryValue),
            t = Object.keys(e).map((t) => {
              const n = i(p.suggestion, this.state.active === t && p.selected);
              return o.createElement(
                "li",
          ...
          return o.createElement(
            "ul",
            {
              className: i(p.suggestions, this.state.isOpened && p.opened),
        ...
        _getActiveKeyByValue(e) {
          const { filter: t = h } = this.props,
            ...
            r = Object.keys(n);
          for (const s of r) if (t(e, n[s])) return s;
          return r[0];
        }
        _valueToQuery(e) {
    ...
    50655: (e, t, n) => {
      "use strict";
      n.d(t, { Slot: () => r.Slot, SlotContext: () => r.SlotContext });
      var r = n(99663);
    },
    10381: (e, t, n) => {
      "use strict";
      ...
      function l(e) {
        ...
        return r.createElement(o.Icon, {
          className: s(n, i.icon, { [i.dropped]: t }),
          icon: a,
        });
      }
    },
