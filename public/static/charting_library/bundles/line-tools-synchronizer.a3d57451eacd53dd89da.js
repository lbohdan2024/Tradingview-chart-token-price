  ...
  [7129, 5565],
  {
    ...
    49053: (e, t, i) => {
      ...
      var o = i(12481),
        ...
        r = i(53822),
        l = i(54814),
        a = s.default ? s.default.isConcatSpreadable : void 0;
      const d = function (e) {
        return (0, l.default)(e) || (0, r.default)(e) || !!(a && e && e[a]);
      };
      const h = function e(t, i, o, s, r) {
        var l = -1,
          a = t.length;
        for (o || (o = d), r || (r = []); ++l < a; ) {
          var h = t[l];
      ...
      class m {
        ...
        resolveLinkKey(e, t, i) {
          ...
          const n = (function (e, t) {
            ...
            s =
              null !== (o = this._pendingRequests.get(n)) && void 0 !== o
                ? o
                : new Map();
          if (s.has(t)) return s.get(t).promise;
          const r = (0, y.createDeferredPromise)();
          return (
            s.set(t, r),
            this._pendingRequests.set(n, s),
          ...
          try {
            ...
            null !== t &&
              ...
              (t.sources.forEach((e, t) => {
                ...
                if (!i) return;
                const o = n.get(i);
                null == o || o.resolve(e.id), n.delete(i);
              }),
              t.serverRequestId &&
      ...
      class w extends I.StudyStub {
        constructor(e, t, i) {
          ...
          super(e, { ...t, ownFirstValue: null }, i),
            (this._linkKey = new b.WatchedValue(
              null !== (o = t.linkKey) && void 0 !== o ? o : null,
            ));
        }
        linkKey() {
      ...
      function N(e, t, i) {
        const o = new Map(),
          n = new Set(null == i ? void 0 : i.keys());
        return (
          e.forEach((e, s) => {
            const r = !i || i.has(s);
            (e.timestamp > t || !r) && (o.set(s, e), n.delete(s));
          }),
          { stillInvalidated: o, validated: Array.from(n) }
        );
      }
      var R;
      function q(e) {
      ...
      class V {
        constructor(e, t, i) {
          (this._invalidatedLineToolsAndStudyStubs = new Map()),
            ...
            (this._brokerName = ""),
            (this._hasChanges = new b.WatchedValue(!1)),
        ...
        getDTO(e = 0, t = !1, i = !1) {
          return i && this.invalidateAll(), this._prepareDTOItem(t, e);
        }
        ...
        resetInvalidated(e, t, i) {
          const o = (e, t, o, n) => {
            if (!o.has(n) || o.get(n)) o.has(n) && t(n, i);
            else {
              const o = e.get(n);
              o && (o === i ? t(n, null) : 0 === i && t(n, o));
            }
          };
          ...
          const {
            ...
            a = N(
              ...
              e,
              new Set(null != r ? r : s.keys()),
            );
          (this._invalidatedLineToolsAndStudyStubs = a.stillInvalidated),
            a.validated.forEach(
              o.bind(
                this,
        ...
        applyLineToolUpdateNotification(e, t) {
          ...
          (o.clientId === this._origin.clientId &&
            ...
            (void 0 !== e.symbol && null === e.sources
              ...
              : this._applyLineToolsAndGroupsDTO(e, t, o));
        }
        ...
        async markSyncedLineToolAsDeleted(e, t) {
          if (this._linkKeyResolver) {
            ...
            if (null !== i) {
              const t = (0, S.lineToolByLinkKey)(this._chartModel, e);
              null === t
        ...
        _processDataSourceCollectionChanged(e) {
          ...
          if (this._allLineToolsAndStudyStubs.has(e.id())) {
            ...
            (n = t.filter((e) => !i.has(e.id()))),
              n.forEach((e) => this._invalidateLineToolOrStudyStub(e.id(), s)),
              Array.from(i.entries())
                .filter((e) => !o.has(e[0]))
                .forEach((e) => {
                  null !== e[1] && this._debouncedSave(),
                    this._invalidateLineToolOrStudyStub(e[0], s);
                });
          } else
            (n = t),
              t.forEach((e) => this._invalidateLineToolOrStudyStub(e.id(), s));
          n.forEach((e) => {
            if ((0, S.isLineTool)(e)) {
        ...
        _unloadLineTools(e, t, i) {
          ...
          this._withoutInvalidating(() => {
            o.forEach((e) => {
              ...
              const i = (0, c.ensureNotNull)(this._chartModel.paneForSource(e));
              this._chartModel.removeSource(e);
              (null !== (t = this._allLineToolsAndStudyStubs.get(i.id())) &&
              void 0 !== t
                ? t
                : new Map()
              ).delete(e.id());
        ...
        _unloadLinesOnSeries(e, t, i) {
          ...
          const n = Array.from(i.keys()).filter((t) => !e(t));
          ...
          const o = this.prepareDTO(e),
            n = k
              .map((e) => {
                var t, n;
                const s = o.get(e);
                if (!s || null === s.sources) return null;
                const r =
                    null !== (t = s.lineToolsToValidate) && void 0 !== t
                      ? t
                      : Array.from(s.sources.keys()),
                  l =
                    null !== (n = s.groupsToValidate) && void 0 !== n
                      ? n
                      : Array.from(s.groups.keys());
                if (0 === r.length && 0 === l.length) return null;
                const a = performance.now();
                if (s.sources.size || s.groups.size) {
                  const t = this._savingAbortControllersBySharingMode.get(e);
                  t && t.abort();
                  const o = new AbortController();
                  return (
                    this._savingAbortControllersBySharingMode.set(e, o),
                    s.sources.forEach((t, i) => {
                      t && this._setOriginalLineToolSharingMode(i, e);
                    }),
                    (0, c.ensureNotNull)(this._saveChartService)
                      .saveChartLineTools(this._origin.chartId, s, e, o.signal)
                      .then(() => {
                        this.resetInvalidated(a, s, e);
                      })
                      .catch(async (t) => {
                ...
                return this.resetInvalidated(a, s, e), null;
              })
              .filter(T.notNull);
        ...
        async _savePromise(e, t) {
          ...
          return this._isAutosaveEnabled()
            ? null !==
                (o =
                  null === (i = this._debouncedSave) || void 0 === i
                    ? void 0
                    : i.flush()) && void 0 !== o
              ? o
              : Promise.resolve()
        ...
        async _makeLoadRequestAndMerge(e, t, i) {
          var o;
          const n = this._chartModel.mainSeries(),
            s =
              null !== (o = this._currentlyLoadedSymbol.get(e.sharingMode)) &&
              void 0 !== o
                ? o
                : "";
          if (!!n.symbolSameAsCurrent(s)) return;
        ...
        _restoreGroups(e, t, i, o) {
          const n = new Map();
          return (
            (t.groups || new Map()).forEach((t, s) => {
              const r = this._chartModel.lineToolsGroupModel().groupForId(s);
              if (null === t) {
                if (r) {
                  const e =
                    o &&
                  ...
                  r.lineTools()[0].sharingMode().value() === i &&
                    ((e && 0 !== i) ||
                      ...
                      this._setOriginalLineToolGroupsSharingMode(s, null)));
                }
              } else {
                ...
                this._setOriginalLineToolGroupsSharingMode(s, i);
              }
            }),
            n
          );
        ...
        _restoreLineTool(e, t, i, o) {
          var n;
          if (
            (null !== (n = t.state.points) && void 0 !== n ? n : []).some(
              (e) => !(0, T.isNumber)(e.time_t),
            )
          )
            return null;
          ...
          if (
            (null === s &&
              t.state.linkKey &&
              (s = (0, S.lineToolByLinkKey)(this._chartModel, t.state.linkKey)),
            null !== s && !(0, S.isLineTool)(s))
          )
            return null;
          if (this._origin.clientId === (null == o ? void 0 : o.clientId) && !s)
            return null;
          if (s && t.serverUpdateTime) {
            ...
            this._origin.clientId !== (null == o ? void 0 : o.clientId) &&
          ...
          let l = s || this._createNewLineTool(t);
          if (
            l &&
            (r &&
              this._invalidateLineToolOrStudyStub(t.id, performance.now(), !0),
            t.serverUpdateTime && l.setServerUpdateTime(t.serverUpdateTime),
            this._restoreLineToolAlert(l, t.state.alertId),
            0 !== i && l.share(i),
            void 0 === o && (0, S.isEditableTextLineTool)(l))
          ) {
            this._removeTextLineToolIfEmpty(l) && (l = null);
          }
          return l;
        }
        ...
        async _applyLineToolsAndGroupsDTO(e, t, i) {
          const o = this._chartModel.chartSaveTime(),
            n = this._withoutInvalidating(() =>
              this._restoreGroups(o, e, t, i),
            ),
            s = `ChartStorage.Synchronizer.ApplyingDTO.${`${this._origin.layoutId}.${this._origin.chartId}`}`,
            r = new Set();
          (e.sources || new Map()).forEach((e) => {
            e && r.add(e.state.type);
          }),
            await Promise.all(Array.from(r).map((e) => (0, S.initLineTool)(e))),
            (0, g.perfMeasureOperation)(s, () =>
              this._withoutInvalidating(() => {
                (e.sources || new Map()).forEach((e, s) => {
                  try {
                    ...
                    this._restoreLineDTO(e, s, n, o, t, i);
                  } catch (e) {
                    G.logError(`Error restoring line tool ${s}: ${e}`);
                  }
                }),
        ...
        _invalidateLineToolOrStudyStub(e, t, i) {
          ...
          const n =
              null === (o = this._invalidatedLineToolsAndStudyStubs.get(e)) ||
              void 0 === o
                ? void 0
                : o.invalidatedViaSyncOnly,
            s = (void 0 === n || n) && this.invalidateViaSync();
        ...
        _prepareDTOItem(e, t) {
          const i = new Map(),
            ...
            s = [];
          return (
            this._invalidatedLineToolsAndStudyStubs.forEach((s, r) => {
              if (0 !== t && s.invalidatedViaSyncOnly) return void n.push(r);
              const l = this._chartModel.dataSourceForId(r);
              if (!A(l))
                if (null === l) {
                  this._originalLineToolSharingMode.get(r) === t &&
                    i.set(r, null);
                } else {
                  if (
                  ...
                  if (s) {
                    ...
                    if (a)
                      i.set(
                        ...
                        null !== e && o.set(e.id, D(e, this._chartModel));
                    else {
                      const n = this._originalLineToolSharingMode.get(r);
                      n === t && i.set(r, null),
                        null !== e && n === t && o.set(e.id, null);
                    }
                  }
                }
            }),
            this._invalidatedLineToolGroups.forEach((e, i) => {
              if (0 !== t && e.invalidatedViaSyncOnly) s.push(i);
              else if (!o.has(i)) {
            ...
            }),
            {
              ...
              groupsToValidate: Array.from(o.keys()).concat(s),
            }
          );
        }
        ...
        _loadAndMergeLineToolsOnStudies(e, t) {
          ...
          this._makeLoadRequestAndMerge(i, (i) => {
            const n = t
              ...
              : [];
            this._unloadLineTools(n, (e) => e.ownerSource() !== o, e);
          });
        }
        _loadAndMergeLineToolsWithoutSymbol(e, t) {
          const i = {
            ...
            o = this._chartModel.mainSeries(),
            n = (0, c.ensureNotNull)(this._chartModel.paneForSource(o)),
            s = this._allLineToolsAndStudyStubs.get(n.id());
          this._makeLoadRequestAndMerge(i, (i) => {
            const n = t && s ? Array.from(s.keys()).filter((e) => !i(e)) : [];
            this._unloadLineTools(
              n,
              (e) => !e.boundToSymbol() && e.ownerSource() === o,
              e,
