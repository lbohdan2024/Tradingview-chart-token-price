  ...
  [9039],
  {
                ...
                (i = [].concat(t(i), [p])),
                  ...
                  (e.ontouchmove = function (t) {
                    ...
                    1 === t.targetTouches.length &&
                      ((n = e),
                      (i = (o = t).targetTouches[0].clientY - s),
                      !u(o.target) &&
                        ((n && 0 === n.scrollTop && 0 < i) ||
                        ((r = n) &&
    ...
    9038: (e, t, o) => {
      ...
      var n = o(50959),
        ...
        l = o(27011),
        s = o(86332);
      const a = n.createContext({ isInButtonGroup: !1, isGroupPrimary: !1 }),
        c = (e, t, o) => {
          const c = (0, n.useContext)(i.CustomBehaviourContext),
            {
              className: u,
              isSelected: d,
              children: p,
              ...
              variant: g = "primary",
              size: y = "medium",
              enableActiveStateStyles: w = c.enableActiveStateStyles,
              typography: b,
              isLink: x = !1,
              textWrap: C,
              isPills: E,
            ...
            _ = (0, n.useContext)(s.ControlGroupContext),
            { isInButtonGroup: B, isGroupPrimary: N } = (0, n.useContext)(a);
          return r(
            u,
            e.lightButton,
            x && e.link,
            S && e.active,
            d && e.selected,
            (0, l.isIconOnly)(p, v) && e.noContent,
            !!k && e.withStartSlot,
            (m || !!T) && e.withEndSlot,
            o && e.withGrouped,
            h && e[h],
            ...
            e[y],
            O,
            !w && e.disableActiveStateStyles,
            _.isGrouped && e.grouped,
            C && e.wrap,
    ...
    66860: (e, t, o) => {
      ...
      function d(e) {
        ...
        return n.createElement(
            ...
            n.createElement(
              "span",
              {
                ...
                "data-overflow-tooltip-text":
                  null != p ? p : (0, i.getTextForTooltip)(m),
              },
              d || c
                ? n.createElement(
                    n.Fragment,
          ...
          h &&
            n.createElement("span", { className: r(u().slot, u().endSlot) }, h),
          t &&
            ((e) =>
    ...
    67961: (e, t, o) => {
      "use strict";
      o.d(t, { OverlapManager: () => i, getRootOverlapManager: () => s });
      var n = o(50151);
      class r {
        constructor() {
          this._storage = [];
      ...
      const n = (() => {
        ...
        return () => {
          ...
          if (void 0 === e) {
            ...
            (i.style.width = "100%"), o.appendChild(i);
    ...
    37558: (e, t, o) => {
      "use strict";
      o.d(t, { DrawerContext: () => l, DrawerManager: () => i });
      var n = o(50959),
        r = o(99054);
    ...
    41590: (e, t, o) => {
      ...
      function m(e) {
        const {
          ...
          f = (0, r.ensureNotNull)((0, n.useContext)(a.DrawerContext)),
        ...
        return (
          (0, n.useLayoutEffect)(
            () => (
              ...
              f.addDrawer(g),
              () => {
                f.removeDrawer(g), w.unsubscribe(f, o);
              }
            ),
            [],
          ),
          n.createElement(
            ...
            n.createElement(
              "div",
              { ref: p, className: i(d.wrap, d[`position${t}`]) },
              g === f.currentDrawer &&
    ...
    42842: (e, t, o) => {
      "use strict";
      o.d(t, { Portal: () => a, PortalContext: () => c });
      var n = o(50959),
        r = o(32227),
        i = o(25931),
        l = o(67961),
    ...
    184: (e, t, o) => {
      "use strict";
      o.r(t), o.d(t, { showLollipopTooltip: () => P });
      var n = o(50959),
        r = o(32227),
        i = o(50151),
        l = o(97754),
      ...
      const f = (0, n.forwardRef)((e, t) => {
        ...
        const c = (0, n.useCallback)(
            (t) => {
              var o;
              null === (o = e.onKeyDown) || void 0 === o || o.call(e, t),
                27 === (0, h.hashFromEvent)(t) && (t.preventDefault(), r());
            },
            [r],
          ),
          u = (0, n.useCallback)(() => {
        ...
        return n.createElement(
          "div",
          {
            className: s()(
              ...
              [
                "mob" === l && C.lollipopTooltipTitle_mobile,
                "mini" === l && C.lollipopTooltipTitle_minimal,
              ],
              i,
            ),
          },
      ...
      function B(e) {
        ...
        return n.createElement(
          "div",
          { className: s()(_.groupRow, c), style: r },
          t &&
            n.createElement(
              "div",
              { className: _.groupCell },
              n.createElement("span", { className: _.text }, t),
            ),
          n.createElement(
            "div",
            { className: _.groupCell },
            n.createElement(
              "span",
              { className: _.text, style: i, onClick: l },
              o,
            ),
            a &&
              n.createElement(x.Icon, {
      ...
      function N(e) {
        const { content: t = [], subTitle: o, cardRowClass: r } = e,
          i = t.map((e, t) => {
            ...
            return n.createElement(
              "div",
              { key: `group${t}`, className: _.group },
              o && n.createElement("span", { className: _.groupTitle }, o),
              r.map((e, t) =>
                n.createElement(B, { key: `contentRow${t}`, ...e }),
              ),
            );
          }),
          l =
            "string" == typeof o
              ? o
              : o.map((e, t) =>
                  n.createElement(B, { key: `subTitle${t}`, ...e }),
                );
        return n.createElement(
          "div",
          { className: r },
          n.createElement("span", { className: _.subtitle }, l),
          i.length > 0 && n.createElement("div", null, i),
        );
      }
      !(function (e) {
        (e[(e.BeforeMarketOpen = _.beforeMarketOpen)] = "BeforeMarketOpen"),
          (e[(e.AfterMarketClose = _.afterMarketClose)] = "AfterMarketClose");
      })(T || (T = {})),
        (function (e) {
      ...
      function W(e) {
        ...
        const {
            ...
            title: l,
            tooltipIcon: a,
            tooltipInformationButtonProps: c,
            className: u,
            ...d
          } = e,
          p = r ? s()(_.content, _[r]) : _.content,
          m = (0, n.useMemo)(() => {
            var t;
            return l && a
              ? {
        ...
        return n.createElement(
          "div",
          {
            className: s()(_.wrap, u),
            style: {
              borderColor:
                null === (o = d.style) || void 0 === o ? void 0 : o.color,
            },
          },
          n.createElement(
            "div",
            ...
            l &&
              n.createElement(E, {
                title: l,
                icon: a,
                informationButtonProps: c,
                iconStyle: m,
                cardType: r,
              }),
            "common" === d.type && n.createElement(N, { ...d }),
            i &&
              ("mob" !== r || !i.hideInMobileMode) &&
              n.createElement(
                "div",
                { className: _.group },
                n.createElement(k, { ...i }),
      ...
      var D = o(58101);
      const L = (0, w.mergeThemes)(b.DEFAULT_MENU_THEME, {
        menuWrap: D.menuWrap,
        menuBox: D.menuBox,
      });
      function Q(e) {
        ...
        const O = { display: k ? "block" : "none", width: C },
          [_, B] = (0, n.useState)(!1);
        a(
          x,
          () => B(!1),
        ...
        const N = { display: _ ? "block" : "none", width: C };
        g(p);
        const Q = h ? s()(D.card, D[h]) : D.card;
        return n.createElement(
          d.DrawerManager,
          null,
          n.createElement(
      ...
      function P(e) {
        ...
        const t = {
          ...
          position: M.bind(null, e.position),
        ...
        return (
          ...
          r.render(n.createElement(Q, { ...t }), F),
          I
        );
      }
      function I() {
      ...
      function M(e, t) {
        const { contentWidth: o, contentHeight: n } = t,
          ...
          s = l.width - e.targetSize.width,
          a = l.height - e.targetSize.height,
          c = (0, i.ensureNotNull)(r.closest(".chart-container")),
          u = c.getBoundingClientRect(),
          d = (0, i.ensureNotNull)(c.parentElement).getBoundingClientRect(),
          p = l.left + e.point.x + s,
          m = Math.round(p - o / 2),
          h = Math.min(m + o, u.right, d.right);
        let v,
          f,
          g = Math.max(h - o, u.left, d.left);
        g + o >= d.right && (g = d.right - o);
        const y = u.bottom - (l.top + e.point.y + a),
          w = u.height - y - e.marginTop;
        return (
          w < n
            ? ((f = e.marginTop + u.top), (v = Math.max(w, 0)))
