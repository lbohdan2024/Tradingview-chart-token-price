(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [6408],
  {
    ...
    41590: (e, t, n) => {
      ...
      function h(e) {
        const {
          ...
          [w] = (0, o.useState)(() => (0, i.randomHash)()),
          g = (0, o.useRef)(null),
          b = (0, o.useContext)(s.CloseDelegateContext);
        return (
          (0, o.useLayoutEffect)(
            () => (
              ...
              f.addDrawer(w),
              () => {
                f.removeDrawer(w), b.unsubscribe(f, n);
              }
            ),
            [],
          ),
          o.createElement(
            ...
            o.createElement(
              "div",
              { ref: v, className: a(u.wrap, u[`position${t}`]) },
              w === f.currentDrawer &&
                o.createElement("div", { className: u.backdrop, onClick: n }),
              o.createElement(
                d,
                {
                  className: a(p.drawer, u[`position${t}`], h),
                  ref: g,
    ...
    173: (e, t, n) => {
      "use strict";
      n.d(t, { emojiGroups: () => j, removeUnavailableEmoji: () => k });
      var o = n(50959),
        r = n(11542),
        a = n(99616),
        i = n(37603),
    ...
    47291: (e, t, n) => {
      ...
      function c(e) {
        ...
        return o.createElement("div", { className: i()(l.wrapper, n) }, t);
      }
      var s = n(26601),
        m = n(78036),
        u = n(63273),
      ...
      function d(e) {
        ...
        const f = (0, o.useCallback)(
          ...
          g = Math.min(d - 102, window.innerHeight - 102);
        return o.createElement(
          h.Provider,
          {
            value: (0, o.useMemo)(
      ...
      const p = o.memo((e) => {
        ...
        return "title" === a.type
          ? o.createElement(
              "div",
              { style: t },
              o.createElement(c, { title: a.relatedTitle }),
            )
          : o.createElement(
              "div",
              { style: t },
    ...
    38297: (e, t, n) => {
      ...
      function h(e) {
        ...
        const [y, I] = (0, o.useState)(
            (null === (t = k[0]) || void 0 === t ? void 0 : t.relatedTitle) ||
              "",
          ),
          N = (0, o.useCallback)((e) => {
            E.current || I(e);
        ...
        return o.createElement(
          ...
          o.createElement(
            "div",
            { ref: j, onKeyDown: x },
            o.createElement(c.EmojiListContent, {
              listRef: b,
              outerRef: z,
              emojiGroups: k,
              emojiSize: g,
        ...
        function S(e) {
          ...
          s.CheckMobile.iOS() &&
            z.current &&
            (z.current.style.overflow = "hidden"),
            (E.current = !0),
            null === (t = b.current) ||
              void 0 === t ||
    ...
    85034: (e, t, n) => {
      ...
      function s(e) {
        const {
          ...
          [m, u] = (0, l.useRovingTabindexElement)(null);
        return o.createElement(
          "button",
          {
            ref: m,
            ...
            className: a()(c.wrapper, n && c.isActive, c.button, s),
            type: "button",
            "aria-pressed": n,
          },
          i,
    ...
    83682: (e, t, n) => {
      ...
      function v(e) {
        const {
          ...
          [v, h] = (0, s.useRovingTabindexElement)(null);
        return o.createElement(
          "button",
          {
            ref: v,
            ...
            className: a()(m.button, m.wrapper, t),
            type: "button",
          },
          o.createElement(l, { emoji: n }),
        );
      }
    },
    40173: (e, t, n) => {
    ...
    20243: (e, t, n) => {
      ...
      function c(e) {
        ...
        const c = v(e.currentTarget).sort(o.navigationOrderComparator);
        ...
        switch ((0, o.mapKeyCodeToDirection)(n)) {
          case "inlinePrev":
            if (!p.length) return;
            e.preventDefault(),
              g(0 === f ? c[d] : w ? m(p, f, -1) : p[p.length - 1]);
            break;
          case "inlineNext":
            if (!p.length) return;
            e.preventDefault(),
              f === p.length - 1 ? g(c[d]) : g(w ? m(p, f, 1) : p[0]);
            break;
          case "blockPrev": {
            e.preventDefault();
            const t = m(c, d, -1);
    ...
    6190: (e, t, n) => {
      ...
      const u = (0, o.forwardRef)(function (e, t) {
        const {
          ...
          p = (0, s.useFunctionalRefObject)(t);
        return (
          (0, o.useLayoutEffect)(() => {
            const e = (0, r.ensureNotNull)(p.current),
              t = () => {
          ...
          o.createElement("div", {
            ...m.MouseClickAutoBlurHandler.attributes(h),
            ...d,
            role: "toolbar",
            "aria-orientation": u,
            ref: p,
            onKeyDown: (0, a.createSafeMulticastEventHandler)(function (e) {
              ...
              const a = () => {
                  ...
                  (0, c.becomeSecondaryElement)(o[r]),
                    (0, c.becomeMainElement)(o[e]),
                    o[e].focus();
                },
                s = () => {
                  const e = (r + o.length + 1) % o.length;
