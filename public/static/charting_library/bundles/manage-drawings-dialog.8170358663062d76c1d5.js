  ...
  [1702],
  {
    ...
    64530: (e, t, n) => {
      ...
      function m(e) {
        ...
        return i.createElement(
          ...
          i.createElement(
            "div",
            { className: l()(d.itemInfo, !p && d.itemInfoWithPadding) },
            i.createElement(
              "div",
              {
                className: l()(d.title, f && !w && d.active, b && d.mobile),
            ...
            i.createElement(
              "div",
              { className: l()(d.details, f && !w && d.active, b && d.mobile) },
              n,
            ),
          ),
    ...
    41662: (e, t, n) => {
      ...
      class u extends i.PureComponent {
        constructor(e) {
          ...
          const t = (0, l.service)(o.CHART_WIDGET_COLLECTION_SERVICE);
        ...
        show() {
          this.visible().value() ||
            ((this._rootInstance = (0, m.createReactRoot)(
              i.createElement(u, { onClose: this._handleClose }),
              this._container,
            )),
    ...
    11386: (e, t, n) => {
      ...
      const w = r.t(null, void 0, n(92931)),
        C = r.t(null, void 0, n(41870)),
        b = r.t(null, void 0, n(80996));
      function p(e) {
        ...
        return i.createElement(f.RoundButtonTabs, {
      ...
      var y = n(29540),
        E = n(68016);
      const S = (0, d.getLogger)("Chart.ManageDrawings"),
        k = new Map();
      function M(e) {
        let t = k.get(e);
        return void 0 === t && ((t = new u.WatchedValue([])), k.set(e, t)), t;
      }
      const B = new c.TranslatedString(
          "remove all line tools for {symbol}",
          r.t(null, void 0, n(58407)),
        ),
        R = r.t(null, void 0, n(8182)),
        I = r.t(null, void 0, n(84212));
      function N(e) {
        const [t, n] = i.useState(null),
          [l, o] = i.useState(null),
          [s, r] = i.useState(null),
          [c, u] = (i.useRef(null), i.useState([]));
        return (
          i.useEffect(() => {
            let t;
            const i = () => {
              t && o(t.mainSeries().proSymbol());
            };
            return (
              e.withModel(null, () => {
                (t = e.model()),
              ...
              () => {
                null == t ||
                  t.mainSeries().symbolResolved().unsubscribe(null, i),
                  n(null);
              }
            );
          }, [e]),
          ...
          if (t && s) {
            ...
            if (i) {
              const n = Array.from(i)
                ...
                .filter(h.notNull);
              n.length > 0 && t.removeSources(n, !1, B.format({ symbol: e }));
              const a = M(t.model().id());
              a.setValue([...a.value(), e]);
              try {
                await f();
              } catch (e) {
                S.logError(`Error removing line tools: ${e}`);
              }
              a.setValue(a.value().filter((t) => t !== e));
            }
          }
        }
        function v(n) {
          e.setSymbol(n), null !== t && o(n);
        }
        async function g(e) {
          const t = (function (e) {
            ...
            return (
              e.forEach((e) => {
                ...
                if ((0, m.isLineTool)(e) && e.showInObjectTree()) {
                  const i = null !== (n = e.symbol()) && void 0 !== n ? n : "",
                    a = e.sharingMode().value();
                  t[a].set(i, (t[a].get(i) || new Set()).add(e.id()));
                }
              }),
              t
            );
        ...
        async function f() {
          null !== t && r(await g(t.dataSources()));
        }
      }
      function _(e) {
        const {
        ...
        return (
          ...
          i.createElement(
            ...
            i.createElement(
              "div",
              { className: o()(E.container, (a || t) && E.mobile) },
              i.createElement(p, { sharingMode: k, onTabClick: b }),
            ),
            0 === S.length
              ? null === m
                ? i.createElement(g.Spinner, { className: E.spinner })
                : i.createElement(
                    "div",
                    { className: E.empty },
              ...
              : S.map(
                  ({
                    ...
                    return i.createElement(v.DialogContentItem, {
                      key: e,
                      title: e,
                      subtitle:
                        ((s = a),
                        r
                          .t(
                            null,
                            { plural: "{drawingsCount} drawings", count: s },
                            n(90755),
                          )
                          .format({ drawingsCount: s.toString() })),
                      removeBtnLabel: R,
                      isActive: e === d,
                      isMobile: t,
                      onClick: o,
