(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [1859],
  {
    ...
    14543: (e, t, n) => {
      "use strict";
      n.d(t, { LightButton: () => a.LightButton });
      n(9038);
      var a = n(15893);
      n(50959), n(21593), n(66860), n(29075), n(62978);
      n(78572);
    },
    9038: (e, t, n) => {
      "use strict";
      n.d(t, { useLightButtonClasses: () => c });
      var a = n(50959),
        l = n(97754),
        o = n(17946),
        r = n(27011),
        i = n(86332);
      const s = a.createContext({ isInButtonGroup: !1, isGroupPrimary: !1 }),
        c = (e, t, n) => {
          const c = (0, a.useContext)(o.CustomBehaviourContext),
            {
              className: u,
              isSelected: d,
              children: m,
              ...
              variant: g = "primary",
              size: h = "medium",
              enableActiveStateStyles: C = c.enableActiveStateStyles,
              typography: x,
              isLink: w = !1,
              textWrap: y,
              isPills: k,
            ...
            O = (0, a.useContext)(i.ControlGroupContext),
            { isInButtonGroup: R, isGroupPrimary: T } = (0, a.useContext)(s);
          return l(
            u,
            e.lightButton,
            w && e.link,
            S && e.active,
            d && e.selected,
            (0, r.isIconOnly)(m, v) && e.noContent,
            !!D && e.withStartSlot,
            (f || !!E) && e.withEndSlot,
            n && e.withGrouped,
            p && e[p],
      ...
      function d(e) {
        ...
        return a.createElement(
          ...
          v &&
            a.createElement(
              "span",
              { className: l(u().slot, u().startSlot) },
              v,
            ),
          !(0, r.isIconOnly)(f, n) &&
            a.createElement(
              "span",
              {
                ...
                "data-overflow-tooltip-text":
                  null != m ? m : (0, o.getTextForTooltip)(f),
              },
              d || c
                ? a.createElement(
                    a.Fragment,
          ...
          p &&
            a.createElement("span", { className: l(u().slot, u().endSlot) }, p),
          t &&
            ((e) =>
              a.createElement(i.Icon, {
                className: l(u().caret, e && u().activeCaret),
                icon: s,
              }))(b),
        );
      }
    ...
    15893: (e, t, n) => {
      ...
      var a = n(50959),
        ...
        u = n.n(c);
      function d(e) {
        const { isGrouped: t } = a.useContext(l.ControlGroupContext),
          {
            reference: n,
            className: i,
            isSelected: c,
          ...
          I = k ? (null != S ? S : 2) : 1,
          N =
            I > 0 ? { ...D, "--ui-lib-light-button-content-max-lines": I } : D;
        return a.createElement(
          "button",
          {
            ...T,
    ...
    53885: (e, t, n) => {
      "use strict";
      n.d(t, { getStyleClasses: () => r, isCircleLogoWithUrlProps: () => i });
      var a = n(97754),
        l = n(3196),
        o = n.n(l);
      function r(e, t) {
        return a(o()["tv-circle-logo"], o()[`tv-circle-logo--${e}`], t);
      }
      function i(e) {
        return (
          "logoUrl" in e &&
    ...
    95854: (e, t, n) => {
      ...
      function u(e) {
        const {
          ...
          [h, C] = (0, l.useState)({ visible: t, hidden: [] }),
          x = (0, l.useMemo)(
          ...
          A = (0, o.useResizeObserver)(E),
          O = (0, o.useResizeObserver)(S),
          R = (0, l.useRef)(null),
          T = (0, c.mergeRefs)([O, R]),
          I = (0, l.useRef)(t),
          N = (0, l.useRef)(!0),
        ...
        return (
          (0, s.useIsomorphicLayoutEffect)(() => {
            (!f && !N.current && d(I.current, t) && d(x, P.current)) ||
              (w(), (N.current = !1), (I.current = t), (P.current = x));
          }, [t, w, x, f]),
          {
            containerRefCallback: T,
            moreButtonRef: b,
            innerContainerRefCallback: A,
            itemsRefs: p,
            setItemRef: v,
        ...
        const r = (0, l.useCallback)(
          (n, l) => {
            ...
            return (function ({
              ...
              if (u <= t) return { visible: i, hidden: c };
              const d = [...n];
              if (
                ((u = o.map((e) => d[e]).reduce((e, t) => e + t, 0) + l),
                r === a.EndFirst)
              )
                for (let e = 0; e < i.length; e++)
                  o.includes(e)
                    ? s.push(i[e])
                    : ((u += d[e]), u <= t ? s.push(i[e]) : c.push(i[e]));
              else
                for (let e = i.length - 1; e >= 0; e--)
                  o.includes(e)
                    ? s.unshift(i[e])
                    : ((u += d[e]), u <= t ? s.unshift(i[e]) : c.unshift(i[e]));
    ...
    86781: (e, t, n) => {
      "use strict";
      n.d(t, { useMatchMedia: () => o, useSafeMatchMedia: () => l });
      var a = n(50959);
      function l(e, t = !1) {
        const [n, l] = (0, a.useState)(t);
        return (
          (0, a.useEffect)(() => {
      ...
      function o(e) {
        const t = (0, a.useMemo)(() => window.matchMedia(e).matches, []);
        return l(e, t);
      }
    },
    78869: (e, t, n) => {
    ...
    67842: (e, t, n) => {
      "use strict";
      n.d(t, { useResizeObserver: () => r });
      var a = n(50959),
        l = n(43010),
        o = n(39416);
      function r(e, t = []) {
        const { callback: n, ref: r = null } = (function (e) {
            return "function" == typeof e ? { callback: e } : e;
          })(e),
          i = (0, a.useRef)(null),
          s = (0, a.useRef)(n);
        s.current = n;
        const c = (0, o.useFunctionalRefObject)(r),
          u = (0, a.useCallback)(
            (e) => {
              c(e),
                null !== i.current &&
        ...
        return (
          (0, l.useIsomorphicLayoutEffect)(
            () => (
              (i.current = new ResizeObserver((e, t) => {
                s.current(e, t);
              })),
    ...
    16212: (e, t, n) => {
          ...
          "automatic" === t
            ? (function (e) {
                ...
                return (0, c.useKeyboardEventHandler)(
                  [(0, u.useItemsKeyboardNavigation)(m, t, n, o, f, !0)],
                  l,
                );
              })(e)
            : (function (e) {
                const {
                  ...
                  p = (0, u.useItemsKeyboardNavigation)(s, t, n, o, f, !0),
                  v = (0, c.useKeyboardActionHandler)([13, 32], m);
                return (0, c.useKeyboardEventHandler)([p, v], l);
              })(e)
        );
      }
      var f = n(5325);
      function p(e) {
        ...
        const {
            ...
            items: u,
            orientation: d,
            activationType: p = "manual",
            disabled: v,
            tablistLabelId: b,
            tablistLabel: g,
            focusOnHighlight: h = !0,
            preventDefaultIfKeyboardActionHandled: C = !0,
            scrollIntoViewOptions: x,
            isActive: w,
            onActivate: y,
            isCollapsed: k,
            isRtl: S,
            isDisclosureOpened: D,
          } = e,
          E = (function () {
          ...
          [I, N] = (0, r.useFocus)(),
          P = u.find(w),
          M = (0, a.useCallback)((e) => !v && !e.disabled && e === R, [v, R]),
          F = (0, a.useCallback)(
            (e) => {
          ...
          Y = m({
            isRtl: S,
            items: (0, a.useMemo)(
              () => u.filter((e) => !v && !e.disabled),
              [u, v],
            ),
            activationType: p,
            preventDefaultIfHandled: C,
            onActivate: W,
            isHighlighted: M,
            onHighlight: z,
            isCollapsed: k,
          ...
          L = (0, a.useCallback)(
            (e) => {
              let t = null;
              for (const [n, a] of O.current.entries())
                if (e.target === a) {
                  t = n;
                  break;
                }
              t && !M(t) && ("automatic" === p && k && !k(t) ? W(t) : z(t));
            },
            [p, M, z, W, k],
          );
        (0, a.useEffect)(() => {
          ...
          (0, a.useEffect)(() => () => clearTimeout(B.current), []);
        const V =
            null !== (s = null == x ? void 0 : x.additionalScroll) &&
            void 0 !== s
              ? s
              : 0,
          [H, j] = (0, i.useKeepActiveItemIntoView)({
            ...x,
            visibilityDetectionOffsetInline: V + 24,
            snapToMiddle: !0,
            activeItem: null != R ? R : P,
            getKey: (0, a.useCallback)((e) => e.id, []),
          }),
          Q = (0, a.useCallback)(
            (e, t) => {
              j(e, t), null !== t ? O.current.set(e, t) : O.current.delete(e);
            },
            [j],
          ),
          X = u.map((e) => {
            ...
            const a = M(e),
              ...
              r =
                null !==
                  (n = null !== (t = e.disabled) && void 0 !== t ? t : v) &&
                void 0 !== n &&
                n,
              i = !r && (I ? a : o);
            return {
              ...(0, l.getTabAttributes)(e.id, i, o, e.tabpanelId, r),
              highlighted: a,
              active: o,
              handleItemRef: Q,
            };
        ...
        return {
          tabsBindings: X,
          tablistBinding: {
            ...(0, l.getTabListAttributes)((0, l.getTablistId)(c), d, v, b, g),
            onBlur: N.onBlur,
            onFocus: (0, o.createSafeMulticastEventHandler)(N.onFocus, L),
            onKeyDown: Y,
          },
    ...
    37507: (e, t, n) => {
      ...
      var a,
        ...
        i = n(22064);
      function s(e) {
        return (0, i.createDomId)(e, "tablist");
      }
      function c(e, t = "horizontal", n, a, l) {
        return {
          id: e,
          role: "tablist",
          "aria-orientation": t,
    ...
    56073: (e, t, n) => {
      ...
      function a(e, t = !1) {
        ...
        return (
          ...
          a.reduce((e, t) => e + (parseFloat(t) || 0), 0)
        );
      }
      function l(e, t = !1) {
        const n = getComputedStyle(e),
      ...
      n.d(t, { outerHeight: () => a, outerWidth: () => l });
    },
    34094: (e, t, n) => {
      "use strict";
      n.d(t, { getTextForTooltip: () => r });
      var a = n(50959);
      const l = (e) => (0, a.isValidElement)(e) && Boolean(e.props.children),
        o = (e) =>
          null == e || "boolean" == typeof e || "{}" === JSON.stringify(e)
            ? ""
            : e.toString() + " ",
        r = (e) =>
          Array.isArray(e) || (0, a.isValidElement)(e)
            ? a.Children.toArray(e)
                .reduce((e, t) => {
                  let n = "";
                  return (
                    (n =
                      (0, a.isValidElement)(t) && l(t)
                        ? r(t.props.children)
                        : (0, a.isValidElement)(t) && !l(t)
                          ? ""
                          : o(t)),
    ...
    59695: (e, t, n) => {
      "use strict";
      n.d(t, { CircleLogo: () => i, hiddenCircleLogoClass: () => r });
      var a = n(50959),
        l = n(53885),
        o = n(3196);
      const r = n.n(o)()["tv-circle-logo--visually-hidden"];
      function i(e) {
        var t, n;
    ...
    73775: (e, t, n) => {
      "use strict";
      n.d(t, { useDisclosure: () => a.useDisclosure });
      var a = n(7953);
    },
    42707: (e, t, n) => {
      "use strict";
      ...
      function m(e) {
        const {
          ...
          $ = (0, a.useMemo)(
            () =>
              (function (e) {
                function t(t) {
                  const { reference: n, ...l } = t,
                    o = null != e ? e : l.href ? "a" : "div",
                    r =
                      "a" === o
                        ? l
                        : (function (e) {
                  ...
                  return a.createElement(o, { ...r, ref: n });
                }
        ...
        return a.createElement(
          K,
          {
            ...
            id: t,
            role: n,
            className: l(u, B.item, h && B.withIcon, {
              [B.isActive]: x,
              [B.isDisabled]: w || k,
              [B.hovered]: y,
            }),
            ...
            reference: function (e) {
              (J.current = e), "function" == typeof I && I(e);
              "object" == typeof I && (I.current = e);
            },
            onClick: function (e) {
              if (w) return;
              U && (0, o.trackEvent)(U.category, U.event, U.label);
              Q && Q(X, e);
              j ||
            ...
            onContextMenu: function (e) {
              U &&
                _ &&
                (0, o.trackEvent)(U.category, U.event, `${U.label}_rightClick`);
            },
            onMouseUp: function (e) {
              if (1 === e.button && D && U) {
                let e = U.label;
                G && (e += "_mouseWheelClick"),
                  (0, o.trackEvent)(U.category, U.event, e);
              }
            },
            onMouseOver: P,
            onMouseOut: N,
          ...
          h &&
            a.createElement("span", {
              ...
              className: l(B.icon, L && c["round-icon"], C),
              dangerouslySetInnerHTML: { __html: h },
            }),
          a.createElement(
            "span",
            { className: l(B.labelRow, f) },
            a.createElement("span", { className: l(B.label, p) }, S),
          ),
          (void 0 !== b || g) &&
            a.createElement(
              "span",
    ...
    93081: (e, t, n) => {
      ...
      function g(e) {
        ...
        return o(
          ...
          b[`size-${t}`],
          n && b.selected,
          !l && b["disable-active-state-styles"],
          i && b["disable-focus-outline"],
          a && b.fake,
      ...
      const h = (0, l.forwardRef)((e, t) => {
        const { size: n, overflowBehaviour: a } = (0, l.useContext)(p),
          o = (0, l.useContext)(v.CustomBehaviourContext),
          {
            active: i,
            fake: s,
            className: c,
      ...
      function T(e) {
        ...
        return l.createElement(k.Icon, {
          icon: R(t),
          className: o(O["arrow-icon"], O[`size-${t}`], n && O.dropped),
        });
      }
      var I = n(456);
      function N(e) {
        const {
          ...
          g = (0, l.useRef)(null),
          C = (0, c.useMergedRefs)([d, g]),
          k = (function (e, t) {
            const n = (0, l.useRef)(M);
            return (
              (0, l.useEffect)(() => {
        ...
        return l.createElement(y.PopupMenuDisclosureView, {
          buttonRef: g,
          listboxTabIndex: -1,
          isOpened: a,
          onClose: b,
          ...
          button: l.createElement(
            ...
            u,
            l.createElement(T, { size: t, isDropped: a }),
          ),
          popupChildren: s.map((e) =>
            l.createElement(w.PopupMenuItem, {
              key: e.id,
              className: m ? I["link-item"] : void 0,
              onClick: v,
              onClickArg: e,
              isActive: f(e),
              label: e.label,
      ...
      var V = n(12481),
        ...
        Q = n.n(j);
      function X(e) {
        const { disabled: t, translateX: n, transitionDuration: a } = e,
          r = e.scale / 100;
        return l.createElement(
          "div",
          {
            className: o(Q().underline, t && Q().disabled),
            style: {
              transform: `translateX(${n}px) scaleX(${r})`,
      ...
      function U(e) {
        const {
            ...
            orientation: v,
            disabled: b,
            moreButtonContent: g = i.t(null, void 0, n(37117)),
            size: h = "small",
            onActivate: x,
            isActive: w,
            className: y,
            ...
            tablistLabelId: E,
            tablistLabel: A,
            "data-name": O = "underline-tabs-buttons",
            stretchTabs: R,
            equalTabSize: T,
          } = e,
          I = L(),
          P = (function (e) {
            const t = (0, B.useSafeMatchMedia)(
                z["media-mf-phone-landscape"],
                !0,
              ),
              n = L();
          ...
          U = null != D ? D : !I,
          {
            visibleItems: G,
            hiddenItems: _,
            containerRefCallback: q,
            innerContainerRefCallback: J,
            moreButtonRef: $,
            setItemRef: K,
          } = (0, s.useCollapsible)(a, F, w),
          Z = "collapse" === P ? G : a,
          ee = "collapse" === P ? _ : [],
          te = (0, l.useCallback)((e) => ee.includes(e), [ee]),
          ne = (0, l.useRef)(new Map()),
          {
            isOpened: ae,
            open: le,
            close: oe,
          ...
          })(h),
          {
            ...
            scrollIntoViewOptions: { additionalScroll: ie },
          }),
          pe = a.find(w),
          ve = ee.find(fe),
          be = (0, l.useCallback)(() => {
        ...
        (ue.ref = (0, c.useMergedRefs)([ue.ref, q])),
          (ce.ref = (0, c.useMergedRefs)([ce.ref, J])),
          (ce.onKeyDown = (0, u.createSafeMulticastEventHandler)(
            (0, f.useKeyboardEventHandler)([
              (0, f.useKeyboardClose)(ae, he),
              (0, f.useKeyboardActionHandler)(
                [13, 32],
                Ce,
                (0, l.useCallback)(() => Boolean(ve), [ve]),
              ),
            ]),
            ce.onKeyDown,
          ));
        const xe = (0, l.useCallback)(
            (e) => {
              (M.current = !0), re(e);
            },
            [M, re],
        ...
        (0, l.useEffect)(() => {
          M.current ? (M.current = !1) : (ve && !ae && le(), !ve && ae && oe());
        }, [ve, ae, le, oe]);
        const ye = (function (e, t, n = []) {
          const [a, o] = (0, l.useState)(),
            r = (0, l.useRef)(),
            i = (0, l.useRef)(),
            s = (e) => {
              var t;
              ...
              if (void 0 === n) return;
              const a = void 0 === i.current || i.current === e ? 0 : 100;
              i.current = e;
              const { left: l, right: r, width: s } = e.getBoundingClientRect(),
                { left: c, right: u } = n.getBoundingClientRect(),
                d = (0, H.isRtl)() ? r - u : l - c;
              o({ translateX: d, scale: s, transitionDuration: a });
            };
          return (
            (0, l.useEffect)(() => {
              const e = (0, V.default)((e) => {
                const t = e[0].target;
                void 0 !== t && s(t);
              }, 50);
        ...
        return l.createElement(
          p.Provider,
          { value: { size: h, overflowBehaviour: P } },
          l.createElement(
            "div",
            {
              ...ue,
              className: Y({ size: h, overflowBehaviour: P, className: y }),
              style: k,
              "data-name": O,
            },
            l.createElement(
              ...
              {
                ...ce,
                className: r()(W["underline-tabs"], {
                  [W["make-grid-column"]]: j || Q,
                  [W["stretch-tabs"]]: j,
                  [W["equal-tab-size"]]: Q,
                }),
              },
              ...
              ye
                ? l.createElement(X, { ...ye, disabled: b })
      ...
      var G = n(38952);
      function _(e) {
        return l.createElement("a", { ...(0, G.renameRef)(e) });
      }
      (0, l.forwardRef)((e, t) => {
        var n;
        const { size: a, overflowBehaviour: o } = (0, l.useContext)(p),
          r = (0, l.useContext)(v.CustomBehaviourContext),
          {
            item: i,
            highlighted: s,
            handleItemRef: c,
          ...
          S = null !== (n = i.renderComponent) && void 0 !== n ? n : _;
        return l.createElement(
          S,
          {
            ...w,
    ...
    4237: (e, t, n) => {
      "use strict";
      var a = n(32227);
      (t.createRoot = a.createRoot), a.hydrateRoot;
    },
    72170: (e) => {
    ...
    84828: (e, t, n) => {
      "use strict";
      n.r(t), n.d(t, { showGoToDateDialog: () => le });
      var a = n(50959),
        l = n(50151),
        o = n(82992),
        r = n(23935),
      ...
      function d(e) {
        ...
        return a.createElement(u.Provider, { value: s }, n);
      }
      const m = a.createContext(null);
      function f(e) {
        const { initialRanges: t, children: n } = e,
          [l, o] = (0, a.useState)(t.from),
          [r, i] = (0, a.useState)(t.to),
          s = l.valueOf() <= r.valueOf(),
          c = (0, a.useMemo)(
            () => ({
              dateFrom: l,
              dateTo: r,
        ...
        return a.createElement(m.Provider, { value: c }, n);
      }
      var p = n(11542),
        v = n(97754),
        b = n.n(v),
      ...
      function S(e) {
        ...
        return a.createElement(
          "div",
          { className: b()(k.row, j && k.mobileRow) },
          t,
        );
      }
      var D = n(85528),
        E = n(76056);
      const A = a.createContext({ isActive: !1, isFocused: !1 });
      function O(e) {
        const {
            value: t,
            reference: n,
      ...
      function R(e) {
        const { isActive: t, isFocused: n } = (0, a.useContext)(A);
        return a.createElement(E.DateInput, { ...e, highlight: t || n });
      }
      var T = n(36565);
      function I(e) {
        const { value: t, isDisabled: n, onPick: l, className: o } = e;
        return a.createElement(T.TimeInput, {
          value:
            ((i = t),
            (0, r.twoDigitsFormat)(i.getHours()) +
              ":" +
              (0, r.twoDigitsFormat)(i.getMinutes())),
          onChange: l,
          disabled: n,
          className: o,
        });
      ...
      function M(e) {
        ...
        return a.createElement(N.Calendar, {
          ...n,
          className: b()(P.calendar, t),
          popupStyle: !1,
        });
      }
      function F(e, t) {
      ...
      function z(e) {
        const {
          ...
          { date: i, setDate: s } = (0, l.ensureNotNull)((0, a.useContext)(u)),
          c = (0, a.useRef)(null),
          d = (0, a.useRef)(null);
        return (
          (0, a.useEffect)(() => {
            j || null === d.current || d.current.focus();
          }, []),
          a.createElement(
            "div",
            { ref: c, tabIndex: -1 },
              ...
              !o &&
                a.createElement(I, {
                  ...
                  onPick: function (e) {
                    ...
                    const [n, a] = e.split(":"),
                      l = new Date();
                    l.setHours(Number(n)), l.setMinutes(Number(a));
                    const o = B(l, i);
                    s(o),
                      j ||
                        null === (t = c.current) ||
            ...
            !j &&
              a.createElement(M, {
                key: `${i.getFullYear()}-${i.getMonth()}-${i.getDate()}`,
      ...
      function W(e) {
        const {
          ...
          } = e,
          {
            ...
            setDateFrom: s,
            setDateTo: c,
          } = (0, l.ensureNotNull)((0, a.useContext)(m)),
          [u, d] = (0, a.useState)("from"),
          f = (0, a.useRef)(null),
          p = (0, a.useRef)(null),
          v = (0, a.useRef)(null),
          b = (0, a.useMemo)(
            () => ("from" === u ? new Date(r) : new Date(i)),
            [u, i, r],
          );
        return (
          (0, a.useEffect)(() => {
            j || null === p.current || p.current.focus();
          }, []),
          a.createElement(
            "div",
            { ref: f, tabIndex: -1 },
            ...
            !j &&
              a.createElement(M, {
                key: `${b.getFullYear()}-${b.getMonth()}-${b.getDate()}`,
                selectedDate: new Date(b),
                onSelect: function (e) {
                  const t = F(e, "from" === u ? r : i);
                  ({
                    from: () => {
                      var e;
                      s(t),
                ...
                minDate: "to" === u ? new Date(r) : void 0,
              }),
          )
        );
        function g(e, t, n) {
          ...
          const [l, o] = e.split(":"),
            r = new Date();
          r.setHours(Number(l)), r.setMinutes(Number(o));
          n(B(r, t)),
            j ||
              null === (a = f.current) ||
              void 0 === a ||
      ...
      const X = () => !0,
        U = [
          {
            label: p.t(null, void 0, n(62154)),
            id: "Date",
            dataId: "tab-item-date",
          },
          {
            label: p.t(null, void 0, n(81861)),
            id: "CustomRange",
            dataId: "tab-item-customrange",
          },
        ];
      function G(e) {
        const { dateOnly: t, onClose: o, onGoToDate: r, onGoToRange: i } = e,
          s = (0, a.useRef)(null),
          [c, d] = (0, a.useState)(
            C().getValue("GoToDialog.activeTab", "Date"),
          ),
          [f, v] = (0, a.useState)(0),
          { date: h, isValid: k } = (0, l.ensureNotNull)((0, a.useContext)(u)),
          {
            dateFrom: S,
            dateTo: D,
            isValid: E,
        ...
        return (
          (0, a.useEffect)(
            () => (
              g.subscribe(x.CLOSE_POPUPS_AND_DIALOGS_COMMAND, T, null),
              () => {
                g.unsubscribe(x.CLOSE_POPUPS_AND_DIALOGS_COMMAND, T, null);
              }
            ),
            [o],
          ),
          ...
          a.createElement(
            ...
            (e) =>
              a.createElement(y.AdaptiveConfirmDialog, {
                className: b()(H.dialogWrapper, e && H.dialogWrapperSmall),
                title: p.t(null, void 0, n(42432)),
                ...
                submitButtonText: p.t(null, void 0, n(42432)),
                forceCloseOnEsc: X,
                shouldForceFocus: !1,
                fullScreen: e,
                isOpened: !0,
          ...
          return (
            ...
            a.createElement(
              ...
              a.createElement(
                "div",
                { className: H.tabs },
                a.createElement(Y.UnderlineButtonTabs, {
                  id: "go-to-date-tabs",
                  isActive: (e) => e.id === c,
                  items: U,
                  onActivate: I,
              ...
              a.createElement(
                "div",
                { className: b()(H.content, j && H.contentMobile) },
                a.createElement(
                  "div",
        ...
        function I(e) {
          d(e.id), C().setValue("GoToDialog.activeTab", e.id);
        }
        function N() {
          v(f + 1);
        }
      ...
      var ee = n(27365),
        te = n(28124);
      const ne = "goTo",
        ae = new i.DialogsOpenerManager();
      function le(e) {
        if (ae.isOpened(ne)) return;
        ...
        const t = e.model(),
          ...
          l = a.createElement(q, {
            ...
            onGoToDate: (e) => {
              !(function (e, t) {
                Z.setItem("goToDateTabLastPickedDate", String(t.valueOf()));
                if (void 0 === e.model().timeScale().tickMarks().minIndex)
                  return;
                const n = (0, r.addLocalTime)(t).valueOf();
                e.model()
                  .gotoTime(n)
                  .then((t) => {
            ...
            onGoToRange: (t, n) => {
              !(function (e, t, n) {
                const a = (0, ee.getTimezoneName)(e.model());
                if (!a) return;
                const l = o.linking.interval.value(),
                  i = l && (0, $.normalizeIntervalString)(l),
                  u = c().get_timezone(a),
                  d = (e) => (0, s.cal_to_utc)(u, new Date(e)),
                  m = (0, r.addLocalTime)(t).valueOf(),
                  f = (0, r.addLocalTime)(n).valueOf(),
                  p = {
                    val: {
                      type: "time-range",
                      from: d(m) / 1e3,
          ...
          i = (0, te.createReactRoot)(l, n);
        function u() {
          i.unmount(), ae.setAsClosed(ne);
        }
        ae.setAsOpened(ne);
      }
      function oe() {
        const e = Z.getItemOrDefault("goToDateTabLastPickedDate", null);
        return null === e
          ? (0, r.resetToDayStart)(new Date())
          : new Date(Number(e));
      }
      function re(e) {
        const t = (function (e) {
          ...
          const a = e.model().mainSeries(),
            o = a.nearestIndex(n.firstBar(), K.PlotRowSearchMode.NearestRight),
            r = a.nearestIndex(n.lastBar(), K.PlotRowSearchMode.NearestLeft);
          if (void 0 === o || void 0 === r) return;
          return {
            from: (0, l.ensureNotNull)(t.indexToUserTime(o)),
            to: (0, l.ensureNotNull)(t.indexToUserTime(r)),
          };
        })(e);
        return t
          ? {
              from: (0, r.subtractLocalTime)(t.from),
              to: (0, r.subtractLocalTime)(t.to),
            }
          : {
              from: (0, r.subtractLocalTime)(new Date()),
              to: (0, r.subtractLocalTime)(new Date()),
            };
      }
    },
    47531: (e) => {
