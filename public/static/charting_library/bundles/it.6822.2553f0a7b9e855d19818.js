(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    94920: (t) => {
      t.exports = { en: ["ADJ"], it: ["adg"] };
    },
    16755: (t) => {
      t.exports = { en: ["B-ADJ"], it: ["b-adg"] };
    },
    82631: (t) => {
      t.exports = { en: ["SET"], it: ["set"] };
    },
    22233: (t) => {
      t.exports = { en: ["auto"], it: ["auto"] };
    },
    4161: (t) => {
      t.exports = { en: ["log"], it: ["log"] };
    },
    58221: (t) => {
      t.exports = { en: ["All data"], it: ["Tutti i dati"] };
    },
    19273: (t) => {
      t.exports = { en: ["Year to day"], it: ["Anno in corso"] };
    },
    58426: (t) => {
      t.exports = {
    ...
    61206: (t) => {
      t.exports = { en: ["Maximize chart"], it: ["Espandi grafico"] };
    },
    2031: (t) => {
      t.exports = {
    ...
    27665: (t) => {
      t.exports = { en: ["Sessions"], it: ["Sessioni"] };
    },
    31142: (t) => {
      t.exports = { en: ["Restore chart"], it: ["Ripristina grafico"] };
    },
    41888: (t) => {
      t.exports = {
    ...
    77073: (t) => {
      t.exports = { en: ["Timezone"], it: ["Fuso orario"] };
    },
    49545: (t) => {
      t.exports = {
