  ...
  [5009],
  {
    ...
    57340: (e, t, n) => {
      ...
      const d = o.forwardRef((e, t) =>
        o.createElement(r.NavButton, { ...e, ref: t, icon: u(e.size) }),
      );
    },
    64388: (e, t, n) => {
      "use strict";
      ...
      function a(e) {
        ...
        return o.createElement(
          o.Fragment,
          null,
          o.createElement("span", { className: l.background }),
          o.createElement(i.Icon, {
            icon: n,
            className: l.icon,
            "aria-hidden": !0,
          }),
          t && o.createElement("span", { className: l["visually-hidden"] }, t),
        );
      }
      const c = (0, o.forwardRef)((e, t) => {
        ...
        return o.createElement(
          "button",
          { ...d, className: s({ ...e, children: u }), ref: t, type: r },
          o.createElement(a, { icon: n }, u),
        );
      });
      ...
      var u = n(21593),
        d = n(53017);
      (0, o.forwardRef)((e, t) => {
        const { icon: n, renderComponent: r, "aria-label": i, ...l } = e,
          c = null != r ? r : u.CustomComponentDefaultLink;
        return o.createElement(
          c,
          {
            ...l,
    ...
    53885: (e, t, n) => {
      "use strict";
      n.d(t, { getStyleClasses: () => l, isCircleLogoWithUrlProps: () => s });
      var o = n(97754),
        r = n(3196),
        i = n.n(r);
      function l(e, t) {
        return o(i()["tv-circle-logo"], i()[`tv-circle-logo--${e}`], t);
      }
      function s(e) {
        return (
          "logoUrl" in e &&
    ...
    67029: (e, t, n) => {
      ...
      function h(e, t, n, o) {
        const {
          ...
          x = m(null != i ? i : (0, c.getGroupCellRemoveRoundBorders)(n));
        return r(
          d().container,
          d()[`container-${u}`],
          d()[`intent-${s}`],
      ...
      function f(e, t, n) {
        ...
        const l = m(null != i ? i : (0, c.getGroupCellRemoveRoundBorders)(t));
    ...
    36104: (e, t, n) => {
      ...
      function r(e) {
        const { intent: t, highlight: n, ...r } = e,
          { isFocused: i, ...l } = (0, o.useDisclosure)(r);
        return {
          ...l,
          isFocused: i,
    ...
    7953: (e, t, n) => {
      ...
      function c(e) {
        const {
          ...
          k = c ? [] : [m, g.onBlur],
          D = c ? [] : [h, R],
          M = (0, s.createSafeMulticastEventHandler)(...P),
          F = (0, s.createSafeMulticastEventHandler)(...k),
          B = (0, s.createSafeMulticastEventHandler)(...D);
        return {
          listboxId: x,
          isOpened: f,
          isFocused: b,
          ...
          toggle: R,
          onOpen: y,
          buttonFocusBindings: { onFocus: M, onBlur: F },
          onButtonClick: B,
          buttonRef: C,
          listboxRef: E,
          buttonAria: {
    ...
    22064: (e, t, n) => {
      ...
      function a(...e) {
        const t = e.map(i).filter(r).filter(l).map(s);
        return (t.length > 0 && t[0].startsWith("id_") ? t : ["id", ...t]).join(
          "_",
        );
      }
      function c(...e) {
        return e.map(i).filter(r).filter(l).join(" ");
      }
    },
    47201: (e, t, n) => {
      "use strict";
    ...
    79418: (e, t, n) => {
      ...
      var p = n(52092),
        ...
        g = n(11542),
        b = n(57340);
      const x = o.createContext({ setHideClose: () => {} });
      var C = n(80822);
      function w(e) {
        const {
            title: t,
            ...
            className: h,
            unsetAlign: f,
            closeAriaLabel: p = g.t(null, void 0, n(47742)),
        ...
        return o.createElement(
          ...
          o.createElement(
            "div",
            { className: l()(C.container, h, (i || f) && C.unsetAlign) },
            u,
            o.createElement(
              "div",
              { "data-dragg-area": m, className: C.title },
              o.createElement(
                "div",
                { className: l()(r ? C.textWrap : C.ellipsis) },
                t,
              ),
              i &&
                o.createElement(
              ...
              if (!e.defaultPrevented) {
                if (
                  ...
                  if (null !== n) {
                    ...
                    const o = this._reference;
                    if (null !== o && (0, c.isTextEditingField)(n))
                      return void o.focus();
                    if (null == o ? void 0 : o.contains(n))
                      return (
                        this.props.onKeyboardClose &&
                          this.props.onKeyboardClose(),
                        void this._handleClose()
              ...
              o.createElement(
                ...
                (m) =>
                  o.createElement(
                    ...
                    {
                      rounded: !(m || M) && B,
                      className: l()(S.dialog, M && V && S.bounded, e),
                      isOpened: r,
                      reference: U,
                      ...
                      calculateDialogPosition:
                        M && V ? this._calculatePositionWithOffsets : void 0,
                      shadowed: Q,
                      fixedBody: q,
                      onClick: X,
                      ...$,
    ...
    64530: (e, t, n) => {
      ...
      function m(e) {
        ...
        return o.createElement(
          ...
          o.createElement(
            "div",
            { className: i()(d.itemInfo, !C && d.itemInfoWithPadding) },
            o.createElement(
              "div",
              {
                className: i()(d.title, v && !g && d.active, x && d.mobile),
            ...
            o.createElement(
              "div",
              { className: i()(d.details, v && !g && d.active, x && d.mobile) },
              n,
            ),
          ),
    ...
    69654: (e, t, n) => {
      ...
      function d(e) {
        const {
          ...
          iconClassName: v,
          cancelTitle: g = l.t(null, void 0, n(4543)),
          ...b
        } = e;
        return o.createElement(
          "div",
          { className: i()(u.container, r && u.mobile, f) },
          o.createElement(
            "div",
            {
              className: i()(
            ...
            d || o.createElement(m, { isMobile: r, ...b }),
          ),
          t,
      ...
      function h(e) {
        const {
          ...
          E = (0, o.useRef)(0),
          {
            ...
            sizePropName: S,
            minSizePropName: R,
            startPointPropName: P,
            currentMousePointPropName: k,
        ...
        const M = t / n || 0,
          ...
          O = N ? -z : 0,
          A = N ? 0 : z,
          I = H((0, a.clamp)(l, O, A)) || 0;
        return o.createElement(
          "div",
          {
            ref: b,
            className: i()(f.wrap, y && f["wrap--horizontal"]),
            style: { [S]: t },
            onMouseDown: function (e) {
              if (e.isDefaultPrevented()) return;
              e.preventDefault();
              const t = _(e.nativeEvent, (0, s.ensureNotNull)(b.current)),
                n = Math.sign(t),
                o = (0, s.ensureNotNull)(x.current).getBoundingClientRect();
              E.current = (n * o[S]) / 2;
              let r = Math.abs(t) - Math.abs(E.current);
              const i = H(z);
              r < 0
                ? ((r = 0), (E.current = t))
                : r > i && ((r = i), (E.current = t - n * i));
              u(K(n * r)), w(!0);
            },
          },
          o.createElement(
            ...
            {
              ref: x,
              className: i()(f.bar, y && f["bar--horizontal"]),
              style: { [R]: g, [S]: B, transform: `${D}(${I}px)` },
              onMouseDown: function (e) {
                e.preventDefault(),
                  (E.current = _(
                    e.nativeEvent,
                    (0, s.ensureNotNull)(x.current),
                  )),
                  w(!0);
              },
            },
            o.createElement("div", {
              className: i()(f.barInner, y && f["barInner--horizontal"]),
            }),
          ),
        );
        function W(e) {
          const t = _(e, (0, s.ensureNotNull)(b.current)) - E.current;
          u(K(t));
        }
        function T() {
          w(!1);
        ...
        function _(e, t) {
          const n = t.getBoundingClientRect()[P];
          return e[k] - n;
        }
        function H(e) {
          return e * M * L;
    ...
    59695: (e, t, n) => {
      ...
      var o = n(50959),
        r = n(53885),
        i = n(3196);
      const l = n.n(i)()["tv-circle-logo--visually-hidden"];
      function s(e) {
        var t, n;
    ...
    59054: (e, t, n) => {
      ...
      function h(e) {
        ...
        return o.createElement(u.Icon, {
          className: i()(m.icon, t && m.dropped),
          icon: d,
        });
      }
      function f(e) {
        ...
        return o.createElement(
          "span",
          { className: i()(m.button, n && m.disabled, t) },
      ...
      const v = o.forwardRef((e, t) => {
        const {
          ...
          A =
            ...
            o.createElement(
              a.EndSlot,
              null,
              o.createElement(f, { isDropped: b, disabled: g, className: F }),
            );
        return o.createElement(c.PopupMenuDisclosureView, {
          ...
          button: o.createElement(s.ControlSkeleton, {
            ...
            size: y,
            ref: (0, l.useMergedRefs)([O, t]),
            middleSlot: o.createElement(
              a.MiddleSlot,
              null,
              o.createElement(
                "span",
                { className: i()(p["button-children"], m && p.hiddenArrow, B) },
                D,
              ),
            ),
            endSlot: A,
      ...
      v.displayName = "ControlDisclosureView";
    },
    95276: (e, t, n) => {
      "use strict";
      n.d(t, { ControlDisclosure: () => u });
      var o = n(50959),
        r = n(38528),
        i = n(26597),
        l = n(59054),
      ...
      const u = o.forwardRef((e, t) => {
        const {
          ...
          I = (0, i.useKeyboardToggle)(F),
          W = (0, i.useKeyboardClose)(y, M),
          T = (0, i.useKeyboardEventHandler)([I, W]);
        return o.createElement(
          l.ControlDisclosureView,
          {
            ...
            listboxTabIndex: R,
            listboxReference: O,
            listboxAria: null != b ? b : w.current,
      ...
      u.displayName = "ControlDisclosure";
    },
    4523: (e, t, n) => {
      "use strict";
    ...
    36189: (e, t, n) => {
      ...
      function d(e) {
        const { className: t, isFilled: n, isActive: o, onClick: d, ...m } = e;
    ...
    19785: (e, t, n) => {
      ...
      function i(e) {
        const {
          ...
          primaryKey: l,
          secondaryKey: s = l,
          optionalPrimaryKey: a,
          tertiaryKey: c,
        } = e;
        return t
          .map((e) => {
            const t = a && e[a] ? e[a] : e[l],
              i = e[s],
              u = c && e[c];
            let d,
              m = 0;
            return (
              n.forEach((e) => {
                ...
                if ((0, r.isString)(i) && h.test(i))
                  return (
                    (m = 2),
                    void (d =
                      null === (a = i.match(h)) || void 0 === a
                        ? void 0
                        : a.index)
                  );
                if (Array.isArray(u))
    ...
    24637: (e, t, n) => {
      ...
      var o = n(50959),
        ...
        l = n(32248);
      function s(e) {
        const { queryString: t, rules: n, text: s, className: a } = e,
          c = (0, o.useMemo)(
      ...
      function m(e) {
        ...
        return o.createElement(
          $,
          {
            ...
            id: t,
            role: n,
            className: r(u, A.item, b && A.withIcon, {
              [A.isActive]: C,
              [A.isDisabled]: w || y,
              [A.hovered]: E,
            }),
            ...
            reference: function (e) {
              (Y.current = e), "function" == typeof F && F(e);
              "object" == typeof F && (F.current = e);
            },
            onClick: function (e) {
              if (w) return;
              V && (0, i.trackEvent)(V.category, V.event, V.label);
              Z && Z(Q, e);
              j ||
            ...
            onContextMenu: function (e) {
              V &&
                X &&
                (0, i.trackEvent)(V.category, V.event, `${V.label}_rightClick`);
            },
            onMouseUp: function (e) {
              if (1 === e.button && S && V) {
                let e = V.label;
                q && (e += "_mouseWheelClick"),
                  (0, i.trackEvent)(V.category, V.event, e);
              }
            },
            onMouseOver: L,
            onMouseOut: B,
          ...
          K &&
            o.createElement(s.CircleLogo, {
              ...
              logoUrl: K.logoUrl,
              placeholderLetter:
                "placeholderLetter" in K ? K.placeholderLetter : void 0,
            }),
          b &&
            o.createElement("span", {
              "aria-label": H && H["aria-label"],
              "aria-hidden": H && Boolean(H["aria-hidden"]),
              className: r(A.icon, _ && c["round-icon"], x),
              dangerouslySetInnerHTML: { __html: b },
            }),
          o.createElement(
            "span",
            { className: r(A.labelRow, h) },
            o.createElement("span", { className: r(A.label, f) }, N),
          ),
          (void 0 !== v || g) &&
            o.createElement(
              "span",
      ...
      function a(e) {
        ...
        switch ((0, o.mapKeyCodeToDirection)(n)) {
          case "inlinePrev":
            if (!p.length) return;
            e.preventDefault(),
              b(0 === v ? a[f] : g ? u(p, v, -1) : p[p.length - 1]);
            break;
          case "inlineNext":
            if (!p.length) return;
            e.preventDefault(),
              v === p.length - 1 ? b(a[f]) : b(g ? u(p, v, 1) : p[0]);
            break;
          case "blockPrev": {
            e.preventDefault();
            const t = u(a, f, -1);
    ...
    10838: (e, t, n) => {
      ...
      function u(e) {
        const { className: t, ...n } = e,
          [r, u] = (0, s.useRovingTabindexElement)(null);
    ...
    75693: (e, t, n) => {
      "use strict";
      n.r(t), n.d(t, { LoadChartDialogRenderer: () => ae });
      var o,
        r,
        i = n(50959),
        l = n(97754),
        ...
        return i.createElement(
          ...
          i.createElement(
            p.ControlDisclosure,
            {
              hideArrowButton: !0,
              ref: r,
              buttonChildren: i.createElement(f.Icon, {
                className: x.icon,
                icon: 0 === t ? g : b,
              }),
              ...
              onListboxFocus: function (e) {
                e.target instanceof HTMLElement &&
                  (0, v.handleAccessibleMenuFocus)(e, r);
              },
      ...
      function y(e) {
        const {
          ...
          d = o === n && s === r;
        return i.createElement(w.AccessibleMenuItem, {
          ...u,
          isActive: d,
          className: l(E.container, c),
          label: i.createElement(
            ...
            i.createElement("span", { className: E.text }, t),
          ),
          onClick: function () {
            a(o, s);
          },
          ...
          "data-sort-field": o,
          "data-sort-direction": 0 === s ? "asc" : "desc",
        });
      }
      var N = n(69654),
        S = n(7176);
      function R(e) {
        ...
        return i.createElement("div", { className: s()(S.container, n) }, t);
      }
      function P(e) {
        const { title: t } = e;
        return i.createElement("div", { className: S.title }, t);
      }
      var k = n(50335);
      var D = n(84952),
        M = n(63273),
      ...
      function O(e) {
        const {
          ...
          [u, m] = (0, F.useDimensions)(),
          [h, f, p, v] = (0, B.useOverlayScroll)();
        return (
          (0, i.useEffect)(() => {
            const e = () => {};
            return d.isFF
          ...
          i.createElement(
            ...
            {
              ...("overlay" === a && f),
              className: s()(z.container, t),
              onTouchStart: o,
              onScrollCapture: n,
              ref: u,
            },
            "overlay" === a &&
              i.createElement(L.OverlayScrollContainer, {
                ...h,
                className: z.overlayScrollWrap,
              }),
            i.createElement(D.FixedSizeList, {
              ref: r,
              className: s()("native" === a ? z.scroll : z.list),
              outerRef: "overlay" === a ? p : void 0,
              onItemsRendered: v,
              layout: "vertical",
              width: "100%",
      ...
      var K = n(82826),
        ...
        Q = n(19785),
        V = n(92821);
      const q = new K.DateFormatter("dd-MM-yyyy"),
        X = new j.TimeFormatter(j.hourMinuteFormat),
        G = I.enabled("items_favoriting");
      function Y(e) {
        const {
            chart: t,
          ...
          g = t.url
            ? (function (e) {
                ...
                return (
                  ...
                  (0, A.urlWithMobileAppParams)(n.href)
                );
              })({ chartId: t.url })
            : void 0,
          b = (0, i.useContext)(_.SlotContext),
          x = (0, i.useMemo)(() => new Date(1e3 * t.modified), [t]),
          C = (0, i.useMemo)(() => (0, Q.createRegExpList)(u), [u]),
          w = s()(V.highlight, h && V.active);
        return (
          (0, i.useEffect)(
            () => (
          ...
          i.createElement(W.DialogContentItem, {
            url: g,
            title: i.createElement(Z.HighlightedText, {
              className: w,
              queryString: u,
              rules: C,
              text: t.name,
            }),
            subtitle: i.createElement(
              i.Fragment,
              null,
              i.createElement(Z.HighlightedText, {
                className: w,
                queryString: u,
                rules: C,
                text: t.description,
              ...
              " ",
              "(",
              q.format(x).replace(/-/g, "."),
              " ",
              X.formatLocal(x),
              ")",
            ),
            onClick: function (e) {
              if (I.enabled("symphony_embed")) return;
              0;
              t.openAction(), !1;
            },
            ...
            onClickRemove: async function () {
              ...
              const e = await (async function (e) {
                return c.t(null, { replace: { name: e.name } }, n(30448));
              })(t);
              v(!1),
                (function (e, t, n, o) {
                  (0, H.showConfirm)(
      ...
      const te = { sortField: "modified", sortDirection: 1 },
        ne = (function (e) {
          ...
          return (0, i.forwardRef)(({ style: e, ...o }, r) => {
            const { height: l = 0 } = e;
            return i.createElement("div", {
              ref: r,
              style: {
                ...e,
                height: `${((0, k.isNumber)(l) ? l : parseFloat(l)) + t + n}px`,
              },
              ...o,
            });
          });
      ...
      function oe(e) {
        let t;
        try {
          t = (0, T.getTranslatedResolution)(e);
        } catch (n) {
          t = e;
        }
        return t;
      }
      const re = I.enabled("items_favoriting");
      function ie(e) {
        const { onClose: t, chartWidgetCollection: o, serviceState: r } = e,
          [l, f] = (0, i.useState)(""),
          [p, v] = (0, i.useState)(l),
          g = (0, i.useRef)(null),
          [b, x] = (0, i.useState)(() =>
            u.getJSON("loadChartDialog.viewState", te),
          ),
          w = (0, i.useRef)(null),
          E = (0, i.useRef)(null),
          { chartList: S, favorites: k } = (0, m.useWatchedValueReadonly)({
            watchedValue: r,
          }),
          D = (0, i.useMemo)(
            () =>
              S.map((e) => ({
                ...e,
                description: `${e.symbol}, ${oe(e.interval)}`,
              })),
            [S],
          );
        (0, i.useEffect)(() => {
          d.CheckMobile.any() || (0, a.ensureNotNull)(w.current).focus();
        }, []);
        const M = (0, i.useRef)();
        (0, i.useEffect)(
          () => (
          ...
          B = (0, i.useMemo)(() => {
            return (0, Q.rankedSearch)({
              data: D.sort(
                ((e = b.sortDirection),
                (t, n) => {
                  if (!U.showFavoriteLayouts) {
                    if (k[t.id] && !k[n.id]) return -1;
                    if (!k[t.id] && k[n.id]) return 1;
                  }
                  const o = 0 === e ? 1 : -1;
                  return "modified" === b.sortField
                    ? o * (t.modified - n.modified)
                    : o * t.name.localeCompare(n.name);
                }),
              ),
              rules: (0, Q.createRegExpList)(l),
              queryString: l,
              primaryKey: "name",
              secondaryKey: "description",
            });
            var e;
          }, [l, b, D, !U.showFavoriteLayouts && k]),
          {
            selectedItemIndex: L,
        ...
        return i.createElement(h.AdaptivePopupDialog, {
          ...
          isOpened: !0,
          className: ee.dialog,
          title: c.t(null, void 0, n(79825)),
          dataName: "load-layout-dialog",
          render: function () {
            return i.createElement(
              i.Fragment,
              null,
              i.createElement(N.DialogSearch, {
                reference: w,
                onChange: W,
                placeholder: c.t(null, void 0, n(8573)),
              }),
              i.createElement(
                R,
                { className: s()(!re && ee.contentHeader) },
                i.createElement(P, { title: c.t(null, void 0, n(11478)) }),
                i.createElement(
                  C,
                  {
                    sortDirection: b.sortDirection,
                    title: c.t(null, void 0, n(5191)),
                    "data-name": "load-chart-dialog-sort-button",
                  },
                  i.createElement(y, {
                    label: c.t(null, void 0, n(21329)),
                    listSortField: b.sortField,
                    itemSortField: "title",
                    listSortDirection: b.sortDirection,
                    itemSortDirection: 0,
                    onClick: H,
                    "data-name": "load-chart-dialog-sort-menu-item",
                  }),
                  i.createElement(y, {
                    label: c.t(null, void 0, n(11324)),
                    listSortField: b.sortField,
                    itemSortField: "title",
                    listSortDirection: b.sortDirection,
                    itemSortDirection: 1,
              ...
              i.createElement(O, {
                ...
                onScroll: I,
                innerElementType: ne,
                itemKey: (e) => (k[B[e].id] ? "f_" : "") + B[e].id,
                children: ({ style: e, index: n }) =>
                  i.createElement(
                    "div",
                    { style: e },
                    i.createElement(Y, {
        ...
        function _() {
          (0, a.ensureNotNull)(g.current).focus();
        }
        function H(e, t) {
          const n = { sortField: e, sortDirection: t };
          x(n),
            u.setValue("loadChartDialog.viewState", JSON.stringify(n), {
              forceFlush: !0,
            }),
            T();
        }
      ...
      var le = n(29280),
        se = n(28124);
      class ae extends le.DialogRenderer {
        constructor(e) {
