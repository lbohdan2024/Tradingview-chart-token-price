(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    92389: (e) => {
      e.exports = { en: ["Clone, Copy"], fa: ["Clone, Copy"] };
    },
    47742: (e) => {
    ...
    80996: (e) => {
      e.exports = { en: ["Local drawings"], fa: ["Local drawings"] };
    },
    37117: (e) => {
    ...
    84212: (e) => {
      e.exports = { en: ["No drawings yet"], fa: ["شکلی رسم نشده است"] };
    },
    92931: (e) => {
      e.exports = { en: ["Synced globally"], fa: ["Synced globally"] };
    },
    41870: (e) => {
      e.exports = { en: ["Synced in layout"], fa: ["Synced in layout"] };
    },
    8182: (e) => {
      e.exports = {
    ...
    93277: (e) => {
      e.exports = { en: ["hide objects"], fa: ["hide objects"] };
    },
    10370: (e) => {
      e.exports = {
    ...
    36044: (e) => {
      e.exports = { en: ["move objects"], fa: ["move objects"] };
    },
    51382: (e) => {
      e.exports = { en: ["show {title}"], fa: ["show {title}"] };
    },
    23771: (e) => {
      e.exports = { en: ["show objects"], fa: ["show objects"] };
    },
    79688: (e) => {
