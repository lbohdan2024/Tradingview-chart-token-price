  ...
  [7260],
  {
    ...
    23829: (e, t, n) => {
      ...
      function p(e) {
        ...
        return i
          ? s.createElement(
              "li",
              { className: a()(t, m.item, m.loading, m[w]) },
          ...
          : s.createElement(
              ...
              W && s.createElement(o.Icon, { className: m.nested, icon: d }),
              k,
            );
      }
    },
    ...
    6190: (e, t, n) => {
      ...
      var s = n(50959),
        ...
        c = n(39416),
        h = n(7047);
      const d = (0, s.forwardRef)(function (e, t) {
        const {
            onKeyDown: n,
            orientation: d,
        ...
        return (
          ...
          s.createElement("div", {
            ...h.MouseClickAutoBlurHandler.attributes(m),
            ...p,
            role: "toolbar",
            "aria-orientation": d,
            ref: g,
    ...
    68426: (e, t, n) => {
      "use strict";
      n.r(t), n.d(t, { BottomToolbarRenderer: () => Ct });
      var s = n(50959),
        i = n(32227),
        a = n(11542),
        o = n(19036),
      ...
      const x = (e) =>
        ...
        E = {
          1: { resolution: "1", text: x(1) },
          3: { resolution: "3", text: x(3) },
          5: { resolution: "5", text: x(5) },
          15: { resolution: "15", text: x(15) },
          30: { resolution: "30", text: x(30) },
          45: { resolution: "45", text: x(45) },
          60: { resolution: "60", text: S(1) },
          120: { resolution: "120", text: S(2) },
          180: { resolution: "180", text: S(3) },
          240: { resolution: "240", text: S(4) },
          "1D": {
            resolution: "1D",
            text:
              ((R = 1),
          ...
          "1M": { resolution: "1M", text: y(1) },
          "3M": { resolution: "3M", text: y(3) },
          "6M": { resolution: "6M", text: y(6) },
          "12M": {
            resolution: "12M",
            text:
              ((M = 1),
      ...
      function B(e) {
        const t = (function (e) {
            const t = e.value.value,
              s = f.Interval.parse(t);
            if (!s.isValid()) {
              if ("YTD" === t)
                return a.t(null, { context: "timeframe_title" }, n(19273));
              if ("ALL" === t)
                return a.t(null, { context: "timeframe_title" }, n(58221));
            ...
            var i;
            var o;
            if (s.isDays()) return w(s.multiplier());
            if (s.isWeeks())
              return ((e) =>
                a.t(
                  null,
      ...
      class T {
        ...
        _updateAvailableRanges(e) {
          ...
          const s = n.model().mainSeries(),
            i = s.symbolInfo(),
            a = s.status();
          if (2 === a || 1 === a || (e && !i)) return;
          const o = t(i, a).map((e) => ({
            ...e,
            description: "" === e.description ? B(e) : e.description,
          }));
          this._setState({ ranges: o });
        }
      }
      const W = (0, _.registryContextType)();
      function A(e) {
        var t;
        return (
          ((t = class extends s.PureComponent {
            constructor(e, t) {
              super(e, t),
                ...
                D.has(t.chartWidget) || D.set(t.chartWidget, new T(t));
              const n = (this._binding = (0, b.ensureDefined)(
                D.get(t.chartWidget),
              ));
              this.state = n.state();
            }
      ...
      function I(e) {
        ...
        return s.createElement(
          ...
          null,
          t.map((e) =>
            s.createElement(z.ContextMenuItem, {
              key: e.value.value,
      ...
      function X(e) {
        ...
        return s.createElement(
          s.Fragment,
          null,
          s.createElement(F.Separator, { className: L.separator }),
          s.createElement(z.ContextMenuItem, {
            icon: H,
            label: (0, P.appendEllipsis)(a.t(null, void 0, n(42432))),
            onClick: t,
            active: !1,
            checked: !1,
            checkable: !1,
      ...
      const O = {
          ...
          goToDate: (0, P.appendEllipsis)(a.t(null, void 0, n(42432))),
        },
        G = (0, _.registryContextType)();
      class j extends s.PureComponent {
        constructor(e, t) {
          super(e, t),
            (this._handleGoToDateClick = () => {
              const { chartWidget: e } = this.context;
              (0, N.showGoToDateDialog)(e), (0, u.globalCloseMenu)();
            }),
          ...
          return s.createElement(
            ...
            (e) =>
              s.createElement(
                h.ToolbarMenuButton,
                {
                  className: l()(L.button, this.props.className),
                  content: O.title,
                  arrow: !0,
      ...
      function q(e) {
        return class extends s.PureComponent {
          ...
          componentDidUpdate() {
            ((0, b.ensureNotNull)(this._slider).style.transition =
              "transform 350ms"),
          ...
          render() {
            ...
            return s.createElement(
              "div",
              { className: r(t, J.tabs), "data-name": this.props["data-name"] },
              n,
              s.createElement(e, {
                reference: (e) => {
                  this._slider = e;
          ...
          _componentDidUpdate() {
            const e = (0, b.ensureNotNull)(this._slider).style;
      ...
      var $ = n(40173),
        Z = n(20792),
        K = n(56905);
      (0, $.mergeThemes)(Z.DEFAULT_TOOLBAR_BUTTON_THEME, K);
      function Y(e) {
        const {
            reference: t,
            text: n,
          ...
          d = r(o, c.item, { [c.isActive]: a });
        return s.createElement(Z.ToolbarButton, {
          ...h,
          ref: t,
          text: n,
          isActive: a,
      ...
      var Q = n(41745);
      const ee = (0, $.mergeThemes)(V, Q);
      var te = n(49564);
      const ne = q(function (e) {
        return s.createElement(
          "div",
          { className: r(e.className, ee.slider), ref: e.reference },
          s.createElement("div", { className: ee.inner }),
        );
      });
      const se = A(function (e) {
        const { className: t, ranges: n, activeRange: i, onSelectRange: a } = e;
        return s.createElement(
          ne,
          { className: r(te.sliderRow, t), "data-name": "date-ranges-tabs" },
          n.map((e) =>
            s.createElement(Y, {
              key: e.value.value,
              value: e.value.value,
      ...
      var ie = n(61814),
        ...
        re = n(92574),
        le = n(3080);
      const ce = (0, ie.hotKeySerialize)({
          keys: [(0, ae.humanReadableModifiers)(ae.Modifiers.Alt, !1), "G"],
          text: "{0} + {1}",
        }),
        he = (0, _.registryContextType)();
      ...
      var me = n(76460),
        ...
        fe = n(40443),
        xe = n(98638);
      const Se = (0, $.mergeThemes)(Z.DEFAULT_TOOLBAR_BUTTON_THEME, {
        isDisabled: xe.disabled,
        button: xe.button,
      });
          ...
          super(e, t),
            ...
            (this._getActions = () => {
              ...
              return (function (e) {
                e.updateActions();
                const t = e.actions();
                return t && t.applyTimeZone instanceof be.Action
            ...
            (this._showMenu = (e) => {
              if (this._preventShowingMenu)
                return void fe.ContextMenuManager.hideAll();
              const t = (0, b.ensureNotNull)(this._element),
                n = this._getActions();
              if (0 === n.length) return;
              const s = t.getBoundingClientRect();
              fe.ContextMenuManager.showMenu(
                n,
      ...
      const We = (0, _.registryContextType)(),
        Ae = new Be.TranslatedString(
          "toggle log scale",
          a.t(null, void 0, n(49403)),
        );
      const De = (0, _.registryContextType)(),
        Ne = new Be.TranslatedString(
          "toggle auto scale",
          a.t(null, void 0, n(42240)),
        );
      const ze = (0, _.registryContextType)(),
        Fe = new Be.TranslatedString(
          "toggle percentage scale",
          a.t(null, void 0, n(98994)),
        );
      const Pe = (0, _.registryContextType)();
      var He = n(42142),
        Le = n(14729),
        Ie = n(16829),
        Xe = n(95700),
        Oe = n(88108);
      const Ge = new Be.TranslatedString(
          "change session",
      ...
      class Je extends s.PureComponent {
        ...
        updateSessionButton() {
          ...
          if (!n.model()) return;
          const s = n.model().mainSeries().symbolInfo();
          if (null === s) return;
          const i = s.subsession_id,
            a =
              null !==
                (t =
                  null === (e = s.subsessions) || void 0 === e
                    ? void 0
          ...
          this.setState({
            sessionId: i,
            sessionName: (0, Xe.translateSessionShortDescription)(
              (null == o ? void 0 : o.description) || "",
            ),
            sessionDescription: (0, Xe.translateSessionDescription)(
              (null == o ? void 0 : o.description) || "",
            ),
            availableSessions: a,
          });
        ...
        _menuItems() {
          ...
          const n = e.model().mainSeries(),
            i = [
              s.createElement(
                ...
                { key: "header_menu_text", className: Oe.headerMenuText },
          ...
          for (const a of t) {
            ...
            i.push(
              s.createElement(p.AccessibleMenuItem, {
                key: a.id,
                label: (0, Xe.translateSessionDescription)(a.description),
      ...
      const tt =
        ((nt = (e) =>
          s.createElement(Z.ToolbarButton, {
            text: Ye.logLabel,
            tooltip: Ye.logHint,
            className: e.className,
            isActive: e.isLogarithm,
            "aria-pressed": e.isLogarithm,
            onClick: ut(e.onClick, "log", e.isLogarithm),
            onMouseEnter: e.onMouseEnter,
            onMouseLeave: e.onMouseLeave,
            "data-name": "logarithm",
          })),
        ((st = class extends s.PureComponent {
          constructor(e, t) {
            super(e, t),
              (this._priceScale = null),
              (this._handleSelect = () => {
                const e = this.context.chartWidget.model(),
                  t = (0, b.ensureNotNull)(this.state.series),
                  n = t.priceScale(),
                  s = n.mode();
                t.priceScale().isLockScale() ||
                  e.setPriceScaleMode({ log: !s.log }, n, Ae);
              }),
              (0, _.validateRegistry)(t, { chartWidget: o.any.isRequired }),
              (this.state = { isActive: !1, series: null }),
              (this._priceAxisHighlighter = new Te(
      ...
      const it = (function (e) {
            ...
            ((t = class extends s.PureComponent {
              constructor(e, t) {
                super(e, t),
                  ...
                  (this._handleSelect = () => {
                    const e = this.context.chartWidget.model(),
                      t = (0, b.ensureNotNull)(this.state.series).priceScale(),
                      n = t.mode();
                    e.setPriceScaleMode({ autoScale: !n.autoScale }, t, Ne);
                  }),
                  (0, _.validateRegistry)(t, { chartWidget: o.any.isRequired }),
                  (this.state = { isActive: !1, series: null }),
                  (this._priceAxisHighlighter = new Te(
          ...
          s.createElement(Z.ToolbarButton, {
            ...
            onClick: ut(e.onClick, "auto", e.isAuto),
            onMouseEnter: e.onMouseEnter,
            onMouseLeave: e.onMouseLeave,
            "data-name": "auto",
          }),
        ...
        at = (function (e) {
                ...
                super(e, t),
                  ...
                  (this._handleSelect = () => {
                    const e = this.context.chartWidget.model(),
                      ...
                      s = n.mode();
                    t.priceScale().isLockScale() ||
                      e.setPriceScaleMode({ percentage: !s.percentage }, n, Fe);
                  }),
                  (0, _.validateRegistry)(t, { chartWidget: o.any.isRequired }),
                  (this.state = { isActive: !1, series: null }),
                  (this._priceAxisHighlighter = new Te(
          ...
          s.createElement(Z.ToolbarButton, {
            icon: qe,
            tooltip: Ye.percentageHint,
            className: e.className,
            isActive: e.isPercentage,
            "aria-pressed": e.isPercentage,
            isDisabled: e.isDisabled,
            onClick: ut(e.onClick, "percent", e.isPercentage),
            onMouseEnter: e.onMouseEnter,
            onMouseLeave: e.onMouseLeave,
            "data-name": "percentage",
          }),
        );
      const ot = (0, ie.hotKeySerialize)({
          keys: [(0, ae.humanReadableModifiers)(ae.Modifiers.Alt, !1), "Enter"],
          text: "{0} + {1}",
        }),
        rt = (function (e) {
          var t;
          ...
          s.createElement(Z.ToolbarButton, {
            icon: e.isFullscreen ? Ze : $e,
            tooltip: e.isFullscreen
              ? Ye.restoreChartHint
              : Ye.maximizeChartHint,
            className: e.className,
            isActive: e.isFullscreen,
            onClick: ut(e.onClick, "maximize chart", e.isFullscreen),
            "data-tooltip-hotkey": ot,
            "data-name": "fullscreen",
          }),
        ),
        lt = { fullscreen: !0, preventPhoneLayout: !0 },
        ct = {
      ...
      class gt extends s.PureComponent {
        constructor(e, t) {
          ...
          super(e, t),
                ...
                if (s.isValidElement(e) && "string" != typeof e.type) {
                  ...
                  if ("string" == typeof t.className) {
                    const i = { className: t.className },
                      o = n(),
                      l = (0, b.ensureDefined)(ht.get(e.type));
                    return s.createElement(
                      "div",
                      {
                        key: null === e.key ? void 0 : e.key,
                        className: r(Ke.inline, o[l] && Ke.collapsed),
                        ref: (e) => a(e, l),
                        onClick: () => dt(),
                      },
                      s.cloneElement(e, i),
            ...
            (this._updateButtonsVisibilityImp = (e) => {
              ...
              const o =
                ((null == i ? void 0 : i.subsessions) || []).filter(
                  (e) => !e.private,
                ).length > 1;
            ...
            (this._resizeHandler = () => {
              const e = this._layout,
                t = (0, b.ensureNotNull)(this._toolbar),
                n = (0, b.ensureNotNull)(this._rangeExpanded),
                s =
                  ((a = (function (e) {
                    const t = {};
                    return (
                  ...
                  Object.keys(a)
                    ...
                    .sort((e, t) => ct[e.name] - ct[t.name]));
              var a;
              const o = t.offsetWidth,
                r = s.reduce((e, t) => e + t.width, 0),
                l = n.offsetWidth,
                c = !Boolean(n.textContent),
                h = o - r - l <= 0 ? "collapsed" : "expanded";
              if (
                (Object.assign(e, { dateRangeMode: h, noRanges: c }),
                "expanded" !== h)
              ) {
                const t =
                  o -
                  (0, b.ensureNotNull)(this._rangeCollapsed).offsetWidth -
                  0;
                let n = 0,
                  i = 0;
                for (const a of s)
        ...
        componentWillUnmount() {
          ...
          t.unsubscribe(this, this._resizeByRaf),
            ...
            t &&
              s.createElement(
                ...
                s.createElement(
                  ...
                  s.createElement(
                    "div",
                    { className: r(Ke.dateRangeCollapsed) },
                    s.createElement(U, {
                      goToDateButton: this.props.goToDateEnabled,
                      className: Ke.dateRange,
                    }),
                  ),
                ),
                s.createElement(
                  "div",
                  {
                    className: r(
                      ...
                      e.noRanges && Ke.noranges,
                    ),
                    ref: this._handleRangeExpandedRef,
                  },
                  s.createElement(
                    "div",
                    { className: r(Ke.dateRangeExpanded) },
                    s.createElement(se, {
                      onSelectRange: this._trackRangeButtonClick,
                      className: Ke.dateRange,
                    }),
                    this.props.goToDateEnabled &&
                      s.createElement(ke, { className: r(Ke.separator) }),
                    this.props.goToDateEnabled && s.createElement(ue, null),
                  ),
                ),
              ),
            s.createElement(
              ...
              n &&
                s.createElement(
                  "div",
                  {
                    className: r(Ke.inline, e.timeZones && Ke.collapsed),
              ...
              this.props.sessionIdButtonEnabled &&
                ...
                s.createElement(
                  "div",
                  {
                    className: r(Ke.inline, e.session && Ke.collapsed),
              ...
              s.createElement(
                "div",
                {
                  ...
                  className: r(Ke.inline, e.separator && Ke.collapsed),
                },
              ...
              s.createElement(
                ...
                i &&
                  ...
                  s.createElement(at, { className: Ke.item }),
                a && s.createElement(tt, { className: Ke.item }),
                o && s.createElement(it, { className: Ke.item }),
                l &&
        ...
        _applyResizing() {
          ...
          this._rangeExpanded &&
            ...
            this._rangeExpanded.classList.toggle(Ke.noranges, t)),
            ...
            if ("separator" !== t) {
              ...
              e &&
                ("timeZones" === t || "session" === t
                  ? (s = s || !a)
                  : (i = i || !a),
                e.classList.toggle(Ke.collapsed, a));
            }
          });
          const a = this._seriesComponents.separator;
          if (a) {
            const e = !s || !i || !0 === n.separator;
            a.classList.toggle(Ke.collapsed, e);
          }
        }
