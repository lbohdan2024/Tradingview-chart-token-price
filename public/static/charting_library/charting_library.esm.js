...
ce.Money, ce.Money, de.Right;
var he, ge, ue, Ce, Se, pe, me, _e, ye, Te, be, Pe, Le, fe, Ae;
function we(e, t) {
  const i = { ...e };
  for (const o in t)
...
const De = class {
  ...
  applyOverrides(e) {
    (this._options = we(this._options, { overrides: e })),
...
export {
  ...
  J as OrderOrPositionMessageType,
  F as OrderStatus,
  M as OrderStatusFilter,
  j as OrderTicketFocusControl,
  D as OrderType,
  oe as OverrideLineStyle,
  ie as OverridePriceAxisLastValueMode,
  U as ParentType,
  ce as PlDisplay,
  pe as PriceScaleMode,
  me as SeriesType,
  k as Side,
  te as StandardFormatterName,
  S as StudyInputType,
  h as StudyPlotDisplayTarget,
  c as StudyPlotType,
  P as StudyTargetPriceScale,
  o as TimeFrameType,
  se as TimeHoursFormat,
  de as TradedGroupHorizontalAlignment,
  Se as VisibilityType,
  Re as version,
  De as widget,
};
