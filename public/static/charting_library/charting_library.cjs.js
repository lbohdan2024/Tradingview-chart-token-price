...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  ...
  (e.ChartDialogsShowGeneralSettingsEventsAndAlertsTab =
  ...
  (e.ChartLinesTogglePrePostMarketLineVisibility =
  ...
  (e.ScreenerAddSymbolToCompare = "Screener.AddSymbolToCompare"),
  ...
  (e.ScreenerOpenSymbolChart = "Screener.OpenSymbolChart"),
  (e.ScreenerOpenSymbolOverview = "Screener.OpenSymbolOverview"),
  ...
  ((A = exports.FilledAreaType || (exports.FilledAreaType = {})).TypePlots =
    "plot_plot"),
  ...
  ((O = exports.ConnectionStatus || (exports.ConnectionStatus = {}))[
    (O.Connected = 1)
  ] = "Connected"),
  (O[(O.Connecting = 2)] = "Connecting"),
  (O[(O.Disconnected = 3)] = "Disconnected"),
  (O[(O.Error = 4)] = "Error"),
  (function (e) {
    (e[(e.LIMIT = 1)] = "LIMIT"),
      (e[(e.MARKET = 2)] = "MARKET"),
  ...
  ((D = exports.OrderType || (exports.OrderType = {}))[(D.Limit = 1)] =
    "Limit"),
  (D[(D.Market = 2)] = "Market"),
  (D[(D.Stop = 3)] = "Stop"),
  (D[(D.StopLimit = 4)] = "StopLimit"),
  (function (e) {
    (e[(e.BUY = 1)] = "BUY"), (e[(e.SELL = -1)] = "SELL");
  })(V || (V = {})),
  ((k = exports.Side || (exports.Side = {}))[(k.Buy = 1)] = "Buy"),
  (k[(k.Sell = -1)] = "Sell"),
  (function (e) {
  ...
  ((x = exports.OrderStatus || (exports.OrderStatus = {}))[(x.Canceled = 1)] =
    "Canceled"),
  (x[(x.Filled = 2)] = "Filled"),
  (x[(x.Inactive = 3)] = "Inactive"),
  (x[(x.Placing = 4)] = "Placing"),
  (x[(x.Rejected = 5)] = "Rejected"),
  (x[(x.Working = 6)] = "Working"),
  ((W = exports.OrderStatusFilter || (exports.OrderStatusFilter = {}))[
    (W.All = 0)
  ] = "All"),
  (W[(W.Canceled = 1)] = "Canceled"),
  (W[(W.Filled = 2)] = "Filled"),
  (W[(W.Inactive = 3)] = "Inactive"),
  (W[(W.Rejected = 5)] = "Rejected"),
  (W[(W.Working = 6)] = "Working"),
  (function (e) {
  ...
  ((N = exports.ParentType || (exports.ParentType = {}))[(N.Order = 1)] =
    "Order"),
  (N[(N.Position = 2)] = "Position"),
  (N[(N.IndividualPosition = 3)] = "IndividualPosition"),
  (function (e) {
    (e[(e.StopLoss = 0)] = "StopLoss"),
  ...
  (j[(j.StopPrice = 2)] = "StopPrice"),
  (j[(j.TakeProfit = 3)] = "TakeProfit"),
  (j[(j.StopLoss = 4)] = "StopLoss"),
  (j[(j.Quantity = 5)] = "Quantity"),
  (function (e) {
    (e[(e.ERROR = 0)] = "ERROR"), (e[(e.SUCCESS = 1)] = "SUCCESS");
  })(z || (z = {})),
  ((G = exports.NotificationType || (exports.NotificationType = {}))[
    (G.Error = 0)
  ] = "Error"),
  ...
  (te.DateOrDateTime = "dateOrDateTime"),
  (te.Default = "default"),
  (te.Fixed = "fixed"),
  (te.FixedInCurrency = "fixedInCurrency"),
  (te.VariablePrecision = "variablePrecision"),
  (te.FormatQuantity = "formatQuantity"),
  (te.FormatPrice = "formatPrice"),
  (te.FormatPriceForexSup = "formatPriceForexSup"),
  (te.FormatPriceInCurrency = "formatPriceInCurrency"),
  (te.IntegerSeparated = "integerSeparated"),
  (te.LocalDate = "localDate"),
  (te.LocalDateOrDateTime = "localDateOrDateTime"),
  (te.Percentage = "percentage"),
  (te.Pips = "pips"),
  (te.Profit = "profit"),
  (te.ProfitInInstrumentCurrency = "profitInInstrumentCurrency"),
  (te.Side = "side"),
  (te.PositionSide = "positionSide"),
  (te.Status = "status"),
  (te.Symbol = "symbol"),
  (te.Text = "text"),
  (te.Type = "type"),
  (te.MarginPercent = "marginPercent"),
  (te.Empty = "empty"),
  ((ie =
    exports.OverridePriceAxisLastValueMode ||
    (exports.OverridePriceAxisLastValueMode = {}))[
    (ie.LastPriceAndPercentageValue = 0)
  ] = "LastPriceAndPercentageValue"),
  (ie[(ie.LastValueAccordingToScale = 1)] = "LastValueAccordingToScale"),
  ((oe = exports.OverrideLineStyle || (exports.OverrideLineStyle = {}))[
    (oe.Solid = 0)
  ] = "Solid"),
  ...
  ((ae = exports.ChartStyle || (exports.ChartStyle = {}))[(ae.Bar = 0)] =
    "Bar"),
  (ae[(ae.Candle = 1)] = "Candle"),
  (ae[(ae.Line = 2)] = "Line"),
  (ae[(ae.Area = 3)] = "Area"),
  (ae[(ae.Renko = 4)] = "Renko"),
  (ae[(ae.Kagi = 5)] = "Kagi"),
  (ae[(ae.PnF = 6)] = "PnF"),
  (ae[(ae.LineBreak = 7)] = "LineBreak"),
  (ae[(ae.HeikinAshi = 8)] = "HeikinAshi"),
  (ae[(ae.HollowCandle = 9)] = "HollowCandle"),
  (ae[(ae.Baseline = 10)] = "Baseline"),
  (ae[(ae.Range = 11)] = "Range"),
  (ae[(ae.HiLo = 12)] = "HiLo"),
  (ae[(ae.Column = 13)] = "Column"),
  (ae[(ae.LineWithMarkers = 14)] = "LineWithMarkers"),
  (ae[(ae.Stepline = 15)] = "Stepline"),
  (ae[(ae.HLCArea = 16)] = "HLCArea"),
  (ae[(ae.VolFootprint = 17)] = "VolFootprint"),
  (ae[(ae.TPO = 18)] = "TPO"),
  (ae[(ae.VolCandle = 19)] = "VolCandle"),
  (ae[(ae.SVP = 20)] = "SVP"),
  ((se =
    exports.TimeHoursFormat || (exports.TimeHoursFormat = {})).TwentyFourHours =
    "24-hours"),
  (se.TwelveHours = "12-hours"),
  (function (e) {
    (e[(e.Initial = 2)] = "Initial"),
      (e[(e.SeriesZOrderIsAlwaysZero = 3)] = "SeriesZOrderIsAlwaysZero"),
      (e[(e.Current = 3)] = "Current");
  })(le || (le = {})),
  ((de = exports.PlDisplay || (exports.PlDisplay = {}))[(de.Money = 0)] =
    "Money"),
  (de[(de.Pips = 1)] = "Pips"),
  (de[(de.Percentage = 2)] = "Percentage"),
  ((ce =
    exports.TradedGroupHorizontalAlignment ||
    (exports.TradedGroupHorizontalAlignment = {}))[(ce.Left = 0)] = "Left"),
  (ce[(ce.Center = 1)] = "Center"),
  (ce[(ce.Right = 2)] = "Right");
exports.PlDisplay.Money,
  exports.PlDisplay.Money,
  exports.TradedGroupHorizontalAlignment.Right;
var he, ge, ue, Ce, pe, Se, me, ye, Te, _e, be, Pe, Le, Ae, we;
function fe(e, t) {
  const i = { ...e };
  for (const o in t)
...
!(function (e) {
  ...
  ((pe = exports.VisibilityType || (exports.VisibilityType = {})).AlwaysOn =
    "alwaysOn"),
  (pe.VisibleOnMouseOver = "visibleOnMouseOver"),
  (pe.AlwaysOff = "alwaysOff"),
  ((Se = exports.PriceScaleMode || (exports.PriceScaleMode = {}))[
    (Se.Normal = 0)
  ] = "Normal"),
  (Se[(Se.Log = 1)] = "Log"),
  (Se[(Se.Percentage = 2)] = "Percentage"),
  (Se[(Se.IndexedTo100 = 3)] = "IndexedTo100"),
  ((me = exports.SeriesType || (exports.SeriesType = {}))[(me.Bars = 0)] =
    "Bars"),
  (me[(me.Candles = 1)] = "Candles"),
  (me[(me.Line = 2)] = "Line"),
  (me[(me.Area = 3)] = "Area"),
  (me[(me.HeikenAshi = 8)] = "HeikenAshi"),
  (me[(me.HollowCandles = 9)] = "HollowCandles"),
  (me[(me.Baseline = 10)] = "Baseline"),
  (me[(me.HiLo = 12)] = "HiLo"),
  (me[(me.Column = 13)] = "Column"),
  (me[(me.LineWithMarkers = 14)] = "LineWithMarkers"),
  (me[(me.Stepline = 15)] = "Stepline"),
  (me[(me.HLCArea = 16)] = "HLCArea"),
  (me[(me.VolCandle = 19)] = "VolCandle"),
  (me[(me.Renko = 4)] = "Renko"),
  (me[(me.Kagi = 5)] = "Kagi"),
  (me[(me.PointAndFigure = 6)] = "PointAndFigure"),
  (me[(me.LineBreak = 7)] = "LineBreak"),
  (function (e) {
    e.Value = "_seriesId";
  })(ye || (ye = {})),
  ((Te = exports.HHistDirection || (exports.HHistDirection = {})).LeftToRight =
    "left_to_right"),
  ...
  ((Pe = exports.MarkLocation || (exports.MarkLocation = {})).AboveBar =
    "AboveBar"),
  (Pe.BelowBar = "BelowBar"),
  (Pe.Top = "Top"),
  (Pe.Bottom = "Bottom"),
  (Pe.Right = "Right"),
  (Pe.Left = "Left"),
  (Pe.Absolute = "Absolute"),
  (Pe.AbsoluteUp = "AbsoluteUp"),
  (Pe.AbsoluteDown = "AbsoluteDown"),
  (function (e) {
  ...
  ((we = exports.LineStyle || (exports.LineStyle = {}))[(we.Solid = 0)] =
    "Solid"),
  (we[(we.Dotted = 1)] = "Dotted"),
...
let Oe = !1;
function Re() {
  return "CL v28.0.0 (internal id 1e591f07 @ 2024-08-13T15:03:46.703Z)";
}
const De = class {
  constructor(e) {
    var t, i;
    ...
    "dark" ===
      ...
      (this._options.debug || this._options.debug_broker) &&
        (Oe ||
          ((Oe = !0),
          console.log(
            "Using CL v28.0.0 (internal id 1e591f07 @ 2024-08-13T15:03:46.703Z)",
          ))),
      this._create();
  }
  setDebugMode(e) {
  ...
  applyOverrides(e) {
    (this._options = fe(this._options, { overrides: e })),
  ...
  _create() {
    ...
    (this._innerWindowLoaded = new Promise((e) => {
      const t = () => {
        s.removeEventListener("load", t, !1), e();
      };
  ...
  _render(e) {
    ...
    const i = (function (e, t) {
      ...
      const o = new URL(`${e || ""}`, location.href).href,
        r = JSON.parse(
          '["bundles/runtime.4a59971d836709dfc991.js","bundles/__LANG__.4026.7e5fb703c7ef1394cbb4.js","bundles/9662.03109f673cda5962c847.css","bundles/7346.b02c4b5d2d08b5be4162.js","bundles/library.b717a95e17e4d6e9f5ca.js"]',
        ),
        n = encodeURIComponent(t),
        a =
          null !== (i = ve.find((e) => e.language === n)) && void 0 !== i
            ? i
            : { iso: "en", dir: "ltr" },
    ...
    if (e) {
      const e = new Blob([i], { type: "text/html" }),
...
(exports.version = Re), (exports.widget = De);
