!(function (e, t) {
  ...
  var ge, ue, Ce, Se, pe, me, ye, Te, _e, be, Pe, Le, Ae, we, fe;
  function Ie(e, t) {
    const i = { ...e };
    for (const o in t)
  ...
  !(function (e) {
    ...
    ((_e = e.HHistDirection || (e.HHistDirection = {})).LeftToRight =
      "left_to_right"),
    (_e.RightToLeft = "right_to_left"),
    (function (e) {
  ...
  const Ve = class {
    ...
    applyOverrides(e) {
      (this._options = Ie(this._options, { overrides: e })),
