...
export class LocalStorageSaveLoadAdapter implements IExternalSaveLoadAdapter {
    public _charts: SavedChartData[] = [];
    public _studyTemplates: StudyTemplateData[] = [];
    public _drawingTemplates: DrawingTemplate[] = [];
    public _chartTemplates: SavedChartTemplate[] = [];
    public _isDirty = false;
    public _drawings: SavedDrawings = {};
